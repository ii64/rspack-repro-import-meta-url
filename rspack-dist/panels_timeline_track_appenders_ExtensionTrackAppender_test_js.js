"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_timeline_track_appenders_ExtensionTrackAppender_test_js"], {
"./panels/timeline/track_appenders/ExtensionTrackAppender.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function initTrackAppender(flameChartData, traceParsedData, entryData, entryTypeByLevel) {
    ...
    return compatibilityTracksAppender.allVisibleTrackAppenders().filter(function(track) {
        return track.appenderName === 'Extension';
    });
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('ExtensionTrackAppender', function() {
    var traceData;
    var extensionTrackAppenders;
    var entryData = [];
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    level = 0;
                    extensionTrackAppenders.forEach(function(appender) {
    ...
    describe('appendTrackAtLevel', function() {
        ...
        it('adds start times correctly', function() {
            var allExtensionTrackEntries = traceData.ExtensionTraceData.extensionTrackData.map(function(track) {
                return Object.values(track.entriesByTrack);
            }).flat(2);
            for(var i = 0; i < allExtensionTrackEntries.length; ++i){
                var event = allExtensionTrackEntries[i];
    ...
    describe('colorForEvent and titleForEvent', function() {
        ...
        it('returns the correct color and title for extension entries', function() {
            ...
            try {
                for(var _iterator = allExtensionTrackEntries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
    ...
    describe('highlightedEntryInfo', function() {
        it('returns the info for an entry correctly', function() {
            ...
            var highlightedEntryInfo = extensionTrackAppenders[0].highlightedEntryInfo(allExtensionTrackEntries[0]);
