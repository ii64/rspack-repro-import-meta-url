"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_ReportingApiView_test_js"], {
"./panels/application/ReportingApiView.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('ReportingApiView', function() {
    var ORIGIN_1 = 'origin1';
    var ENDPOINTS_1 = [
        {
            url: 'url1',
            groupName: 'group1'
    ...
    it('updates endpoints grid when they change', function() {
        ...
        var frameTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)({
        ...
        var networkManager = frameTarget.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.NetworkManager.NetworkManager);
        assert.exists(networkManager);
        var endpointsGrid = new _components_components_js__WEBPACK_IMPORTED_MODULE_4__.EndpointsGrid.EndpointsGrid();
        new _application_js__WEBPACK_IMPORTED_MODULE_3__.ReportingApiView.ReportingApiView(endpointsGrid);
        var endpointsGridData = sinon.spy(endpointsGrid, 'data', [
            'set'
        ]);
        networkManager.dispatchEventToListeners(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.NetworkManager.Events.ReportingApiEndpointsChangedForOrigin, {
            origin: ORIGIN_1,
            endpoints: ENDPOINTS_1
        });
        assert.isTrue(endpointsGridData.set.calledOnce);
        sinon.assert.calledWith(endpointsGridData.set, {
            endpoints: new Map([
                [
                    ORIGIN_1,
                    ENDPOINTS_1
