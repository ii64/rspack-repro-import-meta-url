...
"./panels/snippets/ScriptSnippetFileSystem.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_4__.describeWithMockConnection)('ScriptSnippetFileSystem', function() {
    it('evaluates snippets with user gesture', /*#__PURE__*/ _async_to_generator(function() {
        var uiSourceCode;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    uiSourceCode = new _models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_2__.UISourceCode.UISourceCode({}, 'snippet://test.js', _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.Script);
                    return [
                        4,
                        _snippets_js__WEBPACK_IMPORTED_MODULE_7__.ScriptSnippetFileSystem.evaluateScriptSnippet(uiSourceCode)
                    ];
                case 1:
                    _state.sent();
