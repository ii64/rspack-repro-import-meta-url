...
"./ui/components/docs/issue_counter/basic.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var IssueCounter = await Promise.resolve(/*! import() */ ).then(__webpack_require__.bind(__webpack_require__, /*! ../../../../ui/components/issue_counter/issue_counter.js */ "./ui/components/issue_counter/issue_counter.js"));
function appendComponent(data) {
    var _document_getElementById;
    var component = new IssueCounter.IssueCounter.IssueCounter();
    component.data = data;
...
var mockIssueManager = {
    addEventListener: function addEventListener() {},
    removeEventListener: function removeEventListener() {},
    numberOfIssues: function numberOfIssues() {
        return 1;
    }
};
appendComponent({
    issuesManager: mockIssueManager
});
appendComponent({
    issuesManager: mockIssueManager,
