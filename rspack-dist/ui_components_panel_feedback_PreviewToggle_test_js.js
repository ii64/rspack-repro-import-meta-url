"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_components_panel_feedback_PreviewToggle_test_js"], {
"./ui/components/panel_feedback/PreviewToggle.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('Preview toggle', function() {
    it('calls out correctly to enable experiment', /*#__PURE__*/ _async_to_generator(function() {
        var isEnabledStub, setEnabledStub, spy, component, input;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    isEnabledStub = sinon.stub(_core_root_root_js__WEBPACK_IMPORTED_MODULE_0__.Runtime.experiments, 'isEnabled');
                    isEnabledStub.callsFake(function() {
                        return false;
                    });
                    setEnabledStub = sinon.stub(_core_root_root_js__WEBPACK_IMPORTED_MODULE_0__.Runtime.experiments, 'setEnabled');
                    setEnabledStub.callsFake(function() {});
                    spy = sinon.spy();
                    component = new _panel_feedback_js__WEBPACK_IMPORTED_MODULE_4__.PreviewToggle.PreviewToggle();
                    component.data = {
                        name: 'toggle name',
    ...
    it('calls out correctly to disable experiment', /*#__PURE__*/ _async_to_generator(function() {
        var isEnabledStub, setEnabledStub, spy, component, input;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
