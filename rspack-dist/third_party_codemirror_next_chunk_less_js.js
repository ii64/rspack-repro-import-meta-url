"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["third_party_codemirror_next_chunk_less_js"], {
"./third_party/codemirror.next/chunk/less.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  less: function() { return Z; },
  lessCompletionSource: function() { return W; },
  lessLanguage: function() { return s; }
});
...
var X = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, T) {
    if (40 == O.next) {
        var _$T = O.peek(-1);
        (y(_$T) || (_$Q = _$T) >= 48 && _$Q <= 57 || 95 == _$T || 45 == _$T) && O.acceptToken(2, 1);
    }
    var _$Q;
}), P = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O) {
    if ($.indexOf(O.peek(-1)) > -1) {
        var _$T = O.next;
        (y(_$T) || 95 == _$T || 35 == _$T || 46 == _$T || 91 == _$T || 58 == _$T || 45 == _$T) && O.acceptToken(110);
    }
}), m = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O) {
    if ($.indexOf(O.peek(-1)) < 0) {
        var _$T = O.next;
        if (37 == _$T && (O.advance(), O.acceptToken(1)), y(_$T)) {
            do {
                O.advance();
            }while (y(O.next));
            O.acceptToken(1);
...
}), n = (0,_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.s)({
    "import charset namespace keyframes media supports when": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.definitionKeyword,
    "from to selector": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.keyword,
    ...
    ClassName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.className,
    ...
    "FeatureName PropertyName PropertyVariable": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.propertyName,
    ...
    "AtKeyword Interpolation": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.special(_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.variableName),
    ...
    "UniversalSelector NestingSelector": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.definitionOperator,
    ...
    Important: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.modifier,
    "Comment LineComment": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.blockComment,
    ...
    Escape: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.special(_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.string),
    ...
    "@keyframes": 166,
    "@supports": 178
}, p = _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.b.deserialize({
    version: 14,
    ...
    tokenPrec: 2180
}), s = _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.L.define({
    name: "less",
    parser: p.configure({
        props: [
...
}), W = (0,_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.k)(function(O) {
    return "VariableName" == O.name || "AtKeyword" == O.name;
});
function Z() {
    return new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.a(s, s.data.of({
        autocomplete: W
    }));
}
