...
"./ui/components/docs/recorder_create_recording_view/basic.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var _document_getElementById, _document_getElementById1, _component2_shadowRoot_querySelector, _component2_shadowRoot;
...
var component1 = new _panels_recorder_components_components_js__WEBPACK_IMPORTED_MODULE_1__.CreateRecordingView.CreateRecordingView();
(_document_getElementById = document.getElementById('container')) === null || _document_getElementById === void 0 ? void 0 : _document_getElementById.appendChild(component1);
var component2 = new _panels_recorder_components_components_js__WEBPACK_IMPORTED_MODULE_1__.CreateRecordingView.CreateRecordingView();
(_document_getElementById1 = document.getElementById('container')) === null || _document_getElementById1 === void 0 ? void 0 : _document_getElementById1.appendChild(component2);
(_component2_shadowRoot = component2.shadowRoot) === null || _component2_shadowRoot === void 0 ? void 0 : (_component2_shadowRoot_querySelector = _component2_shadowRoot.querySelector('devtools-control-button')) === null || _component2_shadowRoot_querySelector === void 0 ? void 0 : _component2_shadowRoot_querySelector.click(); //# sourceMappingURL=basic.js.map
