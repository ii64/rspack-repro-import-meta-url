"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_network_RequestPreviewView_test_js-ui_components_report_view_report_view_js"], {
"./panels/network/RequestPreviewView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */var _network_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./network.js */ "./panels/network/network.js");
...
function contentData() {
    return _contentData.apply(this, arguments);
}
function _contentData() {
    _contentData = _async_to_generator(function() {
        var content;
        return _ts_generator(this, function(_state) {
            content = '<style> p { color: red; }</style><link rel="stylesheet" ref="http://devtools-frontend.test/style">';
            return [
                2,
                new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData(content, false, 'text/css')
            ];
        });
    });
    return _contentData.apply(this, arguments);
...
function renderPreviewView(request) {
    var component = new _network_js__WEBPACK_IMPORTED_MODULE_5__.RequestPreviewView.RequestPreviewView(request);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithLocale)('RequestPreviewView', function() {
    it('prevents previewed html from making same-site requests', /*#__PURE__*/ _async_to_generator(function() {
        var request, component, widget, frame;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'http://devtools-frontend.test/content', '', null, null, null);
                    request.setContentDataProvider(contentData);
                    request.mimeType = "text/html" /* Platform.MimeType.MimeType.HTML */ ;
                    component = renderPreviewView(request);
                    return [
                        4,
                ...
                case 1:
                    widget = _state.sent();
                    frame = widget.contentElement.querySelector('iframe');
                    expect(frame).to.be.not.null;
                    expect(frame === null || frame === void 0 ? void 0 : frame.getAttribute('csp')).to.eql('default-src \'none\';img-src data:;style-src \'unsafe-inline\'');
                    component.detach();
                    return [
                        2
                    ];
    ...
    it('does add utf-8 charset to the data URL for the HTML preview for already decoded content', /*#__PURE__*/ _async_to_generator(function() {
        var request, component, widget, frame;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'http://devtools-frontend.test/index.html', '', null, null, null);
                    request.setContentDataProvider(function() {
                        return Promise.resolve(new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData('<!DOCTYPE html>\n<p>Iñtërnâtiônàlizætiøn☃𝌆</p>', false, 'text/html', 'utf-16'));
                    });
                    request.mimeType = "text/html" /* Platform.MimeType.MimeType.HTML */ ;
    ...
    it('does add the correct charset to the data URL for the HTML preview for base64 content', /*#__PURE__*/ _async_to_generator(function() {
        var request, component, widget, frame;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    request.setContentDataProvider(function() {
                        return Promise.resolve(new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData('//48ACEARABPAEMAVABZAFAARQAgAGgAdABtAGwAPgAKADwAcAA+AEkA8QB0AOsAcgBuAOIAdABpAPQAbgDgAGwAaQB6AOYAdABpAPgAbgADJjTYBt88AC8AcAA+AAoA', true, 'text/html', 'utf-16'));
                    });
                    request.mimeType = "text/html" /* Platform.MimeType.MimeType.HTML */ ;
                    request.setCharset('utf-16');
                    assert.strictEqual(request.charset(), 'utf-16');
