...
"./models/trace/handlers/MemoryHandler.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('MemoryHandler', function() {
    ...
    it('gathers update counters', /*#__PURE__*/ _async_to_generator(function() {
        var _data_updateCountersByProcess_get, events, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event, data, meta, topLevelProcesses, expectedPid;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 2:
                    _state.sent();
                    data = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.Memory.data();
                    meta = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.Meta.data();
                    topLevelProcesses = Array.from(meta.topLevelRendererIds);
                    expectedPid = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.ProcessID(73704);
                    assert.deepEqual(topLevelProcesses, [
                        expectedPid
                    ]);
                    assert.strictEqual((_data_updateCountersByProcess_get = data.updateCountersByProcess.get(expectedPid)) === null || _data_updateCountersByProcess_get === void 0 ? void 0 : _data_updateCountersByProcess_get.length, 158);
                    return [
                        2
                    ];
            }
