...
"./panels/recorder/converters/PuppeteerReplayConverter.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('PuppeteerReplayConverter', function() {
    it('should stringify a flow', /*#__PURE__*/ _async_to_generator(function() {
        var converter, _ref, result, sourceMap;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    converter = new _converters_js__WEBPACK_IMPORTED_MODULE_1__.PuppeteerReplayConverter.PuppeteerReplayConverter('  ');
                    return [
                        4,
                        converter.stringify({
                            title: 'test',
