"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_components_ComputedStyleTrace_test_js"], {
"./panels/elements/components/ComputedStyleTrace.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('ComputedStyleTrace', function() {
    it('renders ComputedStyleTrace selector correctly', function() {
        var component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.ComputedStyleTrace.ComputedStyleTrace();
        ...
        component.data = data;
        var renderedSelector = component.shadowRoot.querySelector('.trace-selector');
        if (!renderedSelector) {
    ...
    it('has a clickable goto icon and trace value', function() {
        var component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.ComputedStyleTrace.ComputedStyleTrace();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
        var clickCounter = 0;
        var data = {
        ...
        component.data = data;
        var goto = component.shadowRoot.querySelector('.goto');
        if (!goto) {
        ...
        var traceValue = component.shadowRoot.querySelector('slot[name="trace-value"]');
        if (!traceValue) {
