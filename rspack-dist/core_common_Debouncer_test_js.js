...
"./core/common/Debouncer.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('Debouncer', function() {
    it('debounces correctly', function(done) {
        ...
        var count = 0;
        var debouncedIncrement = _common_js__WEBPACK_IMPORTED_MODULE_0__.Debouncer.debounce(increment, 10);
