"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_preloading_components_PreloadingString_js"], {
"./panels/application/preloading/components/PreloadingString.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  PrefetchReasonDescription: function() { return PrefetchReasonDescription; },
  capitalizedAction: function() { return capitalizedAction; },
  composedStatus: function() { return composedStatus; },
  prefetchFailureReason: function() { return prefetchFailureReason; },
  prerenderFailureReason: function() { return prerenderFailureReason; },
  ruleSetLocationShort: function() { return ruleSetLocationShort; },
...
var str_ = _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_0__.i18n.registerUIStrings('panels/application/preloading/components/PreloadingString.ts', UIStrings);
...
var PrefetchReasonDescription = {
    ...
    'PrefetchFailedInvalidRedirect': {
        name: i18nLazyString(UIStrings.PrefetchFailedInvalidRedirect)
    },
    'PrefetchFailedMIMENotSupported': {
        name: i18nLazyString(UIStrings.PrefetchFailedMIMENotSupported)
    },
    'PrefetchFailedNetError': {
        name: i18nLazyString(UIStrings.PrefetchFailedNetError)
    },
    'PrefetchFailedNon2XX': {
        name: i18nLazyString(UIStrings.PrefetchFailedNon2XX)
    },
    'PrefetchFailedPerPageLimitExceeded': {
        name: i18nLazyString(UIStrings.PrefetchFailedPerPageLimitExceeded)
    },
    'PrefetchIneligibleRetryAfter': {
        name: i18nLazyString(UIStrings.PrefetchIneligibleRetryAfter)
    },
    'PrefetchIsPrivacyDecoy': {
        name: i18nLazyString(UIStrings.PrefetchIsPrivacyDecoy)
    },
    'PrefetchIsStale': {
        name: i18nLazyString(UIStrings.PrefetchIsStale)
    },
    ...
    'PrefetchNotUsedCookiesChanged': {
        name: i18nLazyString(UIStrings.PrefetchNotUsedCookiesChanged)
    },
    'PrefetchProxyNotAvailable': {
        name: i18nLazyString(UIStrings.PrefetchProxyNotAvailable)
    },
    'PrefetchNotUsedProbeFailed': {
        name: i18nLazyString(UIStrings.PrefetchNotUsedProbeFailed)
    },
...
function prefetchFailureReason(param) {
    var prefetchStatus = param.prefetchStatus;
    ...
    switch(prefetchStatus){
        ...
        default:
            ...
            return _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_0__.i18n.lockedString("Unknown failure reason: ".concat(prefetchStatus));
    }
}
...
function prerenderFailureReason(attempt) {
    ...
    switch(attempt.prerenderStatus){
        ...
        default:
            ...
            return _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_0__.i18n.lockedString("Unknown failure reason: ".concat(attempt.prerenderStatus));
    }
}
...
function composedStatus(attempt) {
    var short = status(attempt.status);
    ...
    switch(attempt.action){
        case "Prefetch" /* Protocol.Preload.SpeculationAction.Prefetch */ :
            {
                var _prefetchFailureReason;
                var detail = (_prefetchFailureReason = prefetchFailureReason(attempt)) !== null && _prefetchFailureReason !== void 0 ? _prefetchFailureReason : _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_0__.i18n.lockedString('Internal error');
                return short + ' - ' + detail;
            }
        case "Prerender" /* Protocol.Preload.SpeculationAction.Prerender */ :
            {
                var detail1 = prerenderFailureReason(attempt);
                (0,_core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.assertNotNullOrUndefined)(detail1);
                return short + ' - ' + detail1;
            }
    }
