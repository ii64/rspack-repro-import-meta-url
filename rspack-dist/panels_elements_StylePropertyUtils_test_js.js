...
"./panels/elements/StylePropertyUtils.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('StylePropertyUtils', function() {
    it('convert CSS declaration to JS property', function() {
        assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_1__.StylePropertyUtils.getCssDeclarationAsJavascriptProperty({
            name: 'display',
            value: 'flex'
        }), 'display: \'flex\'');
        assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_1__.StylePropertyUtils.getCssDeclarationAsJavascriptProperty({
        ...
        assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_1__.StylePropertyUtils.getCssDeclarationAsJavascriptProperty({
            ...
            value: 'var(--color-background-elevation-1)'
