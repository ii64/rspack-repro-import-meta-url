...
"./models/trace/handlers/LargestTextPaintHandler.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('LargestTextPaintHandler', function() {
    ...
    it('creates a map of DOM Node IDs to Text candidates', /*#__PURE__*/ _async_to_generator(function() {
        var _textCandidate_args_data, events, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event, data, textCandidate;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_0__.TraceLoader.rawEvents(this, 'lcp-web-font.json.gz')
                    ];
                case 1:
                    events = _state.sent();
                    ...
                    data = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.LargestTextPaint.data();
                    assert.strictEqual(data.size, 1);
                    textCandidate = data.get(8);
                    assert.exists(textCandidate);
                    assert.strictEqual(textCandidate === null || textCandidate === void 0 ? void 0 : (_textCandidate_args_data = textCandidate.args.data) === null || _textCandidate_args_data === void 0 ? void 0 : _textCandidate_args_data.DOMNodeId, 8);
                    return [
                        2
                    ];
            }
