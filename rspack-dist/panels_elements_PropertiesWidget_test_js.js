"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_PropertiesWidget_test_js"], {
"./panels/elements/PropertiesWidget.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var NODE_ID = 1;
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('PropertiesWidget', function() {
    var target;
    var view;
    beforeEach(function() {
    ...
    var updatesUiOnEvent = function(event, inScope) {
        return /*#__PURE__*/ _async_to_generator(function() {
            var _model, model, node, populateWithProperties;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        model = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.DOMModel.DOMModel);
                        assert.exists(model);
                        node = new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.DOMModel.DOMNode(model);
                    ...
                    case 1:
                        _state.sent();
                        populateWithProperties = sinon.spy(_ui_legacy_components_object_ui_object_ui_js__WEBPACK_IMPORTED_MODULE_3__.ObjectPropertiesSection.ObjectPropertyTreeElement, 'populateWithProperties');
