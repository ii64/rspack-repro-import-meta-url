...
"./models/trace/handlers/GPUHandler.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('GPUHandler', function() {
    ...
    it('finds all the GPU Tasks for the main GPU Thread', /*#__PURE__*/ _async_to_generator(function() {
        var events, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event, gpuEvents;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_0__.TraceLoader.rawEvents(this, 'threejs-gpu.json.gz')
                    ];
                case 1:
                    events = _state.sent();
                ...
                case 2:
                    ...
                    return [
                        4,
                        _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.GPU.finalize()
                    ];
                case 3:
                    _state.sent();
                    gpuEvents = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.GPU.data().mainGPUThreadTasks;
