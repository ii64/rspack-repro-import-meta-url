...
"./ui/components/docs/tree_outline/lazy-children.js": (function (module, __webpack_exports__, __webpack_require__) {
...
function loadInSomeNodes() {
    return _loadInSomeNodes.apply(this, arguments);
}
function _loadInSomeNodes() {
    _loadInSomeNodes = _async_to_generator(function() {
        var europeanOffices;
        return _ts_generator(this, function(_state) {
            ...
            return [
                ...
                new Promise(function(resolve) {
                    setTimeout(function() {
                        return resolve(europeanOffices);
                    }, 250);
                })
            ];
        });
