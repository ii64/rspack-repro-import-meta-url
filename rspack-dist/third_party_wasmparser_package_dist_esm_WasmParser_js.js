"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["third_party_wasmparser_package_dist_esm_WasmParser_js"], {
"./third_party/wasmparser/package/dist/esm/WasmParser.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  BinaryReader: function() { return BinaryReader; },
  BinaryReaderState: function() { return BinaryReaderState; },
  DataMode: function() { return DataMode; },
  ElementMode: function() { return ElementMode; },
  ExternalKind: function() { return ExternalKind; },
  Int64: function() { return Int64; },
  LinkingType: function() { return LinkingType; },
  NameType: function() { return NameType; },
  OperatorCode: function() { return OperatorCode; },
  OperatorCodeNames: function() { return OperatorCodeNames; },
  RelocType: function() { return RelocType; },
  SectionCode: function() { return SectionCode; },
  Type: function() { return Type; },
  TypeKind: function() { return TypeKind; },
  bytesToString: function() { return bytesToString; }
});
...
var Type = function Type(kind) {
    "use strict";
    var index = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1, depth = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : -1;
    _class_call_check(this, Type);
    if (kind < 0 || kind === 0 && index >= 0) {
    // all good
    } else {
        throw new Error("invalid type: ".concat(kind, "/").concat(index, "/").concat(depth));
    }
    this.kind = kind;
    this.index = index;
    this.depth = depth;
    // Canonicalize (ref any) to (anyref) etc.
    if (index === -16 /* funcref */  && kind === -20 /* optref */  || index === -17 /* externref */  && kind === -20 /* optref */  || index === -18 /* anyref */  && kind === -20 /* optref */  || index === -19 /* eqref */  && kind === -20 /* optref */  || index === -22 /* i31ref */  && kind === -21 /* ref */  || index === -25 /* dataref */  && kind === -21 /* ref */ ) {
        this.kind = index;
        this.index = -1;
    }
};
...
var DataRange = /*#__PURE__*/ function() {
    "use strict";
    function DataRange(start, end) {
        _class_call_check(this, DataRange);
        this.start = start;
        this.end = end;
    }
    _create_class(DataRange, [
        {
            key: "offset",
        ...
        },
        {
            ...
            value: function toDouble() {
                ...
                if (this._data[7] & 0x80) {
                    sum = -1;
                    for(var i = 0; i < 8; i++, power *= 256)sum -= power * (0xff ^ this._data[i]);
                } else {
                    sum = 0;
...
var BinaryReader = /*#__PURE__*/ function() {
    ...
    _create_class(BinaryReader, [
        ...
        {
            key: "setData",
            value: function setData(buffer, pos, length, eof) {
        ...
        {
            key: "readVarUint1",
            value: function readVarUint1() {
                return this.readUint8();
            }
        },
        {
            key: "readVarInt7",
            value: function readVarInt7() {
                return this.readUint8() << 25 >> 25;
            }
        },
        {
            key: "readVarUint7",
            value: function readVarUint7() {
                return this.readUint8();
            }
        },
        {
        ...
        {
            key: "readTypeInternal",
            value: function readTypeInternal(kind) {
                if (kind === -21 /* ref */  || kind === -20 /* optref */  || kind === -24 /* rtt */ ) {
        ...
        {
            key: "readStringBytes",
            value: function readStringBytes() {
        ...
        {
            key: "hasSectionPayload",
            value: function hasSectionPayload() {
                return this.hasBytes(this._sectionRange.end - this._pos);
            }
        },
        {
            key: "readFuncType",
            value: function readFuncType() {
        ...
        {
            key: "readFuncSubtype",
            value: function readFuncSubtype() {
        ...
        {
            key: "readStructSubtype",
            value: function readStructSubtype() {
        ...
        {
            key: "readArraySubtype",
            value: function readArraySubtype() {
        ...
        {
            key: "readResizableLimits",
            value: function readResizableLimits(maxPresent) {
        ...
        {
            key: "readImportEntry",
            value: function readImportEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readExportEntry",
            value: function readExportEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readFunctionEntry",
            value: function readFunctionEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readMemoryEntry",
            value: function readMemoryEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readGlobalEntry",
            value: function readGlobalEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readElementEntry",
            value: function readElementEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readElementEntryBody",
            value: function readElementEntryBody() {
        ...
        {
            key: "readDataEntryBody",
            value: function readDataEntryBody() {
        ...
        {
            key: "readInitExpressionBody",
            value: function readInitExpressionBody() {
        ...
        {
            key: "readOffsetExpressionBody",
            value: function readOffsetExpressionBody() {
        ...
        {
            key: "readMemoryImmediate",
            value: function readMemoryImmediate() {
                var flags = this.readVarUint32();
        ...
        {
            key: "readRelocHeader",
            value: function readRelocHeader() {
        ...
        {
            key: "readLinkingEntry",
            value: function readLinkingEntry() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readSourceMappingURL",
            value: function readSourceMappingURL() {
        ...
        {
            key: "readCodeOperator_0xfb",
            value: function readCodeOperator_0xfb() {
        ...
        {
            key: "readCodeOperator_0xfc",
            value: function readCodeOperator_0xfc() {
                if (!this.hasVarIntBytes()) {
                    return false;
                }
        ...
        {
            key: "readCodeOperator_0xfd",
            value: function readCodeOperator_0xfd() {
        ...
        {
            key: "readCodeOperator_0xfe",
            value: function readCodeOperator_0xfe() {
        ...
        {
            key: "readCodeOperator",
            value: function readCodeOperator() {
                switch(this.state){
                    ...
                    case 26 /* INIT_EXPRESSION_OPERATOR */ :
                        if (this.result && this.result.code === 11 /* end */ ) {
                ...
                if (this.state === 26 /* INIT_EXPRESSION_OPERATOR */  && this._sectionId === 9 /* Element */  && isExternvalElementSegmentType(this._segmentType)) {
                    // We are reading a `vec(funcidx)` here, which is a dense encoding
                    // for a sequence of `((ref.func y) end)` instructions.
                    if (this.result && this.result.code === 210 /* ref_func */ ) {
                        code = 11 /* end */ ;
                    } else {
                        if (!this.hasVarIntBytes()) return false;
                        code = 210 /* ref_func */ ;
        ...
        {
            key: "readFunctionBody",
            value: function readFunctionBody() {
                if (this._sectionEntriesLeft === 0) {
                    this.skipSection();
                    return this.read();
                }
        ...
        {
            key: "readSectionHeader",
            value: function readSectionHeader() {
        ...
        {
            key: "readSectionRawData",
            value: function readSectionRawData() {
        ...
        {
            key: "readSectionBody",
            value: function readSectionBody() {
        ...
        },
        {
            ...
            value: function skipSection() {
                if (this.state === -1 /* ERROR */  || this.state === 0 /* INITIAL */  || this.state === 4 /* END_SECTION */  || this.state === 1 /* BEGIN_WASM */  || this.state === 2 /* END_WASM */ ) return;
                this.state = 5 /* SKIPPING_SECTION */ ;
            }
        },
        {
            key: "skipFunctionBody",
            value: function skipFunctionBody() {
                if (this.state !== 28 /* BEGIN_FUNCTION_BODY */  && this.state !== 30 /* CODE_OPERATOR */ ) return;
                this.state = 32 /* SKIPPING_FUNCTION_BODY */ ;
            }
        },
        {
            key: "skipInitExpression",
            value: function skipInitExpression() {
                while(this.state === 26 /* INIT_EXPRESSION_OPERATOR */ )this.readCodeOperator();
            }
        },
        {
            key: "fetchSectionRawData",
            value: function fetchSectionRawData() {
