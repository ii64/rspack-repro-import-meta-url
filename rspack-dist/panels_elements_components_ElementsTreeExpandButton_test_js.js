"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_components_ElementsTreeExpandButton_test_js"], {
"./panels/elements/components/ElementsTreeExpandButton.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('Elements tree expand button', function() {
    it('render and click handler trigger correctly', /*#__PURE__*/ _async_to_generator(function() {
        var component, clicks, clickHandler, button;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.ElementsTreeExpandButton.ElementsTreeExpandButton();
                    clicks = 0;
                ...
                case 1:
                    _state.sent();
                    button = component.shadowRoot.querySelector('.expand-button');
    ...
    it('it should only contains html tags, no other visible characters', /*#__PURE__*/ _async_to_generator(function() {
        var component, noop, button;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.ElementsTreeExpandButton.ElementsTreeExpandButton();
