"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_components_docs_console_insight_basic_js"], {
...
"./ui/components/docs/console_insight/basic.js": (function (module, __webpack_exports__, __webpack_require__) {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            _await_async_generator(new Promise(function(resolve) {
