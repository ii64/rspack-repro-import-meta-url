...
"./panels/application/StorageBucketsTreeElement.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('StorageBucketsTreeElement', function() {
    ...
    var getNonDefaultBuckets = function() {
        return STORAGE_BUCKET_INFOS.filter(function(param) {
            var bucket = param.bucket;
            return bucket.name !== undefined;
        });
    };
    ...
    beforeEach(/*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            ...
            storageKeyManager = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.StorageKeyManager.StorageKeyManager);
    ...
    it('adds bucket tree elements on non default buckets added', /*#__PURE__*/ _async_to_generator(function() {
        var panel, parentTreeElement, appendChildSpy;
        return _ts_generator(this, function(_state) {
            assert.exists(storageBucketsModel);
            ...
            panel = _application_js__WEBPACK_IMPORTED_MODULE_5__.ResourcesPanel.ResourcesPanel.instance({
                forceNew: true
            });
            panel.markAsRoot();
            panel.show(document.body);
            parentTreeElement = new _application_js__WEBPACK_IMPORTED_MODULE_5__.StorageBucketsTreeElement.StorageBucketsTreeParentElement(panel);
            appendChildSpy = sinon.spy(parentTreeElement, 'appendChild');
    ...
    it('shows view on select', /*#__PURE__*/ _async_to_generator(function() {
        var panel, treeElement, showViewSpy;
        return _ts_generator(this, function(_state) {
            assert.exists(storageBucketsModel);
            panel = _application_js__WEBPACK_IMPORTED_MODULE_5__.ResourcesPanel.ResourcesPanel.instance({
                forceNew: true
            ...
            panel.markAsRoot();
            panel.show(document.body);
            treeElement = new _application_js__WEBPACK_IMPORTED_MODULE_5__.StorageBucketsTreeElement.StorageBucketsTreeElement(panel, storageBucketsModel, STORAGE_BUCKET_INFOS[0]);
            showViewSpy = sinon.spy(treeElement, 'showView');
