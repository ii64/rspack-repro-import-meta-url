...
"./panels/settings/emulation/utils/StructuredHeaders.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function makeItem(bareItem) {
    return {
        ...
        value: bareItem,
        parameters: {
            kind: 3 /* StructuredHeaders.ResultKind.PARAMETERS */ ,
            items: []
        }
    };
}
    ...
    try {
        for(var _iterator = params[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            typedParams.items.push({
                ...
                name: {
                    kind: 1 /* StructuredHeaders.ResultKind.PARAM_NAME */ ,
                    value: param[0]
                },
                value: param[1]
            });
...
function makeList(items) {
    return {
        kind: 11 /* StructuredHeaders.ResultKind.LIST */ ,
        items: items
    };
}
function makeInnerList(items, params) {
    return {
        kind: 12 /* StructuredHeaders.ResultKind.INNER_LIST */ ,
        items: items,
        parameters: makeParams(params)
    };
}
describe('StructuredHeaders', function() {
    describe('Parsing', function() {
        ...
        it('Parses parameters', function() {
            var r1 = StructuredHeaders.parseItem('token; a=1; b=?0');
            assertItemToken(r1, 'token');
            assertItemParams(r1, [
                [
                    'a',
                    {
                        kind: 5 /* StructuredHeaders.ResultKind.INTEGER */ ,
                        value: 1
                    }
                ],
                [
                    'b',
                    {
                        kind: 10 /* StructuredHeaders.ResultKind.BOOLEAN */ ,
                        value: false
                    }
                ]
            ]);
            var r2 = StructuredHeaders.parseItem('token; a; b=?0');
            ...
            var r3 = StructuredHeaders.parseItem('token; *a123-456.789_0*');
        ...
        it('Handles duplicate parameter names per spec', function() {
            var r = StructuredHeaders.parseItem('toooken; a=1; b=?0; a=2; c=4.2; b=?1; a=4; b="hi"');
            assertItemToken(r, 'toooken');
            assertItemParams(r, [
                [
                    'c',
                    {
                        kind: 6 /* StructuredHeaders.ResultKind.DECIMAL */ ,
                        value: 4.2
                    }
                ],
                [
                ...
                [
                    'b',
                    {
                        kind: 7 /* StructuredHeaders.ResultKind.STRING */ ,
                        value: 'hi'
                    }
                ]
            ]);
        ...
        it('Parses lists', function() {
            var items = assertListAndGetItems(StructuredHeaders.parseList('a, \t"b", ?0;d;e=42'));
            assert.lengthOf(items, 3);
            assertListItem(items[0], {
                kind: 8 /* StructuredHeaders.ResultKind.TOKEN */ ,
                value: 'a'
            }, []);
            assertListItem(items[1], {
                kind: 7 /* StructuredHeaders.ResultKind.STRING */ ,
                value: 'b'
            }, []);
            assertListItem(items[2], {
                kind: 10 /* StructuredHeaders.ResultKind.BOOLEAN */ ,
                value: false
            }, [
                [
        ...
        it('Parses empty list', function() {
            ...
            var items = assertListAndGetItems(StructuredHeaders.parseList(''));
            assert.lengthOf(items, 0);
        });
        it('Parses inner lists', function() {
            var items = assertListAndGetItems(StructuredHeaders.parseList('a, ("b" "c"), (d e)'));
            assert.lengthOf(items, 3);
            assertListItem(items[0], {
                kind: 8 /* StructuredHeaders.ResultKind.TOKEN */ ,
                value: 'a'
            }, []);
            var itemsL1 = assertInnerListAndGetItems(items[1], []);
            assert.lengthOf(itemsL1, 2);
            assertListItem(itemsL1[0], {
                kind: 7 /* StructuredHeaders.ResultKind.STRING */ ,
                value: 'b'
            }, []);
            assertListItem(itemsL1[1], {
                kind: 7 /* StructuredHeaders.ResultKind.STRING */ ,
                value: 'c'
            }, []);
            var itemsL2 = assertInnerListAndGetItems(items[2], []);
            assert.lengthOf(itemsL2, 2);
            assertListItem(itemsL2[0], {
                kind: 8 /* StructuredHeaders.ResultKind.TOKEN */ ,
                value: 'd'
            }, []);
            assertListItem(itemsL2[1], {
                kind: 8 /* StructuredHeaders.ResultKind.TOKEN */ ,
                value: 'e'
            }, []);
        });
        it('Parses empty inner lists', function() {
            // Empty inner lists are OK.
            var items = assertListAndGetItems(StructuredHeaders.parseList(' (  )  '));
            assert.lengthOf(items, 1);
            var itemsL0 = assertInnerListAndGetItems(items[0], []);
            assert.lengthOf(itemsL0, 0);
        });
        it('Parses inner list params', function() {
            // Example from spec, with inner list params and item params.
            var items = assertListAndGetItems(StructuredHeaders.parseList('("foo"; a=1;b=2);lvl=5, ("bar" "baz");lvl=1'));
        ...
        it('Detects various list syntax errors', function() {
    ...
    describe('Serialization', function() {
        it('Serializes integers', function() {
            assertSerializeResult(StructuredHeaders.serializeItem(makeItem({
                kind: 5 /* StructuredHeaders.ResultKind.INTEGER */ ,
                value: -45
            })), '-45');
            assertSerializeResult(StructuredHeaders.serializeItem(makeItem({
            ...
            assertSerializeError(StructuredHeaders.serializeItem(makeItem({
                kind: 5 /* StructuredHeaders.ResultKind.INTEGER */ ,
                value: 3.14
            })));
            assertSerializeError(StructuredHeaders.serializeItem(makeItem({
        ...
        it('Serializes parameters', function() {
            assertSerializeResult(StructuredHeaders.serializeItem(makeItemWithParams({
                kind: 10 /* StructuredHeaders.ResultKind.BOOLEAN */ ,
                value: true
            }, [
                [
