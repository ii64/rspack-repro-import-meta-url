...
"./ui/components/docs/performance_panel/network_request_details.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var detailsLinkifier = new _ui_legacy_components_utils_utils_js__WEBPACK_IMPORTED_MODULE_4__.Linkifier.Linkifier();
function renderDetails() {
    return _renderDetails.apply(this, arguments);
}
function _renderDetails() {
    _renderDetails = /**
 * Render details for a basic network request
 **/ _async_to_generator(function() {
        var container, traceData, networkEvent, maybeTarget, details;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_3__.TraceLoader.traceEngine(/* mocha context */ null, 'lcp-images.json.gz')
                    ];
                case 1:
                    traceData = _state.sent().traceData;
                    networkEvent = traceData.NetworkRequests.byTime[0];
                    maybeTarget = _panels_timeline_timeline_js__WEBPACK_IMPORTED_MODULE_1__.TargetForEvent.targetForEvent(traceData, networkEvent);
                    details = new _panels_timeline_components_components_js__WEBPACK_IMPORTED_MODULE_0__.NetworkRequestDetails.NetworkRequestDetails(detailsLinkifier);
                    return [
                        4,
                        details.setData(networkEvent, maybeTarget)
                    ];
                case 2:
                    _state.sent();
...
await renderDetails(); //# sourceMappingURL=network_request_details.js.map
