...
"./ui/components/docs/color_swatch/change-color.js": (function (module, __webpack_exports__, __webpack_require__) {
...
container === null || container === void 0 ? void 0 : container.insertBefore(component, picker);
picker === null || picker === void 0 ? void 0 : picker.addEventListener('input', function(e) {
    var color = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(e.target.value);
    if (color) {
        component.renderColor(color);
    }
});
component.addEventListener(_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_2__.ColorSwatch.ClickEvent.eventName, function() {
    return picker === null || picker === void 0 ? void 0 : picker.click();
