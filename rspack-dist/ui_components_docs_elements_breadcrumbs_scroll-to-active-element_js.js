"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_components_docs_elements_breadcrumbs_scroll-to-active-element_js"], {
...
"./ui/components/docs/elements_breadcrumbs/scroll-to-active-element.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var _this, _document_getElementById, _component_shadowRoot_querySelector, _component_shadowRoot;
...
var bodyCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    nodeType: Node.ELEMENT_NODE,
    id: 1,
    nodeName: 'body',
    nodeNameNicelyCased: 'body',
...
var divCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    nodeType: Node.ELEMENT_NODE,
    id: 2,
    nodeName: 'div',
...
var spanCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    nodeType: Node.ELEMENT_NODE,
    id: 3,
    nodeName: 'span',
...
var strongCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    nodeType: Node.ELEMENT_NODE,
    id: 4,
    nodeName: 'strong',
...
var emCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    nodeType: Node.ELEMENT_NODE,
    id: 5,
    nodeName: 'em',
...
var crumbsReversed = _to_consumable_array(crumbs).reverse();
var selectedNodeParam = (_this = new URLSearchParams(location.search)) === null || _this === void 0 ? void 0 : _this.get('selectedCrumbIndex');
var selectedNode = selectedNodeParam ? crumbsReversed[Number(selectedNodeParam)] : bodyCrumb;
component.data = {
    crumbs: crumbs,
...
var button = (_component_shadowRoot = component.shadowRoot) === null || _component_shadowRoot === void 0 ? void 0 : (_component_shadowRoot_querySelector = _component_shadowRoot.querySelector) === null || _component_shadowRoot_querySelector === void 0 ? void 0 : _component_shadowRoot_querySelector.call(_component_shadowRoot, 'button.overflow.right');
