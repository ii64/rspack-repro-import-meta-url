"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_DOMStorageModel_test_js"], {
"./panels/application/DOMStorageModel.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('DOMStorageModel', function() {
    var domStorageModel;
    var domStorage;
    var target;
    var initKey = 'storageKey1';
    beforeEach(function() {
    ...
    it('DOMStorage is instantiated correctly', function() {
        assert.strictEqual(domStorage.storageKey, initKey);
        assert.deepStrictEqual(domStorage.id, {
            storageKey: initKey,
            isLocalStorage: true
        });
    });
    it('StorageKey events trigger addition/removal of DOMStorage', function() {
        ...
        var manager = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.StorageKeyManager.StorageKeyManager);
