"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_legacy_components_inline_editor_CSSLength_test_js"], {
"./ui/legacy/components/inline_editor/CSSLength.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('CSSLength', function() {
    it('can render CSSLength component correctly', function() {
        var component = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLength.CSSLength();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
        component.data = initialData;
        assert.isNotNull(component.shadowRoot);
        var valueElement = component.shadowRoot.querySelector('.value');
        if (!valueElement) {
    ...
    it('can +/- length values when the value is dragged', /*#__PURE__*/ _async_to_generator(function() {
        var component, lengthText, lengthValueElement, mousePositionX, mousemoveRight, mousemoveLeftShift, mousemoveRightAlt;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    component = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLength.CSSLength();
                    (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
                    component.data = initialData;
                    assert.isNotNull(component.shadowRoot);
                    lengthText = initialData.lengthText;
                    component.addEventListener('valuechanged', function(event) {
                        var data = event.data;
                        lengthText = data.value;
                    });
                    lengthValueElement = component.shadowRoot.querySelector('.value');
                    ...
                    mousePositionX = 1;
                    lengthValueElement.dispatchEvent(new MouseEvent('mousedown', {
                ...
                case 1:
                    _state.sent();
                    mousemoveRight = new MouseEvent('mousemove', {
                        clientX: ++mousePositionX
                    });
                    ...
                    mousemoveLeftShift = new MouseEvent('mousemove', {
                        clientX: --mousePositionX,
                        shiftKey: true
                    });
                    ...
                    mousemoveRightAlt = new MouseEvent('mousemove', {
                        clientX: ++mousePositionX,
                        altKey: true
                    });
    ...
    describe('#CSSLengthUtils', function() {
        it('parses CSS properties with length correctly', function() {
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('42px'), {
                value: 42,
                unit: "px" /* InlineEditor.CSSLengthUtils.LengthUnit.PIXEL */ 
            });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('-5vw'), {
                value: -5,
                unit: "vw" /* InlineEditor.CSSLengthUtils.LengthUnit.VW */ 
            });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('42'), null);
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText(''), null);
        });
    });
