...
"./panels/sources/SearchSourcesView.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  ActionDelegate: function() { return ActionDelegate; },
  Revealer: function() { return Revealer; },
  SearchSources: function() { return SearchSources; },
  SearchSourcesView: function() { return SearchSourcesView; }
});
...
var SearchSources = function SearchSources(query) {
    "use strict";
    _class_call_check(this, SearchSources);
    _define_property(this, "query", void 0);
    this.query = query;
};
var SearchSourcesView = /*#__PURE__*/ function(_Search_SearchView_SearchView) {
    "use strict";
    _inherits(SearchSourcesView, _Search_SearchView_SearchView);
    var _super = _create_super(SearchSourcesView);
    function SearchSourcesView() {
        _class_call_check(this, SearchSourcesView);
        return _super.call(this, 'sources', new _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Throttler.Throttler(/* timeoutMs */ 200));
    }
    _create_class(SearchSourcesView, [
        {
            key: "createScope",
    ...
    return SearchSourcesView;
}(_search_search_js__WEBPACK_IMPORTED_MODULE_2__.SearchView.SearchView);
    ...
    _create_class(ActionDelegate, [
        {
            ...
            value: function handleAction(_context, actionId) {
                switch(actionId){
                    case 'sources.search':
                        {
                            var selection = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_1__.InspectorView.InspectorView.instance().element.window().getSelection();
                            var query = selection ? selection.toString().replace(/\r?\n.*/, '') : '';
    ...
    _create_class(Revealer, [
        {
            ...
            value: function reveal(param, omitFocus) {
                ...
                return _async_to_generator(function() {
                    var viewManager, searchSourcesView;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                viewManager = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_1__.ViewManager.ViewManager.instance();
                                return [
                                    4,
                                    viewManager.showView('sources.search-sources-tab', true, omitFocus)
                                ];
                            case 1:
                                _state.sent();
                                searchSourcesView = viewManager.materializedWidget('sources.search-sources-tab');
                                if (_instanceof(searchSourcesView, SearchSourcesView)) {
