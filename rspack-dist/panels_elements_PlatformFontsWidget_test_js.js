"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_PlatformFontsWidget_test_js"], {
"./panels/elements/PlatformFontsWidget.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_0__.describeWithMockConnection)('PlatformFontsWidget', function() {
    it('correctly displays font stats', /*#__PURE__*/ _async_to_generator(function() {
        var sharedModel, cssModel, node, platformFontsWidget, fontStatsItems, firstFontContent, secontFontContent;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    cssModel = {};
                    cssModel.getPlatformFonts = /*#__PURE__*/ _async_to_generator(function() {
                        return _ts_generator(this, function(_state) {
                            return [
                                2,
                                [
                    ...
                    sharedModel.cssModel = function() {
                        return cssModel;
                    };
                    sharedModel.node = function() {
                        return node;
                    };
                    platformFontsWidget = new _elements_js__WEBPACK_IMPORTED_MODULE_1__.PlatformFontsWidget.PlatformFontsWidget(sharedModel);
                    return [
                        4,
                        platformFontsWidget.doUpdate()
                    ];
                case 1:
                    _state.sent();
                    fontStatsItems = platformFontsWidget.contentElement.querySelectorAll('.font-stats-item');
                    firstFontContent = fontStatsItems[0].textContent;
                    secontFontContent = fontStatsItems[1].textContent;
