...
"./ui/legacy/components/inline_editor/CSSShadowEditor.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('CSSLength', function() {
    it('parses lengths correctly', function() {
        var parseLength = function(input, expected) {
            var _InlineEditor_CSSShadowEditor_CSSLength_parse;
            assert.strictEqual((_InlineEditor_CSSShadowEditor_CSSLength_parse = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.CSSShadowEditor.CSSLength.parse(input)) === null || _InlineEditor_CSSShadowEditor_CSSLength_parse === void 0 ? void 0 : _InlineEditor_CSSShadowEditor_CSSLength_parse.asCSSText(), expected);
        };
