...
"./entrypoints/formatter_worker/Substitute.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
describe('Substitute', function() {
    ...
    it('Substitutes in blocks', function() {
    ...
    it('Substitutes in functions', function() {
    ...
    it('Substitutes in object literals', function() {
    ...
    it('Substitutes in switch', function() {
    ...
    it('Does not substitute in strings', function() {
        assert.strictEqual(substitute('\'varX\''), '\'varX\'');
        assert.strictEqual(substitute('\"varX\"'), '\"varX\"');
        assert.strictEqual(substitute('\`varX\`'), '\`varX\`');
    });
    it('Does not substitute in comments', function() {
        assert.strictEqual(substitute('/* varX */'), '/* varX */');
        assert.strictEqual(substitute('// varX'), '// varX');
    });
    it('Throws on to-be-captured "this" and "arguments" bound by a function', function() {
        assert.throws(function() {
            return substitute('function f() { return rename_to_this; }');
        }, 'Cannot avoid capture of \'this\'');
        assert.throws(function() {
            return substitute('function f() { return rename_to_arguments; }');
        }, 'Cannot avoid capture of \'arguments\'');
    });
    it('Throws on parse error', function() {
        assert.throws(function() {
            return substitute('(');
        }, SyntaxError);
    });
    it('Throws if the renamed variable is unavailable', function() {
        assert.throws(function() {
            return substitute('varQ');
        }, Error);
    });
