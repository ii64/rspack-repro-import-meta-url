...
"./third_party/csp_evaluator/package/allowlist_bypasses/angular.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"./third_party/csp_evaluator/package/allowlist_bypasses/flash.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  URLS: function() { return URLS; }
});
...
"./third_party/csp_evaluator/package/allowlist_bypasses/jsonp.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  NEEDS_EVAL: function() { return NEEDS_EVAL; },
  URLS: function() { return URLS; }
});
/**
...
"./third_party/csp_evaluator/package/checks/security_checks.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  DIRECTIVES_CAUSING_XSS: function() { return DIRECTIVES_CAUSING_XSS; },
  URL_SCHEMES_CAUSING_XSS: function() { return URL_SCHEMES_CAUSING_XSS; },
  checkDeprecatedDirective: function() { return checkDeprecatedDirective; },
  checkFlashObjectAllowlistBypass: function() { return checkFlashObjectAllowlistBypass; },
  checkHasConfiguredReporting: function() { return checkHasConfiguredReporting; },
  checkIpSource: function() { return checkIpSource; },
  checkMissingBaseUriDirective: function() { return checkMissingBaseUriDirective; },
  checkMissingDirectives: function() { return checkMissingDirectives; },
  checkMissingObjectSrcDirective: function() { return checkMissingObjectSrcDirective; },
  checkMissingScriptSrcDirective: function() { return checkMissingScriptSrcDirective; },
  checkMultipleMissingBaseUriDirective: function() { return checkMultipleMissingBaseUriDirective; },
  checkNonceLength: function() { return checkNonceLength; },
  checkPlainUrlSchemes: function() { return checkPlainUrlSchemes; },
  checkScriptAllowlistBypass: function() { return checkScriptAllowlistBypass; },
  checkScriptUnsafeEval: function() { return checkScriptUnsafeEval; },
  checkScriptUnsafeInline: function() { return checkScriptUnsafeInline; },
  checkSrcHttp: function() { return checkSrcHttp; },
  checkWildcards: function() { return checkWildcards; },
  looksLikeIpAddress: function() { return looksLikeIpAddress; }
});
 ...
 * validation.
 */ var DIRECTIVES_CAUSING_XSS = [
    _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC,
    _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.OBJECT_SRC,
    _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.BASE_URI
];
/**
 * A list of URL schemes that can allow XSS vulnerabilities when requests to
 * them are made.
 */ var URL_SCHEMES_CAUSING_XSS = [
    'data:',
    'http:',
    'https:'
];
 ...
 */ function checkScriptUnsafeInline(effectiveCsp) {
    var directiveName = effectiveCsp.getEffectiveDirective(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC);
    var values = effectiveCsp.directives[directiveName] || [];
    // Check if unsafe-inline is present.
    if (values.includes(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.UNSAFE_INLINE)) {
        return [
            new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.SCRIPT_UNSAFE_INLINE, "'unsafe-inline' allows the execution of unsafe in-page scripts " + 'and event handlers.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, directiveName, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.UNSAFE_INLINE)
        ];
    }
    return [];
}
 ...
 */ function checkScriptUnsafeEval(parsedCsp) {
    var directiveName = parsedCsp.getEffectiveDirective(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC);
    ...
    if (values.includes(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.UNSAFE_EVAL)) {
        return [
            new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.SCRIPT_UNSAFE_EVAL, "'unsafe-eval' allows the execution of code injected into DOM APIs " + 'such as eval().', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.MEDIUM_MAYBE, directiveName, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.UNSAFE_EVAL)
        ];
    }
    return [];
}
 ...
 */ function checkPlainUrlSchemes(parsedCsp) {
    var violations = [];
    var directivesToCheck = parsedCsp.getEffectiveDirectives(DIRECTIVES_CAUSING_XSS);
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = directivesToCheck[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var directive = _step.value;
            var values = parsedCsp.directives[directive] || [];
            ...
            try {
                for(var _iterator1 = values[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true){
                    ...
                    if (URL_SCHEMES_CAUSING_XSS.includes(value)) {
                        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.PLAIN_URL_SCHEMES, value + ' URI in ' + directive + ' allows the execution of ' + 'unsafe scripts.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, directive, value));
                    }
                }
            } catch (err) {
    ...
    try {
        for(var _iterator = directivesToCheck[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            try {
                for(var _iterator1 = values[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true){
                    var value = _step1.value;
                    var url = _utils_js__WEBPACK_IMPORTED_MODULE_5__.getSchemeFreeUrl(value);
                    if (url === '*') {
 ...
 */ function checkMissingScriptSrcDirective(parsedCsp) {
    if (_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC in parsedCsp.directives || _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.DEFAULT_SRC in parsedCsp.directives) {
        return [];
    }
    return [
        new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.MISSING_DIRECTIVES, 'script-src directive is missing.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC)
    ];
}
/**
 ...
 */ function checkMissingBaseUriDirective(parsedCsp) {
    return checkMultipleMissingBaseUriDirective([
        parsedCsp
    ]);
}
/**
 ...
 */ function checkMultipleMissingBaseUriDirective(parsedCsps) {
    ...
    // use strict dynamic
    var needsBaseUri = function(csp) {
        return csp.policyHasScriptNonces() || csp.policyHasScriptHashes() && csp.policyHasStrictDynamic();
    };
    var hasBaseUri = function(csp) {
        return _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.BASE_URI in csp.directives;
    };
    if (parsedCsps.some(needsBaseUri) && !parsedCsps.some(hasBaseUri)) {
        var description = 'Missing base-uri allows the injection of base tags. ' + 'They can be used to set the base URL for all relative (script) ' + 'URLs to an attacker controlled domain. ' + "Can you set it to 'none' or 'self'?";
        return [
            new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.MISSING_DIRECTIVES, description, _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.BASE_URI)
        ];
    }
    return [];
}
 ...
 */ function checkMissingDirectives(parsedCsp) {
    return _to_consumable_array(checkMissingObjectSrcDirective(parsedCsp)).concat(_to_consumable_array(checkMissingScriptSrcDirective(parsedCsp)), _to_consumable_array(checkMissingBaseUriDirective(parsedCsp)));
}
/**
 ...
 */ function checkScriptAllowlistBypass(parsedCsp) {
    var violations = [];
    var effectiveScriptSrcDirective = parsedCsp.getEffectiveDirective(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.SCRIPT_SRC);
    var scriptSrcValues = parsedCsp.directives[effectiveScriptSrcDirective] || [];
    if (scriptSrcValues.includes(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.NONE)) {
        return violations;
    }
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = scriptSrcValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var value = _step.value;
            if (value === _csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.SELF) {
                violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.SCRIPT_ALLOWLIST_BYPASS, "'self' can be problematic if you host JSONP, AngularJS or user " + 'uploaded files.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.MEDIUM_MAYBE, effectiveScriptSrcDirective, value));
                continue;
            }
            ...
            var url = '//' + _utils_js__WEBPACK_IMPORTED_MODULE_5__.getSchemeFreeUrl(value);
            var angularBypass = _utils_js__WEBPACK_IMPORTED_MODULE_5__.matchWildcardUrls(url, _allowlist_bypasses_angular_js__WEBPACK_IMPORTED_MODULE_0__.URLS);
            var jsonpBypass = _utils_js__WEBPACK_IMPORTED_MODULE_5__.matchWildcardUrls(url, _allowlist_bypasses_jsonp_js__WEBPACK_IMPORTED_MODULE_2__.URLS);
            // Some JSONP bypasses only work in presence of unsafe-eval.
            if (jsonpBypass) {
                var evalRequired = _allowlist_bypasses_jsonp_js__WEBPACK_IMPORTED_MODULE_2__.NEEDS_EVAL.includes(jsonpBypass.hostname);
                var evalPresent = scriptSrcValues.includes(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Keyword.UNSAFE_EVAL);
            ...
            if (jsonpBypass || angularBypass) {
                ...
                violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.SCRIPT_ALLOWLIST_BYPASS, bypassDomain + ' is known to host' + bypassTxt + ' which allow to bypass this CSP.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, effectiveScriptSrcDirective, value));
            } else {
                violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.SCRIPT_ALLOWLIST_BYPASS, "No bypass found; make sure that this URL doesn't serve JSONP " + 'replies or Angular libraries.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.MEDIUM_MAYBE, effectiveScriptSrcDirective, value));
            }
        }
    } catch (err) {
        _didIteratorError = true;
 ...
 */ function checkFlashObjectAllowlistBypass(parsedCsp) {
    var violations = [];
    var effectiveObjectSrcDirective = parsedCsp.getEffectiveDirective(_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.OBJECT_SRC);
    var objectSrcValues = parsedCsp.directives[effectiveObjectSrcDirective] || [];
    // If flash is not allowed in plugin-types, continue.
    var pluginTypes = parsedCsp.directives[_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.PLUGIN_TYPES];
    if (pluginTypes && !pluginTypes.includes('application/x-shockwave-flash')) {
        return [];
    }
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = objectSrcValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var value = _step.value;
            ...
            var url = '//' + _utils_js__WEBPACK_IMPORTED_MODULE_5__.getSchemeFreeUrl(value);
            var flashBypass = _utils_js__WEBPACK_IMPORTED_MODULE_5__.matchWildcardUrls(url, _allowlist_bypasses_flash_js__WEBPACK_IMPORTED_MODULE_1__.URLS);
            if (flashBypass) {
                violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.OBJECT_ALLOWLIST_BYPASS, flashBypass.hostname + ' is known to host Flash files which allow to bypass this CSP.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.HIGH, effectiveObjectSrcDirective, value));
 ...
 */ function checkIpSource(parsedCsp) {
    ...
    var checkIp = function(directive, directiveValues) {
        var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        try {
            for(var _iterator = directiveValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var value = _step.value;
                var host = _utils_js__WEBPACK_IMPORTED_MODULE_5__.getHostname(value);
                if (looksLikeIpAddress(host)) {
                    // Check if localhost.
                    // See 4.8 in https://www.w3.org/TR/CSP2/#match-source-expression
                    if (host === '127.0.0.1') {
                        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.IP_SOURCE, directive + ' directive allows localhost as source. ' + 'Please make sure to remove this in production environments.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.INFO, directive, value));
                    } else {
                        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.IP_SOURCE, directive + ' directive has an IP-Address as source: ' + host + ' (will be ignored by browsers!). ', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.INFO, directive, value));
                    }
                }
            }
        } catch (err) {
 ...
 */ function checkDeprecatedDirective(parsedCsp) {
    ...
    if (_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REFLECTED_XSS in parsedCsp.directives) {
        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.DEPRECATED_DIRECTIVE, 'reflected-xss is deprecated since CSP2. ' + 'Please, use the X-XSS-Protection header instead.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.INFO, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REFLECTED_XSS));
    }
    ...
    if (_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REFERRER in parsedCsp.directives) {
        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.DEPRECATED_DIRECTIVE, 'referrer is deprecated since CSP2. ' + 'Please, use the Referrer-Policy header instead.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.INFO, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REFERRER));
    }
    ...
    if (_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.DISOWN_OPENER in parsedCsp.directives) {
        violations.push(new _finding_js__WEBPACK_IMPORTED_MODULE_4__.Finding(_finding_js__WEBPACK_IMPORTED_MODULE_4__.Type.DEPRECATED_DIRECTIVE, 'disown-opener is deprecated since CSP3. ' + 'Please, use the Cross Origin Opener Policy header instead.', _finding_js__WEBPACK_IMPORTED_MODULE_4__.Severity.INFO, _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.DISOWN_OPENER));
    }
    return violations;
}
/**
 ...
 */ function checkNonceLength(parsedCsp) {
    ...
    var violations = [];
    _utils_js__WEBPACK_IMPORTED_MODULE_5__.applyCheckFunktionToDirectives(parsedCsp, function(directive, directiveValues) {
        var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        try {
            for(var _iterator = directiveValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var value = _step.value;
                var match = value.match(noncePattern);
                if (!match) {
                    continue;
                }
                // Not a nonce.
 ...
 */ function checkSrcHttp(parsedCsp) {
    ...
    _utils_js__WEBPACK_IMPORTED_MODULE_5__.applyCheckFunktionToDirectives(parsedCsp, function(directive, directiveValues) {
        ...
        try {
            for(var _iterator = directiveValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var value = _step.value;
                var description = directive === _csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REPORT_URI ? 'Use HTTPS to send violation reports securely.' : 'Allow only resources downloaded over HTTPS.';
 ...
 */ function checkHasConfiguredReporting(parsedCsp) {
    var reportUriValues = parsedCsp.directives[_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REPORT_URI] || [];
    if (reportUriValues.length > 0) {
        return [];
    }
    var reportToValues = parsedCsp.directives[_csp_js__WEBPACK_IMPORTED_MODULE_3__.Directive.REPORT_TO] || [];
