"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_components_CSSHintDetailsView_test_js"], {
"./panels/elements/components/CSSHintDetailsView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('CSSHintDetailsView', function() {
    it('renders every section', /*#__PURE__*/ _async_to_generator(function() {
        var hintMessage, popupComponent;
        return _ts_generator(this, function(_state) {
            hintMessage = new _elements_js__WEBPACK_IMPORTED_MODULE_2__.CSSRuleValidator.Hint('This element has <code class="unbreakable-text"><span class="property">flex-wrap</span>: nowrap</code> rule, therefore <code class="unbreakable-text"><span class="property">align-content</span></code> has no effect.', 'For this property to work, please remove or change the value of <code class="unbreakable-text"><span class="property">flex-wrap</span></code> rule.', 'align-content');
            popupComponent = new _components_js__WEBPACK_IMPORTED_MODULE_3__.CSSHintDetailsView.CSSHintDetailsView(hintMessage);
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(popupComponent);
    ...
    it('does not render learn more', /*#__PURE__*/ _async_to_generator(function() {
        var hint, popupComponent;
        return _ts_generator(this, function(_state) {
            hint = new _elements_js__WEBPACK_IMPORTED_MODULE_2__.CSSRuleValidator.Hint('This element has <code class="unbreakable-text"><span class="property">flex-wrap</span>: nowrap</code> rule, therefore <code class="unbreakable-text"><span class="property">align-content</span></code> has no effect.', 'For this property to work, please remove or change the value of <code class="unbreakable-text"><span class="property">flex-wrap</span></code> rule.');
            popupComponent = new _components_js__WEBPACK_IMPORTED_MODULE_3__.CSSHintDetailsView.CSSHintDetailsView(hint);
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(popupComponent);
            assert.isNotNull(popupComponent.shadowRoot.querySelector('.hint-popup-reason'));
            assert.isNotNull(popupComponent.shadowRoot.querySelector('.hint-popup-possible-fix'));
