"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_legacy_components_inline_editor_AnimationTimingUI_test_js"], {
"./ui/legacy/components/inline_editor/AnimationTimingUI.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('AnimationTimingUI', function() {
    it('can be instantiated successfully', function() {
        var model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingModel.AnimationTimingModel.parse('linear(0, 1)');
        var animationTimingUI = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingUI.AnimationTimingUI({
            model: model,
            onChange: function() {}
        });
        animationTimingUI.draw();
        var bezierContainer = animationTimingUI.element().querySelector('.bezier-ui-container');
        var linearEasingContainer = animationTimingUI.element().querySelector('.linear-easing-ui-container');
        assert.exists(linearEasingContainer);
        assert.exists(bezierContainer);
    });
    it('should bezier-ui-container be hidden when linear-easing function is visualized', function() {
        var model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingModel.AnimationTimingModel.parse('linear(0, 1)');
        var animationTimingUI = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingUI.AnimationTimingUI({
            model: model,
            onChange: function() {}
    ...
    it('should linear-easing-ui-container be hidden when cubic-bezier function is visualized', function() {
        var model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingModel.AnimationTimingModel.parse('cubic-bezier(0, 0, 1, 1)');
        var animationTimingUI = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingUI.AnimationTimingUI({
            model: model,
            onChange: function() {}
        });
