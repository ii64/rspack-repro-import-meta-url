"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_components_CSSQuery_test_js"], {
"./panels/elements/components/CSSQuery.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('CSSQuery', function() {
    it('renders a normal query correctly', function() {
        var component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.CSSQuery.CSSQuery();
        ...
        var queryElement = component.shadowRoot.querySelector('.query');
    ...
    it('renders an editable named query correctly', function() {
        var component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.CSSQuery.CSSQuery();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
        ...
        var queryText = queryElement.querySelector('.editable .query-text');
