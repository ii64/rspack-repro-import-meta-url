...
"./panels/elements/WebCustomData.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('WebCustomData', function() {
    var fetchStub;
    var fetchResolve;
    var fetchReject;
    beforeEach(function() {
        fetchStub = sinon.stub(window, 'fetch');
        fetchStub.returns(new Promise(function(res, rej) {
            fetchReject = rej;
            // Allow users to provide the plain JSON. We turn it into a response.
            fetchResolve = function(value) {
                return res(new Response(JSON.stringify(value), {
                    status: 200,
                    headers: {
    ...
    describe('findCssProperty', function() {
        it('returns the correct info', /*#__PURE__*/ _async_to_generator(function() {
            var webCustomData, property;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        webCustomData = new _elements_js__WEBPACK_IMPORTED_MODULE_0__.WebCustomData.WebCustomData('http://does-not-matter.com/');
                        fetchResolve({
                            properties: [
                                {
                                    name: 'display',
                                    description: 'In combiniation with \'float\' ...'
                                }
                            ]
                        });
                        return [
                            4,
                            webCustomData.fetchPromiseForTest
                        ];
                    case 1:
                        _state.sent();
                        property = webCustomData.findCssProperty('display');
        ...
        it('returns undefined while the .json is loading', /*#__PURE__*/ _async_to_generator(function() {
            var webCustomData;
            return _ts_generator(this, function(_state) {
                webCustomData = new _elements_js__WEBPACK_IMPORTED_MODULE_0__.WebCustomData.WebCustomData('http://does-not-matter.com/');
        ...
        it('returns undefined if the .json loading failed', /*#__PURE__*/ _async_to_generator(function() {
            var webCustomData, e;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
        ...
        it('returns undefind if the CSS property was not found', /*#__PURE__*/ _async_to_generator(function() {
            var webCustomData;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
