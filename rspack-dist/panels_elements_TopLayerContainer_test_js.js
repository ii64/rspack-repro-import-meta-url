...
"./panels/elements/TopLayerContainer.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var stubTopLayerDOMNode = function(nodeName, backendNodeId, ownerDocument) {
    return {
        nodeName: function() {
            return nodeName;
        },
...
var stubElementsTreeElement = function() {
    return {
        adorn: function(_unused) {
            return new _ui_components_adorners_adorners_js__WEBPACK_IMPORTED_MODULE_2__.Adorner.Adorner();
        }
    };
};
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithMockConnection)('TopLayerContainer', function() {
    it('should update top layer elements correctly', /*#__PURE__*/ _async_to_generator(function() {
        var stubDocument, topLayerDOMNode1, topLayerDOMNode2, domModel, topLayerTreeNode1, topLayerTreeNode2, tree, topLayerContainer;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    stubDocument = {};
                    topLayerDOMNode1 = stubTopLayerDOMNode('dialog', 1, stubDocument);
                    topLayerDOMNode2 = stubTopLayerDOMNode('div', 2, stubDocument);
                    domModel = {
                        target: function() {
                            return (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.createTarget)();
                        },
                        getTopLayerElements: /*#__PURE__*/ _async_to_generator(function() {
                            return _ts_generator(this, function(_state) {
                                return [
                                    2,
                                    Promise.resolve([
                    ...
                    stubDocument.domModel = function() {
                        return domModel;
                    };
                    topLayerTreeNode1 = stubElementsTreeElement();
                    topLayerTreeNode2 = stubElementsTreeElement();
                    tree = {
                    ...
                    topLayerContainer = new _elements_js__WEBPACK_IMPORTED_MODULE_3__.TopLayerContainer.TopLayerContainer(tree, stubDocument);
                    return [
                        4,
                        topLayerContainer.updateTopLayerElements()
                    ];
                case 1:
                    _state.sent();
