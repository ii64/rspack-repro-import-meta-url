...
"./ui/components/docs/markdown_image/basic.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var iconComponent = new _markdown_view_markdown_view_js__WEBPACK_IMPORTED_MODULE_2__.MarkdownImage.MarkdownImage();
(_document_getElementById = document.getElementById('icon')) === null || _document_getElementById === void 0 ? void 0 : _document_getElementById.appendChild(iconComponent);
iconComponent.data = {
    key: 'test-icon',
    title: 'Test icon title'
};
var imageComponent = new _markdown_view_markdown_view_js__WEBPACK_IMPORTED_MODULE_2__.MarkdownImage.MarkdownImage();
(_document_getElementById1 = document.getElementById('image')) === null || _document_getElementById1 === void 0 ? void 0 : _document_getElementById1.appendChild(imageComponent);
imageComponent.data = {
    key: 'test-image',
