"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_elements_components_ComputedStyleProperty_test_js"], {
"./panels/elements/components/ComputedStyleProperty.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../testing/DOMHelpers.js */ "./testing/DOMHelpers.js");
/* harmony import */var _components_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components.js */ "./panels/elements/components/components.js");
...
describe('ComputedStyleProperty', function() {
    it('renders inherited property correctly', function() {
        var component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.ComputedStyleProperty.ComputedStyleProperty();
        ...
        var wrapper = component.shadowRoot.querySelector('.computed-style-property.inherited');
        assert.exists(wrapper, 'it should add .inherited class to wrapper for inherited properties');
    });
    it('renders a clickable goto icon that dispatches a onNavigateToSource event', /*#__PURE__*/ _async_to_generator(function() {
        var component, navigateEvent, goto, event;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    component = new _components_js__WEBPACK_IMPORTED_MODULE_1__.ComputedStyleProperty.ComputedStyleProperty();
                    (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
                    component.traceable = true;
                    component.inherited = false;
                    navigateEvent = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, _components_js__WEBPACK_IMPORTED_MODULE_1__.ComputedStyleProperty.NavigateToSourceEvent.eventName);
                    goto = component.shadowRoot.querySelector('.goto');
                    if (!goto) {
