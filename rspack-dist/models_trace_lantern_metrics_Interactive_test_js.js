...
"./models/trace/lantern/metrics/Interactive.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _Lantern_Metrics = _lantern_js__WEBPACK_IMPORTED_MODULE_0__.Metrics, Interactive = _Lantern_Metrics.Interactive, FirstContentfulPaint = _Lantern_Metrics.FirstContentfulPaint, LargestContentfulPaint = _Lantern_Metrics.LargestContentfulPaint;
describe('Metrics: Lantern TTI', function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        (0,_testing_testing_js__WEBPACK_IMPORTED_MODULE_1__.loadTrace)(this, 'lantern/iframe/trace.json.gz')
                    ];
                case 2:
                    iframeTrace = _state.sent();
                    return [
                        2
                    ];
            }
    ...
    it('should compute predicted value', /*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    data = _state.sent();
                    result = Interactive.compute(data, {
    ...
    it('should compute predicted value on iframes with substantial layout', /*#__PURE__*/ _async_to_generator(function() {
        var data, result, _, _tmp, _tmp1, _1, _tmp2, _tmp3;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                ...
                case 1:
                    data = _state.sent();
                    _ = Interactive.compute;
                    _tmp = [
                        data
                    ];
                    _tmp1 = {};
                    _1 = LargestContentfulPaint.compute;
                    _tmp2 = [
                        data
                    ];
                    _tmp3 = {};
                    return [
                        4,
                        FirstContentfulPaint.compute(data)
                    ];
                case 2:
                    return [
                        4,
                        _1.apply(LargestContentfulPaint, _tmp2.concat([
                            (_tmp3.fcpResult = _state.sent(), _tmp3)
                        ]))
                    ];
                case 3:
                    return [
                        4,
                        _.apply(Interactive, _tmp.concat([
                            (_tmp1.lcpResult = _state.sent(), _tmp1)
                        ]))
                    ];
                case 4:
                    result = _state.sent();
