"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_PreloadingTreeElement_test_js"], {
"./panels/application/PreloadingTreeElement.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
_application_js__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];// Copyright 2023 The Chromium Authors. All rights reserved.
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('PreloadingTreeElement', function() {
    it('shows view even if initialization happens after selection', function() {
        ...
        var preloadingRuleSetTreeElement = new _application_js__WEBPACK_IMPORTED_MODULE_3__.PreloadingTreeElement.PreloadingRuleSetTreeElement(panel);
