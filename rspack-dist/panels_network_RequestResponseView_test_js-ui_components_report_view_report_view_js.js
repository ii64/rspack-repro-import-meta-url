"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_network_RequestResponseView_test_js-ui_components_report_view_report_view_js"], {
"./panels/network/RequestResponseView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('RequestResponseView', function() {
    it('does show WASM disassembly for WASM module requests', /*#__PURE__*/ _async_to_generator(function() {
        var request, mockedSourceView, viewStub, component, widget;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.NetworkRequest.NetworkRequest.create('requestId', 'http://devtools-frontend.test/module.wasm', '', null, null, null);
                    request.setContentDataProvider(function() {
                        return Promise.resolve(new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_1__.ContentData.ContentData('AGFzbQEAAAABBQFgAAF/AwIBAAcHAQNiYXIAAAoGAQQAQQILACQEbmFtZQAQD3Nob3ctd2FzbS0yLndhdAEGAQADYmFyAgMBAAA=', true, 'application/wasm'));
                    });
                    request.mimeType = 'application/wasm';
                    request.finished = true;
                    mockedSourceView = new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.EmptyWidget.EmptyWidget('<disassembled WASM>');
                    viewStub = sinon.stub(_ui_legacy_components_source_frame_source_frame_js__WEBPACK_IMPORTED_MODULE_3__.ResourceSourceFrame.ResourceSourceFrame, 'createSearchableView').returns(mockedSourceView);
                    component = new _network_js__WEBPACK_IMPORTED_MODULE_5__.RequestResponseView.RequestResponseView(request);
