"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["third_party_chromium_client-variations_ClientVariations_js"], {
"./third_party/chromium/client-variations/ClientVariations.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  formatClientVariations: function() { return formatClientVariations; },
  parseClientVariations: function() { return parseClientVariations; }
});
/* eslint-disable */ // Copyright 2020 The Chromium Authors
...
(function() {
    ...
    function u(a) {
        var b = v, c = [];
        _instanceof(a, b) || q("Expected instanceof %s but got %s.", [
            ja(b),
            ja(a)
        ], void 0, c);
    }
    function ja(a) {
        return _instanceof(a, Function) ? a.displayName || a.name || "unknown type name" : _instanceof(a, Object) ? a.constructor.displayName || a.constructor.name || Object.prototype.toString.call(a) : null === a ? "null" : typeof a === "undefined" ? "undefined" : _type_of(a);
    }
    ;
    function x(a, b) {
        this.g = a;
    ...
    function ra(a) {
        ...
        if (_instanceof(a, Uint8Array)) return new Uint8Array(a.buffer, a.byteOffset, a.byteLength);
    ...
    f.v = function() {
        ...
        this.g += 5;
        128 <= a[this.g++] && 128 <= a[this.g++] && 128 <= a[this.g++] && 128 <= a[this.g++] && 128 <= a[this.g++] && r(!1);
        r(this.g <= this.j);
        return c;
    };
    f.fa = function() {
    ...
    f.ca = function(a) {
        if (0 > a || this.g + a > this.h.length) return this.D = !0, t("Invalid byte length!"), new Uint8Array(0);
    ...
    f.J = function(a) {
        r(Infinity === a || -Infinity === a || isNaN(a) || -3.4028234663852886E38 <= a && 3.4028234663852886E38 >= a);
        var b = a;
        b = (a = 0 > b ? 1 : 0) ? -b : b;
        ...
        else if (1.1754943508222875E-38 > b) b = Math.round(b / Math.pow(2, -149)), z = 0, y = (a << 31 | b) >>> 0;
        else {
    ...
    f.I = function(a) {
        r(Infinity === a || -Infinity === a || isNaN(a) || -1.7976931348623157E308 <= a && 1.7976931348623157E308 >= a);
        var b = a;
        b = (a = 0 > b ? 1 : 0) ? -b : b;
        ...
        else if (2.2250738585072014E-308 > b) b /= Math.pow(2, -1074), z = (a << 31 | b / 4294967296) >>> 0, y = b >>> 0;
        else {
            var c = b, d = 0;
    ...
    f.V = function(a) {
        ...
        "string" !== typeof a && q("Expected string but got %s: %s.", [
            h(a),
            a
        ], void 0, c);
    ...
    E.prototype.M = function() {
        ...
        a = b >>> 3;
        b &= 7;
        if (0 != b && 5 != b && 1 != b && 2 != b && 3 != b && 4 != b) return t("Invalid wire type: %s (at position %s)", b, this.D), this.o = !0, !1;
        this.j = a;
        this.h = b;
        return !0;
    };
    ...
    E.prototype.Ia = function(a, b, c) {
        ...
        r(this.j == a);
        c(b, this);
        this.o || 4 == this.h || (t("Group submessage did not end with an END_GROUP tag"), this.o = !0);
    };
    ...
    H.prototype.U = function(a, b) {
        null != b && (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b), null != b && (J(this, a, 0), Ca(this.g, b)));
    };
    ...
    H.prototype.W = function(a, b) {
        null != b && (r(0 <= b && 1.8446744073709552E19 > b), null != b && (J(this, a, 0), Ba(this.g, b)));
    };
    ...
    H.prototype.Lb = function(a, b) {
        null != b && (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b), null != b && (J(this, a, 0), Ea(this.g, b)));
    };
    ...
    H.prototype.xa = function(a, b) {
        null != b && (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b), J(this, a, 1), this.g.U(b));
    };
    ...
    function Ga(a, b, c, d, e, g) {
        ...
        a: {
            c = a.s.length;
            b = -1;
            if (c && (b = c - 1, c = a.s[b], !(null === c || "object" != (typeof c === "undefined" ? "undefined" : _type_of(c)) || Array.isArray(c) || R && _instanceof(c, Uint8Array)))) {
                a.F = b - a.B;
                a.m = c;
                break a;
            }
    ...
    v.readBinaryExtension = function(a, b, c, d, e) {
        ...
        if (g) {
            ...
            c.L && !g.Fa ? (b = d.call(a, c)) ? b.push(m) : e.call(a, c, [
                m
            ]) : e.call(a, c, m);
        } else F(b);
    };
    ...
    function La(a) {
        ...
        if (R && _instanceof(a, Uint8Array)) {
            var b;
            void 0 === b && (b = 0);
            ia();
            b = ea[b];
            var m = Array(Math.floor(a.length / 3)), n = b[64] || "";
            var w = 0, K = 0;
    ...
    v.bytesAsB64 = La;
    function Ma(a) {
        if (null == a || _instanceof(a, Uint8Array)) return a;
    ...
    v.bytesListAsU8 = function(a) {
        Na(a);
        return !a.length || _instanceof(a[0], Uint8Array) ? a : l(a, Ma);
    };
    function Na(a) {
        if (a && 1 < a.length) {
            var b = h(a[0]);
    ...
    v.difference = function(a, b) {
        if (!_instanceof(a, b.constructor)) throw Error("Messages have different types.");
        var c = a.l();
        b = b.l();
    ...
    v.equals = function(a, b) {
        return a == b || !(!a || !b) && _instanceof(a, b.constructor) && X(a.l(), b.l());
    };
    function Ta(a, b) {
        a = a || {};
        b = b || {};
    ...
    function Ua(a) {
        if (Array.isArray(a)) {
            for(var b = Array(a.length), c = 0; c < a.length; c++){
                var d = a[c];
                null != d && (b[c] = "object" == (typeof d === "undefined" ? "undefined" : _type_of(d)) ? Ua(r(d)) : d);
            }
            return b;
        }
        if (R && _instanceof(a, Uint8Array)) return new Uint8Array(a);
        b = {};
        for(c in a)d = a[c], null != d && (b[c] = "object" == (typeof d === "undefined" ? "undefined" : _type_of(d)) ? Ua(r(d)) : d);
        return b;
    }
    ...
    Z.prototype.ta = function(a) {
        var b, c = {
            Qb: null == (b = U(this, 1)) ? void 0 : b,
            Pb: null == (b = U(this, 3)) ? void 0 : b
        };
        a && (c.Mb = this);
        return c;
    };
    function Wa(a) {
        ...
        for(var b = new Z; a.M() && !a.aa();)switch(a.j){
            case 1:
                for(var c = a.Z() ? a.ea() : [
                    a.G()
                ], d = 0; d < c.length; d++)Pa(b, 1, c[d], void 0);
                break;
            case 3:
                c = a.Z() ? a.ea() : [
                    a.G()
    ...
    k("parseClientVariations", function(a) {
        ...
        a = [];
        for(var c = 0; c < b.length; c++)a.push(b.charCodeAt(c));
        b = null;
        try {
            b = Wa(a);
        } catch (c) {
        ...
        return {
            variationIds: U(b, 1),
            triggerVariationIds: U(b, 3)
        };
    });
    k("formatClientVariations", function(a) {
        var b = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "Active Google-visible variation IDs on this client. These are reported for analysis, but do not directly affect any server-side behavior.", c = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "Active Google-visible variation IDs on this client that trigger server-side behavior. These are reported for analysis *and* directly affect server-side behavior.";
        var d = a.variationIds;
        a = a.triggerVariationIds;
        var e = [
            "message ClientVariations {"
        ];
        d.length && e.push("  // ".concat(b), "  repeated int32 variation_id = [".concat(d.join(", "), "];"));
        a.length && e.push("  // ".concat(c), "  repeated int32 trigger_variation_id = [".concat(a.join(", "), "];"));
        e.push("}");
        return e.join("\n");
    });
}).call(gen);
