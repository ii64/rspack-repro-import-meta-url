...
"./panels/recorder/converters/LighthouseConverter.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('LighthouseConverter', function() {
    it('should stringify a flow', /*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    converter = new _converters_js__WEBPACK_IMPORTED_MODULE_1__.LighthouseConverter.LighthouseConverter('  ');
                    return [
                        4,
                        converter.stringify({
                            title: 'test',
                            steps: [
                                {
                                    type: _models_models_js__WEBPACK_IMPORTED_MODULE_0__.Schema.StepType.Navigate,
