"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_legacy_components_inline_editor_FontEditorUtils_test_js"], {
"./ui/legacy/components/inline_editor/FontEditorUtils.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('FontEditorUtils', function() {
    it('getRoundingPrecision rounds units as expected', function() {
        var roundingPrecisionValue = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.FontEditorUtils.getRoundingPrecision(1);
