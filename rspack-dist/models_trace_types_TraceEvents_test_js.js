...
"./models/trace/types/TraceEvents.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('TraceEvent types', function() {
    var _TraceEngine_Types_TraceEvents = _trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.TraceEvents, Phase = _TraceEngine_Types_TraceEvents.Phase, isNestableAsyncPhase = _TraceEngine_Types_TraceEvents.isNestableAsyncPhase, isAsyncPhase = _TraceEngine_Types_TraceEvents.isAsyncPhase, isFlowPhase = _TraceEngine_Types_TraceEvents.isFlowPhase;
    ...
    it('is able to determine that an event is a synthetic user timing event', /*#__PURE__*/ _async_to_generator(function() {
        var traceData, timingEvent, consoleEvent;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_1__.TraceLoader.traceEngine(this, 'timings-track.json.gz')
                    ];
                case 1:
                    traceData = _state.sent().traceData;
                    timingEvent = traceData.UserTimings.performanceMeasures[0];
                    assert.isTrue(_trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.TraceEvents.isSyntheticUserTiming(timingEvent));
                    consoleEvent = traceData.UserTimings.consoleTimings[0];
    ...
    it('is able to determine that an event is a synthetic console event', /*#__PURE__*/ _async_to_generator(function() {
        var traceData, consoleEvent, timingEvent;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
    ...
    it('is able to detemrine that an event is a synthetic network request event', /*#__PURE__*/ _async_to_generator(function() {
        var traceData, networkEvent, otherEvent;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_1__.TraceLoader.traceEngine(this, 'lcp-images.json.gz')
                    ];
                case 1:
                    traceData = _state.sent().traceData;
                    ...
                    otherEvent = traceData.Renderer.allTraceEntries[0];
    ...
    it('is able to determine that an event is a synthetic layout shift event', /*#__PURE__*/ _async_to_generator(function() {
        var traceData, syntheticLayoutShift;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_1__.TraceLoader.traceEngine(this, 'cls-single-frame.json.gz')
                    ];
                case 1:
                    traceData = _state.sent().traceData;
                    syntheticLayoutShift = traceData.LayoutShifts.clusters[0].events[0];
