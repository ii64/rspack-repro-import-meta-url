"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["third_party_codemirror_next_chunk_sass_js"], {
"./third_party/codemirror.next/chunk/sass.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  sass: function() { return U; },
  sassCompletionSource: function() { return z; },
  sassLanguage: function() { return T; }
});
...
function P(O) {
    var _$$;
    return 47 == O.next && (47 == (_$$ = O.peek(1)) || 42 == _$$);
}
var y = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, $) {
    if ($.dialectEnabled(0)) {
        var _$e;
        if (O.next < 0 && $.canShift(161)) O.acceptToken(161);
        else if (((_$e = O.peek(-1)) == d || _$e < 0) && $.canShift(160)) {
            var _$$ = 0;
            for(; O.next != d && S.includes(O.next);)O.advance(), _$$++;
            O.next == d || P(O) ? O.acceptToken(160, -_$$) : _$$ && O.acceptToken(162);
        } else if (O.next == d) O.acceptToken(159, 1);
        else if (S.includes(O.next)) {
            for(O.advance(); O.next != d && S.includes(O.next);)O.advance();
            O.acceptToken(162);
        }
    } else {
        var _$$1 = 0;
        for(; S.includes(O.next);)O.advance(), _$$1++;
        _$$1 && O.acceptToken(162);
    }
}, {
    contextual: !0
}), s = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, $) {
    if (P(O)) {
        if (O.advance(), $.dialectEnabled(0)) {
            var _$$ = -1;
            for(var _$e = 1;; _$e++){
                var _$Q = O.peek(-_$e - 1);
                if (_$Q == d || _$Q < 0) {
                    _$$ = _$e + 1;
                    break;
                }
                if (!S.includes(_$Q)) break;
            }
            if (_$$ > -1) {
                var _$e1 = 42 == O.next, _$Q1 = 0;
                for(O.advance(); O.next >= 0;)if (O.next == d) {
                    O.advance();
                    var _$e2 = 0;
                    for(; O.next != d && S.includes(O.next);)_$e2++, O.advance();
                    if (_$e2 < _$$) {
                        _$Q1 = -_$e2 - 1;
                        break;
                    }
                } else {
                    if (_$e1 && 42 == O.next && 47 == O.peek(1)) {
                        _$Q1 = 2;
                        break;
                    }
                    O.advance();
                }
                return void O.acceptToken(_$e1 ? 7 : 6, _$Q1);
            }
        }
        if (47 == O.next) {
...
}), m = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, $) {
    43 != O.next && 61 != O.next || !$.dialectEnabled(0) || O.acceptToken(61 == O.next ? 8 : 9, 1);
}), p = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, $) {
    if (!$.dialectEnabled(0)) return;
    var _$e = $.context.depth;
    if (O.next < 0 && _$e) O.acceptToken(155);
    else if (O.peek(-1) == d) {
        var _$$ = 0;
        for(; O.next != d && S.includes(O.next);)O.advance(), _$$++;
        _$$ == _$e || O.next == d || P(O) || (_$$ < _$e ? O.acceptToken(155, -_$$) : O.acceptToken(154));
    }
}), k = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O, $) {
    for(var _$e = !1, _$Q = 0, _$a = 0;; _$a++){
        var _$t = O.next;
        if (!(c(_$t) || 45 == _$t || 95 == _$t || _$e && X(_$t))) {
            if (35 == _$t && 123 == O.peek(1)) {
                O.acceptToken(5, 2);
                break;
            }
            _$e && O.acceptToken(40 == _$t ? 157 : 2 == _$Q && $.canShift(4) ? 4 : 158);
            break;
        }
        !_$e && (45 != _$t || _$a > 0) && (_$e = !0), _$Q === _$a && 45 == _$t && _$Q++, O.advance();
    }
...
}), f = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O) {
    if (S.includes(O.peek(-1))) {
        var _$$ = O.next;
        (c(_$$) || 95 == _$$ || 35 == _$$ || 46 == _$$ || 91 == _$$ || 58 == _$$ || 45 == _$$ || 38 == _$$) && O.acceptToken(156);
    }
}), Z = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.E(function(O) {
    if (!S.includes(O.peek(-1))) {
        var _$$ = O.next;
        if (37 == _$$ && (O.advance(), O.acceptToken(3)), c(_$$)) {
            do {
                O.advance();
            }while (c(O.next));
            O.acceptToken(3);
...
var W = new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.H({
    start: new x(null, 0),
    shift: function(O, $, e, Q) {
        return 154 == $ ? new x(O, e.pos - Q.pos) : 155 == $ ? O.parent : O;
    },
    hash: function(O) {
        return O.hash;
    }
}), v = (0,_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.s)({
    "AtKeyword import charset namespace keyframes media supports include mixin use forward extend at-root": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.definitionKeyword,
    "Keyword selector": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.keyword,
    ControlKeyword: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.controlKeyword,
    NamespaceName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.namespace,
    KeyframeName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.labelName,
    TagName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.tagName,
    "ClassName Suffix": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.className,
    PseudoClassName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.constant(_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.className),
    IdName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.labelName,
    "FeatureName PropertyName": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.propertyName,
    AttributeName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.attributeName,
    NumberLiteral: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.number,
    KeywordQuery: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.keyword,
    UnaryQueryOp: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.operatorKeyword,
    "CallTag ValueName": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.atom,
    VariableName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.variableName,
    SassVariableName: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.special(_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.variableName),
    Callee: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.operatorKeyword,
    Unit: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.unit,
    "UniversalSelector NestingSelector IndentedMixin IndentedInclude": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.definitionOperator,
    MatchOp: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.compareOperator,
    "ChildOp SiblingOp, LogicOp": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.logicOperator,
    BinOp: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.arithmeticOperator,
    "Important Global Default": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.modifier,
    ...
    ColorLiteral: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.color,
    "ParenthesizedContent StringLiteral": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.string,
    "InterpolationStart InterpolationContinue InterpolationEnd": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.meta,
    ': "..."': _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.punctuation,
    "PseudoOp #": _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.t.derefOperator,
    ...
    tokenPrec: 3027
}), T = _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.L.define({
    name: "sass",
    parser: h.configure({
        props: [
            _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.e.add({
                Block: _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.g,
                Comment: function(O, $) {
                    return {
                        from: O.from + 2,
            ...
            _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.i.add({
                Declaration: (0,_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.c)()
            })
        ]
    }),
    languageData: {
...
}), z = (0,_codemirror_js__WEBPACK_IMPORTED_MODULE_0__.k)(function(O) {
    return "VariableName" == O.name || "SassVariableName" == O.name;
});
function U(O) {
    return new _codemirror_js__WEBPACK_IMPORTED_MODULE_0__.a((null == O ? void 0 : O.indented) ? q : T, T.data.of({
        autocomplete: z
    }));
}
