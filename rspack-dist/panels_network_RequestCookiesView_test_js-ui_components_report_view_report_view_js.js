"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_network_RequestCookiesView_test_js-ui_components_report_view_report_view_js"], {
"./panels/network/RequestCookiesView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function renderCookiesView(request) {
    var component = new _network_js__WEBPACK_IMPORTED_MODULE_4__.RequestCookiesView.RequestCookiesView(request);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('RequestCookiesView', function() {
    beforeEach(function() {
        _core_root_root_js__WEBPACK_IMPORTED_MODULE_0__.Runtime.experiments.register('experimental-cookie-features', '');
    });
    it('show a message when request site has cookies in another partition', function() {
        var request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/foo.html', '', null, null, null);
        var component = renderCookiesView(request);
        var message = component.element.querySelector('.site-has-cookies-in-other-partition');
