...
"./panels/application/InterestGroupTreeElement.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  InterestGroupTreeElement: function() { return InterestGroupTreeElement; },
...
var str_ = _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_1__.i18n.registerUIStrings('panels/application/InterestGroupTreeElement.ts', UIStrings);
var i18nString = _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_1__.i18n.getLocalizedString.bind(undefined, str_);
var InterestGroupTreeElement = /*#__PURE__*/ function(ApplicationPanelTreeElement) {
    "use strict";
    _inherits(InterestGroupTreeElement, ApplicationPanelTreeElement);
    var _super = _create_super(InterestGroupTreeElement);
    function InterestGroupTreeElement(storagePanel) {
        _class_call_check(this, InterestGroupTreeElement);
        var _this;
        _this = _super.call(this, storagePanel, i18nString(UIStrings.interestGroups), false, 'interest-groups');
        _define_property(_assert_this_initialized(_this), "view", void 0);
        var interestGroupIcon = _ui_components_icon_button_icon_button_js__WEBPACK_IMPORTED_MODULE_3__.Icon.create('database');
        _this.setLeadingIcons([
            interestGroupIcon
        ]);
        _this.view = new _InterestGroupStorageView_js__WEBPACK_IMPORTED_MODULE_5__.InterestGroupStorageView(_assert_this_initialized(_this));
        return _this;
    }
    _create_class(InterestGroupTreeElement, [
        {
            key: "itemURL",
            get: function get() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    mainTarget.storageAgent().invoke_getInterestGroupDetails({
                                        'ownerOrigin': owner,
                                        'name': name
                                    })
                                ];
        ...
        },
        {
            ...
            value: function onselect(selectedByUser) {
                _get(_get_prototype_of(InterestGroupTreeElement.prototype), "onselect", this).call(this, selectedByUser);
    ...
    return InterestGroupTreeElement;
} //# sourceMappingURL=InterestGroupTreeElement.js.map
(_ApplicationPanelTreeElement_js__WEBPACK_IMPORTED_MODULE_4__.ApplicationPanelTreeElement);
