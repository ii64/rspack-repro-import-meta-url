"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_BackgroundServiceView_test_js"], {
"./panels/application/BackgroundServiceView.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('BackgroundServiceView', function() {
    var testKey = 'test-storage-key';
    var serviceName = "backgroundFetch" /* Protocol.BackgroundService.ServiceName.BackgroundFetch */ ;
    var target;
    var backgroundServiceModel;
    var manager;
    var view;
    beforeEach(function() {
        target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)();
        backgroundServiceModel = target.model(_application_js__WEBPACK_IMPORTED_MODULE_4__.BackgroundServiceModel.BackgroundServiceModel);
        manager = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.StorageKeyManager.StorageKeyManager);
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.ActionRegistration.maybeRemoveActionExtension('background-service.toggle-recording');
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.ActionRegistration.registerActionExtension({
        ...
        sinon.stub(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.ShortcutRegistry.ShortcutRegistry, 'instance').returns({
            shortcutTitleForAction: function() {},
            shortcutsForAction: function() {
                return [
                    new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.KeyboardShortcut.KeyboardShortcut([
                        {
                            key: 0,
                            name: ''
                        }
                    ], '', "DefaultShortcut" /* UI.KeyboardShortcut.Type.DefaultShortcut */ )
                ];
            }
        });
        assert.exists(backgroundServiceModel);
        view = new _application_js__WEBPACK_IMPORTED_MODULE_4__.BackgroundServiceView.BackgroundServiceView(serviceName, backgroundServiceModel);
    });
    afterEach(function() {
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.ActionRegistration.maybeRemoveActionExtension('background-service.toggle-recording');
    });
    it('updates event list when main storage key changes', function() {
        assert.exists(backgroundServiceModel);
        ...
        var dataRow = view.getDataGrid().dataTableBody.getElementsByClassName('data-grid-data-grid-node')[0];
        var expectedData = [
            'Event1',
            testKey,
            'Instance1'
