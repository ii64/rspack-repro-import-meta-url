...
"./panels/timeline/FreshRecording.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('FreshRecordingTracker', function() {
    it('knows that a recording has been registered as fresh', /*#__PURE__*/ _async_to_generator(function() {
        var instance, traceData;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    instance = _timeline_js__WEBPACK_IMPORTED_MODULE_1__.FreshRecording.Tracker.instance({
                        forceNew: true
                    });
                    return [
                        4,
    ...
    it('knows that un-registered recordings are not fresh', /*#__PURE__*/ _async_to_generator(function() {
        var instance, traceData;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
