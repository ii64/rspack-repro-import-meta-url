...
"./ui/legacy/components/inline_editor/AnimationTimingModel.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('AnimationTimingModel', function() {
    it('should parse `linear` as linear easing function', function() {
        var model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingModel.AnimationTimingModel.parse('linear');
    ...
    it('should parse a valid cubic bezier curve', function() {
        var model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.AnimationTimingModel.AnimationTimingModel.parse('cubic-bezier(0, 0.5, 1, 1)');
        assert.strictEqual(model.asCSSText(), 'cubic-bezier(0, 0.5, 1, 1)');
    });
    it('should parse a valid linear easing function', function() {
