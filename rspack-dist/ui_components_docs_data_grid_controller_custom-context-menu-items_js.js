...
"./ui/components/docs/data_grid_controller/custom-context-menu-items.js": (function (module, __webpack_exports__, __webpack_require__) {
...
component.data = {
    ...
    contextMenus: {
        bodyRow: function(menu) {
            menu.defaultSection().appendItem('Hello World', function() {
                alert('You clicked!');
            });
        }
    }
};
(_document_getElementById = document.getElementById('container')) === null || _document_getElementById === void 0 ? void 0 : _document_getElementById.appendChild(component); //# sourceMappingURL=custom-context-menu-items.js.map
