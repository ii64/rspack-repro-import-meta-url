...
"./core/sdk/AutofillModel.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('AutofillModel', function() {
    beforeEach(function() {
    ...
    it('can enable and disable the Autofill CDP domain', function() {
        var target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)();
        var autofillModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.AutofillModel.AutofillModel);
        var enableSpy = sinon.spy(autofillModel.agent, 'invoke_enable');
        var disableSpy = sinon.spy(autofillModel.agent, 'invoke_disable');
    ...
    it('sets test addresses by calling the Autofill backend', function() {
        var target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)();
        var autofillModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.AutofillModel.AutofillModel);
        var setAddressSpy = sinon.spy(autofillModel.agent, 'invoke_setAddresses');
    ...
    it('dispatches addressFormFilledEvent on autofill event', function() {
        var target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)();
        var autofillModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.AutofillModel.AutofillModel);
        var dispatchedEvents = [];
        autofillModel.addEventListener("AddressFormFilled" /* SDK.AutofillModel.Events.AddressFormFilled */ , function(e) {
            return dispatchedEvents.push(e.data);
        });
