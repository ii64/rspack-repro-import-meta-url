"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_network_RequestHTMLView_test_js-ui_components_report_view_report_view_js"], {
"./panels/network/RequestHTMLView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */var _network_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./network.js */ "./panels/network/network.js");
...
describe('RequestHTMLView', function() {
    it('renders a HTML document into an iframe', /*#__PURE__*/ _async_to_generator(function() {
        var content, contentData, htmlView, div, iframe;
        return _ts_generator(this, function(_state) {
            content = '<body><p>octothorp: #</p><p>hello world!<p>%3Cp%3EURI%20encoded%20tag!%3C%2Fp%3E</body>';
            contentData = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_0__.ContentData.ContentData(content, false, 'text/html');
            htmlView = _network_js__WEBPACK_IMPORTED_MODULE_1__.RequestHTMLView.RequestHTMLView.create(contentData);
            assert.exists(htmlView);
            htmlView.markAsRoot();
            div = document.createElement('div');
            htmlView.show(div);
            iframe = htmlView.contentElement.querySelector('iframe');
