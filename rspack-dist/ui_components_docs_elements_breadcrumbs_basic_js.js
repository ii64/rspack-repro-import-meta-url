...
"./ui/components/docs/elements_breadcrumbs/basic.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var bodyCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    ...
    highlightNode: function() {
        ...
        (_document_querySelector = document.querySelector('[data-fake-crumb-1]')) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.classList.add('highlight');
    },
    clearHighlight: function() {
        var _document_querySelector;
        (_document_querySelector = document.querySelector('[data-fake-crumb-1]')) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.classList.remove('highlight');
    }
});
var divCrumb = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.makeCrumb)({
    ...
    highlightNode: function() {
        var _document_querySelector;
        (_document_querySelector = document.querySelector('[data-fake-crumb-2]')) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.classList.add('highlight');
    },
    clearHighlight: function() {
        var _document_querySelector;
        (_document_querySelector = document.querySelector('[data-fake-crumb-2]')) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.classList.remove('highlight');
    }
});
...
component.addEventListener('breadcrumbsnodeselected', function(param) {
    var legacyDomNode = param.legacyDomNode;
