...
"./panels/media/TickingFlameChartHelpers.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('TickingFlameChartTests', function() {
    it('checks that the formatter works correctly', function() {
    ...
    it('checks that the bounds are correct', function() {
        var bounds = new _media_js__WEBPACK_IMPORTED_MODULE_0__.TickingFlameChartHelpers.Bounds(0, 100, 1000, 100);
        assertParameters(bounds, 0, 100, 0, 100, 100);
    });
    it('checks zoom toggle works correctly', function() {
        var bounds = new _media_js__WEBPACK_IMPORTED_MODULE_0__.TickingFlameChartHelpers.Bounds(0, 1000, 1000, 100);
    ...
    it('checks zoom different locations works correctly', function() {
        var bounds = new _media_js__WEBPACK_IMPORTED_MODULE_0__.TickingFlameChartHelpers.Bounds(0, 1000, 1000, 100);
    ...
    it('checks adding to the bounds range', function() {
        var bounds = new _media_js__WEBPACK_IMPORTED_MODULE_0__.TickingFlameChartHelpers.Bounds(0, 1000, 1000, 100);
