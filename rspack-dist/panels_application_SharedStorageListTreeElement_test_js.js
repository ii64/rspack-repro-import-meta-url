"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_SharedStorageListTreeElement_test_js"], {
"./panels/application/SharedStorageListTreeElement.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('SharedStorageListTreeElement', function() {
    var target;
    ...
    beforeEach(/*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            ...
            sharedStorageModel = target.model(_application_js__WEBPACK_IMPORTED_MODULE_6__.SharedStorageModel.SharedStorageModel);
            return [
                2
            ];
        });
    ...
    it('shows view on select', /*#__PURE__*/ _async_to_generator(function() {
        var panel, view, wasShownSpy;
        return _ts_generator(this, function(_state) {
            assert.exists(sharedStorageModel);
            sinon.stub(sharedStorageModel, 'enable').resolves();
            panel = _application_js__WEBPACK_IMPORTED_MODULE_6__.ResourcesPanel.ResourcesPanel.instance({
                forceNew: true
            });
            panel.markAsRoot();
            panel.show(document.body);
            treeElement = new _application_js__WEBPACK_IMPORTED_MODULE_6__.SharedStorageListTreeElement.SharedStorageListTreeElement(panel);
            view = treeElement.view;
            wasShownSpy = sinon.spy(view, 'wasShown');
    ...
    it('adds events', /*#__PURE__*/ _async_to_generator(function() {
        var panel, view, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event;
        return _ts_generator(this, function(_state) {
            assert.exists(sharedStorageModel);
            sinon.stub(sharedStorageModel, 'enable').resolves();
            panel = _application_js__WEBPACK_IMPORTED_MODULE_6__.ResourcesPanel.ResourcesPanel.instance({
            ...
            treeElement = new _application_js__WEBPACK_IMPORTED_MODULE_6__.SharedStorageListTreeElement.SharedStorageListTreeElement(panel);
            view = treeElement.view;
            view.setDefaultIdForTesting(_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_4__.MAIN_FRAME_ID);
    ...
    it('clears events upon main frame navigation', /*#__PURE__*/ _async_to_generator(function() {
        var panel, view, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event;
        return _ts_generator(this, function(_state) {
            assert.exists(sharedStorageModel);
            sinon.stub(sharedStorageModel, 'enable').resolves();
