...
"./models/issues_manager/CheckFormsIssuesTrigger.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('CheckFormsIssuesTrigger', function() {
    it('should call `checkFormsIssues` on devtools open.', /*#__PURE__*/ _async_to_generator(function() {
        var parentTarget, target, resourceTreeModel, auditsAgent, spyCheckFormsIssues;
        return _ts_generator(this, function(_state) {
            parentTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)();
            ...
            auditsAgent = target.auditsAgent();
            assert.exists(resourceTreeModel);
            spyCheckFormsIssues = sinon.stub(auditsAgent, 'invoke_checkFormsIssues');
            resourceTreeModel.dispatchEventToListeners(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.ResourceTreeModel.Events.Load, {
