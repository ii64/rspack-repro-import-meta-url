...
"./models/issues_manager/DeprecationIssue.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('DeprecationIssue', function() {
    var createDeprecationIssue = function createDeprecationIssue(type) {
    ...
    var createDeprecationIssueDetails = function createDeprecationIssueDetails(type) {
        return {
    ...
    it('normal deprecation issue works', function() {
        var details = createDeprecationIssueDetails('DeprecationExample');
        var issue = _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_4__.DeprecationIssue.DeprecationIssue.fromInspectorIssue(mockModel, details);
        assert.isNotEmpty(issue);
    });
    it('aggregates issues with the same type', function() {
        var issues = [
        ...
        var deprecationIssues = Array.from(aggregatedIssues[0].getDeprecationIssues());
        assert.strictEqual(deprecationIssues.length, 2);
    });
    it('does not aggregate issues with different types', function() {
        var issues = [
            createDeprecationIssue('DeprecationExample'),
