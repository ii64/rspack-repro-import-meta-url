...
"./panels/elements/AccessibilityTreeView.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var MAIN_FRAME_ID = 'MAIN_FRAME_ID';
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('AccessibilityTreeView', function() {
    var target;
    var toggleButoon;
    var treeComponent;
    beforeEach(function() {
    ...
    var updatesUiOnEvent = function(inScope) {
        return /*#__PURE__*/ _async_to_generator(function() {
            var model, treeComponentDataSet;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        model = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.AccessibilityModel.AccessibilityModel);
                        treeComponentDataSet = sinon.spy(treeComponent, 'data', [
                            'set'
                        ]);
