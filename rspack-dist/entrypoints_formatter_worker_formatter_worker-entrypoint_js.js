...
"./entrypoints/formatter_worker/formatter_worker-entrypoint.js?c8c7": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
self.onmessage = function(event) {
    ...
    switch(method){
        ...
        case "javaScriptScopeTree" /* FormatterActions.JAVASCRIPT_SCOPE_TREE */ :
            {
                ...
                self.postMessage((_FormatterWorker_ScopeParser_parseScopes = _formatter_worker_js__WEBPACK_IMPORTED_MODULE_1__.ScopeParser.parseScopes(params.content, params.sourceType)) === null || _FormatterWorker_ScopeParser_parseScopes === void 0 ? void 0 : _FormatterWorker_ScopeParser_parseScopes.export());
                break;
            }
        case "evaluatableJavaScriptSubstring" /* FormatterActions.EVALUATE_JAVASCRIPT_SUBSTRING */ :
            ...
            break;
        default:
            _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.assertNever(method, "Unsupport method name: ".concat(method));
    }
};
