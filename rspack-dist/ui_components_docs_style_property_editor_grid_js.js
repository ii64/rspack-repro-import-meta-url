"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["ui_components_docs_style_property_editor_grid_js"], {
...
"./ui/components/docs/style_property_editor/grid.js": (function (module, __webpack_exports__, __webpack_require__) {
...
var component = new _panels_elements_components_components_js__WEBPACK_IMPORTED_MODULE_0__.StylePropertyEditor.GridEditor();
...
var computedProperties = new Map([
    [
        'align-content',
        'initial'
    ],
...
var originalComputedProperties = new Map(computedProperties);
...
component.data = {
    ...
    authoredProperties: authoredProperties
};
component.addEventListener('propertyselected', function(event) {
...
component.addEventListener('propertydeselected', function(event) {
