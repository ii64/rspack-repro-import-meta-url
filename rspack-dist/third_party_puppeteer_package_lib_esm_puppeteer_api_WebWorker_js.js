...
"./third_party/puppeteer/package/lib/esm/puppeteer/api/WebWorker.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  WebWorker: function() { return WebWorker; }
});
 ...
 *
 * @public
 */ var WebWorker = /*#__PURE__*/ function(EventEmitter) {
    "use strict";
    _inherits(WebWorker, EventEmitter);
    var _super = _create_super(WebWorker);
    function WebWorker(url) {
        _class_call_check(this, WebWorker);
        var _this;
        _this = _super.call(this);
        /**
     * @internal
     */ _define_property(_assert_this_initialized(_this), "timeoutSettings", new _common_TimeoutSettings_js__WEBPACK_IMPORTED_MODULE_2__.TimeoutSettings());
     ...
     */ function evaluate(func) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                func = (0,_common_util_js__WEBPACK_IMPORTED_MODULE_3__.withSourcePuppeteerURLIfNone)(_this.evaluate.name, func);
                                return [
                                    4,
     ...
     */ function evaluateHandle(func) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                func = (0,_common_util_js__WEBPACK_IMPORTED_MODULE_3__.withSourcePuppeteerURLIfNone)(_this.evaluateHandle.name, func);
                                return [
                                    4,
