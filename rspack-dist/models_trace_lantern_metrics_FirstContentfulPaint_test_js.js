"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["models_trace_lantern_metrics_FirstContentfulPaint_test_js"], {
"./models/trace/lantern/metrics/FirstContentfulPaint.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var FirstContentfulPaint = _lantern_js__WEBPACK_IMPORTED_MODULE_0__.Metrics.FirstContentfulPaint;
describe('Metrics: Lantern FCP', function() {
    ...
    it('should compute predicted value', /*#__PURE__*/ _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    data = _state.sent();
                    result = FirstContentfulPaint.compute(data);
    ...
    it('should handle negative request networkEndTime', /*#__PURE__*/ _async_to_generator(function() {
        var data, result, optimisticNodes, pessimisticNodes;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                ...
                case 1:
                    ...
                    result = FirstContentfulPaint.compute(data);
                    optimisticNodes = [];
                    result.optimisticGraph.traverse(function(node) {
                        if (node.type === 'network') {
                            optimisticNodes.push(node);
                        }
                    });
                    expect(optimisticNodes.map(function(node) {
                        return node.request.url;
                    })).to.deep.equal([
                        'https://squoosh.app/'
                    ]);
                    pessimisticNodes = [];
                    result.pessimisticGraph.traverse(function(node) {
                        if (node.type === 'network') {
                            pessimisticNodes.push(node);
                        }
                    });
                    expect(pessimisticNodes.map(function(node) {
                        return node.request.url;
                    })).to.deep.equal([
                        'https://squoosh.app/'
                    ]);
