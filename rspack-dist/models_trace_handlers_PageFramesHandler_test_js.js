"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["models_trace_handlers_PageFramesHandler_test_js"], {
"./models/trace/handlers/PageFramesHandler.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('PageFramesHandler', function() {
    it('returns frames and their data', /*#__PURE__*/ _async_to_generator(function() {
        var events, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event, data, frames;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    data = _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.PageFrames.data();
                    frames = Array.from(data.frames.entries());
