"use strict";
(self['webpackChunk'] = self['webpackChunk'] || []).push([["panels_application_InterestGroupTreeElement_test_js"], {
"./panels/application/InterestGroupTreeElement.test.js": (function (module, __webpack_exports__, __webpack_require__) {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('InterestGroupTreeElement', function() {
    var OWNER = 'OWNER';
    var NAME = 'NAME';
    var DETAILS = {
        ownerOrigin: OWNER,
    ...
    it('reads details', /*#__PURE__*/ _async_to_generator(function() {
        var tabTarget, frameTarget, view, details;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    frameTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)({
                    ...
                    view = new _application_js__WEBPACK_IMPORTED_MODULE_3__.InterestGroupTreeElement.InterestGroupTreeElement({});
                    sinon.stub(frameTarget.storageAgent(), 'invoke_getInterestGroupDetails').withArgs({
                        ownerOrigin: OWNER,
                        name: NAME
                    ...
                    return [
                        4,
                        view.getInterestGroupDetails(OWNER, NAME)
                    ];
                case 1:
                    details = _state.sent();
