...
"./ui/legacy/Context.test.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
describe('Context', function() {
    it('can be instantiated without issues', function() {
        var context = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Context.Context.instance({
            forceNew: true
        });
