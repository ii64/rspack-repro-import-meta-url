"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["panels_application_preloading_components_RuleSetGrid_test_js-ui_components_chrome_link_chrome-b8b37e"],{

/***/ "./panels/application/preloading/components/RuleSetGrid.test.js":
/*!**********************************************************************!*\
  !*** ./panels/application/preloading/components/RuleSetGrid.test.js ***!
  \**********************************************************************/
...
async function assertRenderResult(rowsInput, headerExpected, rowsExpected) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_4__.RuleSetGrid.RuleSetGrid();
    component.update(rowsInput);
    (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.renderElementIntoDOM)(component);
    await coordinator.done();
    return (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_0__.assertGridContents)(component, headerExpected, rowsExpected);
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('RuleSetGrid', () => {
