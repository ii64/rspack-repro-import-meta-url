"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_linkifier_LinkifierImpl_test_ts"],{
...
/***/ "./src/ui/components/linkifier/LinkifierImpl.test.ts":
/*!***********************************************************!*\
  !*** ./src/ui/components/linkifier/LinkifierImpl.test.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _linkifier_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./linkifier.js */ "./src/ui/components/linkifier/linkifier.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('Linkifier', () => {
    it('renders a link when given a URL', async () => {
        const component = new _linkifier_js__WEBPACK_IMPORTED_MODULE_3__.Linkifier.Linkifier();
        component.data = {
    ...
    it('throws when given an invalid URL', () => {
        const component = new _linkifier_js__WEBPACK_IMPORTED_MODULE_3__.Linkifier.Linkifier();
        assert.throws(() => {
            component.data = { url: _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.DevToolsPath.EmptyUrlString };
    ...
    it('emits an event when clicked', async () => {
        ...
        const link = component.shadowRoot.querySelector('a');
        assert.instanceOf(link, HTMLAnchorElement);
        const clickEventPromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getEventPromise)(component, 'linkifieractivated');
