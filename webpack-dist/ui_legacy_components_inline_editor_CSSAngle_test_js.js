...
/***/ "./ui/legacy/components/inline_editor/CSSAngle.test.js":
/*!*************************************************************!*\
  !*** ./ui/legacy/components/inline_editor/CSSAngle.test.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
describe('CSSAngle', () => {
    ...
    describe('#CSSAngleUtils', () => {
        ...
        it('parses CSS properties with angles correctly', () => {
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotate(45deg)'), { value: 45, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotate(calc(45deg))'), { value: 45, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('skew(20deg)'), { value: 20, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotateX(20deg)'), { value: 20, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotateY(20deg)'), { value: 20, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotateZ(20deg)'), { value: 20, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotate3d(1, 1, 1, 20deg)'), { value: 20, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('linear-gradient(10.5grad, black, white)'), { value: 10.5, unit: "grad" /* InlineEditor.CSSAngleUtils.AngleUnit.Grad */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('conic-gradient(black 25%, white 10deg 50%, black 20deg 75%, white 30deg)'), { value: 10, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('rotate3d(2, -1, -1, -0.2rad);'), { value: -0.2, unit: "rad" /* InlineEditor.CSSAngleUtils.AngleUnit.Rad */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('hue-rotate(1.5turn)'), { value: 1.5, unit: "turn" /* InlineEditor.CSSAngleUtils.AngleUnit.Turn */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('oblique 25deg'), { value: 25, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSAngleUtils.parseText('ray(20.8deg closest-side)'), { value: 20.8, unit: "deg" /* InlineEditor.CSSAngleUtils.AngleUnit.Deg */ });
