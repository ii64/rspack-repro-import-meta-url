"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_i18n_i18n_test_ts"],{

/***/ "./src/third_party/i18n/i18n.test.ts":
/*!*******************************************!*\
  !*** ./src/third_party/i18n/i18n.test.ts ***!
  \*******************************************/
...
/* harmony import */ var _i18n_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./i18n.js */ "./src/third_party/i18n/i18n.ts");
...
describe('i18n', () => {
    let i18nInstance;
    beforeEach(() => {
        i18nInstance = new _i18n_js__WEBPACK_IMPORTED_MODULE_0__.I18n.I18n(['en-US', 'de-DE'], 'en-US'); // A fresh instance for each test.
    });
    ...
    describe('locales', () => {
        it('should provide the exact locale if it is supported', () => {
            const instance = new _i18n_js__WEBPACK_IMPORTED_MODULE_0__.I18n.I18n(['en-US', 'de-DE'], 'en-US');
        ...
        it('should provide the closest related locale if its not supported', () => {
            const instance = new _i18n_js__WEBPACK_IMPORTED_MODULE_0__.I18n.I18n(['en-US', 'de'], 'en-US');
        ...
        it('should provide the default locale if no closely related locale was found', () => {
            const instance = new _i18n_js__WEBPACK_IMPORTED_MODULE_0__.I18n.I18n(['en-US'], 'en-US');
