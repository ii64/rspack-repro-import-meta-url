"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_components_LiveMetricsView_test_ts"],{

/***/ "./src/panels/timeline/components/LiveMetricsView.test.ts":
/*!****************************************************************!*\
  !*** ./src/panels/timeline/components/LiveMetricsView.test.ts ***!
  \****************************************************************/
...
/* harmony import */ var _models_crux_manager_crux_manager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../models/crux-manager/crux-manager.js */ "./src/models/crux-manager/crux-manager.ts");
/* harmony import */ var _models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../models/emulation/emulation.js */ "./src/models/emulation/emulation.ts");
/* harmony import */ var _models_live_metrics_live_metrics_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../models/live-metrics/live-metrics.js */ "./src/models/live-metrics/live-metrics.ts");
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components.js */ "./src/panels/timeline/components/components.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_7__.describeWithMockConnection)('LiveMetricsView', () => {
    ...
    beforeEach(async () => {
        ...
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_9__.ActionRegistration.registerActionExtension({
            ...
            category: _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_9__.ActionRegistration.ActionCategory.PERFORMANCE,
        ...
        _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.registerSettingExtension({
            category: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingCategory.MOBILE,
    ...
    it('should show LCP value', async () => {
        ...
        _models_live_metrics_live_metrics_js__WEBPACK_IMPORTED_MODULE_4__.LiveMetrics.instance().dispatchEventToListeners(_models_live_metrics_live_metrics_js__WEBPACK_IMPORTED_MODULE_4__.Events.Status, {
            lcp: { value: 100 },
            interactions: [],
        });
    ...
    it('should show INP value', async () => {
        const view = new _components_js__WEBPACK_IMPORTED_MODULE_10__.LiveMetricsView.LiveMetricsView();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_5__.renderElementIntoDOM)(view);
        _models_live_metrics_live_metrics_js__WEBPACK_IMPORTED_MODULE_4__.LiveMetrics.instance().dispatchEventToListeners(_models_live_metrics_live_metrics_js__WEBPACK_IMPORTED_MODULE_4__.Events.Status, { inp: { value: 2000 }, interactions: [] });
        await coordinator.done();
