...
/***/ "./panels/application/SharedStorageEventsView.test.js":
/*!************************************************************!*\
  !*** ./panels/application/SharedStorageEventsView.test.js ***!
  \************************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithMockConnection)('SharedStorageEventsView', () => {
    ...
    it('updates sidebarWidget upon receiving cellFocusedEvent', async () => {
        ...
        grid.dispatchEvent(new _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_2__.DataGridEvents.BodyCellFocusedEvent({ columnId: 'event-time', value: '0' }, { cells }));
