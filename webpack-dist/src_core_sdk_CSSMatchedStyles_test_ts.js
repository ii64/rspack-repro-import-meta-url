"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_CSSMatchedStyles_test_ts"],{

/***/ "./src/core/sdk/CSSMatchedStyles.test.ts":
/*!***********************************************!*\
  !*** ./src/core/sdk/CSSMatchedStyles.test.ts ***!
  \***********************************************/
...
function createMatchedStyles(payload) {
    const node = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
    node.id = 1;
    return _sdk_js__WEBPACK_IMPORTED_MODULE_3__.CSSMatchedStyles.CSSMatchedStyles.create({
        cssModel: sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.CSSModel.CSSModel),
        node,
        inlinePayload: null,
...
describe('CSSMatchedStyles', () => {
    describe('computeCSSVariable', () => {
        ...
        it('correctly resolves the declaration', async () => {
            const node = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
            node.id = 1;
            node.parentNode = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
            node.parentNode.id = 2;
            node.parentNode.parentNode = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
            node.parentNode.parentNode.id = 3;
            node.parentNode.parentNode.parentNode = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
    ...
    it('does not hide inherited rules that also apply directly to the node if it contains custom properties', async () => {
        const parentNode = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
        parentNode.id = 0;
        const node = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.DOMModel.DOMNode);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('NodeCascade', () => {
    it('correctly marks custom properties as Overloaded if they are registered as inherits: false', async () => {
        ...
        assert.strictEqual(matchedStyles.propertyState(nonInheritableProperty), _sdk_js__WEBPACK_IMPORTED_MODULE_3__.CSSMatchedStyles.PropertyState.Overloaded);
        assert.strictEqual(matchedStyles.propertyState(inheritableProperty), _sdk_js__WEBPACK_IMPORTED_MODULE_3__.CSSMatchedStyles.PropertyState.Active);
    });
