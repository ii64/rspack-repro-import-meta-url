"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_components_BreakpointsViewUtils_test_ts"],{

/***/ "./src/panels/sources/components/BreakpointsViewUtils.test.ts":
/*!********************************************************************!*\
  !*** ./src/panels/sources/components/BreakpointsViewUtils.test.ts ***!
  \********************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components.js */ "./src/panels/sources/components/components.ts");
...
describe('getDifferentiatingPathMap', () => {
    ...
    it('can extract the differentiating segment if it is the parent folder', () => {
        ...
        const differentiatingPathMap = _components_js__WEBPACK_IMPORTED_MODULE_0__.BreakpointsViewUtils.getDifferentiatingPathMap(titleInfos);
