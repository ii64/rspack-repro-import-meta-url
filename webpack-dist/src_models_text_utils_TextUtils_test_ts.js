"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_text_utils_TextUtils_test_ts"],{

/***/ "./src/models/text_utils/TextUtils.test.ts":
/*!*************************************************!*\
  !*** ./src/models/text_utils/TextUtils.test.ts ***!
  \*************************************************/
...
describe('TextUtils', () => {
    describe('Utils', () => {
        ...
        describe('splitStringByRegexes', () => {
            it('returns the correct result for a single regex', () => {
                let result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('', [/a/]);
                assert.strictEqual(result.length, 0, 'length was wrong');
                result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('a', [/a/]);
                ...
                result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('ba b', [/a/]);
            ...
            it('returns the correct result for a multiple regexs', () => {
                let result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('', [/a/, /b/]);
                assert.strictEqual(result.length, 0, 'length was wrong');
                result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('a', [/a/, /b/]);
                assert.strictEqual(result.length, 1, 'length was wrong');
                assert.strictEqual(result[0].value, 'a', 'value was wrong');
                assert.strictEqual(result[0].position, 0, 'position was wrong');
                assert.strictEqual(result[0].regexIndex, 0, 'regex index was wrong');
                assert.deepEqual(result[0].captureGroups, [], 'capture groups was not empty');
                result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('ba b', [/a/, /b/]);
            ...
            it('returns the correct result for global regexs', () => {
                let result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('', [/a/g, /b/g]);
                assert.strictEqual(result.length, 0, 'length was wrong');
                result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.Utils.splitStringByRegexes('a', [/a/g, /b/g]);
                assert.strictEqual(result.length, 1, 'length was wrong');
                assert.strictEqual(result[0].value, 'a', 'value was wrong');
                assert.strictEqual(result[0].position, 0, 'position was wrong');
                assert.strictEqual(result[0].regexIndex, 0, 'regex index was wrong');
    ...
    describe('FilterParser', () => {
        it('can be instantiated successfully', () => {
            ...
            const filterParser = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.FilterParser(['TestVal1']);
        ...
        describe('parse', () => {
            ...
            it('returns correct results for a range of inputs', () => {
                const filterParser = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.FilterParser(['key1', 'key2']);
                const parse = (text) => {
        ...
        it('cloneFilter gives a correct copy', () => {
            ...
            const cloned = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.FilterParser.cloneFilter(filter);
    ...
    describe('BalancedJSONTokenizer', () => {
        it('can be instantiated successfully', () => {
            ...
            const tokenizer = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.BalancedJSONTokenizer(callback, findMultiple);
    ...
    describe('isMinified', () => {
        const { isMinified } = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils;
...
`;
    ...
    describe('detectIndentation', () => {
        const { detectIndentation } = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils;
...
export class ApiProxy {
    ...
    describe('performExtendedSearchInContent', () => {
        it('returns an entry for each match on the same line', () => {
            ...
            const result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.performSearchInContent(lines.join('\n'), 'the', false, false);
    ...
    describe('performExtendedSearchInSearchMatches', () => {
        it('returns an entry for each match on the same line', () => {
            ...
            const result = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextUtils.performSearchInSearchMatches(searchMatches, 'the', false, false);
            assert.deepEqual(result, [
