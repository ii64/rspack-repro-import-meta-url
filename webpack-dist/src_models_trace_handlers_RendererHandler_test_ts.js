"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_handlers_RendererHandler_test_ts"],{

/***/ "./src/models/trace/handlers/RendererHandler.test.ts":
/*!***********************************************************!*\
  !*** ./src/models/trace/handlers/RendererHandler.test.ts ***!
  \***********************************************************/
...
async function handleEventsFromTraceFile(context, file) {
    const { traceData } = await _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_3__.TraceLoader.traceEngine(context, file);
    return traceData;
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('RendererHandler', function () {
    ...
    it('finds all the main frame threads in a real world profile', async () => {
        const { Renderer: renderers } = await handleEventsFromTraceFile(this, 'multiple-navigations-with-iframes.json.gz');
        const frame = renderers.processes.get(_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(MAIN_FRAME_PID));
    ...
    it('finds all the sub frame threads in a real world profile', async () => {
        const { Renderer: renderers } = await handleEventsFromTraceFile(this, 'multiple-navigations-with-iframes.json.gz');
        const frame = renderers.processes.get(_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID));
        const names = [...frame.threads].map(([, thread]) => thread.name).sort();
        assert.deepEqual(names, [
            'Chrome_ChildIOThread',
            'Compositor',
    ...
    it('builds a hierarchy for the main frame\'s main thread in a real world profile', async () => {
        ...
        const isInstant = (event) => _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.isTraceEventInstant(event);
        const isLong = (event) => _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.isTraceEventComplete(event) && event.dur > 1000;
        const isIncluded = (node, event) => (!isRoot(node) || isInstant(event) || isLong(event)) &&
            Boolean(_panels_timeline_timeline_js__WEBPACK_IMPORTED_MODULE_0__.EventUICategory.getEventStyle(event.name));
...
......................................................................................................................`);
    ...
    it('builds a hierarchy for the sub frame\'s main thread in a real world profile', async () => {
        ...
        const isIncluded = (_node, event) => Boolean(_panels_timeline_timeline_js__WEBPACK_IMPORTED_MODULE_0__.EventUICategory.getEventStyle(event.name));
        assert.strictEqual((0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.prettyPrint)(tree, isIncluded), `
-RunTask [0.13ms]
-RunTask [0.005ms]
-RunTask [0.009ms]
...
.`);
    ...
    it('has some correct known roots for the main frame\'s main thread in a real world profile', async () => {
        ...
        const event0 = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, 1).entry;
        ...
        const event1 = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, 2).entry;
        ...
        const eventLast = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, tree.roots.size - 1).entry;
    ...
    it('has some correct known roots for the sub frame\'s main thread in a real world profile', async () => {
        ...
        const event0 = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, 0).entry;
        assert.deepEqual(event0, {
            'args': {},
            'cat': 'disabled-by-default-devtools.timeline',
            'dur': 130,
        ...
        const event1 = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, 1).entry;
        assert.deepEqual(event1, {
            'args': {},
            'cat': 'disabled-by-default-devtools.timeline',
            'dur': 5,
        ...
        const event2 = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getRootAt)(thread, 2).entry;
    ...
    it('can process multiple processes', async () => {
         ...
         */
        const data1 = [
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('A', 0, 10), // 0..10
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('B', 1, 3), // 1..4
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('D', 5, 3), // 5..8
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('C', 2, 1), // 2..3
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('E', 11, 3), // 11..14
        ];
        /**
         * |-- Task F --||------------- Task G -------------|
         *               |-- Task H --||-- Task J --|
         ...
         */
        const data2 = [
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('F', 0, 3), // 0..3
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('G', 3, 10), // 3..13 (starts when F finishes)
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('H', 3, 3), // 3..6 (starts same time as G)
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('J', 6, 3), // 6..9 (starts when H finishes)
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('I', 5, 1), // 5..6 (finishes when H finishes)
        ];
        ...
        await _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Samples.finalize();
        _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Renderer.buildHierarchy(processes, { filter: { has: () => true } });
        ...
        const firstRoots = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getEventsIn)(firstThread.tree.roots.values());
        assert.deepEqual(firstRoots.map(e => e ? { name: e.name, ts: e.ts, dur: e.dur } : null), [
            { 'name': 'A', 'ts': 0, 'dur': 10 },
            { 'name': 'E', 'ts': 11, 'dur': 3 },
        ]);
        const secondRoots = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getEventsIn)(secondThread.tree.roots.values());
    ...
    it('can assign origins to processes', async () => {
        ...
        assert.deepEqual([...processes].map(([pid, p]) => [pid, p.url ? new URL(p.url).origin : null]), [
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(MAIN_FRAME_PID), 'http://localhost:5000'],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID), 'https://www.example.com'],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID_2), 'https://www.example.com'],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID_3), 'https://www.example.com'],
        ]);
    });
    it('can assign main frame flags to processes', async () => {
        ...
        assert.deepEqual([...processes].map(([pid, p]) => [pid, p.isOnMainFrame]), [
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(MAIN_FRAME_PID), true],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID), false],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID_2), false],
            [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(SUB_FRAME_PID_3), false],
        ]);
    });
    it('can assign thread names to threads in processes', async () => {
        ...
        assert.deepEqual([...processes].map(([pid, p]) => [pid, [...p.threads].map(([tid, t]) => [tid, t.name])]), [
            [
                ...
                [
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(1), 'CrRendererMain'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(7), 'Compositor'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(2), 'ThreadPoolServiceThread'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(4), 'Chrome_ChildIOThread'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(24), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(27), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(17), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(29), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(25), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(28), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(30), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(26), 'ThreadPoolForegroundWorker'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(11), 'CompositorTileWorker3'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(12), 'CompositorTileWorker4'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(10), 'CompositorTileWorker2'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(9), 'CompositorTileWorker1'],
                ],
            ],
            [
            ...
            [
                ...
                [
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(1), 'CrRendererMain'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(4), 'Chrome_ChildIOThread'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(8), 'Compositor'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(2), 'ThreadPoolServiceThread'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(10), 'CompositorTileWorker1'],
                ],
            ],
            [
                ...
                [
                    ...
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(7), 'Compositor'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(10), 'CompositorTileWorker2'],
                    [_trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(3), 'ThreadPoolForegroundWorker'],
                ],
            ],
        ]);
    });
    ...
    describe('Synthetic complete events', () => {
        async function handleEvents(traceEvents) {
            ...
            await _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Meta.finalize();
            await _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Samples.finalize();
            await _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Renderer.finalize();
            return _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Renderer.data();
        }
        let defaultTraceEvents;
        const pid = _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(28274);
        const tid = _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(775);
        beforeEach(async function () {
            defaultTraceEvents = await _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_3__.TraceLoader.rawEvents(this, 'basic.json.gz');
        });
        afterEach(() => {
            _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Renderer.reset();
            _trace_js__WEBPACK_IMPORTED_MODULE_4__.Handlers.ModelHandlers.Meta.reset();
        ...
        it('builds a hierarchy using begin and end trace events', async () => {
            ...
            //   |- FunctionCall -|
            const traceEvents = [
                ...defaultTraceEvents, (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunTask', 0, '*', pid, tid), // 0..10
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunMicrotasks', 1, '*', pid, tid), // 1..4
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('FunctionCall', 2, '*', pid, tid), // 2..3
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('FunctionCall', 3, '*', pid, tid), // 2..3
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('RunMicrotasks', 4, '*', pid, tid), // 1..4
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('Layout', 5, '*', pid, tid), // 5..8
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('Layout', 8, '*', pid, tid), // 5..8
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('RunTask', 10, '*', pid, tid), // 0..10
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunTask', 11, '*', pid, tid), // 11..14
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('RunTask', 14, '*', pid, tid), // 11..14
            ];
            ...
            const allNodes = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getAllNodes)(thread.tree?.roots);
...
-RunTask [0.003ms]`);
        ...
        it('builds a hierarchy using complete, begin and end trace events', async () => {
            ...
            const traceEvents = [
                ...defaultTraceEvents, (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunTask', 0, '*', pid, tid), // 0..10
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunMicrotasks', 1, '*', pid, tid), // 1..4
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('FunctionCall', 2, 1, '*', pid, tid), // 2..3
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('RunMicrotasks', 4, '*', pid, tid), // 1..4
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('Layout', 5, '*', pid, tid), // 5..8
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('Layout', 8, '*', pid, tid), // 5..8
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeEndEvent)('RunTask', 10, '*', pid, tid), // 0..10
...
-RunTask [0.01ms]
  ...
  -Layout [0.003ms]`);
        ...
        it('keeps a FunctionCall that has the end event missing', async () => {
            const traceEvents = [
                ...defaultTraceEvents, (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('RunMicrotasks', 1, '*', pid, tid), // 1..4
                (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeBeginEvent)('FunctionCall', 2, '*', pid, tid), // 2..3
            ];
            const data = await handleEvents(traceEvents);
            assert.strictEqual(data.processes.size, 1);
    ...
    describe('building hierarchies trace events and profile calls', () => {
        it('build a hierarchy using data from real world trace file', async () => {
            ...
            const threadId = _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ThreadID(259);
            const firstProcessId = _trace_js__WEBPACK_IMPORTED_MODULE_4__.Types.TraceEvents.ProcessID(23239);
