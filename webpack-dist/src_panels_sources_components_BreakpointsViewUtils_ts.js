"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_components_BreakpointsViewUtils_ts"],{

/***/ "./src/panels/sources/components/BreakpointsViewUtils.ts":
/*!***************************************************************!*\
  !*** ./src/panels/sources/components/BreakpointsViewUtils.ts ***!
  \***************************************************************/
...
/* harmony export */   findNextNodeForKeyboardNavigation: () => (/* binding */ findNextNodeForKeyboardNavigation),
/* harmony export */   getDifferentiatingPathMap: () => (/* binding */ getDifferentiatingPathMap)
/* harmony export */ });
...
function findNextNodeForPauseOnExceptions(target, key) {
    ...
    let nextNode = null;
    switch (key) {
        case _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.KeyboardUtilities.ArrowKey.UP: {
        ...
        case _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.KeyboardUtilities.ArrowKey.DOWN: {
...
async function findNextNodeForKeyboardNavigation(target, key, setGroupExpandedStateCallback) {
    ...
    let nextNode = null;
    switch (key) {
        case _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.KeyboardUtilities.ArrowKey.LEFT: {
        ...
        case _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.KeyboardUtilities.ArrowKey.RIGHT: {
            if (domNodeIsSummaryNode(target)) {
...
function populateDifferentiatingPathMap(urls, urlToDifferentiator) {
    const splitReversedUrls = urls.map(url => {
        ...
        const paths = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ParsedURL.ParsedURL.fromString(url)?.folderPathComponents.slice(1);
