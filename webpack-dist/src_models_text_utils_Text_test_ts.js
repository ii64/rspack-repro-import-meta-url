"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_text_utils_Text_test_ts"],{

/***/ "./src/models/text_utils/Text.test.ts":
/*!********************************************!*\
  !*** ./src/models/text_utils/Text.test.ts ***!
  \********************************************/
...
describe('Text', () => {
    it('can be instantiated successfully', () => {
        ...
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text(testVal);
        assert.strictEqual(text.value(), testVal);
    });
    it('has a list of line ending offsets including the end of the string', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('\nLine 2\nLine 3\n');
    ...
    it('should be able to return line 0', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('Line 1\nLine 2\nLine 3\n');
        assert.strictEqual(text.lineAt(0), 'Line 1');
    });
    it('should return a source range for a given text range', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('\nLine 2\nLine 3\n');
        const textRange = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange(1, 0, 2, 6);
    ...
    it('should return a source range with an offset and length of NaN if the startLine is out of range', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('\nLine 2\nLine 3\n');
        const textRange = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange(10, 0, 12, 6);
        const sourceRange = text.toSourceRange(textRange);
    ...
    it('should return a text range for a given source range', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('\nLine 2\nLine 3\n');
        const sourceRange = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.SourceRange(1, 13);
    ...
    it('should replace a given range with a new string', () => {
        const text = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.Text.Text('\nLine 2\nLine 3\n');
        const textRange = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange(1, 0, 2, 0);
