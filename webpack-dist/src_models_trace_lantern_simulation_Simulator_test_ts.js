"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_lantern_simulation_Simulator_test_ts"],{

/***/ "./src/models/trace/lantern/simulation/Simulator.test.ts":
/*!***************************************************************!*\
  !*** ./src/models/trace/lantern/simulation/Simulator.test.ts ***!
  \***************************************************************/
...
/* harmony import */ var _testing_testing_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../testing/testing.js */ "./src/models/trace/lantern/testing/testing.ts");
...
const { NetworkNode, CPUNode } = _lantern_js__WEBPACK_IMPORTED_MODULE_2__.Graph;
const { Simulator, DNSCache } = _lantern_js__WEBPACK_IMPORTED_MODULE_2__.Simulation;
let nextRequestId = 1;
let nextTid = 1;
async function createGraph(trace) {
    const traceEngineData = await (0,_testing_testing_js__WEBPACK_IMPORTED_MODULE_3__.runTraceEngine)(trace);
    const requests = _trace_js__WEBPACK_IMPORTED_MODULE_1__.LanternComputationData.createNetworkRequests(trace, traceEngineData);
    return _trace_js__WEBPACK_IMPORTED_MODULE_1__.LanternComputationData.createGraph(requests, trace, traceEngineData);
}
...
describe('DependencyGraph/Simulator', () => {
    ...
    before(async function () {
        trace = await (0,_testing_testing_js__WEBPACK_IMPORTED_MODULE_3__.loadTrace)(this, 'lantern/progressive-app/trace.json.gz');
