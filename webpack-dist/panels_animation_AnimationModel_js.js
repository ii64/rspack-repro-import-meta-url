...
/***/ "./panels/animation/AnimationModel.js":
/*!********************************************!*\
  !*** ./panels/animation/AnimationModel.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class AnimationModel extends _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.SDKModel.SDKModel {
    ...
    constructor(target) {
        ...
        this.#flushPendingAnimations = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Debouncer.debounce(() => {
    ...
    node() {
        if (!this.#deferredNodeInternal) {
            this.#deferredNodeInternal =
                new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMModel.DeferredDOMNode(this.#animationModel.target(), this.backendNodeId());
        }
        return this.#deferredNodeInternal.resolvePromise();
    }
    deferredNode() {
        return new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMModel.DeferredDOMNode(this.#animationModel.target(), this.backendNodeId());
    }
    backendNodeId() {
...
class AnimationGroup {
    ...
    async scrollNode() {
        ...
        const deferredScrollNode = new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMModel.DeferredDOMNode(this.#animationModel.target(), sourceNodeId);
        const scrollNode = await deferredScrollNode.resolvePromise();
        if (!scrollNode) {
            return null;
        }
        this.#scrollNodeInternal = new _AnimationDOMNode_js__WEBPACK_IMPORTED_MODULE_2__.AnimationDOMNode(scrollNode);
        return this.#scrollNodeInternal;
    }
    seekTo(currentTime) {
...
_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.SDKModel.SDKModel.register(AnimationModel, { capabilities: 2 /* SDK.Target.Capability.DOM */, autostart: false });
