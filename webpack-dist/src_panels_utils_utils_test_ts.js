"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_utils_utils_test_ts"],{

/***/ "./src/panels/utils/utils.test.ts":
/*!****************************************!*\
  !*** ./src/panels/utils/utils.test.ts ***!
  \****************************************/
...
/* harmony import */ var _third_party_diff_diff_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../third_party/diff/diff.js */ "./src/third_party/diff/diff.ts");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ "./src/panels/utils/utils.ts");
...
describe('panels/utils', () => {
    it('formats CSS changes from diff arrays', async () => {
      ...
      @supports (display: flex) {
        ...
        const diff = _third_party_diff_diff_js__WEBPACK_IMPORTED_MODULE_0__.Diff.DiffWrapper.lineDiff(original.split('\n'), current.split('\n'));
        const changes = await _utils_js__WEBPACK_IMPORTED_MODULE_1__.PanelUtils.formatCSSChangesFromDiff(diff);
