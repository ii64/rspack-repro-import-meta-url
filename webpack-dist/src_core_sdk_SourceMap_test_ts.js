"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_SourceMap_test_ts"],{

/***/ "./src/core/sdk/SourceMap.test.ts":
/*!****************************************!*\
  !*** ./src/core/sdk/SourceMap.test.ts ***!
  \****************************************/
...
/* harmony import */ var _testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../testing/SourceMapEncoder.js */ "./src/testing/SourceMapEncoder.ts");
/* harmony import */ var _root_root_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../root/root.js */ "./src/core/root/root.ts");
...
describe('SourceMapEntry', () => {
    it('can be instantiated correctly', () => {
        const sourceMapEntry = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(1, 1, 'http://www.example.com/', 1, 1, 'example');
    ...
    describe('comparison', () => {
        it('checks line numbers first', () => {
            const sourceMapEntry1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(1, 5, sourceUrlFoo, 1, 5, 'foo');
            const sourceMapEntry2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(2, 5, sourceUrlFoo, 2, 5, 'foo');
        ...
        it('checks column numbers second when line numbers are equal', () => {
            const sourceMapEntry1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(2, 5, sourceUrlFoo, 1, 5, 'foo');
            const sourceMapEntry2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(2, 25, sourceUrlFoo, 2, 5, 'foo');
            assert.isBelow(_sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry.compare(sourceMapEntry1, sourceMapEntry2), 0, 'first entry is not smaller');
        });
        it('works for equal SourceMapEntries', () => {
            const sourceMapEntry1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(2, 5, sourceUrlFoo, 1, 5, 'foo');
            const sourceMapEntry2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMapEntry(2, 5, sourceUrlFoo, 1, 5, 'foo');
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('SourceMap', () => {
    ...
    describe('TokenIterator', () => {
        it('detects when it has reached the end', () => {
            const emptyIterator = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.TokenIterator('');
            assert.isFalse(emptyIterator.hasNext());
            const iterator = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.TokenIterator('foo');
        ...
        it('advances when {next} is called', () => {
            const iterator = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.TokenIterator('bar');
        ...
        it('peeks the next VLQ number without moving the iterator', () => {
            ...
            for (const [input, expectedOutput] of cases) {
                const iter = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.TokenIterator(input);
    ...
    it('can parse a simple source map', () => {
        /*
              ...
              foo
        */
        const mappingPayload = (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__.encodeSourceMap)([
            // clang-format off
        ...
        const sourceMap = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledUrl, sourceMapJsonUrl, mappingPayload);
    ...
    it('can parse source maps with mappings in reverse direction', () => {
        /*
            ...
            DCBA
         */
        const sourceMap = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledUrl, sourceMapJsonUrl, {
    ...
    describe('compatibleForURL', () => {
        ...
        it('correctly identifies equal sourcemaps with content', () => {
            ...
            const sourceMap1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, payload);
            const sourceMap2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, payload);
        ...
        it('correctly differentiates based on content', () => {
            const sourceMap1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, {
                mappings: '',
                sourceRoot,
                sources: ['foo.ts'],
            ...
            const sourceMap2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, {
                mappings: '',
                sourceRoot,
                sources: ['foo.ts'],
        ...
        it('correctly differentiates based on ignore-list hint', () => {
            ...
            const sourceMap1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, payload1);
            const sourceMap2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledURL, sourceMappingURL, payload2);
            assert.isFalse(sourceMap1.compatibleForURL(sourceURL, sourceMap2));
            assert.isFalse(sourceMap2.compatibleForURL(sourceURL, sourceMap1));
        });
    });
    describe('source URL resolution', () => {
        ...
        for (const { sourceRoot, sourceURL, sourceMapURL, expected } of cases) {
            it(`can resolve sourceURL "${sourceURL}" with sourceRoot "${sourceRoot}" and sourceMapURL "${sourceMapURL}"`, () => {
                ...
                const sourceMap = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledUrl, sourceMapURL, mappingPayload);
        ...
        it('does not touch sourceURLs that conflict with the compiled URL', () => {
            ...
            const sourceMap = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(sourceURL, sourceMappingURL, {
                version: 3,
                sources: [sourceURL],
    ...
    describe('loadSourceMap', () => {
        ...
        const { parseSourceMap } = _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap;
    ...
    describe('reverseMapTextRanges', () => {
        const { SourceMap } = _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap;
        const { TextRange } = _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange;
        it('yields an empty array for unknown source URLs', () => {
            const sourceMap = new SourceMap(compiledUrl, sourceMapJsonUrl, (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__.encodeSourceMap)(['0:0 => example.js:0:0']));
        ...
        it('yields a single range for trivial single-line, fully contained mappings', () => {
            const sourceMap = new SourceMap(compiledUrl, sourceMapJsonUrl, (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__.encodeSourceMap)([
                '0:0 => example.js:0:0',
                '0:5 => example.js:0:6',
                '1:0 => other.js:0:0',
                '1:8 => other.js:0:9',
    ...
    describe('findEntry', () => {
        it('can resolve generated positions with inlineFrameIndex', () => {
            _root_root_js__WEBPACK_IMPORTED_MODULE_3__.Runtime.experiments.enableForTest(_root_root_js__WEBPACK_IMPORTED_MODULE_3__.Runtime.ExperimentName.USE_SOURCE_MAP_SCOPES);
            // 'foo' calls 'bar', 'bar' calls 'baz'. 'bar' and 'baz' are inlined into 'foo'.
            const names = [];
            const originalScopes = [new _testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__.OriginalScopeBuilder(names)
                    .start(0, 0, 'global')
                    ...
                    .end(70, 0)
                    .build()];
            const generatedRanges = new _testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_2__.GeneratedRangeBuilder(names)
                ...
                .end(0, 10)
                .build();
            const sourceMap = new _sdk_js__WEBPACK_IMPORTED_MODULE_4__.SourceMap.SourceMap(compiledUrl, sourceMapJsonUrl, { version: 3, sources: ['foo.ts'], mappings: '', names, originalScopes, generatedRanges });
