"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_text_utils_TextRange_test_ts"],{

/***/ "./src/models/text_utils/TextRange.test.ts":
/*!*************************************************!*\
  !*** ./src/models/text_utils/TextRange.test.ts ***!
  \*************************************************/
...
function assertIsTextRangeAndEqualsRange(range, expectedRange, description) {
    ...
    assert.isTrue(range instanceof _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange, `${prefix}range is not a TextUtils.TextRange.TextRange`);
...
describe('TextRange', () => {
    it('can be instantiated successfully', () => {
        ...
        const endLine = 3;
        const endColumn = 4;
        const textRange = new _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange(startLine, startColumn, endLine, endColumn);
    ...
    it('can be created from a location', () => {
        const line = 1;
        const column = 2;
        const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.createFromLocation(line, column);
    ...
    it('can be created from a serialized text range', () => {
        ...
        const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(range);
        ...
        const deserializedTextRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(serializedRange);
    ...
    it('can be checked for emptiness', () => {
        const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 2 });
        assert.isTrue(textRange.isEmpty(), 'the range was non-empty');
    });
    describe('immediatelyPrecedes()', () => {
        it('can handle non-range inputs', () => {
            const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
        ...
        it('can judge immediate preceedence correctly', () => {
            const textRangeA = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
            const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 4, endLine: 5, endColumn: 6 });
            const textRangeC = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 5, startColumn: 6, endLine: 7, endColumn: 8 });
    ...
    it('can report the line count', () => {
        const textRangeA = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 2 });
        const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 2, endColumn: 2 });
        const textRangeC = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 12, endColumn: 2 });
    ...
    it('can be collapsed to start', () => {
        ...
        const textRangeA = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(rangeA);
        const rangeB = { startLine: 4, startColumn: 2, endLine: 2, endColumn: 2 };
        const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(rangeB);
    ...
    it('can be checked for equality', () => {
        const rangeA = { startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 };
        const textRangeA = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(rangeA);
        const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject(rangeA);
    ...
    it('can be compared', () => {
        const textRangeA = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
        const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 4, endLine: 3, endColumn: 4 });
        const textRangeC = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 2, startColumn: 2, endLine: 3, endColumn: 4 });
        const textRangeD = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 1, endLine: 3, endColumn: 4 });
    ...
    it('can be adjusted relative to a position', () => {
        const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 4, startColumn: 3, endLine: 6, endColumn: 7 });
    ...
    it('can be adjusted relative from a position', () => {
        ...
        const textRange2 = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 0, startColumn: 3, endLine: 6, endColumn: 7 });
        ...
        const textRange3 = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 3, endLine: 0, endColumn: 7 });
    ...
    describe('containsLocation', () => {
        it('can check if a position is contained', () => {
            ...
            const textRangeB = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 1, endColumn: 4 });
    ...
    describe('fromEdit()', () => {
        it('can construct a range from an edit of a text ending with a newline', () => {
            const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
            const text = 'This is\nan example text\nwith newlines\nin it. It is for\n the test.\n';
            const textRangeEdited = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromEdit(textRange, text);
    ...
    describe('rebaseAfterTextEdit()', () => {
        ...
        beforeEach(() => {
            originalRange =
                _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 3, endColumn: 4 });
            editedRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 1, startColumn: 2, endLine: 7, endColumn: 8 });
        });
        ...
        it('can rebase a range if its rebased range neither starts nor ends at end of the edited range', () => {
            const textRange = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 4, startColumn: 4, endLine: 6, endColumn: 8 });
            const rebasedTextRange = textRange.rebaseAfterTextEdit(originalRange, editedRange);
        ...
        it('can rebase a range if its rebased range starts at the end of the edited range', () => {
            const textRangeToRebase = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 5, endLine: 6, endColumn: 8 });
        ...
        it('can rebase a range if its rebased range starts and ends at the end of the edited range', () => {
            const textRangeToRebase = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange.TextRange.fromObject({ startLine: 3, startColumn: 5, endLine: 3, endColumn: 8 });
            const rebasedTextRange = textRangeToRebase.rebaseAfterTextEdit(originalRange, editedRange);
    ...
    describe('intersection', () => {
        const { TextRange } = _text_utils_js__WEBPACK_IMPORTED_MODULE_0__.TextRange;
