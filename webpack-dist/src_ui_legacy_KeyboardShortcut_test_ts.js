"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_KeyboardShortcut_test_ts"],{

/***/ "./src/ui/legacy/KeyboardShortcut.test.ts":
/*!************************************************!*\
  !*** ./src/ui/legacy/KeyboardShortcut.test.ts ***!
  \************************************************/
...
describe('KeyboardShortcut', () => {
    it('can be instantiated', () => {
        ...
        const shortcut = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardShortcut.KeyboardShortcut(descriptors, 'settings.shortcuts', _legacy_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardShortcut.Type.DefaultShortcut);
