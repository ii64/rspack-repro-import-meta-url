"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_extensions_HostUrlPattern_test_ts"],{

/***/ "./src/models/extensions/HostUrlPattern.test.ts":
/*!******************************************************!*\
  !*** ./src/models/extensions/HostUrlPattern.test.ts ***!
  \******************************************************/
...
describe('HostUrlPattern', () => {
    it('ParseInvalid', () => {
        ...
        for (const pattern of invalidPatterns) {
            const parsedPattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse(pattern);
    ...
    it('Matches all pages for a given scheme', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://*/*');
    ...
    it('Matches all domains', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('https://*/*');
        assert.exists(pattern);
    ...
    it('Matches subdomains', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://*.google.com/');
        assert.exists(pattern);
        assert.strictEqual('http', pattern.scheme);
    ...
    it('Matches ip addresses', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://127.0.0.1/');
        assert.exists(pattern);
        assert.strictEqual('http', pattern.scheme);
    ...
    it('Matches subdomain matching with ip addresses', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://*.0.0.1/');
        assert.exists(pattern);
        assert.strictEqual('http', pattern.scheme);
    ...
    it('Matches chrome://', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('chrome://favicon/*');
        assert.exists(pattern);
    ...
    it('Matches *://', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('*://*/*');
        assert.exists(pattern);
    ...
    it('Matches <all_urls>', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('<all_urls>');
        assert.exists(pattern);
    ...
    it('Matches Specific port', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://www.example.com:80/');
        assert.exists(pattern);
        assert.strictEqual('http', pattern.scheme);
    ...
    it('Matches Explicit port wildcard', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://www.example.com:*/*');
        assert.exists(pattern);
        assert.strictEqual('http', pattern.scheme);
        assert.strictEqual('www.example.com', pattern.host);
        assert.isFalse(pattern.matchesAllUrls());
    ...
    it('Matches chrome-extension://', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('chrome-extension://ftw/*');
        assert.exists(pattern);
    ...
    it('Ignore Ports', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('http://www.example.com:8080/');
        assert.exists(pattern);
    ...
    it('Trailing Dot Domain', () => {
        ...
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('*://example.com/*');
        assert.exists(pattern);
        assert.isTrue(pattern.matchesUrl(normalDomain));
        assert.isTrue(pattern.matchesUrl(trailingDotDomain));
        const trailingPattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('*://example.com./*');
    ...
    it('URLPattern properly canonicalizes uncanonicalized hosts', () => {
        const pattern = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('*://*.gOoGle.com/*');
        assert.exists(pattern);
        ...
        const pattern2 = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('https://*.ɡoogle.com/*');
        ...
        const pattern3 = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_0__.HostUrlPattern.HostUrlPattern.parse('https://\xef\xb7\x90zyx.com/*');
