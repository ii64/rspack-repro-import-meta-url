"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer_package_src_api_HTTPRequest_ts"],{

/***/ "./src/third_party/puppeteer/package/src/api/HTTPRequest.ts":
/*!******************************************************************!*\
  !*** ./src/third_party/puppeteer/package/src/api/HTTPRequest.ts ***!
  \******************************************************************/
...
/* harmony export */   headersArray: () => (/* binding */ headersArray)
/* harmony export */ });
...
class HTTPRequest {
    ...
    constructor() {
         ...
         * @internal
         */
        Object.defineProperty(this, "_interceptionId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
         ...
         * @internal
         */
        Object.defineProperty(this, "_failureText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
         ...
         * @internal
         */
        Object.defineProperty(this, "_fromMemoryCache", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
         ...
         * @internal
         */
        Object.defineProperty(this, "_redirectChain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
         ...
         * @internal
         */
        Object.defineProperty(this, "interception", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {
    ...
    async continue(overrides = {}, priority) {
        ...
        (0,_util_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert)(this.interception.enabled, 'Request Interception is not enabled!');
        (0,_util_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert)(!this.interception.handled, 'Request is already handled!');
    ...
    static getResponse(body) {
        ...
        const byteBody = (0,_common_util_js__WEBPACK_IMPORTED_MODULE_0__.isString)(body)
