"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_ServiceWorkersView_ts"],{

/***/ "./src/panels/application/ServiceWorkersView.ts":
/*!******************************************************!*\
  !*** ./src/panels/application/ServiceWorkersView.ts ***!
  \******************************************************/
...
/* harmony import */ var _mobile_throttling_mobile_throttling_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../mobile_throttling/mobile_throttling.js */ "./src/panels/mobile_throttling/mobile_throttling.ts");
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './serviceWorkersView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module './serviceWorkerUpdateCycleView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _ServiceWorkerUpdateCycleView_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ServiceWorkerUpdateCycleView.js */ "./src/panels/application/ServiceWorkerUpdateCycleView.ts");
...
class ServiceWorkersView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.Widget.VBox {
    constructor() {
        super(true);
        Object.defineProperty(this, "currentWorkersView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "sectionToRegistration", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        document.body.addEventListener(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.InspectorView.Events.DrawerChange, drawerChangeHandler);
    }
    modelAdded(serviceWorkerManager) {
        ...
        this.eventListeners.set(serviceWorkerManager, [
            this.manager.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.Events.RegistrationUpdated, this.registrationUpdated, this),
            this.manager.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.Events.RegistrationDeleted, this.registrationDeleted, this),
    ...
    getTimeStamp(registration) {
        ...
        let timestamp = 0;
        const active = versions.get(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.ServiceWorkerVersion.Modes.Active);
        const installing = versions.get(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.ServiceWorkerVersion.Modes.Installing);
        const waiting = versions.get(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.ServiceWorkerVersion.Modes.Waiting);
        const redundant = versions.get(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.ServiceWorkerVersion.Modes.Redundant);
        if (active) {
...
class Section {
    constructor(manager, section, registration) {
        ...
        Object.defineProperty(this, "pushNotificationDataSetting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "syncTagNameSetting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "periodicSyncTagNameSetting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "updateCycleView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "routerView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "networkRequests", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "updateButton", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "sourceField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "clientsField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "clientInfoCache", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "updateCycleField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "routerField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.updateCycleView = new _ServiceWorkerUpdateCycleView_js__WEBPACK_IMPORTED_MODULE_13__.ServiceWorkerUpdateCycleView(registration);
        ...
        this.networkRequests.data = {
            ...
            variant: _ui_components_buttons_buttons_js__WEBPACK_IMPORTED_MODULE_6__.Button.Variant.TEXT,
        ...
        this.updateButton = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.UIUtils.createTextButton(i18nString(UIStrings.update), this.updateButtonClicked.bind(this), { variant: _ui_components_buttons_buttons_js__WEBPACK_IMPORTED_MODULE_6__.Button.Variant.TEXT, title: i18nString(UIStrings.update), jslogContext: 'update' });
    ...
    networkRequestsClicked() {
        ...
        void _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Revealer.reveal(_panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIFilter.UIRequestFilter.filters([
            {
                ...
                filterValue: _panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIFilter.IsFilterType.ServiceWorkerIntercepted,
            },
        ]));
        ...
        if (lastRequest) {
            const requestLocation = _panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIRequestLocation.tab(lastRequest, _panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIRequestTabs.Timing, { clearFilter: false });
    ...
    updateClientInfo(element, targetInfo) {
        ...
        focusButton.data = {
            ...
            variant: _ui_components_buttons_buttons_js__WEBPACK_IMPORTED_MODULE_6__.Button.Variant.ICON,
