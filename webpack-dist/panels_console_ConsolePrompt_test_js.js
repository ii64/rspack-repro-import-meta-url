...
/***/ "./panels/console/ConsolePrompt.test.js":
/*!**********************************************!*\
  !*** ./panels/console/ConsolePrompt.test.js ***!
  \**********************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('ConsoleContextSelector', () => {
    ...
    it('allows user to enable pasting by typing \'allow pasting\'', async () => {
        const setting = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('disable-self-xss-warning', false, "Synced" /* Common.Settings.SettingStorageType.Synced */);
