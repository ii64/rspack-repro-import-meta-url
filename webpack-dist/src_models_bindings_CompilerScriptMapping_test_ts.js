"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_bindings_CompilerScriptMapping_test_ts"],{

/***/ "./src/models/bindings/CompilerScriptMapping.test.ts":
/*!***********************************************************!*\
  !*** ./src/models/bindings/CompilerScriptMapping.test.ts ***!
  \***********************************************************/
...
/* harmony import */ var _testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../testing/SourceMapEncoder.js */ "./src/testing/SourceMapEncoder.ts");
...
/* harmony import */ var _bindings_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./bindings.js */ "./src/models/bindings/bindings.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('CompilerScriptMapping', () => {
    let backend;
    ...
    beforeEach(() => {
        ...
        workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_6__.Workspace.WorkspaceImpl.instance({ forceNew: true });
        ...
        debuggerWorkspaceBinding = _bindings_js__WEBPACK_IMPORTED_MODULE_7__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance({ forceNew: true, resourceMapping, targetManager });
        backend = new _testing_MockScopeChain_js__WEBPACK_IMPORTED_MODULE_3__.MockProtocolBackend();
        _bindings_js__WEBPACK_IMPORTED_MODULE_7__.IgnoreListManager.IgnoreListManager.instance({ forceNew: true, debuggerWorkspaceBinding });
    });
    ...
    const waitForUISourceCodeRemoved = (uiSourceCode) => new Promise(resolve => {
        const { eventType, listener } = workspace.addEventListener(_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_6__.Workspace.Events.UISourceCodeRemoved, event => {
    ...
    it('creates UISourceCodes with the correct media type', async () => {
        ...
        const sourceMapInfo = {
            ...
            content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_4__.encodeSourceMap)(['0:0 => foo.js:0:0', '1:0 => bar.ts:0:0', '2:0 => baz.jsx:0:0'], sourceRoot),
        };
    ...
    it('creates separate UISourceCodes for separate targets', async () => {
        ...
        const mainTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)({
            id: 'main',
        ...
        const sourceMapInfo = {
            url: `${scriptInfo.url}.map`,
            content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_4__.encodeSourceMap)(['0:0 => script.js:0:0'], sourceRoot),
        };
    ...
    describe('supports modern Web development workflows', () => {
        it('supports webpack code splitting', async () => {
            ...
            const route1SourceMapInfo = {
                ...
                content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_4__.encodeSourceMap)(['0:0 => shared.ts:0:0', '1:0 => route1.ts:0:0'], sourceRoot),
            };
            ...
            const route2SourceMapInfo = {
                ...
                content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_4__.encodeSourceMap)(['0:0 => shared.ts:0:0', '1:0 => route2.ts:0:0'], sourceRoot),
            };
