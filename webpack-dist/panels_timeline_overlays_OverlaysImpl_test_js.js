...
/***/ "./panels/timeline/overlays/OverlaysImpl.test.js":
/*!*******************************************************!*\
  !*** ./panels/timeline/overlays/OverlaysImpl.test.js ***!
  \*******************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('Overlays', () => {
    ...
    describe('rendering overlays', () => {
        ...
        it('can update a time range overlay with new bounds', async function () {
            ...
            const newBounds = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Helpers.Timing.traceWindowFromMicroSeconds(_models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.Timing.MicroSeconds(rangeOverlay.bounds.min + (1_000 * 1_000)), rangeOverlay.bounds.max);
        ...
        it('renders the overlay for a selected layout shift entry correctly', async function () {
            ...
            const boundsRange = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.Timing.MicroSeconds(20_000);
