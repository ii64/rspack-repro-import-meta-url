"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_docs_select_menu_basic_ts"],{

/***/ "./src/ui/components/docs/select_menu/basic.ts":
/*!*****************************************************!*\
  !*** ./src/ui/components/docs/select_menu/basic.ts ***!
  \*****************************************************/
...
/* harmony import */ var _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../ui/components/menus/menus.js */ "./src/ui/components/menus/menus.ts");
...
const menus = [
    ...
    },
    {
        ...
        buttonTitle: 'Show dialog',
        position: _ui_components_dialogs_dialogs_js__WEBPACK_IMPORTED_MODULE_0__.Dialog.DialogVerticalPosition.TOP,
        showArrow: true,
    },
    {
        items: [
        ...
        buttonTitle: 'Show dialog',
        position: _ui_components_dialogs_dialogs_js__WEBPACK_IMPORTED_MODULE_0__.Dialog.DialogVerticalPosition.BOTTOM,
        showConnector: true,
    },
    {
        items: [
...
menus.forEach((menu, i) => {
    const allItems = [];
    const selectMenu = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_1__.SelectMenu.SelectMenu();
    if (menu.buttonTitle) {
        selectMenu.buttonTitle = menu.buttonTitle;
    }
    selectMenu.position = menu.position || _ui_components_dialogs_dialogs_js__WEBPACK_IMPORTED_MODULE_0__.Dialog.DialogVerticalPosition.BOTTOM;
    selectMenu.showConnector = Boolean(menu.showConnector);
    const firstMenuGroup = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_1__.SelectMenu.SelectMenuGroup();
    firstMenuGroup.name = 'Group 1';
    const secondMenuGroup = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_1__.SelectMenu.SelectMenuGroup();
    ...
    menu.items.forEach((item, j) => {
        const selectMenuItem = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_1__.Menu.MenuItem();
