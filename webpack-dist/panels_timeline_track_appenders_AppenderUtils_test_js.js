...
/***/ "./panels/timeline/track_appenders/AppenderUtils.test.js":
/*!***************************************************************!*\
  !*** ./panels/timeline/track_appenders/AppenderUtils.test.js ***!
  \***************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('AppenderUtils', () => {
    ...
    describe('buildTrackHeader', () => {
        ...
        it('builds a track header correctly', () => {
            const builtHeader = _timeline_js__WEBPACK_IMPORTED_MODULE_3__.AppenderUtils.buildTrackHeader("animations" /* Timeline.CompatibilityTracksAppender.VisualLoggingTrackName.ANIMATIONS */, 
