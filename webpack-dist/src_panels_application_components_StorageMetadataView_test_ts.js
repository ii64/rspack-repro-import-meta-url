"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_components_StorageMetadataView_test_ts"],{

/***/ "./src/panels/application/components/StorageMetadataView.test.ts":
/*!***********************************************************************!*\
  !*** ./src/panels/application/components/StorageMetadataView.test.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _ui_components_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../ui/components/report_view/report_view.js */ "./src/ui/components/report_view/report_view.ts");
...
async function makeView(storageKeyOrBucketInfo, storageBucketsModel) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.StorageMetadataView.StorageMetadataView();
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('SharedStorageMetadataView', () => {
    it('renders with an origin only', async () => {
        ...
        const keys = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getCleanTextContentFromElements)(component.shadowRoot, 'devtools-report-key');
        assert.deepEqual(keys, [
            'Origin',
        ]);
        const values = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getCleanTextContentFromElements)(component.shadowRoot, 'devtools-report-value');
    ...
    it('renders with a bucket', async () => {
        const component = await makeView({
            ...
            id: 'BUCKET_ID',
            persistent: true,
            durability: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Storage.StorageBucketsDurability.Relaxed,
            quota: 4096,
            expiration: 42,
        });
        const report = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementWithinComponent)(component, 'devtools-report', _ui_components_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_4__.ReportView.Report);
    ...
    it('renders bucket controls', async () => {
        ...
        const showDialog = sinon.stub(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.ConfirmDialog, 'show').resolves(true);
        deleteButton.click();
