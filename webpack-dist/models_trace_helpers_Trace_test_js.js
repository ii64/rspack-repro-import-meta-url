...
/***/ "./models/trace/helpers/Trace.test.js":
/*!********************************************!*\
  !*** ./models/trace/helpers/Trace.test.js ***!
  \********************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('TraceModel helpers', function () {
    ...
    describe('findUpdateLayoutTreeEvents', () => {
        it('returns the set of UpdateLayoutTree events within the right time range', async function () {
            ...
            const filteredByEndTimeEvents = _trace_js__WEBPACK_IMPORTED_MODULE_3__.Helpers.Trace.findUpdateLayoutTreeEvents(mainThread.entries, traceData.Meta.traceBounds.min, _trace_js__WEBPACK_IMPORTED_MODULE_3__.Types.Timing.MicroSeconds(lastEvent.ts - 1_000));
