"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_dialogs_ShortcutDialog_test_ts"],{
...
/***/ "./src/ui/components/dialogs/ShortcutDialog.test.ts":
/*!**********************************************************!*\
  !*** ./src/ui/components/dialogs/ShortcutDialog.test.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('ShortcutDialog', () => {
    async function getShortcutDialog(open) {
        const shortcutDialog = new _dialogs_js__WEBPACK_IMPORTED_MODULE_3__.ShortcutDialog.ShortcutDialog();
