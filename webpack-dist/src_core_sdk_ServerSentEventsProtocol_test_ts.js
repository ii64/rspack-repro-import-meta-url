"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_ServerSentEventsProtocol_test_ts"],{

/***/ "./src/core/sdk/ServerSentEventsProtocol.test.ts":
/*!*******************************************************!*\
  !*** ./src/core/sdk/ServerSentEventsProtocol.test.ts ***!
  \*******************************************************/
...
describe('ServerSentEventsParser', () => {
    ...
    beforeEach(() => {
        events = [];
        parser = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.ServerSentEventProtocol.ServerSentEventsParser((eventType, data, eventId) => {
