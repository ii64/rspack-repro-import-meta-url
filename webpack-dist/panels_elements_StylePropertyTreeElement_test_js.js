...
/***/ "./panels/elements/StylePropertyTreeElement.test.js":
/*!**********************************************************!*\
  !*** ./panels/elements/StylePropertyTreeElement.test.js ***!
  \**********************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_8__.describeWithMockConnection)('StylePropertyTreeElement', () => {
    ...
    let mockVariableMap;
    beforeEach(async () => {
        stylesSidebarPane = _elements_js__WEBPACK_IMPORTED_MODULE_12__.StylesSidebarPane.StylesSidebarPane.instance({ forceNew: true });
        mockVariableMap = {
            '--a': 'red',
            '--b': 'blue',
            '--blue': 'blue',
        ...
        const resourceMapping = new _models_bindings_bindings_js__WEBPACK_IMPORTED_MODULE_2__.ResourceMapping.ResourceMapping(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.TargetManager.TargetManager.instance(), workspace);
        _models_bindings_bindings_js__WEBPACK_IMPORTED_MODULE_2__.CSSWorkspaceBinding.CSSWorkspaceBinding.instance({ forceNew: true, resourceMapping, targetManager: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.TargetManager.TargetManager.instance() });
    });
    ...
    describe('updateTitle', () => {
        ...
        describe('color-mix swatch', () => {
            ...
            it('shows a popover with it\'s computed color as RGB if possible', () => {
                ...
                const stylePropertyTreeElement = new _elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.StylePropertyTreeElement({
                    stylesPane: stylesSidebarPane,
                    section: mockStylePropertiesSection,
                    matchedStyles: mockMatchedStyles,
    ...
    it('applies the new style when the color format is changed', async () => {
        ...
        const swatch = valueElement.querySelector(`${_ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_10__.ColorSwatch.ColorSwatch.litTagName.value}`);
    ...
    describe('custom-properties', () => {
        it('linkifies var functions to declarations', async () => {
            ...
            mockMatchedStyles.computeCSSVariable.callsFake((_, name) => name === '--prop' ?
                ...
                null);
            const renderValueSpy = sinon.spy(_elements_js__WEBPACK_IMPORTED_MODULE_12__.PropertyRenderer.Renderer, 'renderValueElement');
            const stylePropertyTreeElement = getTreeElement('prop', 'var(--prop)');
            stylePropertyTreeElement.updateTitle();
            const varSwatch = renderValueSpy.returnValues.find(value => value.firstChild instanceof _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_10__.LinkSwatch.CSSVarSwatch)
                ?.firstChild;
        ...
        it('linkifies property definition to registrations', async () => {
            ...
            assert.isTrue(popoverContents instanceof _components_components_js__WEBPACK_IMPORTED_MODULE_11__.CSSVariableValueView.CSSVariableValueView);
    ...
    describe('VariableRenderer', () => {
        it('computes the text for var()s correctly', async () => {
            const cssModel = new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSModel.CSSModel((0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_6__.createTarget)());
            async function matchProperty(value, name = 'color') {
                ...
                assert.exists(ast);
                const matching = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSPropertyParser.BottomUpTreeMatching.walk(ast, [new _elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.VariableRenderer(stylePropertyTreeElement, stylePropertyTreeElement.property.ownerStyle)
                        .matcher()]);
                const res = {
    ...
    describe('BezierRenderer', () => {
        it('renders the easing function swatch', () => {
            ...
            stylePropertyTreeElement.updateTitle();
            assert.instanceOf(stylePropertyTreeElement.valueElement?.firstChild, _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_10__.Swatches.BezierSwatch);
        });
    });
    ...
    describe('ShadowRenderer', () => {
        it('parses shadows correctly', () => {
            const parseShadow = (property, value, success) => {
                ...
                stylePropertyTreeElement.updateTitle();
                assert.strictEqual(stylePropertyTreeElement.valueElement?.firstElementChild instanceof _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_10__.Swatches.CSSShadowSwatch, success);
                assert.strictEqual(stylePropertyTreeElement.valueElement?.textContent, value);
            };
        ...
        it('renders the shadow swatch and color swatch', () => {
            ...
            stylePropertyTreeElement.updateTitle();
            assert.instanceOf(stylePropertyTreeElement.valueElement?.firstElementChild, _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_10__.Swatches.CSSShadowSwatch);
        ...
        class StubSyntaxnode {
            ...
            from = 0;
            to = 0;
            type = new _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_9__.NodeType();
            name = '';
            tree = null;
            node = this;
            matchContext() {
        ...
        it('shadow model renders text properties, authored properties, and computed text properties correctly', () => {
            const renderingContext = sinon.createStubInstance(_elements_js__WEBPACK_IMPORTED_MODULE_12__.PropertyRenderer.RenderingContext);
            const expansionContext = sinon.createStubInstance(_elements_js__WEBPACK_IMPORTED_MODULE_12__.PropertyRenderer.RenderingContext);
            ...
            sinon.stub(_elements_js__WEBPACK_IMPORTED_MODULE_12__.PropertyRenderer.Renderer, 'render').callsFake((nodeOrNodes, context) => {
            ...
            const model = new _elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.ShadowModel("boxShadow" /* Elements.PropertyMatchers.ShadowType.BoxShadow */, properties, renderingContext);
    ...
    describe('AnchorFunctionRenderer', () => {
        ...
        beforeEach(() => {
            ...
            anchorDecoratedForTestStub =
                sinon.stub(_elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.AnchorFunctionRenderer.prototype, 'anchorDecoratedForTest');
        ...
        it('renders `AnchorFunctionLinkSwatch` after decorating the element', async () => {
            const waitForDecorationPromise = (0,_testing_ExpectStubCall_js__WEBPACK_IMPORTED_MODULE_7__.expectCall)(anchorDecoratedForTestStub);
    ...
    describe('AnchorFunctionRenderer', () => {
        ...
        beforeEach(() => {
            ...
            highlightMock = sinon.mock();
            anchorDecoratedForTestStub =
                sinon.stub(_elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.PositionAnchorRenderer.prototype, 'anchorDecoratedForTest');
            getAnchorBySpecifierStub =
                sinon.stub(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMModel.DOMNode.prototype, 'getAnchorBySpecifier').resolves(fakeDOMNode);
        });
        afterEach(() => {
    ...
    describe('LightDarkColorRenderer', () => {
        it('renders light-dark correctly', async () => {
            const colorSchemeSpy = sinon.spy(_elements_js__WEBPACK_IMPORTED_MODULE_12__.StylePropertyTreeElement.LightDarkColorRenderer.prototype, 'applyColorScheme');
