...
/***/ "./panels/application/BackgroundServiceView.test.js":
/*!**********************************************************!*\
  !*** ./panels/application/BackgroundServiceView.test.js ***!
  \**********************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('BackgroundServiceView', () => {
    ...
    beforeEach(() => {
        ...
        sinon.stub(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.ShortcutRegistry.ShortcutRegistry, 'instance').returns({
            ...
            shortcutsForAction: () => [new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_3__.KeyboardShortcut.KeyboardShortcut([{ key: 0, name: '' }], '', "DefaultShortcut" /* UI.KeyboardShortcut.Type.DefaultShortcut */)],
        });
