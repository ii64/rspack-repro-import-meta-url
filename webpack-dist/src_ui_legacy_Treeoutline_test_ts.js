"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_Treeoutline_test_ts"],{
...
/***/ "./src/ui/legacy/Treeoutline.test.ts":
/*!*******************************************!*\
  !*** ./src/ui/legacy/Treeoutline.test.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
describe('TreeOutline', () => {
    describe('correctly reacts to Enter key', () => {
        it('by expanding collapsed parent nodes', () => {
            const tree = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeOutlineInShadow();
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.renderElementIntoDOM)(tree.element);
            const parent = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeElement('parent', true);
            ...
            parent.select();
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.dispatchKeyDownEvent)(tree.contentElement, { bubbles: true, key: 'Enter' });
    ...
    it('responds correctly to navigation keys', () => {
        const treeOutline = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeOutlineInShadow();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.renderElementIntoDOM)(treeOutline.element);
        for (let i = 0; i < 10; i++) {
            const treeElement = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeElement(String(i), true);
        ...
        let selectedTitles = [];
        treeOutline.addEventListener(_legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.Events.ElementSelected, event => {
        ...
        assert.deepEqual(selectedTitles, ['0']);
        selectedTitles = [];
        const innerTreeOutline = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeOutlineInShadow();
        const firstInnerChild = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeElement('First inner child');
        const firstInnerGrandChild = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeElement('First inner grandchild');
        innerTreeOutline.appendChild(firstInnerChild);
        firstInnerChild.appendChild(firstInnerGrandChild);
        const treeElementForNestedTree = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.TreeOutline.TreeElement(innerTreeOutline.element);
        ...
        function sendKey(key) {
            const deepActiveElement = _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.DOMUtilities.deepActiveElement(document);
