...
/***/ "./panels/freestyler/FreestylerEvaluateAction.test.js":
/*!************************************************************!*\
  !*** ./panels/freestyler/FreestylerEvaluateAction.test.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
describe('FreestylerEvaluateAction', () => {
    describe('error handling', () => {
        function executeWithResult(mockResult) {
            ...
            return _FreestylerEvaluateAction_js__WEBPACK_IMPORTED_MODULE_2__.FreestylerEvaluateAction.execute('', executionContextStub, { throwOnSideEffect: false });
        }
    ...
    (0,_testing_RealConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithRealConnection)('serialization', () => {
        async function executionContextForTest() {
            ...
            return (0,_testing_RealConnection_js__WEBPACK_IMPORTED_MODULE_1__.getExecutionContext)(runtimeModel);
        }
        async function executeForTest(code) {
            return _FreestylerEvaluateAction_js__WEBPACK_IMPORTED_MODULE_2__.FreestylerEvaluateAction.execute(code, await executionContextForTest(), { throwOnSideEffect: false });
        }
