...
/***/ "./models/timeline_model/TimelineProfileTree.test.js":
/*!***********************************************************!*\
  !*** ./models/timeline_model/TimelineProfileTree.test.js ***!
  \***********************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('TimelineProfileTree', () => {
    describe('TopDownRootNode', () => {
        it('builds the root node and its children properly from an event tree', () => {
            ...
            // |------------------ROOT---------------------------|
            // |-----A----| |-----B-----| |----------C---------|
            const eventA = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event A', 0, 40_000);
            const eventB = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event B', 50_000, 50_000);
            const eventC = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event C', 150_000, 100_000);
            const events = [
                eventA,
                eventB,
                eventC,
            ];
            const root = new _timeline_model_timeline_model_js__WEBPACK_IMPORTED_MODULE_4__.TimelineProfileTree.TopDownRootNode(events, [], _trace_trace_js__WEBPACK_IMPORTED_MODULE_5__.Types.Timing.MilliSeconds(0), _trace_trace_js__WEBPACK_IMPORTED_MODULE_5__.Types.Timing.MilliSeconds(200_000));
        ...
        it('builds a top-down tree from an event tree with multiple levels 1', () => {
            ...
            // |-C-| |-D-|
            const eventA = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event A', 0, 40_000);
            const eventC = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event C', 0, 10_000);
            const eventD = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event D', 10_000, 10_000);
            const eventB = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event B', 50_000, 50_000);
        ...
        it('builds a top-down tree from an event tree with multiple levels 2', () => {
            ...
            const eventA = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event A', 0, 40_000);
            const eventB = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event B', 50_000, 50_000);
            const eventC = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event C', 50_000, 10_000);
            const eventD = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event D', 60_000, 10_000);
            // Events must be in order.
            const events = [
                eventA,
                eventB,
        ...
        it('calculates the self time for each node in an event tree correctly', () => {
            ...
            const eventC = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event C', 50_000, 10_000);
            const eventD = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event D', 60_000, 10_000);
            const eventE = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)('Event E', 60_000, 5_000);
            // Events must be in order.
            const events = [
                eventA,
                eventB,
