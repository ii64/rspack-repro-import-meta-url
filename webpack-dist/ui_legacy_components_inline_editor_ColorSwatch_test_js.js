...
/***/ "./ui/legacy/components/inline_editor/ColorSwatch.test.js":
/*!****************************************************************!*\
  !*** ./ui/legacy/components/inline_editor/ColorSwatch.test.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithLocale)('ColorSwatch', () => {
    it('accepts colors as color objects', () => {
        ...
        swatch.renderColor(new _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Legacy([1, .5, .2, .5], "rgba" /* Common.Color.Format.RGBA */));
        assertSwatch(swatch, {
