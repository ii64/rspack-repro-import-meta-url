"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_ListWidget_test_ts"],{
...
/***/ "./src/ui/legacy/ListWidget.test.ts":
/*!******************************************!*\
  !*** ./src/ui/legacy/ListWidget.test.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('ListWidget', () => {
    describe('Editor', () => {
        it('Cancel button triggers on mouse click event', () => {
            const editor = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.ListWidget.Editor();
    ...
    it('adds a new item even when the empty string', () => {
        class MockEditor extends _legacy_js__WEBPACK_IMPORTED_MODULE_2__.ListWidget.Editor {
        ...
        const list = new _legacy_js__WEBPACK_IMPORTED_MODULE_2__.ListWidget.ListWidget(delegate);
        list.markAsRoot();
