(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer-replay_package_lib_extension-test_js"],{
...
/***/ "./src/third_party/puppeteer-replay/package/lib/extension-test.js":
/*!************************************************************************!*\
  !*** ./src/third_party/puppeteer-replay/package/lib/extension-test.js ***!
  \************************************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'assert/strict'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
async function startServer() {
    ...
    const server = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'http'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(async (req, res) => {
        if (req.method === 'GET') {
...
(0,yargs__WEBPACK_IMPORTED_MODULE_0__["default"])((0,yargs_helpers__WEBPACK_IMPORTED_MODULE_1__.hideBin)(process.argv))
    ...
    let run = async () => { };
    if (ext instanceof _lib_main_js__WEBPACK_IMPORTED_MODULE_2__.RunnerExtension) {
        console.log('runner');
        run = async () => {
            const extension = new Extension();
            const runner = await (0,_lib_main_js__WEBPACK_IMPORTED_MODULE_2__.createRunner)((0,_lib_main_js__WEBPACK_IMPORTED_MODULE_2__.parse)(recording), extension);
            await runner.run();
        };
    }
    else {
        run = async () => {
            const exported = await (0,_lib_main_js__WEBPACK_IMPORTED_MODULE_2__.stringify)((0,_lib_main_js__WEBPACK_IMPORTED_MODULE_2__.parse)(recording), {
                extension: new Extension(),
            });
            const childProcess = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'child_process'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('node', {
    ...
    Object(function webpackMissingModule() { var e = new Error("Cannot find module 'assert/strict'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(log.contents, expectedLog);
