...
function waitForExecutionContextDestroyed(context) {
    ...
    return waitForEvent(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.RuntimeModel.Events.ExecutionContextDestroyed, runtimeModel, destroyedContext => destroyedContext === context);
}
/**
 * @param {number} a
 * @param {number} b
 ...
 */
function url(url = '') {
    const testScriptURL = /** @type {string} */ (_core_root_root_js__WEBPACK_IMPORTED_MODULE_2__.Runtime.Runtime.queryParam('inspected_test') || _core_root_root_js__WEBPACK_IMPORTED_MODULE_2__.Runtime.Runtime.queryParam('test'));
