...
/***/ "./panels/elements/StylePropertiesSection.test.js":
/*!********************************************************!*\
  !*** ./panels/elements/StylePropertiesSection.test.js ***!
  \********************************************************/
...
describe('StylePropertiesSection', () => {
    it('contains specificity information', async () => {
        ...
        const selectorElement = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection.renderSelectors([{ text: '.child', specificity }], [true], new WeakMap());
    ...
    it('renders selectors correctly', async () => {
        let selectorElement = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection.renderSelectors([{ text: '.child', specificity: { a: 0, b: 2, c: 0 } }, { text: '.item', specificity: { a: 0, b: 2, c: 0 } }], [true], new WeakMap());
        assert.deepEqual(selectorElement.textContent, '.child, .item');
        selectorElement = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection.renderSelectors([{ text: '.child', specificity: { a: 0, b: 2, c: 0 } }, { text: '& .item', specificity: { a: 0, b: 2, c: 0 } }], [true], new WeakMap());
        assert.deepEqual(selectorElement.textContent, '.child, & .item');
        selectorElement = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection.renderSelectors([{ text: '&.child', specificity: { a: 0, b: 2, c: 0 } }, { text: '& .item', specificity: { a: 0, b: 2, c: 0 } }], [true], new WeakMap());
        assert.deepEqual(selectorElement.textContent, '&.child, & .item');
    });
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('StylesPropertySection', () => {
    it('displays the proper sourceURL origin for constructed stylesheets', async () => {
        const cssModel = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.createTarget)().model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSModel.CSSModel);
        ...
        const linkifier = sinon.createStubInstance(_ui_legacy_components_utils_utils_js__WEBPACK_IMPORTED_MODULE_4__.Linkifier.Linkifier);
        const originNode = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection.createRuleOriginNode(matchedStyles, linkifier, rule);
    ...
    it('properly renders ancestor rules', async () => {
        ...
        const range = { startLine: 0, startColumn: 0, endLine: 0, endColumn: 6 };
        {
            ...
            const section = new _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.StylePropertiesSection(stylesSidebarPane, matchedStyles, declaration, 0, null, null);
    ...
    it('updates property rule property names', async () => {
        ...
        const section = new _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.RegisteredPropertiesSection(stylesSidebarPane, matchedStyles, declaration, 0, propertyName.text, /* expandedByDefault=*/ true);
    ...
    it('renders braces correctly with a non-style-rule section', async () => {
        ...
        assert.exists(declaration);
        const section = new _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.FontPaletteValuesRuleSection(stylesSidebarPane, matchedStyles, declaration, 0);
    ...
    it('renders active and inactive position-try rule sections correctly', async () => {
        ...
        const section1 = new _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.PositionTryRuleSection(stylesSidebarPane, matchedStyles, declaration1, 0, positionTryRules[0].active);
        const section2 = new _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylePropertiesSection.PositionTryRuleSection(stylesSidebarPane, matchedStyles, declaration1, 1, positionTryRules[1].active);
