"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_components_inline_editor_BezierUI_test_ts"],{

/***/ "./src/ui/legacy/components/inline_editor/BezierUI.test.ts":
/*!*****************************************************************!*\
  !*** ./src/ui/legacy/components/inline_editor/BezierUI.test.ts ***!
  \*****************************************************************/
...
describe('BezierUI', () => {
    it('can be instantiated successfully', () => {
        ...
        const bezierUI = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.BezierUI.BezierUI({
            width: testWidth,
            height: testHeight,
    ...
    it('can draw velocity chart correctly', () => {
        const bezier = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.CubicBezier(new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 1), new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(3, 4));
