"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_Geometry_test_ts"],{

/***/ "./src/ui/legacy/Geometry.test.ts":
/*!****************************************!*\
  !*** ./src/ui/legacy/Geometry.test.ts ***!
  \****************************************/
...
describe('Vector', () => {
    it('can be instantiated without issues', () => {
        const vector = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(1, 2, 3);
    ...
    it('does not normalize if the length was below epsilon', () => {
        const vector = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(0.000001, 0.000002, 0.000003);
        vector.normalize();
...
describe('Point', () => {
    it('can be instantiated without issues', () => {
        const point = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 2);
    ...
    it('is able to return distanct to a certain point', () => {
        const p1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(0, 0);
        const p2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(0, 1);
        const p3 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 0);
        const p4 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(3, 4);
    ...
    it('is able to be projected on a point that is not the origin', () => {
        const p1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 2);
        const p2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(3, 4);
    ...
    it('is able to be projected on a point that is the origin', () => {
        const p1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 2);
        const p2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(0, 0);
        const projectedPoint = p1.projectOn(p2);
    ...
    it('can be represented as a string', () => {
        const point = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1.23, 4.56);
...
describe('CubicBezier', () => {
    it('can be instantiated without issues', () => {
        const p1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(1, 2);
        const p2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(3, 4);
        const cubicBezier = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.CubicBezier(p1, p2);
    ...
    it('is able to return a cubic bezier from a valid string', () => {
        ...
        const { controlPoints } = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.CubicBezier.parse(testText);
    ...
    it('returns null from an invalid string', () => {
        ...
        const cubicBezier = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.CubicBezier.parse(testText);
    ...
    it('is able to be represented as CSS text with a keyword value', () => {
        const p1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(0.25, 0.1);
        const p2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Point(0.25, 1);
        const cubicBezier = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.CubicBezier(p1, p2);
        const cssText = cubicBezier.asCSSText();
...
describe('EulerAngles', () => {
    it('can be instantiated without issues', () => {
        const eulerAngles = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.EulerAngles(1, 2, 3);
    ...
    it('is able to return Euler angles from an identity rotation matrix', () => {
        ...
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.EulerAngles.fromDeviceOrientationRotationMatrix(matrix);
...
describe('Size', () => {
    it('can be instantiated without issues', () => {
        const size = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
    ...
    it('can be clipped to another smaller size', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
    ...
    it('can be clipped to another larger size', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const resultSize = size1.clipTo(size2);
        assert.strictEqual(resultSize.width, 1, 'width value was not set correctly');
        assert.strictEqual(resultSize.height, 2, 'height value was not set correctly');
    });
    ...
    it('is able to check if it is equal to another size', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const size3 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
...
describe('Constraints', () => {
    it('can be instantiated without issues', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const constraints = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints(size1, size2);
    ...
    it('thows an error if instantiated with a minimum size that is larger than the the preferred size', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
        assert.throws(() => new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints(size1, size2), Error, 'Minimum size is greater than preferred.');
    });
    it('sets minimum and preferred to UI.Geometry.Size(0, 0) if no values were given to the constructor', () => {
        const constraints = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints();
    ...
    it('is able to check if it is equal to another constraint', () => {
        const size1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(1, 2);
        const size2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(3, 4);
        const size3 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(5, 6);
        const size4 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Size(7, 8);
        const constraints1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints(size1, size2);
        const constraints2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints(size3, size4);
        const constraints3 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Constraints(size1, size2);
...
describe('scalarProduct', () => {
    it('returns the scalar product for two vectors', () => {
        const vector1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(1, 2, 3);
        const vector2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(4, 5, 6);
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.scalarProduct(vector1, vector2);
...
describe('crossProduct', () => {
    it('returns the cross product for two vectors', () => {
        const vector1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(1, 2, 3);
        const vector2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(4, 5, 6);
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.crossProduct(vector1, vector2);
...
describe('subtract', () => {
    it('returns the difference between two vectors', () => {
        const vector1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(1, 2, 3);
        const vector2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(4, 5, 6);
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.subtract(vector1, vector2);
        assert.strictEqual(result.x, -3, 'x value for the resulting vector was not set correctly');
...
describe('multiplyVectorByMatrixAndNormalize', () => {
    it('returns the vector multiplied by a matrix and normalized', () => {
        ...
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.multiplyVectorByMatrixAndNormalize(vector, matrix);
...
describe('calculateAngle', () => {
    it('returns the angle between two vectors', () => {
        const vector1 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(1, 2, 3);
        const vector2 = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.Vector(4, 5, 6);
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.calculateAngle(vector1, vector2);
...
describe('boundsForTransformedPoints', () => {
    it('returns the bounds for transformed points', () => {
        const matrix = new WebKitCSSMatrix();
        const result = _legacy_js__WEBPACK_IMPORTED_MODULE_0__.Geometry.boundsForTransformedPoints(matrix, [1, 2, 3], { minX: 5, maxX: 6, minY: 7, maxY: 8 });
