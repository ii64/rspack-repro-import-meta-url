"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_common_Throttler_test_ts"],{

/***/ "./src/core/common/Throttler.test.ts":
/*!*******************************************!*\
  !*** ./src/core/common/Throttler.test.ts ***!
  \*******************************************/
...
/* harmony import */ var _platform_platform_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../platform/platform.js */ "./src/core/platform/platform.ts");
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common.js */ "./src/core/common/common.ts");
// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.


const { Throttler, Scheduling } = _common_js__WEBPACK_IMPORTED_MODULE_1__.Throttler;
describe('Throttler class', () => {
    ...
    it('runs only one process at a time', async () => {
        ...
        const { promise: process1Promise, resolve: process1Resolve } = _platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.PromiseUtilities.promiseWithResolvers();
        const { promise: process2Promise, resolve: process2Resolve } = _platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.PromiseUtilities.promiseWithResolvers();
