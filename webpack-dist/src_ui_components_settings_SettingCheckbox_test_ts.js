"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_settings_SettingCheckbox_test_ts"],{
...
/***/ "./src/ui/components/settings/SettingCheckbox.test.ts":
/*!************************************************************!*\
  !*** ./src/ui/components/settings/SettingCheckbox.test.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./settings.js */ "./src/ui/components/settings/settings.ts");
...
function renderSettingCheckbox(data) {
    const component = new _settings_js__WEBPACK_IMPORTED_MODULE_4__.SettingCheckbox.SettingCheckbox();
    component.data = data;
...
describe('SettingCheckbox', () => {
    ...
    it('renders the checkbox ticked when the setting is enabled', () => {
        const setting = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createFakeSetting)('setting', true);
        const { checkbox } = renderSettingCheckbox({ setting });
        assert.isTrue(checkbox.checked);
    });
    it('renders the checkbox unticked when the setting is disabled', () => {
        const setting = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createFakeSetting)('setting', false);
        const { checkbox } = renderSettingCheckbox({ setting });
    ...
    it('can be reassigned to a different settings', () => {
        const setting1 = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createFakeSetting)('setting1', true);
        const setting2 = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createFakeSetting)('setting2', true);
