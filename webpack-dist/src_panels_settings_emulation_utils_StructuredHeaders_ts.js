"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_settings_emulation_utils_StructuredHeaders_ts"],{

/***/ "./src/panels/settings/emulation/utils/StructuredHeaders.ts":
/*!******************************************************************!*\
  !*** ./src/panels/settings/emulation/utils/StructuredHeaders.ts ***!
  \******************************************************************/
...
/* harmony export */   ResultKind: () => (/* binding */ ResultKind),
...
/* harmony export */   serializeList: () => (/* binding */ serializeList)
/* harmony export */ });
...
function parseListInternal(input) {
    const result = { kind: ResultKind.LIST, items: [] };
    while (!input.atEnd()) {
...
function parseParameters(input) {
    ...
    while (!input.atEnd()) {
        ...
        let paramValue = { kind: ResultKind.BOOLEAN, value: true };
        if (input.peek() === '=') {
            input.eat();
