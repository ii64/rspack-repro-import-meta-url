"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_issues_manager_MarkdownIssueDescription_test_ts"],{

/***/ "./src/models/issues_manager/MarkdownIssueDescription.test.ts":
/*!********************************************************************!*\
  !*** ./src/models/issues_manager/MarkdownIssueDescription.test.ts ***!
  \********************************************************************/
...
/* harmony import */ var _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../issues_manager/issues_manager.js */ "./src/models/issues_manager/issues_manager.ts");
...
describe('createIssueDescriptionFromMarkdown', () => {
    it('only accepts Markdown where the first AST element is a heading, describing the title', () => {
        ...
        const description = _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.createIssueDescriptionFromRawMarkdown(validIssueDescription, emptyMarkdownDescription);
    ...
    it('throws an error for issue description without a heading', () => {
        ...
        assert.throws(() => _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.createIssueDescriptionFromRawMarkdown(invalidIssueDescription, emptyMarkdownDescription));
    });
});
describe('substitutePlaceholders', () => {
    ...
    it('subsitutes a single placeholder', () => {
        ...
        const actual = _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str, new Map([['PLACEHOLDER_placeholder', 'fooholder']]));
    ...
    it('substitutes multiple placeholders', () => {
        ...
        const actual = _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str, new Map([['PLACEHOLDER_ph1', 'foo'], ['PLACEHOLDER_ph2', 'bar']]));
    ...
    it('throws an error for placeholders that don\'t have a replacement in the map', () => {
        ...
        assert.throws(() => _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str));
    });
    ...
    it('throws an error for unused replacements', () => {
        ...
        assert.throws(() => _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str, new Map([['PLACEHOLDER_FOO', 'bar']])));
    });
    it('allows the same placeholder to be used multiple times', () => {
        ...
        const actual = _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str, new Map([['PLACEHOLDER_PH1', 'foo']]));
    ...
    it('throws an error for invalid placeholder syntax provided in the substitutions map', () => {
        const str = 'Example string with no placeholder';
        assert.throws(() => _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_0__.MarkdownIssueDescription.substitutePlaceholders(str, new Map([['invalid_ph', 'foo']])));
    });
});
