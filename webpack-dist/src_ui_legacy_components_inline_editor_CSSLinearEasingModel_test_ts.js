"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_components_inline_editor_CSSLinearEasingModel_test_ts"],{

/***/ "./src/ui/legacy/components/inline_editor/CSSLinearEasingModel.test.ts":
/*!*****************************************************************************!*\
  !*** ./src/ui/legacy/components/inline_editor/CSSLinearEasingModel.test.ts ***!
  \*****************************************************************************/
...
function testValidCase(input, output) {
    const model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.CSSLinearEasingModel.CSSLinearEasingModel.parse(input);
...
describe('CSSLinearEasingModel', () => {
    ...
    it('should parse "linear" as linear(0 0%, 1 100%) function', () => {
        const points = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.CSSLinearEasingModel.CSSLinearEasingModel.parse('linear').points();
        assert.deepEqual(points, [{ input: 0, output: 0 }, { input: 100, output: 1 }]);
    });
    it('linear(0 0%, 1 100%) is stringified as "linear"', () => {
        const model = _inline_editor_js__WEBPACK_IMPORTED_MODULE_0__.CSSLinearEasingModel.CSSLinearEasingModel.parse('linear(0 0%, 1 100%)');
