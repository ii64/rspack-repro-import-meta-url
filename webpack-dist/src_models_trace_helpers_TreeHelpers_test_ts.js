"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_helpers_TreeHelpers_test_ts"],{

/***/ "./src/models/trace/helpers/TreeHelpers.test.ts":
/*!******************************************************!*\
  !*** ./src/models/trace/helpers/TreeHelpers.test.ts ***!
  \******************************************************/
    ...
    describe('treify', () => {
        ...
        describe('building hierarchies trace events and profile calls', () => {
            it('builds a hierarchy from trace events and profile calls', async () => {
                const evaluateScript = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)(_trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.KnownEventName.EvaluateScript, 0, 500);
