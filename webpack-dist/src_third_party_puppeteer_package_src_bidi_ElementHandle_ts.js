"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer_package_src_bidi_ElementHandle_ts"],{
...
/***/ "./src/third_party/puppeteer/package/src/bidi/ElementHandle.ts":
/*!*********************************************************************!*\
  !*** ./src/third_party/puppeteer/package/src/bidi/ElementHandle.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _util_AsyncIterableUtil_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/AsyncIterableUtil.js */ "./src/third_party/puppeteer/package/src/util/AsyncIterableUtil.ts");
...
/* harmony import */ var _JSHandle_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./JSHandle.js */ "./src/third_party/puppeteer/package/src/bidi/JSHandle.ts");
/**
 * @license
 * Copyright 2023 Google Inc.
 * SPDX-License-Identifier: Apache-2.0
...
let BidiElementHandle = (() => {
    ...
    return _a = class BidiElementHandle extends _classSuper {
            static from(value, realm) {
                return new _a(value, realm);
            }
            ...
            async *queryAXTree(name, role) {
                ...
                return yield* _util_AsyncIterableUtil_js__WEBPACK_IMPORTED_MODULE_1__.AsyncIterableUtil.map(results, node => {
                    ...
                    return Promise.resolve(_a.from(node, this.realm));
                });
            }
        },
        (() => {
            ...
            _contentFrame_decorators = [(0,_util_decorators_js__WEBPACK_IMPORTED_MODULE_2__.throwIfDisposed)(), (_b = _api_ElementHandle_js__WEBPACK_IMPORTED_MODULE_0__.ElementHandle).bindIsolatedHandle.bind(_b)];
