...
/***/ "./panels/network/NetworkDataGridNode.test.js":
/*!****************************************************!*\
  !*** ./panels/network/NetworkDataGridNode.test.js ***!
  \****************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('NetworkLogView', () => {
    it('adds marker to requests with overridden headers', async () => {
        ...
        const networkRequestNode = new _network_js__WEBPACK_IMPORTED_MODULE_3__.NetworkDataGridNode.NetworkRequestNode({}, request);
