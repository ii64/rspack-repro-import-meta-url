"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_ShortcutRegistry_test_ts"],{

/***/ "./src/ui/legacy/ShortcutRegistry.test.ts":
/*!************************************************!*\
  !*** ./src/ui/legacy/ShortcutRegistry.test.ts ***!
  \************************************************/
...
describe('ShortcutTreeNode', () => {
    it('can be instantiated without issues', () => {
        const node = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.ShortcutRegistry.ShortcutTreeNode(0, 0);
