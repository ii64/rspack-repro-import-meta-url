"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_components_CPUThrottlingSelector_test_ts"],{

/***/ "./src/panels/timeline/components/CPUThrottlingSelector.test.ts":
/*!**********************************************************************!*\
  !*** ./src/panels/timeline/components/CPUThrottlingSelector.test.ts ***!
  \**********************************************************************/
...
/* harmony import */ var _panels_mobile_throttling_mobile_throttling_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../panels/mobile_throttling/mobile_throttling.js */ "./src/panels/mobile_throttling/mobile_throttling.ts");
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components.js */ "./src/panels/timeline/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithEnvironment)('CPUThrottlingSelector', () => {
    ...
    beforeEach(() => {
        cpuThrottlingManager = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.CPUThrottlingManager.CPUThrottlingManager.instance({ forceNew: true });
        _panels_mobile_throttling_mobile_throttling_js__WEBPACK_IMPORTED_MODULE_1__.ThrottlingManager.ThrottlingManager.instance({ forceNew: true });
    });
    it('renders all CPU throttling presets', async () => {
        const view = new _components_js__WEBPACK_IMPORTED_MODULE_5__.CPUThrottlingSelector.CPUThrottlingSelector();
