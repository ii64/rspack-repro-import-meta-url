"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_TargetManager_test_ts"],{

/***/ "./src/core/sdk/TargetManager.test.ts":
/*!********************************************!*\
  !*** ./src/core/sdk/TargetManager.test.ts ***!
  \********************************************/
...
/* harmony import */ var _host_host_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../host/host.js */ "./src/core/host/host.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithMockConnection)('TargetManager', () => {
    ...
    it('notifies about inspected URL change', () => {
        ...
        targetManager.addEventListener(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.Events.InspectedURLChanged, inspectedURLChangedEventListener);
        targetManager.setScopeTarget(null);
