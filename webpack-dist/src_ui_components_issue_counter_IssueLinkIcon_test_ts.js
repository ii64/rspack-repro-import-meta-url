"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_issue_counter_IssueLinkIcon_test_ts"],{
...
/***/ "./src/ui/components/issue_counter/IssueLinkIcon.test.ts":
/*!***************************************************************!*\
  !*** ./src/ui/components/issue_counter/IssueLinkIcon.test.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _issue_counter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./issue_counter.js */ "./src/ui/components/issue_counter/issue_counter.ts");
// Copyright 2020 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
...
var _MockIssueResolver_promiseMap;
...
class MockIssueResolver {
    constructor() {
        _MockIssueResolver_promiseMap.set(this, new Map());
    }
    waitFor(issueId) {
        if (!issueId) {
            if (__classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").size !== 1) {
                throw new Error('more than one issue being awaited, specify a issue id');
            }
            issueId = __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").keys().next().value;
        }
        issueId = issueId || '';
        const entry = __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").get(issueId);
        if (entry) {
        ...
        __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").set(issueId, { resolve, promise });
        return promise;
    }
    resolve(result, issueId) {
        if (!issueId && __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").size === 1) {
            issueId = __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").keys().next().value;
        }
        ...
        __classPrivateFieldGet(this, _MockIssueResolver_promiseMap, "f").delete(issueId);
    }
}
_MockIssueResolver_promiseMap = new WeakMap();
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithLocale)('IssueLinkIcon', () => {
    const issueId = 'issue1';
    const mockIssue = {
        getKind() {
            return _models_issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_1__.Issue.IssueKind.PageError;
        },
        getIssueId() {
            return issueId;
        },
    ...
    describe('transitions upon issue resolution', () => {
        ...
        it('handles multiple data assignments', async () => {
            ...
            const mockIssue2 = {
                getKind() {
                    return _models_issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_1__.Issue.IssueKind.BreakingChange;
                },
            };
            component.data = {
                issue: mockIssue2,
