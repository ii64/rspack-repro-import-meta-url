"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_entrypoints_formatter_worker_formatter_worker-entrypoint_ts"],{
...
/***/ "./src/entrypoints/formatter_worker/formatter_worker-entrypoint.ts?6083":
/*!*************************************************************************!*\
  !*** ./src/entrypoints/formatter_worker/formatter_worker-entrypoint.ts ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _formatter_worker_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formatter_worker.js */ "./src/entrypoints/formatter_worker/formatter_worker.ts");
...
self.onmessage = function (event) {
    ...
    switch (method) {
        case _FormatterActions_js__WEBPACK_IMPORTED_MODULE_2__.FormatterActions.FORMAT:
            ...
            break;
        case _FormatterActions_js__WEBPACK_IMPORTED_MODULE_2__.FormatterActions.PARSE_CSS:
            _formatter_worker_js__WEBPACK_IMPORTED_MODULE_1__.CSSRuleParser.parseCSS(params.content, self.postMessage);
            break;
        case _FormatterActions_js__WEBPACK_IMPORTED_MODULE_2__.FormatterActions.JAVASCRIPT_SUBSTITUTE: {
        ...
        case _FormatterActions_js__WEBPACK_IMPORTED_MODULE_2__.FormatterActions.JAVASCRIPT_SCOPE_TREE: {
        ...
        case _FormatterActions_js__WEBPACK_IMPORTED_MODULE_2__.FormatterActions.EVALUATE_JAVASCRIPT_SUBSTRING:
