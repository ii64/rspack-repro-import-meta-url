"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["panels_application_preloading_components_PreloadingMismatchedHeadersGrid_test_js-ui_component-61c2ea"],{

/***/ "./panels/application/preloading/components/PreloadingMismatchedHeadersGrid.test.js":
/*!******************************************************************************************!*\
  !*** ./panels/application/preloading/components/PreloadingMismatchedHeadersGrid.test.js ***!
  \******************************************************************************************/
...
async function renderPreloadingMismatchedHeadersGrid(data) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_5__.PreloadingMismatchedHeadersGrid.PreloadingMismatchedHeadersGrid();
    component.data = data;
...
async function testPreloadingMismatchedHeadersGrid(recievedMismatchedHeaders, rowExpected) {
    ...
    assert.isNotNull(component.shadowRoot);
    (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_1__.assertGridContents)(component, ['Header name', 'Value in initial navigation', 'Value in activation navigation'], rowExpected);
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithEnvironment)('PreloadingMismatchedHeadersGrid', () => {
