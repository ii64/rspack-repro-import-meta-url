"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["panels_application_StorageBucketsTreeElement_test_js"],{

/***/ "./panels/application/StorageBucketsTreeElement.test.js":
/*!**************************************************************!*\
  !*** ./panels/application/StorageBucketsTreeElement.test.js ***!
  \**************************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('StorageBucketsTreeElement', function () {
    let target;
    ...
    it('adds bucket tree elements on non default buckets added', async () => {
        ...
        const panel = _application_js__WEBPACK_IMPORTED_MODULE_5__.ResourcesPanel.ResourcesPanel.instance({ forceNew: true });
        panel.markAsRoot();
        panel.show(document.body);
        const parentTreeElement = new _application_js__WEBPACK_IMPORTED_MODULE_5__.StorageBucketsTreeElement.StorageBucketsTreeParentElement(panel);
    ...
    it('shows view on select', async () => {
        ...
        panel.markAsRoot();
        panel.show(document.body);
        const treeElement = new _application_js__WEBPACK_IMPORTED_MODULE_5__.StorageBucketsTreeElement.StorageBucketsTreeElement(panel, storageBucketsModel, STORAGE_BUCKET_INFOS[0]);
        const showViewSpy = sinon.spy(treeElement, 'showView');
        document.body.appendChild(treeElement.listItemNode);
        treeElement.treeOutline = new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.TreeOutline.TreeOutlineInShadow();
