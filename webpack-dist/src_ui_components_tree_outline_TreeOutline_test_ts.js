"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_tree_outline_TreeOutline_test_ts"],{
...
/***/ "./src/ui/components/tree_outline/TreeOutline.test.ts":
/*!************************************************************!*\
  !*** ./src/ui/components/tree_outline/TreeOutline.test.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tree_outline.js */ "./src/ui/components/tree_outline/tree_outline.ts");
// Copyright 2020 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
...
async function renderTreeOutline({ tree, defaultRenderer, filter, }) {
    const component = new _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.TreeOutline();
    const data = {
        tree,
        defaultRenderer: defaultRenderer ||
            ((node) => _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `${node.treeNodeData}`),
        filter,
    };
    component.data = data;
...
describe('TreeOutline', () => {
    ...
    it('can take nodes with a custom key type', async () => {
        const customRenderer = (node) => {
            return _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `<h2 class="item">${node.treeNodeData.property.toUpperCase()}:</h2>${node.treeNodeData.value}`;
        };
        const tinyTree = [{
    ...
    it('allows a node to have a custom renderer', async () => {
        const tinyTree = [{
                treeNodeData: 'Offices',
                id: 'Offices',
                renderer: node => _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `<h2 class="top-node">${node.treeNodeData.toUpperCase()}</h2>`,
                children: async () => [{
                        treeNodeData: 'EMEA',
                        id: 'EMEA',
                    },
        ...
        assert.instanceOf(key, HTMLElement);
        const renderedKey = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.stripLitHtmlCommentNodes)(key.innerHTML);
    ...
    it('passes the custom renderer the expanded state', async () => {
        const tinyTree = [{
                ...
                renderer: (node, { isExpanded }) => {
                    return _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `<h2 class="top-node">${node.treeNodeData.toUpperCase()}. Expanded: ${isExpanded}</h2>`;
                },
                children: async () => [{
                        treeNodeData: 'EMEA',
                        id: 'EMEA',
        ...
        const key = officeNode.querySelector('[data-node-key]');
        assert.instanceOf(key, HTMLElement);
        let renderedKey = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.stripLitHtmlCommentNodes)(key.innerHTML);
    ...
    describe('navigating with keyboard', () => {
        ...
        describe('pressing the ENTER key', () => {
            it('expands the node if it is closed', async () => {
                ...
                await coordinator.done();
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: 'Enter', bubbles: true });
                await waitForRenderedTreeNodeCount(shadowRoot, 3);
        ...
        describe('pressing the SPACE key', () => {
            it('expands the node if it is closed', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
                await coordinator.done();
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: ' ', bubbles: true });
                await waitForRenderedTreeNodeCount(shadowRoot, 3);
                assert.strictEqual(officeNode.getAttribute('aria-expanded'), 'true');
            });
            it('closes the node if it is open', async () => {
        ...
        describe('pressing the HOME key', () => {
            it('takes the user to the top most root node', async () => {
                ...
                await coordinator.done();
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(berlinNode, { key: 'Home', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Offices'));
            });
        });
        describe('pressing the END key', () => {
            it('takes the user to the last visible node if they are all expanded', async () => {
                ...
                const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: 'End', bubbles: true });
                await coordinator.done();
        ...
        describe('pressing the UP arrow', () => {
            it('does nothing if on the root node', async () => {
                ...
                const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: 'ArrowUp', bubbles: true });
                await coordinator.done();
            ...
            it('moves focus to the previous sibling', async () => {
                ...
                const berlinNode = getVisibleTreeNodeByText(shadowRoot, 'BER');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(berlinNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(berlinNode, { key: 'ArrowUp', bubbles: true });
                await coordinator.done();
            ...
            it('moves focus to the parent if there are no previous siblings', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(ukNode, { key: 'ArrowUp', bubbles: true });
                await coordinator.done();
            ...
            it('moves focus to the parent\'s last child if there are no previous siblings and the parent is expanded', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(germanyNode, { key: 'ArrowUp', bubbles: true });
                await coordinator.done();
        ...
        describe('pressing the RIGHT arrow', () => {
            it('does nothing if it is on a node that cannot be expanded', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(chromeNode, { key: 'ArrowRight', bubbles: true });
                await coordinator.done();
            ...
            it('expands the node if on an expandable node that is closed and does not move focus', async () => {
                ...
                const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: 'ArrowRight', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), officeNode);
                assert.strictEqual(officeNode.getAttribute('aria-expanded'), 'true');
            });
        ...
        describe('pressing the LEFT arrow', () => {
            it('closes the node if the focused node is expanded', async () => {
                ...
                const europeNode = getVisibleTreeNodeByText(shadowRoot, 'Europe');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(europeNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(europeNode, { key: 'ArrowLeft', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Europe'));
                const visibleTree = visibleNodesToTree(shadowRoot);
            ...
            it('moves to the parent node if the current node is not expanded or unexpandable', async () => {
                ...
                const berlinNode = getVisibleTreeNodeByText(shadowRoot, 'BER');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(berlinNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(berlinNode, { key: 'ArrowLeft', bubbles: true });
                await coordinator.done();
            ...
            it('does nothing when called on a root node', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(productsNode, { key: 'ArrowLeft', bubbles: true });
                await coordinator.done();
        ...
        describe('pressing the DOWN arrow', () => {
            it('moves down to the next sibling if the node is not expanded', async () => {
                ...
                const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(officeNode, { key: 'ArrowDown', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Products'));
            });
            it('does not move if it is the last sibling and there are no parent siblings', async () => {
                ...
                const productsNode = getVisibleTreeNodeByText(shadowRoot, 'Products');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(productsNode);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(productsNode, { key: 'ArrowDown', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Products'));
            });
            ...
            it('moves to its parent\'s sibling if it is the last child', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(lonNode, { key: 'ArrowDown', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Germany'));
            });
            it('is able to navigate high up the tree to the correct next parent\'s sibling', async () => {
                ...
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(berNode, { key: 'ArrowDown', bubbles: true });
                await coordinator.done();
                assert.strictEqual(getFocusableTreeNode(shadowRoot), getVisibleTreeNodeByText(shadowRoot, 'Products'));
            });
        });
    ...
    describe('emitting events', () => {
        describe('itemselected event', () => {
            it('emits an event when the user clicks on the node', async () => {
                ...
                await coordinator.done();
                const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
                const treeItemSelectedEvent = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'itemselected');
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchClickEvent)(officeNode);
        ...
        describe('itemmouseover', () => {
            it('emits an event when the user mouses over the element', async () => {
                ...
                const itemMouseOverEvent = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'itemmouseover');
        ...
        describe('itemmouseout', () => {
            it('emits an event when the user mouses out of the element', async () => {
                ...
                assert.instanceOf(officeNode, HTMLSpanElement);
                (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchMouseOverEvent)(officeNode);
                const itemMouseOutEvent = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'itemmouseout');
    ...
    describe('matching on id parameter', () => {
        ...
        it('remembers nodes expanded state across node updates', async () => {
            ...
            component.data = {
                ...
                defaultRenderer: (node => _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `${node.treeNodeData}`),
            };
            await waitForRenderedTreeNodeCount(shadowRoot, 4);
            await coordinator.done();
            const visibleTree = visibleNodesToTree(shadowRoot);
...
describe('TreeOutlineUtils', () => {
    describe('getPathToTreeNode', () => {
        it('can find the path to the given node', async () => {
            const path = await _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutlineUtils.getPathToTreeNode(basicTreeData, nodeBelgraveHouse.id);
        ...
        it('returns null if no path is found', async () => {
            const path = await _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutlineUtils.getPathToTreeNode(basicTreeData, '-1');
...
describe('TreeOutlineFiltering', () => {
    it('can flatten nodes', async () => {
        const { component, shadowRoot } = await renderTreeOutline({
            ...
            filter: node => node === 'SA' || node === 'NSW' || node === 'Adelaide' ?
                _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.FilterOption.FLATTEN :
                _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.FilterOption.SHOW,
        });
        await component.expandRecursively();
        await coordinator.done();
        await waitForRenderedTreeNodeCount(shadowRoot, 7);
    ...
    it('should not flatten an already expanded node', async () => {
        ...
        component.data = {
            tree: [nodeAustralia],
            filter: node => node === 'SA' || node === 'NSW' ? _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.FilterOption.FLATTEN :
                _tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.FilterOption.SHOW,
            defaultRenderer: (node => _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.html `${node.treeNodeData}`),
        };
        await waitForRenderedTreeNodeCount(shadowRoot, 9);
