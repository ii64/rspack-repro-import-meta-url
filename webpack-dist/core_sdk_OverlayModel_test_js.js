...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithMockConnection)('OverlayModel', () => {
    ...
    beforeEach(() => {
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.createTarget)({ url: DOCUMENT_URL_FOR_TEST });
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.setMockConnectionResponseHandler)('CSS.getStyleSheetText', () => {
    ...
    it('toggles controls toolbar', async () => {
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.setMockConnectionResponseHandler)('Overlay.setShowWindowControlsOverlay', request => {
            config = request;
            return request;
        });
    ...
    it('toggles the emulated overlay', async () => {
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.setMockConnectionResponseHandler)('CSS.setStyleSheetText', req => {
            styleSheet = req.text;
            return req;
        });
