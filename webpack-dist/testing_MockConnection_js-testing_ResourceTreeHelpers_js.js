...
/***/ "./testing/ResourceTreeHelpers.js":
/*!****************************************!*\
  !*** ./testing/ResourceTreeHelpers.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function setMockResourceTree(shouldMock) {
    if (shouldMock) {
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Page.getResourceTree', () => ({
            frameTree: {
                frame: MAIN_FRAME,
                resources: [],
            },
...
function navigate(frame, framePayload, type = "Navigation" /* Protocol.Page.NavigationType.Navigation */) {
...
function activate(target) {
    ...
    resourceTreeModel.dispatchEventToListeners(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.ResourceTreeModel.Events.PrimaryPageChanged, { frame, type: "Activation" /* SDK.ResourceTreeModel.PrimaryPageChangeType.Activation */ });
}
