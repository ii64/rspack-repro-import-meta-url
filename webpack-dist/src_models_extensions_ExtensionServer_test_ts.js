"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_extensions_ExtensionServer_test_ts"],{

/***/ "./src/models/extensions/ExtensionServer.test.ts":
/*!*******************************************************!*\
  !*** ./src/models/extensions/ExtensionServer.test.ts ***!
  \*******************************************************/
...
/* harmony import */ var _testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../testing/ExtensionHelpers.js */ "./src/testing/ExtensionHelpers.ts");
...
/* harmony import */ var _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../bindings/bindings.js */ "./src/models/bindings/bindings.ts");
/* harmony import */ var _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../extensions/extensions.js */ "./src/models/extensions/extensions.ts");
/* harmony import */ var _logs_logs_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../logs/logs.js */ "./src/models/logs/logs.ts");
/* harmony import */ var _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../text_utils/text_utils.js */ "./src/models/text_utils/text_utils.ts");
/* harmony import */ var _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../workspace/workspace.js */ "./src/models/workspace/workspace.ts");
...
(0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithDevtoolsExtension)('Extensions', {}, context => {
    it('are initialized after the target is initialized and navigated to a non-privileged URL', async () => {
        ...
        const addExtensionStub = sinon.stub(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance(), 'addExtension');
        (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)().setInspectedURL('http://example.com');
    ...
    it('are not initialized before the target is initialized and navigated to a non-privileged URL', async () => {
        ...
        assert.isUndefined(context.chrome.devtools);
        const addExtensionStub = sinon.stub(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance(), 'addExtension');
        (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)().setInspectedURL('chrome://version');
    ...
    it('defers loading extensions until after navigation from a privileged to a non-privileged host', async () => {
        const addExtensionSpy = sinon.spy(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance(), 'addExtension');
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ type: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.Target.Type.Frame });
    ...
    it('only returns page resources for allowed targets', async () => {
        ...
        const targets = urls.map(async (url) => {
            const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ url });
...
(0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithDevtoolsExtension)('Extensions', {}, context => {
    (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.expectConsoleLogs)({
    ...
    it('can register a recorder extension for export', async () => {
        ...
        const manager = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.RecorderPluginManager.RecorderPluginManager.instance();
    ...
    it('can create and show a panel for Recorder', async () => {
        ...
        assert.strictEqual(manager.plugins().length, 1);
        const plugin = manager.plugins()[0];
        const stub = sinon.stub(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_6__.InspectorView.InspectorView.instance(), 'showPanel').callsFake(() => Promise.resolve());
        await plugin.replay({
            name: 'test',
            steps: [],
        });
    ...
    it('can create and show a view for Recorder', async () => {
        ...
        const plugin = manager.plugins()[0];
        const onceShowRequested = manager.once(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.RecorderPluginManager.Events.ShowViewRequested);
        await plugin.replay({
            name: 'test',
            steps: [],
        });
    ...
    it('can not show a view for Recorder without using the replay trigger', async () => {
        ...
        assert.strictEqual(manager.views().length, 1);
        const events = [];
        manager.addEventListener(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.RecorderPluginManager.Events.ShowViewRequested, event => {
            events.push(event);
        });
        view?.show();
    ...
    it('reload only the main toplevel frame', async () => {
        ...
        const secondTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)();
    ...
    it('correcly installs blocked extensions after navigation', async () => {
        ...
        const extensionServer = _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance();
...
const allowedUrl = _testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_5__.FRAME_URL;
...
(0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithDevtoolsExtension)('Runtime hosts policy', { hostsPolicy }, context => {
    (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.expectConsoleLogs)({ error: ['Extension server error: Operation failed: Permission denied'] });
    ...
    it('blocks API calls on blocked hosts', async () => {
        assert.isUndefined(context.chrome.devtools);
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ type: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.Target.Type.Frame });
        const addExtensionStub = sinon.spy(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance(), 'addExtension');
    ...
    it('does not include blocked hosts in the HAR entries', async () => {
        _logs_logs_js__WEBPACK_IMPORTED_MODULE_9__.NetworkLog.NetworkLog.instance();
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ type: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.Target.Type.Frame });
        target.setInspectedURL('http://example.com2');
    ...
    async function setUpFrame(name, url, parentFrame, executionContextOrigin) {
        ...
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ id: `${name}-target-id`, parentTarget });
        const frame = parentFrame ? await (0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_5__.addChildFrame)(target, { url }) : (0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_5__.getMainFrame)(target, { url });
    ...
    async function createUISourceCode(project, url) {
        ...
        const dataProvider = () => Promise.resolve(new _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_10__.ContentData.ContentData('content', /* isBase64 */ false, mimeType));
        project.addUISourceCodeWithProvider(new _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_11__.UISourceCode.UISourceCode(project, url, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.Document), new _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_10__.StaticContentProvider.StaticContentProvider(url, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.Document, dataProvider), null, mimeType);
        await project.uiSourceCodeForURL(url)?.requestContentData();
    }
    it('blocks getting resource contents on blocked urls', async () => {
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)({ id: 'target' });
        target.setInspectedURL(allowedUrl);
        const project = new _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_7__.ContentProviderBasedProject.ContentProviderBasedProject(_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_11__.Workspace.WorkspaceImpl.instance(), target.id(), _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_11__.Workspace.projectTypes.Network, '', false /* isServiceProject */);
    ...
    function createRequest(networkManager, frameId, requestId, url) {
        ...
        const dataProvider = () => Promise.resolve(new _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_10__.ContentData.ContentData('content', false, request.mimeType));
    ...
    it('does not include blocked hosts in onRequestFinished event listener', async () => {
        ...
        await waitForFunction(() => _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.instance().hasSubscribers(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionAPI.PrivateAPI.Events.NetworkRequestFinished));
        const networkManager = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkManager.NetworkManager);
        assert.exists(networkManager);
        createRequest(networkManager, frameId, 'blocked-url-request-id', blockedUrl);
        createRequest(networkManager, frameId, 'allowed-url-request-id', allowedUrl);
...
describe('ExtensionServer', () => {
    it('can correctly expand resource paths', async () => {
        ...
        assert.strictEqual(undefined, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(extensionOrigin, 'http://example.com/foo'));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(extensionOrigin, expectation));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(extensionOrigin, '/foo'));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(extensionOrigin, 'foo'));
        assert.strictEqual(undefined, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(almostOrigin, 'http://example.com/foo'));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(almostOrigin, expectation));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(almostOrigin, '/foo'));
        assert.strictEqual(expectation, _extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.expandResourcePath(almostOrigin, 'foo'));
    });
    it('cannot inspect chrome webstore URLs', () => {
        ...
        for (const url of blockedUrls) {
            assert.isFalse(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.canInspectURL(url), url);
        }
        for (const url of allowedUrls) {
            assert.isTrue(_extensions_extensions_js__WEBPACK_IMPORTED_MODULE_8__.ExtensionServer.ExtensionServer.canInspectURL(url), url);
        }
    });
});
...
(0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithDevtoolsExtension)('Wasm extension API', {}, context => {
    let stopId;
    beforeEach(() => {
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.createTarget)();
        target.setInspectedURL('http://example.com');
        const targetManager = target.targetManager();
        const resourceMapping = new _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_7__.ResourceMapping.ResourceMapping(targetManager, _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_11__.Workspace.WorkspaceImpl.instance());
        _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_7__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance({ forceNew: true, resourceMapping, targetManager });
        ...
        sinon.stub(callFrame.debuggerModel.agent, 'invoke_evaluateOnCallFrame')
            .returns(Promise.resolve({ result: { type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Runtime.RemoteObjectType.Undefined }, getError: () => undefined }));
        stopId = _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_7__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().pluginManager.stopIdForCallFrame(callFrame);
    });
...
(0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithDevtoolsExtension)('Language Extension API', {}, context => {
    it('reports loaded resources', async () => {
        ...
        const extensionId = (0,_testing_ExtensionHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getExtensionOrigin)();
