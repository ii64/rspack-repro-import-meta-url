"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_accessibility_ARIAAttributesView_ts"],{

/***/ "./src/panels/accessibility/ARIAAttributesView.ts":
/*!********************************************************!*\
  !*** ./src/panels/accessibility/ARIAAttributesView.ts ***!
  \********************************************************/
...
class ARIAAttributesPane extends _AccessibilitySubPane_js__WEBPACK_IMPORTED_MODULE_4__.AccessibilitySubPane {
    constructor() {
        ...
        Object.defineProperty(this, "noPropertiesInfo", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
class ARIAAttributePrompt extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_2__.TextPrompt.TextPrompt {
    constructor(ariaCompletions, treeElement) {
        super();
        Object.defineProperty(this, "ariaCompletions", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
