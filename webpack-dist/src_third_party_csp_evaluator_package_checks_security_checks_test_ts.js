"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_csp_evaluator_package_checks_security_checks_test_ts"],{

/***/ "./src/third_party/csp_evaluator/package/checks/security_checks_test.ts":
/*!******************************************************************************!*\
  !*** ./src/third_party/csp_evaluator/package/checks/security_checks_test.ts ***!
  \******************************************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/**
 * @license
...
describe('Test security checks', () => {
    ...
    it('CheckScriptUnsafeInlineInScriptSrc', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(1);
        expect(violations[0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).HIGH);
    });
    ...
    it('CheckScriptUnsafeInlineWithNonce', () => {
        ...
        const parsedCsp = (new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../parser'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(test)).csp;
        let effectiveCsp = parsedCsp.getEffectiveCsp(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../csp'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).CSP1);
        let violations = Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(effectiveCsp);
        expect(violations.length).toBe(1);
        effectiveCsp = parsedCsp.getEffectiveCsp(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../csp'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).CSP3);
        violations = Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(effectiveCsp);
        expect(violations.length).toBe(0);
    });
    ...
    it('CheckScriptUnsafeEvalInScriptSrc', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(1);
        expect(violations[0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).MEDIUM_MAYBE);
    });
    ...
    it('CheckPlainUrlSchemesInScriptSrc', () => {
        ...
        expect(violations.every((v) => v.severity === Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).HIGH)).toBeTrue();
    });
    ...
    it('CheckPlainUrlSchemesMixed', () => {
        ...
        expect(violations.every((v) => v.severity === Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).HIGH)).toBeTrue();
        expect(violations[0].directive).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../csp'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).DEFAULT_SRC);
        expect(violations[1].directive).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../csp'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).OBJECT_SRC);
    });
    ...
    it('CheckIpSource', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(3);
        expect(violations.every((v) => v.severity === Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).INFO)).toBeTrue();
    });
    it('LooksLikeIpAddressIPv4', () => {
        expect(Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('8.8.8.8')).toBeTrue();
    });
    it('LooksLikeIpAddressIPv6', () => {
        expect(Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('[::1]')).toBeTrue();
    });
    ...
    it('CheckNonceLengthWithShortNonce', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(1);
        expect(violations[0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).MEDIUM);
    });
    ...
    it('CheckSrcHttp', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './security_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(2);
        expect(violations.every((v) => v.severity === Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).MEDIUM)).toBeTrue();
    });
