"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_testing_TraceLoader_ts"],{

/***/ "./src/testing/TraceLoader.ts":
/*!************************************!*\
  !*** ./src/testing/TraceLoader.ts ***!
  \************************************/
...
/* harmony export */   TraceLoader: () => (/* binding */ TraceLoader)
/* harmony export */ });
...
class TraceLoader {
     ...
     */
    static async traceEngine(context, name, config = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.Configuration.defaults()) {
        ...
        _services_trace_bounds_trace_bounds_js__WEBPACK_IMPORTED_MODULE_2__.TraceBounds.BoundsManager.instance({ forceNew: true });
        const configCacheKey = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.Configuration.configToCacheKey(config);
    ...
    static initTraceBoundsManager(data) {
        _services_trace_bounds_trace_bounds_js__WEBPACK_IMPORTED_MODULE_2__.TraceBounds.BoundsManager
            .instance({
            forceNew: true,
        })
    ...
    static async executeTraceEngineOnFileContents(contents, emulateFreshRecording = false, traceEngineConfig) {
        ...
        return new Promise((resolve, reject) => {
            const model = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.TraceModel.Model.createWithAllHandlers(traceEngineConfig);
            model.addEventListener(_models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.TraceModel.ModelUpdateEvent.eventName, (event) => {
                const { data } = event;
