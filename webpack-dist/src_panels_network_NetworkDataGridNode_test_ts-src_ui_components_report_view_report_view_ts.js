"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_NetworkDataGridNode_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/NetworkDataGridNode.test.ts":
/*!********************************************************!*\
  !*** ./src/panels/network/NetworkDataGridNode.test.ts ***!
  \********************************************************/
...
/* harmony import */ var _network_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./network.js */ "./src/panels/network/network.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithEnvironment)('NetworkLogView', () => {
    it('adds marker to requests with overridden headers', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com', '', null, null, null);
        request.statusCode = 200;
        request.setWasIntercepted(true);
        request.responseHeaders = [{ name: 'foo', value: 'overridden' }];
        request.originalResponseHeaders = [{ name: 'foo', value: 'original' }];
        const networkRequestNode = new _network_js__WEBPACK_IMPORTED_MODULE_4__.NetworkDataGridNode.NetworkRequestNode({}, request);
    ...
    it('show media icon', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/test.mp3', '', null, null, null);
    ...
    it('show wasm icon', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/test.wasm', '', null, null, null);
    ...
    it('show websocket icon', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/ws', '', null, null, null);
    ...
    it('shows fetch icon', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/test.json?keepalive=false', '', null, null, null);
    ...
    it('mime win: show image preview icon for xhr-image', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/test.svg', '', null, null, null);
        request.setResourceType(_core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.XHR);
    ...
    it('mime win: show document icon for fetch-html', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/page', '', null, null, null);
        request.setResourceType(_core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.Fetch);
        request.mimeType = 'text/html';
        const networkRequestNode = new _network_js__WEBPACK_IMPORTED_MODULE_4__.NetworkDataGridNode.NetworkRequestNode({}, request);
        const el = document.createElement('div');
    ...
    it('mime win: show generic icon for preflight-text', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/api/test', '', null, null, null);
    ...
    it('mime win: show script icon for other-javascript)', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/ping', '', null, null, null);
    ...
    it('mime win: shows json icon for fetch-json', async () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/api/list', '', null, null, null);
        request.setResourceType(_core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ResourceType.resourceTypes.Fetch);
    ...
    it('only counts non-blocked response cookies', async () => {
        ...
        request.addExtraResponseInfo({
            ...
            blockedResponseCookies: [{
                    blockedReasons: [_generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Network.SetCookieBlockedReason.SameSiteNoneInsecure],
                    cookie: null,
                    cookieLine: 'bad=456; Path=/; SameSite=None',
                }],
            resourceIPAddressSpace: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Network.IPAddressSpace.Public,
    ...
    it('shows transferred size when the matched ServiceWorker router source is network', async () => {
        ...
        request.serviceWorkerRouterInfo = {
            ruleIdMatched: 1,
            matchedSourceType: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Network.ServiceWorkerRouterSource.Network,
        };
        const networkRequestNode = new _network_js__WEBPACK_IMPORTED_MODULE_4__.NetworkDataGridNode.NetworkRequestNode({}, request);
        const el = document.createElement('div');
