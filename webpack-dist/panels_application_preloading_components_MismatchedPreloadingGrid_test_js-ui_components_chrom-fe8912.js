"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["panels_application_preloading_components_MismatchedPreloadingGrid_test_js-ui_components_chrom-fe8912"],{

/***/ "./panels/application/preloading/components/MismatchedPreloadingGrid.test.js":
/*!***********************************************************************************!*\
  !*** ./panels/application/preloading/components/MismatchedPreloadingGrid.test.js ***!
  \***********************************************************************************/
...
async function renderMismatchedPreloadingGrid(data) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.MismatchedPreloadingGrid.MismatchedPreloadingGrid();
    component.data = data;
...
function assertDiff(gridComponent, cellIndex, spansExpected) {
    const controller = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getElementWithinComponent)(gridComponent, 'devtools-data-grid-controller', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_4__.DataGridController.DataGridController);
    const grid = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getElementWithinComponent)(controller, 'devtools-data-grid', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_4__.DataGrid.DataGrid);
    assert.isNotNull(grid.shadowRoot);
    const cell = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getCellByIndexes)(grid.shadowRoot, cellIndex);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithEnvironment)('MismatchedPreloadingGrid', () => {
    ...
    it.skip('[crbug.com/1473557]: renderes no diff in URL', async function () {
        ...
        assert.isNotNull(component.shadowRoot);
        (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_1__.assertGridContents)(component, ['URL', 'Action', 'Status'], [
