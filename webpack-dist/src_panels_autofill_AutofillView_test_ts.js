"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_autofill_AutofillView_test_ts"],{

/***/ "./src/panels/autofill/AutofillView.test.ts":
/*!**************************************************!*\
  !*** ./src/panels/autofill/AutofillView.test.ts ***!
  \**************************************************/
...
/* harmony import */ var _models_autofill_manager_autofill_manager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/autofill_manager/autofill_manager.js */ "./src/models/autofill_manager/autofill_manager.ts");
/* harmony import */ var _testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../testing/DataGridHelpers.js */ "./src/testing/DataGridHelpers.ts");
...
/* harmony import */ var _testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../testing/ResourceTreeHelpers.js */ "./src/testing/ResourceTreeHelpers.ts");
...
/* harmony import */ var _autofill_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./autofill.js */ "./src/panels/autofill/autofill.ts");
...
const addressFormFilledEvent = {
    ...
    filledFields: [
        ...
        },
        {
            ...
            fillingStrategy: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Autofill.FillingStrategy.AutocompleteAttribute,
            fieldId: 4,
            frameId: '1',
        },
    ],
};
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_7__.describeWithMockConnection)('AutofillView', () => {
    let target;
    let autofillModel;
    let showViewStub;
    beforeEach(() => {
        ...
        showViewStub = sinon.stub(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_10__.ViewManager.ViewManager.instance(), 'showView').resolves();
        _models_autofill_manager_autofill_manager_js__WEBPACK_IMPORTED_MODULE_3__.AutofillManager.AutofillManager.instance({ forceNew: true });
    });
    afterEach(() => {
        showViewStub.restore();
    });
    const renderAutofillView = async () => {
        const view = new _autofill_js__WEBPACK_IMPORTED_MODULE_11__.AutofillView.AutofillView();
    ...
    const assertViewShowsEventData = (view) => {
        ...
        (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__.assertGridContents)(view, expectedHeaders, expectedRows);
    };
    it('renders autofilled address and filled fields and clears content on navigation', async () => {
        ...
        (0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_8__.navigate)((0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_8__.getMainFrame)(target));
        await coordinator.done();
    ...
    it('highlights corresponding grid row when hovering over address span', async () => {
        ...
        const grid = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getDataGrid)(view);
        assert.isNotNull(grid.shadowRoot);
        const firstGridRow = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getBodyRowByAriaIndex)(grid.shadowRoot, 1);
    ...
    it('highlights corresponding address span and DOM node when hovering over grid row', async () => {
        (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_6__.stubNoopSettings)();
        const mockFrame = {
            resourceTreeModel: () => ({
                target: () => target,
            }),
        ...
        const grid = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getDataGrid)(view);
        assert.isNotNull(grid.shadowRoot);
        const fourthGridRow = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_4__.getBodyRowByAriaIndex)(grid.shadowRoot, 4);
...
/***/ "./src/panels/autofill/autofill.ts":
/*!*****************************************!*\
  !*** ./src/panels/autofill/autofill.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _AutofillView_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AutofillView.js */ "./src/panels/autofill/AutofillView.ts");
// Copyright 2023 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
