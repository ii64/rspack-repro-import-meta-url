"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_RequestHTMLView_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/RequestHTMLView.test.ts":
/*!****************************************************!*\
  !*** ./src/panels/network/RequestHTMLView.test.ts ***!
  \****************************************************/
...
/* harmony import */ var _network_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./network.js */ "./src/panels/network/network.ts");
...
describe('RequestHTMLView', () => {
    it('renders a HTML document into an iframe', async () => {
        ...
        const contentData = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_0__.ContentData.ContentData(content, false, 'text/html');
        const htmlView = _network_js__WEBPACK_IMPORTED_MODULE_1__.RequestHTMLView.RequestHTMLView.create(contentData);
