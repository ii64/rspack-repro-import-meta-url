"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_issues_manager_LowTextContrastIssue_test_ts"],{

/***/ "./src/models/issues_manager/LowTextContrastIssue.test.ts":
/*!****************************************************************!*\
  !*** ./src/models/issues_manager/LowTextContrastIssue.test.ts ***!
  \****************************************************************/
...
/* harmony import */ var _panels_issues_issues_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../panels/issues/issues.js */ "./src/panels/issues/issues.ts");
/* harmony import */ var _testing_MockIssuesManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../testing/MockIssuesManager.js */ "./src/testing/MockIssuesManager.ts");
...
describe('LowTextContrastIssue', () => {
    it('aggregates multiple issues with duplicates correctly', () => {
        ...
        const mockManager = new _testing_MockIssuesManager_js__WEBPACK_IMPORTED_MODULE_1__.MockIssuesManager([]);
        const commonDetails = {
        ...
        const issues = issueDetails.map(details => new _issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_3__.LowTextContrastIssue.LowTextContrastIssue(details, mockModel));
        ...
        for (const issue of issues) {
            mockManager.dispatchEventToListeners(_issues_manager_issues_manager_js__WEBPACK_IMPORTED_MODULE_3__.IssuesManager.Events.IssueAdded, { issuesModel: mockModel, issue });
        }
