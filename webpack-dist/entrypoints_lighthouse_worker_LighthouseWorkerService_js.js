...
/***/ "./entrypoints/lighthouse_worker/LighthouseWorkerService.js":
/*!******************************************************************!*\
  !*** ./entrypoints/lighthouse_worker/LighthouseWorkerService.js ***!
  \******************************************************************/
...
async function fetchLocaleData(locales) {
    ...
    try {
        ...
        if (remoteBase && remoteBase.base) {
            ...
            localeUrl = new URL(`../../third_party/lighthouse/locales/${locale}.json`, "file:///mnt/p0/Personal/rspack-repro-import-meta-url/src/entrypoints/lighthouse_worker/LighthouseWorkerService.js").toString();
        }
