"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_docs_performance_panel_basic_ts"],{

/***/ "./src/ui/components/docs/performance_panel/basic.ts":
/*!***********************************************************!*\
  !*** ./src/ui/components/docs/performance_panel/basic.ts ***!
  \***********************************************************/
...
/* harmony import */ var _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../legacy/legacy.js */ "./src/ui/legacy/legacy.ts");
/* harmony import */ var _helpers_helpers_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../helpers/helpers.js */ "./src/ui/components/helpers/helpers.ts");
...
_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.registerActionExtension({
    ...
    iconClass: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.IconClass.REFRESH,
    category: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.ActionCategory.PERFORMANCE,
    contextTypes() {
        return [_panels_timeline_timeline_js__WEBPACK_IMPORTED_MODULE_5__.TimelinePanel.TimelinePanel];
    },
    bindings: [
        {
            platform: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.Platforms.WindowsLinux,
            shortcut: 'Ctrl+Shift+E',
        },
        {
            platform: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.Platforms.Mac,
...
_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.registerActionExtension({
    ...
    category: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.ActionCategory.PERFORMANCE,
    iconClass: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.IconClass.MOP,
});
_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.registerActionExtension({
    ...
    toggleable: true,
    category: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.ActionCategory.PERFORMANCE,
    iconClass: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_7__.ActionRegistration.IconClass.START_RECORDING,
    contextTypes() {
        return [_panels_timeline_timeline_js__WEBPACK_IMPORTED_MODULE_5__.TimelinePanel.TimelinePanel];
    },
    bindings: [
