"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_common_Color_test_ts"],{

/***/ "./src/core/common/Color.test.ts":
/*!***************************************!*\
  !*** ./src/core/common/Color.test.ts ***!
  \***************************************/
...
const Color = _common_js__WEBPACK_IMPORTED_MODULE_0__.Color;
...
describe('Color', () => {
    ...
    it('is able to return the HSVA value of a color', () => {
        const color = new Color.Legacy([0.5, 0.5, 0.5, 0.5], Color.Format.RGBA, 'testColor');
        const hsva = color.as(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL).hsva();
    ...
    it('is able to return canonical HSLA for a color', () => {
        const color = new Color.Legacy([0.5, 0.5, 0.5, 0.5], Color.Format.RGBA, 'testColor');
        const result = color.as(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL).canonicalHSLA();
    ...
    it('returns the HSL value when turned into a string if its format was "hsl"', () => {
        const color = new Color.Legacy([1, 0, 0, 1], Color.Format.RGB);
        const result = color.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL);
    ...
    it('omits the alpha value when it’s 100% if its format was "hsla"', () => {
        const color = new Color.Legacy([1, 0, 0, 1], Color.Format.RGBA);
        const result = color.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSLA);
        assert.strictEqual(result, 'hsl(0deg 100% 50%)', 'color was not converted to a string correctly');
    });
    ...
    it('find the fg color with good contrast according to APCA', () => {
        ...
        for (const test of tests) {
            ...
            const result = _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.findFgColorForContrastAPCA(fg, bg, test.requiredContrast);
            const absContrast = Math.abs(_common_js__WEBPACK_IMPORTED_MODULE_0__.ColorUtils.contrastRatioAPCA(result.rgba(), bg.rgba()));
    ...
    it('retains and returns the authored text', () => {
        const lime = {
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEX]: '#00ff00',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEXA]: '#00ff00ff',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGB]: 'rgb(0 255 0)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGBA]: 'rgba(0 255 0 / 100%)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL]: 'hsl(120deg 100% 50%)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSLA]: 'hsl(120deg 100% 50% / 80%)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWB]: 'hwb(120deg 0% 0%)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWBA]: 'hwb(120deg 0% 0% / 80%)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LCH]: 'lch(87.82 113.32 134.38)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLCH]: 'oklch(0.87 0.29 142.49)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LAB]: 'lab(87.82 -79.26 80.99)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLAB]: 'oklab(0.87 -0.23 0.18)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB]: 'color(srgb 0 1 0)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB_LINEAR]: 'color(srgb-linear 0 1 0)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.DISPLAY_P3]: 'color(display-p3 0.46 0.99 0.3)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.A98_RGB]: 'color(a98-rgb 0.57 1 0.23)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.PROPHOTO_RGB]: 'color(prophoto-rgb 0.54 0.93 0.3)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.REC_2020]: 'color(rec2020 0.57 0.96 0.27)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D50]: 'color(xyz-d50 0.39 0.72 0.1)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D65]: 'color(xyz-d65 0.36 0.72 0.12)',
            [_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ]: 'color(xyz 0.36 0.72 0.12)',
        };
        for (const format in lime) {
            const spec = lime[format];
            const color = _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(spec);
    ...
    it('prints the correct color when stringified with format', () => {
        const LIME = [
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEX, spec: '#00ff00' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEXA, spec: '#00ff00' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGB, spec: 'rgb(0 255 0)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGBA, spec: 'rgb(0 255 0)' }, // no alpha here because it is ignored at 100%
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL, spec: 'hsl(120deg 100% 50%)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSLA, spec: 'hsl(120deg 100% 50%)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWB, spec: 'hwb(120deg 0% 0%)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWBA, spec: 'hwb(120deg 0% 0%)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LCH, spec: 'lch(88 113.32 134.38)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLCH, spec: 'oklch(0.87 0.29 142.49)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LAB, spec: 'lab(88 -79.26 80.99)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLAB, spec: 'oklab(0.87 -0.23 0.18)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB, spec: 'color(srgb 0 1 0)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB_LINEAR, spec: 'color(srgb-linear 0 1 0)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.DISPLAY_P3, spec: 'color(display-p3 0.46 0.99 0.3)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.A98_RGB, spec: 'color(a98-rgb 0.57 1 0.23)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.PROPHOTO_RGB, spec: 'color(prophoto-rgb 0.54 0.93 0.3)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.REC_2020, spec: 'color(rec2020 0.57 0.96 0.27)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D50, spec: 'color(xyz-d50 0.39 0.72 0.1)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D65, spec: 'color(xyz-d65 0.36 0.72 0.12)' },
            { format: _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ, spec: 'color(xyz 0.36 0.72 0.12)' },
        ];
        for (const { format, spec } of LIME) {
            const color = _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('lime');
    ...
    it('supports all to all and chain conversions', () => {
        ...
        (function (Code) {
            ...
            Code[Code["HEX"] = 1] = "HEX";
            Code[Code["ShortHEX"] = 1] = "ShortHEX";
            Code[Code["HEXA"] = 1] = "HEXA";
            Code[Code["ShortHEXA"] = 1] = "ShortHEXA";
            Code[Code["RGB"] = 1] = "RGB";
        ...
        function stub(fn, input, output) {
            const result = sinon.stub(_common_js__WEBPACK_IMPORTED_MODULE_0__.ColorConverter.ColorConverter, fn);
        ...
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEX, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('#ff0000'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEXA, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('#ff0000ff'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('rgb(255 0 0)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGBA, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('rgb(255 0 0)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('hsl(0deg 100% 50%)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSLA, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('hsl(0deg 100% 50%)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('hwb(0deg 0% 0%)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWBA, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse('hwb(0deg 0% 0%)'));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LCH, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`lch(${Code.LCH} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLCH, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`oklch(${Code.OKLCH} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.LAB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`lab(${Code.LAB} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.OKLAB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`oklab(${Code.OKLAB} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(srgb ${Code.SRGB} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB_LINEAR, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(srgb-linear ${Code.SRGB_LINEAR} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.DISPLAY_P3, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(display-p3 ${Code.DISPLAY_P3} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.A98_RGB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(a98-rgb ${Code.A98_RGB} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.PROPHOTO_RGB, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(prophoto-rgb ${Code.PROPHOTO_RGB} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.REC_2020, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(rec2020 ${Code.REC_2020} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D50, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz-d50 ${Code.XYZ_D50} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ_D65, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz-d65 ${Code.XYZ_D65} 0 0)`));
        colors.set(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.XYZ, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz ${Code.XYZ} 0 0)`));
    ...
    it('correctly clips results on conversion', () => {
        ...
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEX), '#ffd39e');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HEXA), '#ffd39e');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGB), 'rgb(255 211 158)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.RGBA), 'rgb(255 211 158)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSL), 'hsl(0deg 0% 100%)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HSLA), 'hsl(0deg 0% 100%)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWB), 'hwb(15.95deg 61.78% 0%)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.HWBA), 'hwb(15.95deg 61.78% 0%)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB), 'color(srgb 1 0.83 0.62)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.SRGB_LINEAR), 'color(srgb-linear 1 0.65 0.34)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.DISPLAY_P3), 'color(display-p3 1 0.86 0.66)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.A98_RGB), 'color(a98-rgb 1 0.82 0.62)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.PROPHOTO_RGB), 'color(prophoto-rgb 1 0.88 0.61)');
        assert.strictEqual(nonSRGBColor.asString(_common_js__WEBPACK_IMPORTED_MODULE_0__.Color.Format.REC_2020), 'color(rec2020 1 0.87 0.63)');
    });
