"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_components_InteractionBreakdown_test_ts"],{

/***/ "./src/panels/timeline/components/InteractionBreakdown.test.ts":
/*!*********************************************************************!*\
  !*** ./src/panels/timeline/components/InteractionBreakdown.test.ts ***!
  \*********************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('InteractionBreakdown', () => {
    ...
    const { InteractionBreakdown } = _components_js__WEBPACK_IMPORTED_MODULE_4__.InteractionBreakdown;
    it('renders the breakdowns for an InteractionBreakdown', async function () {
        const { traceData } = await _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_2__.TraceLoader.traceEngine(this, 'one-second-interaction.json.gz');
