"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_lighthouse_LighthouseController_ts"],{
...
/***/ "./src/panels/lighthouse/LighthouseController.ts":
/*!*******************************************************!*\
  !*** ./src/panels/lighthouse/LighthouseController.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../models/emulation/emulation.js */ "./src/models/emulation/emulation.ts");
/* harmony import */ var _emulation_emulation_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../emulation/emulation.js */ "./src/panels/emulation/emulation.ts");
...
class LighthouseController extends _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ObjectWrapper.ObjectWrapper {
    constructor(protocolService) {
        super();
        Object.defineProperty(this, "protocolService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "serviceWorkerListeners", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "inspectedURL", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "currentLighthouseRun", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "emulationStateBefore", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.TargetManager.instance().addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.Events.InspectedURLChanged, this.recomputePageAuditability, this);
    }
    modelAdded(serviceWorkerManager) {
        ...
        this.serviceWorkerListeners = [
            this.manager.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.Events.RegistrationUpdated, this.recomputePageAuditability, this),
            this.manager.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.Events.RegistrationDeleted, this.recomputePageAuditability, this),
        ];
    ...
    recordMetrics(flags, categoryIds) {
        ...
        switch (flags.mode) {
            case 'navigation':
                _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.userMetrics.lighthouseModeRun(_core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseModeRun.Navigation);
                break;
            case 'timespan':
                _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.userMetrics.lighthouseModeRun(_core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseModeRun.Timespan);
                break;
            case 'snapshot':
                _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.userMetrics.lighthouseModeRun(_core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseModeRun.Snapshot);
                break;
        }
    }
    ...
    async setupEmulationAndProtocolConnection() {
        const flags = this.getFlags();
        const emulationModel = _models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__.DeviceModeModel.DeviceModeModel.instance();
        ...
        if ('formFactor' in flags && flags.formFactor === 'desktop') {
            ...
            emulationModel.emulate(_models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__.DeviceModeModel.Type.None, null, null);
        }
        else if (flags.formFactor === 'mobile') {
            emulationModel.enabledSetting().set(true);
            emulationModel.deviceOutlineSetting().set(true);
            for (const device of _models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__.EmulatedDevices.EmulatedDevicesList.instance().standard()) {
                if (device.title === 'Moto G Power') {
                    emulationModel.emulate(_models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__.DeviceModeModel.Type.Device, device, device.modes[0], 1);
                }
            }
        }
    ...
    async restoreEmulationAndProtocolConnection() {
        ...
        if (this.emulationStateBefore) {
            ...
            if (type === _models_emulation_emulation_js__WEBPACK_IMPORTED_MODULE_5__.DeviceModeModel.Type.Responsive) {
        ...
        _emulation_emulation_js__WEBPACK_IMPORTED_MODULE_6__.InspectedPagePlaceholder.InspectedPagePlaceholder.instance().update(true);
        const mainTarget = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.TargetManager.instance().primaryPageTarget();
        if (!mainTarget) {
            return;
        }
...
const STORAGE_TYPE_NAMES = new Map([
    [_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Storage.StorageType.Local_storage, i18nLazyString(UIStrings.localStorage)],
    [_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Storage.StorageType.Indexeddb, i18nLazyString(UIStrings.indexeddb)],
    [_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Storage.StorageType.Websql, i18nLazyString(UIStrings.webSql)],
]);
const Presets = [
    // configID maps to Lighthouse's Object.keys(config.categories)[0] value
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.cat-perf', true, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
        configID: 'performance',
        title: i18nLazyString(UIStrings.performance),
        description: i18nLazyString(UIStrings.howLongDoesThisAppTakeToShow),
        supportedModes: ['navigation', 'timespan', 'snapshot'],
        userMetric: _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseCategoryUsed.Performance,
    },
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.cat-a11y', true, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
        configID: 'accessibility',
        title: i18nLazyString(UIStrings.accessibility),
        description: i18nLazyString(UIStrings.isThisPageUsableByPeopleWith),
        supportedModes: ['navigation', 'snapshot'],
        userMetric: _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseCategoryUsed.Accessibility,
    },
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.cat-best-practices', true, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
        configID: 'best-practices',
        title: i18nLazyString(UIStrings.bestPractices),
        description: i18nLazyString(UIStrings.doesThisPageFollowBestPractices),
        supportedModes: ['navigation', 'timespan', 'snapshot'],
        userMetric: _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseCategoryUsed.BestPractices,
    },
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.cat-seo', true, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
        configID: 'seo',
        title: i18nLazyString(UIStrings.seo),
        description: i18nLazyString(UIStrings.isThisPageOptimizedForSearch),
        supportedModes: ['navigation', 'snapshot'],
        userMetric: _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.LighthouseCategoryUsed.SEO,
    },
];
const RuntimeSettings = [
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.device-type', 'mobile', _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
    ...
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.mode', 'navigation', _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
    ...
    },
    {
        ...
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.throttling', 'simulate', _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
    ...
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.clear-storage', true, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
    ...
    {
        setting: _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('lighthouse.enable-sampling', false, _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced),
