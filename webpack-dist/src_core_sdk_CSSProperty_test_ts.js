"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_CSSProperty_test_ts"],{

/***/ "./src/core/sdk/CSSProperty.test.ts":
/*!******************************************!*\
  !*** ./src/core/sdk/CSSProperty.test.ts ***!
  \******************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('CSSProperty', () => {
    describe('formatStyle', () => {
        const formatStyle = (styleText, indentation = ' ', endIndentation = '') => _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty.formatStyle(styleText, indentation, endIndentation);
    ...
    it('should correctly construct new CSSProperty', () => {
        const stubStyle = {};
        const property1 = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 0, 'display', 'block', false, false, true, false, 'display: block');
        ...
        const property2 = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 1, 'margin', '1px', false, false, true, false, 'margin: 1px', undefined, stubLonghands);
        ...
        const property3 = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 1, 'margin', 'var(--margin)', false, false, true, false, 'margin: var(--margin)', undefined, []);
    ...
    it('should correctly disable CSS property', async () => {
        ...
        const property = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 0, 'margin', '10px', false, false, true, false, 'margin: 10px');
        property.setText = setText;
        await property.setDisabled(true);
        assert.strictEqual(setText.firstCall.firstArg, '/* margin: 10px; */');
        const propertyWithComment = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 0, 'margin', '/* comment */ 10px', false, false, true, false, 'margin: /* comment */ 10px');
        ...
        const propertyWithMultilineComment = new _sdk_js__WEBPACK_IMPORTED_MODULE_1__.CSSProperty.CSSProperty(stubStyle, 0, 'margin', '/* com\nment */ 10px', false, false, true, false, 'margin: /* com\nment */ 10px');
