"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_track_appenders_ThreadAppender_test_ts"],{

/***/ "./src/panels/timeline/track_appenders/ThreadAppender.test.ts":
/*!********************************************************************!*\
  !*** ./src/panels/timeline/track_appenders/ThreadAppender.test.ts ***!
  \********************************************************************/
...
/* harmony import */ var _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../testing/TraceLoader.js */ "./src/testing/TraceLoader.ts");
/* harmony import */ var _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../ui/legacy/components/perf_ui/perf_ui.js */ "./src/ui/legacy/components/perf_ui/perf_ui.ts");
/* harmony import */ var _timeline_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../timeline.js */ "./src/panels/timeline/timeline.ts");
...
function initTrackAppender(flameChartData, traceParsedData, entryData, entryTypeByLevel) {
    ...
    const compatibilityTracksAppender = new _timeline_js__WEBPACK_IMPORTED_MODULE_9__.CompatibilityTracksAppender.CompatibilityTracksAppender(flameChartData, traceParsedData, entryData, entryTypeByLevel);
...
async function renderThreadAppendersFromTrace(context, trace) {
    ...
    const entryData = [];
    const flameChartData = _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_8__.FlameChart.FlameChartTimelineData.createEmpty();
    const { traceData } = await _testing_TraceLoader_js__WEBPACK_IMPORTED_MODULE_7__.TraceLoader.traceEngine(context, trace);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_5__.describeWithEnvironment)('ThreadAppender', function () {
    ...
    it('marks all levels used by the track with the TrackAppender type', async function () {
        ...
        const execptedLevelTypes = [
            _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.EntryType.TrackAppender,
            _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.EntryType.TrackAppender,
            _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.EntryType.TrackAppender,
            _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.EntryType.TrackAppender,
            _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.EntryType.TrackAppender,
    ...
    it('will use the function name from the CPUProfile if it has been set', async function () {
        ...
        const [thread] = process.threads.values();
        const profileCalls = thread.entries.filter(_models_trace_trace_js__WEBPACK_IMPORTED_MODULE_3__.Types.TraceEvents.isProfileCall);
    ...
    it('candy-stripes long tasks', async function () {
        ...
        assert.deepEqual(decorationsForEntry, [
            { type: _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_8__.FlameChart.FlameChartDecorationType.WARNING_TRIANGLE },
            {
                type: _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_8__.FlameChart.FlameChartDecorationType.CANDY,
    ...
    describe('ignore listing', () => {
        ...
        beforeEach(() => {
            const targetManager = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.TargetManager.TargetManager.instance({ forceNew: true });
        ...
        it('appends a tree that contains ignore listed entries correctly', async function () {
            ...
            // |\\\\\B\\\\||----F----|
            // |--E--|
            const callFrameA = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('A', 100, 200);
            const callFrameB = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('IgnoreListedB', 100, 100);
            callFrameB.callFrame.url = SCRIPT_TO_IGNORE;
            const callFrameC = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('IgnoreListedC', 100, 50);
            callFrameC.callFrame.url = SCRIPT_TO_IGNORE;
            const callFrameD = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('IgnoreListedD', 151, 49);
            callFrameD.callFrame.url = SCRIPT_TO_IGNORE;
            const callFrameE = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('E', 100, 25);
            const callFrameF = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeProfileCall)('F', 200, 100);
            const allEntries = [callFrameA, callFrameB, callFrameC, callFrameE, callFrameD, callFrameF];
            const rendererData = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_6__.makeMockRendererHandlerData)(allEntries);
            const workersData = {
            ...
            const entryDataNames = entryData.map(entry => {
                const regularEvent = _timeline_js__WEBPACK_IMPORTED_MODULE_9__.TimelineFlameChartDataProvider.TimelineFlameChartDataProvider.timelineEntryIsTraceEvent(entry);
                if (!regularEvent) {
                    return 'Unknown type';
                }
