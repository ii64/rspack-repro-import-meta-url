"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_NetworkConfigView_ts"],{

/***/ "./src/panels/network/NetworkConfigView.ts":
/*!*************************************************!*\
  !*** ./src/panels/network/NetworkConfigView.ts ***!
  \*************************************************/
...
/* harmony import */ var _settings_emulation_components_components_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../settings/emulation/components/components.js */ "./src/panels/settings/emulation/components/components.ts");
Object(function webpackMissingModule() { var e = new Error("Cannot find module './networkConfigView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class NetworkConfigView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Widget.VBox {
    constructor() {
        super(true);
        this.element.setAttribute('jslog', `${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_6__.panel('network-conditions').track({ resize: true })}`);
    ...
    static createUserAgentSelectAndInput(title) {
        ...
        userAgentSelectElement.setAttribute('jslog', `${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_6__.dropDown().track({ change: true }).context(userAgentSetting.name)}`);
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.ARIAUtils.setLabel(userAgentSelectElement, title);
        const customOverride = { title: i18nString(UIStrings.custom), value: 'custom' };
        userAgentSelectElement.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.createOption(customOverride.title, customOverride.value, 'custom'));
        for (const userAgentDescriptor of userAgentGroups) {
            ...
            for (const userAgentVersion of userAgentDescriptor.values) {
                ...
                groupElement.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.createOption(userAgentVersion.title, userAgentValue, _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_2__.StringUtilities.toKebabCase(userAgentVersion.title)));
            }
        }
        userAgentSelectElement.selectedIndex = 0;
        const otherUserAgentElement = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.createInput('', 'text');
        otherUserAgentElement.setAttribute('jslog', `${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_6__.textField().track({ change: true }).context(userAgentSetting.name)}`);
        otherUserAgentElement.value = userAgentSetting.get();
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Tooltip.Tooltip.install(otherUserAgentElement, userAgentSetting.get());
        otherUserAgentElement.placeholder = i18nString(UIStrings.enterACustomUserAgent);
        otherUserAgentElement.required = true;
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.ARIAUtils.setLabel(otherUserAgentElement, otherUserAgentElement.placeholder);
        const errorElement = document.createElement('div');
        errorElement.classList.add('network-config-input-validation-error');
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.ARIAUtils.markAsAlert(errorElement);
        ...
        function userAgentSelected() {
            ...
            if (value !== customOverride.value) {
                ...
                _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Tooltip.Tooltip.install(otherUserAgentElement, value);
        ...
        function applyOtherUserAgent() {
            if (userAgentSetting.get() !== otherUserAgentElement.value) {
                ...
                _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Tooltip.Tooltip.install(otherUserAgentElement, otherUserAgentElement.value);
                settingChanged();
            }
        }
    ...
    createCacheSection() {
        ...
        section.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.SettingsUI.createSettingCheckbox(i18nString(UIStrings.disableCache), _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().moduleSetting('cache-disabled'), true));
    }
    createNetworkThrottlingSection() {
        ...
        _mobile_throttling_mobile_throttling_js__WEBPACK_IMPORTED_MODULE_7__.ThrottlingManager.throttlingManager().decorateSelectWithNetworkThrottling(networkThrottlingSelect);
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.ARIAUtils.setLabel(networkThrottlingSelect, title);
    }
    createUserAgentSection() {
        ...
        const checkboxLabel = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.CheckboxLabel.create(i18nString(UIStrings.selectAutomatically), true, undefined, customUserAgentSetting.name);
        ...
        const clientHints = new _settings_emulation_components_components_js__WEBPACK_IMPORTED_MODULE_8__.UserAgentClientHintsForm.UserAgentClientHintsForm();
    ...
    createAcceptedEncodingSection() {
        ...
        const customAcceptedEncodingSetting = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('custom-accepted-encodings', `${_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Gzip},${_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Br},${_generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Deflate}`);
        const title = i18nString(UIStrings.acceptedEncoding);
        const section = this.createSection(title, 'network-config-accepted-encoding');
        const checkboxLabel = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.CheckboxLabel.create(i18nString(UIStrings.selectAutomatically), true, undefined, useCustomAcceptedEncodingSetting.name);
        section.appendChild(checkboxLabel);
        const autoCheckbox = checkboxLabel.checkboxElement;
        ...
        encodingsSection.setAttribute('jslog', `${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_6__.section().context(customAcceptedEncodingSetting.name)}`);
        ...
        const contentEncodings = {
            Deflate: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Deflate,
            Gzip: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Gzip,
            Br: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Br,
            Zstd: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Network.ContentEncoding.Zstd,
        };
        for (const encoding of Object.values(contentEncodings)) {
            const label = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.UIUtils.CheckboxLabel.create(encoding, true, undefined, encoding);
    ...
    wasShown() {
        super.wasShown();
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './networkConfigView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.ARIAUtils.alert(i18nString(UIStrings.networkConditionsPanelShown));
    }
}
