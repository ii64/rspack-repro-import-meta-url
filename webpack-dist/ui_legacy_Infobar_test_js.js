...
describe('Infobar', () => {
    ...
    it('shows details message containing a string', () => {
        const component = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Infobar.Infobar("warning" /* UI.Infobar.Type.Warning */, 'This is a warning');
