"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_media_MainView_ts"],{

/***/ "./src/panels/media/MainView.ts":
/*!**************************************!*\
  !*** ./src/panels/media/MainView.ts ***!
  \**************************************/
...
class PlayerDataDownloadManager {
    constructor() {
        Object.defineProperty(this, "playerDataCollection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
class MainView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_1__.Panel.PanelWithSidebar {
    constructor(downloadStore = new PlayerDataDownloadManager()) {
        super('media');
        Object.defineProperty(this, "detailPanels", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "deletedPlayers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "downloadStore", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    addEventListeners(mediaModel) {
        ...
        mediaModel.addEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerPropertiesChanged, this.propertiesChanged, this);
        mediaModel.addEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerEventsAdded, this.eventsAdded, this);
        mediaModel.addEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerMessagesLogged, this.messagesLogged, this);
        mediaModel.addEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerErrorsRaised, this.errorsRaised, this);
        mediaModel.addEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayersCreated, this.playersCreated, this);
    }
    removeEventListeners(mediaModel) {
        mediaModel.removeEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerPropertiesChanged, this.propertiesChanged, this);
        mediaModel.removeEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerEventsAdded, this.eventsAdded, this);
        mediaModel.removeEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerMessagesLogged, this.messagesLogged, this);
        mediaModel.removeEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayerErrorsRaised, this.errorsRaised, this);
        mediaModel.removeEventListener(_MediaModel_js__WEBPACK_IMPORTED_MODULE_2__.Events.PlayersCreated, this.playersCreated, this);
    }
