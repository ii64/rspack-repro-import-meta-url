"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_csp_evaluator_package_lighthouse_lighthouse_checks_test_ts"],{

/***/ "./src/third_party/csp_evaluator/package/lighthouse/lighthouse_checks_test.ts":
/*!************************************************************************************!*\
  !*** ./src/third_party/csp_evaluator/package/lighthouse/lighthouse_checks_test.ts ***!
  \************************************************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './lighthouse_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/**
...
function parsePolicies(policies) {
    return policies.map(p => (new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../parser'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(p)).csp);
}
describe('Test evaluateForFailure', () => {
    it('robust nonce-based policy', () => {
        ...
        const violations = Object(function webpackMissingModule() { var e = new Error("Cannot find module './lighthouse_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(parsePolicies([test]));
    ...
    it('policy not attempt', () => {
        ...
        expect(violations[1].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).HIGH);
    ...
    it('robust policy and not robust policy', () => {
        ...
        const violations = Object(function webpackMissingModule() { var e = new Error("Cannot find module './lighthouse_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(parsePolicies(policies));
        expect(violations.length).toBe(0);
    });
    ...
    it('not robust and not attempt', () => {
        ...
        expect(violations[0].description)
            .toBe(`Missing object-src allows the injection of plugins which can execute JavaScript. Can you set it to 'none'?`);
        expect(violations[1].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).STRICT_CSP);
...
describe('Test evaluateForSyntaxErrors', () => {
    ...
    it('whenShortNonce', () => {
        ...
        expect(violations[0][0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).MEDIUM);
    ...
    it('whenUnknownDirective', () => {
        ...
        expect(violations.length).toBe(1);
        expect(violations[0].length).toBe(1);
        expect(violations[0][0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).SYNTAX);
    ...
    it('whenDeprecatedDirective', () => {
        ...
        expect(violations.length).toBe(1);
        expect(violations[0].length).toBe(1);
        expect(violations[0][0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).INFO);
    ...
    it('manyPolicies', () => {
        ...
        expect(violations[2][0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).MEDIUM);
        expect(violations[2][0].directive).toBe('script-src');
        expect(violations[2][0].description)
            .toBe('Nonces should be at least 8 characters long.');
        expect(violations[2][1].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).SYNTAX);
