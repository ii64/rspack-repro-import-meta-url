"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_markdown_view_CodeBlock_test_ts"],{
...
/***/ "./src/ui/components/markdown_view/CodeBlock.test.ts":
/*!***********************************************************!*\
  !*** ./src/ui/components/markdown_view/CodeBlock.test.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('CodeBlock', () => {
    it('copies the code to clipboard', () => {
        const component = new _markdown_view_js__WEBPACK_IMPORTED_MODULE_3__.CodeBlock.CodeBlock();
        component.code = 'test';
