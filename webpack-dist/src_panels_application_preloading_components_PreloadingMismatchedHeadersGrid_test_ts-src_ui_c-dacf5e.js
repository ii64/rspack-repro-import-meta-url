"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_preloading_components_PreloadingMismatchedHeadersGrid_test_ts-src_ui_c-dacf5e"],{

/***/ "./src/panels/application/preloading/components/PreloadingMismatchedHeadersGrid.test.ts":
/*!**********************************************************************************************!*\
  !*** ./src/panels/application/preloading/components/PreloadingMismatchedHeadersGrid.test.ts ***!
  \**********************************************************************************************/
...
async function renderPreloadingMismatchedHeadersGrid(data) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.PreloadingMismatchedHeadersGrid.PreloadingMismatchedHeadersGrid();
    component.data = data;
...
async function testPreloadingMismatchedHeadersGrid(recievedMismatchedHeaders, rowExpected) {
    ...
    assert.isNotNull(component.shadowRoot);
    (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_2__.assertGridContents)(component, ['Header name', 'Value in initial navigation', 'Value in activation navigation'], rowExpected);
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithEnvironment)('PreloadingMismatchedHeadersGrid', () => {
