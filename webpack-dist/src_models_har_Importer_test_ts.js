"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_har_Importer_test_ts"],{

/***/ "./src/models/har/Importer.test.ts":
/*!*****************************************!*\
  !*** ./src/models/har/Importer.test.ts ***!
  \*****************************************/
...
/* harmony import */ var _har_har_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../har/har.js */ "./src/models/har/har.ts");
// Copyright 2020 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.


const exampleLog = new _har_har_js__WEBPACK_IMPORTED_MODULE_1__.HARFormat.HARLog({
    version: '1.2',
    creator: {
        name: 'WebInspector',
        version: '537.36',
...
describe('HAR Importer', () => {
    let requests;
    before(async () => {
        requests = _har_har_js__WEBPACK_IMPORTED_MODULE_1__.Importer.Importer.requestsFromHARLog(exampleLog);
    });
    ...
    it('Parses the main parts of a Network Request', () => {
        ...
        assert.deepStrictEqual(parsedRequest.initiator(), {
            type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.InitiatorType.Script,
            requestId: '12',
            stack: {
                callFrames: [
                    {
