"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_lighthouse_LighthouseStatusView_ts"],{

/***/ "./src/panels/lighthouse/LighthouseStatusView.ts":
/*!*******************************************************!*\
  !*** ./src/panels/lighthouse/LighthouseStatusView.ts ***!
  \*******************************************************/
...
/* harmony export */   StatusPhases: () => (/* binding */ StatusPhases),
/* harmony export */   StatusView: () => (/* binding */ StatusView),
/* harmony export */   fastFactRotationInterval: () => (/* binding */ fastFactRotationInterval),
/* harmony export */   minimumTextVisibilityDuration: () => (/* binding */ minimumTextVisibilityDuration)
/* harmony export */ });
...
const str_ = _core_i18n_i18n_js__WEBPACK_IMPORTED_MODULE_1__.i18n.registerUIStrings('panels/lighthouse/LighthouseStatusView.ts', UIStrings);
...
class StatusView {
    constructor(panel) {
        ...
        Object.defineProperty(this, "progressWrapper", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "textChangedAt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "fastFactsQueued", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "scheduledFastFactTimeout", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    render() {
        const dialogRoot = _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_2__.UIUtils.createShadowRootWithCoreStyles(this.dialog.contentElement, { cssFile: [Object(function webpackMissingModule() { var e = new Error("Cannot find module './lighthouseDialog.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())], delegatesFocus: undefined });
  ...
  `;
        ...
        this.dialog.setSizeBehavior(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_2__.GlassPane.SizeBehavior.SetExactWidthMaxHeight);
    ...
    show(dialogRenderElement) {
        ...
        const parsedURL = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ParsedURL.ParsedURL.fromString(this.inspectedURL);
    ...
    getMessageForPhase(phase) {
        ...
        const deviceTypeSetting = _LighthouseController_js__WEBPACK_IMPORTED_MODULE_3__.RuntimeSettings.find(item => item.setting.name === 'lighthouse.device-type');
        const throttleSetting = _LighthouseController_js__WEBPACK_IMPORTED_MODULE_3__.RuntimeSettings.find(item => item.setting.name === 'lighthouse.throttling');
...
const fastFactRotationInterval = 6000;
const minimumTextVisibilityDuration = 3000;
