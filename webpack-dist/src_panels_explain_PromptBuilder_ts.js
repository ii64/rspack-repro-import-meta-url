"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_explain_PromptBuilder_ts"],{

/***/ "./src/panels/explain/PromptBuilder.ts":
/*!*********************************************!*\
  !*** ./src/panels/explain/PromptBuilder.ts ***!
  \*********************************************/
...
var _PromptBuilder_consoleMessage;
...
class PromptBuilder {
    constructor(consoleMessage) {
        _PromptBuilder_consoleMessage.set(this, void 0);
        __classPrivateFieldSet(this, _PromptBuilder_consoleMessage, consoleMessage, "f");
    }
    async getNetworkRequest() {
        const requestId = __classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f").consoleMessage().getAffectedResources()?.requestId;
        if (!requestId) {
            return;
        }
    ...
    async getMessageSourceCode() {
        const callframe = __classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f").consoleMessage().stackTrace?.callFrames[0];
        const runtimeModel = __classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f").consoleMessage().runtimeModel();
    ...
    async buildPrompt(sourcesTypes = Object.values(SourceType)) {
        ...
        const stacktrace = sourcesTypes.includes(SourceType.STACKTRACE) ? formatStackTrace(__classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f")) : '';
        const message = formatConsoleMessage(__classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f"));
        ...
        return {
            ...
            isPageReloadRecommended: sourcesTypes.includes(SourceType.NETWORK_REQUEST) &&
                Boolean(__classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f").consoleMessage().getAffectedResources()?.requestId) && !relatedRequest,
        };
    }
...
\`\`\``;
    ...
    getSearchQuery() {
        let message = __classPrivateFieldGet(this, _PromptBuilder_consoleMessage, "f").toMessageTextString();
        if (message) {
...
_PromptBuilder_consoleMessage = new WeakMap();
