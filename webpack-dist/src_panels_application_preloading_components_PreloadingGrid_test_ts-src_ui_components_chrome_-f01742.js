"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_preloading_components_PreloadingGrid_test_ts-src_ui_components_chrome_-f01742"],{

/***/ "./src/panels/application/preloading/components/PreloadingGrid.test.ts":
/*!*****************************************************************************!*\
  !*** ./src/panels/application/preloading/components/PreloadingGrid.test.ts ***!
  \*****************************************************************************/
...
async function assertRenderResult(rowsInput, headerExpected, rowsExpected) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.PreloadingGrid.PreloadingGrid();
    component.update(rowsInput);
    (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_3__.renderElementIntoDOM)(component);
    await coordinator.done();
    return (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_2__.assertGridContents)(component, headerExpected, rowsExpected);
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithEnvironment)('PreloadingGrid', () => {
...
`,
        ...
        const cell = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getCellByIndexes)(grid.shadowRoot, { row: 1, column: 3 });
