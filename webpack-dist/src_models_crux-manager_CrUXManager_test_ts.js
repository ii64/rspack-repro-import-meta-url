"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_crux-manager_CrUXManager_test_ts"],{

/***/ "./src/models/crux-manager/CrUXManager.test.ts":
/*!*****************************************************!*\
  !*** ./src/models/crux-manager/CrUXManager.test.ts ***!
  \*****************************************************/
...
/* harmony import */ var _crux_manager_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./crux-manager.js */ "./src/models/crux-manager/crux-manager.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('CrUXManager', () => {
    ...
    describe('automatic refresh', () => {
        ...
        beforeEach(() => {
            eventBodies = [];
            cruxManager.addEventListener(_crux_manager_js__WEBPACK_IMPORTED_MODULE_4__.Events.FieldDataChanged, event => {
