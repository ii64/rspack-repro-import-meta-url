"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_components_ServiceWorkerRouterView_test_ts"],{

/***/ "./src/panels/application/components/ServiceWorkerRouterView.test.ts":
/*!***************************************************************************!*\
  !*** ./src/panels/application/components/ServiceWorkerRouterView.test.ts ***!
  \***************************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components.js */ "./src/panels/application/components/components.ts");
...
async function renderServiceWorkerRouterView() {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerRouterView.ServiceWorkerRouterView();
    (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
    await coordinator.done();
    return component;
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('ServiceWorkerRouterView', () => {
    const routerRules = [
        {
