"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_components_BreadcrumbsUI_test_ts"],{

/***/ "./src/panels/timeline/components/BreadcrumbsUI.test.ts":
/*!**************************************************************!*\
  !*** ./src/panels/timeline/components/BreadcrumbsUI.test.ts ***!
  \**************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('BreadcrumbsUI', () => {
    const { BreadcrumbsUI } = _components_js__WEBPACK_IMPORTED_MODULE_4__.BreadcrumbsUI;
