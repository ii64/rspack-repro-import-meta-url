"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_elements_components_AnchorFunctionLinkSwatch_test_ts"],{

/***/ "./src/panels/elements/components/AnchorFunctionLinkSwatch.test.ts":
/*!*************************************************************************!*\
  !*** ./src/panels/elements/components/AnchorFunctionLinkSwatch.test.ts ***!
  \*************************************************************************/
...
/* harmony import */ var _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../ui/legacy/components/inline_editor/inline_editor.js */ "./src/ui/legacy/components/inline_editor/inline_editor.ts");
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components.js */ "./src/panels/elements/components/components.ts");
...
function createAnchorFunctionLinkSwatch(props = {}) {
    return new _components_js__WEBPACK_IMPORTED_MODULE_4__.AnchorFunctionLinkSwatch.AnchorFunctionLinkSwatch({
        onLinkActivate: () => { },
        onMouseEnter: () => { },
        onMouseLeave: () => { },
        ...props,
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('AnchorFunctionLinkSwatch', () => {
    describe('when identifier exists', () => {
        let linkSwatchDataStub;
        beforeEach(() => {
            linkSwatchDataStub = sinon.spy(_ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_3__.LinkSwatch.LinkSwatch.prototype, 'data', ['set']);
        });
        afterEach(() => {
