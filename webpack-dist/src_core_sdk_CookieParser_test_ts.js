"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_CookieParser_test_ts"],{

/***/ "./src/core/sdk/CookieParser.test.ts":
/*!*******************************************!*\
  !*** ./src/core/sdk/CookieParser.test.ts ***!
  \*******************************************/
...
/* harmony import */ var _testing_Cookies_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../testing/Cookies.js */ "./src/testing/Cookies.ts");
...
describe('CookieParser', () => {
    function parseAndExpectSetCookies(setCookieString, cookieExpectations) {
        const cookies = _sdk_js__WEBPACK_IMPORTED_MODULE_2__.CookieParser.CookieParser.parseSetCookie(setCookieString);
        if (ensureCookiesExistOrFailTest(cookies)) {
            ...
            for (let i = 0; i < cookieExpectations.length; ++i) {
                (0,_testing_Cookies_js__WEBPACK_IMPORTED_MODULE_1__.expectCookie)(cookies[i], cookieExpectations[i]);
            }
        }
    }
        ...
        describe('handles the SameSite attribute', () => {
            it('with value Lax', () => {
                parseAndExpectSetCookies('cookie1 = value; HttpOnly; Secure; SameSite=Lax', [{
                        ...
                        httpOnly: true,
                        secure: true,
                        sameSite: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.CookieSameSite.Lax,
                        size: 47,
                    }]);
            });
            it('with value None', () => {
                parseAndExpectSetCookies('cookie1 = value; HttpOnly; Secure; SameSite=None', [{
                        ...
                        httpOnly: true,
                        secure: true,
                        sameSite: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.CookieSameSite.None,
                        size: 48,
                    }]);
            });
        ...
        describe('it handles the priority attribute', () => {
            it('with value Low', () => {
                parseAndExpectSetCookies('cookie1=; Path=/; Domain=.example.com; Priority=Low', [{
                        ...
                        path: '/',
                        domain: '.example.com',
                        priority: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.CookiePriority.Low,
                        size: 51,
                    }]);
            });
