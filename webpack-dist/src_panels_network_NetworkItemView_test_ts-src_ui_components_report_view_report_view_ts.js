"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_NetworkItemView_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/NetworkItemView.test.ts":
/*!****************************************************!*\
  !*** ./src/panels/network/NetworkItemView.test.ts ***!
  \****************************************************/
...
/* harmony import */ var _testing_OverridesHelpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../testing/OverridesHelpers.js */ "./src/testing/OverridesHelpers.ts");
...
function renderNetworkItemView(request) {
    ...
    const networkItemView = new _network_js__WEBPACK_IMPORTED_MODULE_6__.NetworkItemView.NetworkItemView(request, {});
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('NetworkItemView', () => {
    beforeEach(() => {
    ...
    it('reveals header in RequestHeadersView', async () => {
        ...
        networkItemView.revealHeader(_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIHeaderSection.Response, 'headerName');
        assert.isTrue(headersViewComponentSpy.calledWith(_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIHeaderSection.Response, 'headerName'));
        networkItemView.detach();
    });
});
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('NetworkItemView', () => {
    let request;
    ...
    it('shows the Response and EventSource tab for text/event-stream requests', () => {
        ...
        const networkItemView = renderNetworkItemView(request);
        assert.isTrue(networkItemView.hasTab(_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIRequestTabs.EventSource));
        assert.isTrue(networkItemView.hasTab(_forward_forward_js__WEBPACK_IMPORTED_MODULE_5__.UIRequestLocation.UIRequestTabs.Response));
        networkItemView.detach();
    });
});
