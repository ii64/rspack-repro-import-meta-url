"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_host_AidaClient_test_ts"],{

/***/ "./src/core/host/AidaClient.test.ts":
/*!******************************************!*\
  !*** ./src/core/host/AidaClient.test.ts ***!
  \******************************************/
...
/* harmony import */ var _host_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./host.js */ "./src/core/host/host.ts");
    ...
    describe('registerClientEvent', () => {
        it('should populate the default value for Aida Client event', async () => {
            ...
            void provider.registerClientEvent({
                ...
                do_conversation_client_event: { user_feedback: { sentiment: _host_js__WEBPACK_IMPORTED_MODULE_1__.AidaClient.Rating.POSITIVE } },
            });
