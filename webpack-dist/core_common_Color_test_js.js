...
describe('Color', () => {
    ...
    it('supports all to all and chain conversions', () => {
        ...
        colors.set("lch" /* Common.Color.Format.LCH */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`lch(${0.2 /* Code.LCH */} 0 0)`));
        colors.set("oklch" /* Common.Color.Format.OKLCH */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`oklch(${0.3 /* Code.OKLCH */} 0 0)`));
        colors.set("lab" /* Common.Color.Format.LAB */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`lab(${0.4 /* Code.LAB */} 0 0)`));
        colors.set("oklab" /* Common.Color.Format.OKLAB */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`oklab(${0.5 /* Code.OKLAB */} 0 0)`));
        colors.set("srgb" /* Common.Color.Format.SRGB */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(srgb ${1 /* Code.SRGB */} 0 0)`));
        colors.set("srgb-linear" /* Common.Color.Format.SRGB_LINEAR */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(srgb-linear ${0.6 /* Code.SRGB_LINEAR */} 0 0)`));
        colors.set("display-p3" /* Common.Color.Format.DISPLAY_P3 */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(display-p3 ${0.7 /* Code.DISPLAY_P3 */} 0 0)`));
        colors.set("a98-rgb" /* Common.Color.Format.A98_RGB */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(a98-rgb ${0.8 /* Code.A98_RGB */} 0 0)`));
        colors.set("prophoto-rgb" /* Common.Color.Format.PROPHOTO_RGB */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(prophoto-rgb ${0.9 /* Code.PROPHOTO_RGB */} 0 0)`));
        colors.set("rec2020" /* Common.Color.Format.REC_2020 */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(rec2020 ${0.91 /* Code.REC_2020 */} 0 0)`));
        colors.set("xyz-d50" /* Common.Color.Format.XYZ_D50 */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz-d50 ${0.92 /* Code.XYZ_D50 */} 0 0)`));
        colors.set("xyz-d65" /* Common.Color.Format.XYZ_D65 */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz-d65 ${0.1 /* Code.XYZ_D65 */} 0 0)`));
        colors.set("xyz" /* Common.Color.Format.XYZ */, _common_js__WEBPACK_IMPORTED_MODULE_0__.Color.parse(`color(xyz ${0.1 /* Code.XYZ */} 0 0)`));
