"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_elements_components_StylePropertyEditor_test_ts"],{

/***/ "./src/panels/elements/components/StylePropertyEditor.test.ts":
/*!********************************************************************!*\
  !*** ./src/panels/elements/components/StylePropertyEditor.test.ts ***!
  \********************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components.js */ "./src/panels/elements/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('StylePropertyEditor', () => {
    ...
    describe('FlexboxEditor', () => {
        it('renders the editor', async () => {
            const component = new _components_js__WEBPACK_IMPORTED_MODULE_2__.StylePropertyEditor.FlexboxEditor();
        ...
        it('allows selecting a property value', async () => {
            ...
            const eventPromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'propertyselected');
        ...
        it('allows deselecting a property value', async () => {
            ...
            const eventPromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'propertydeselected');
            const flexDirectionColumnButton = component.shadowRoot.querySelector('.row .buttons .button:nth-child(2)');
            assert.instanceOf(flexDirectionColumnButton, HTMLButtonElement);
            flexDirectionColumnButton.click();
            const event = await eventPromise;
    ...
    describe('GridEditor', () => {
        it('renders the editor', async () => {
            const component = new _components_js__WEBPACK_IMPORTED_MODULE_2__.StylePropertyEditor.GridEditor();
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
            component.data = {
                authoredProperties: new Map([
                    ['align-content', 'end'],
