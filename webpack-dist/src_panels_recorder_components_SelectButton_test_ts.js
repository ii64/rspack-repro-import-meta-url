"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_recorder_components_SelectButton_test_ts"],{

/***/ "./src/panels/recorder/components/SelectButton.test.ts":
/*!*************************************************************!*\
  !*** ./src/panels/recorder/components/SelectButton.test.ts ***!
  \*************************************************************/
...
describe('SelectButton', () => {
    it('should emit selectbuttonclick event on button click', async () => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.SelectButton.SelectButton();
