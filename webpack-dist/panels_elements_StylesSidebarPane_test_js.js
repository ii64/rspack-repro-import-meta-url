...
/***/ "./panels/elements/StylesSidebarPane.test.js":
/*!***************************************************!*\
  !*** ./panels/elements/StylesSidebarPane.test.js ***!
  \***************************************************/
...
describe('StylesSidebarPane', () => {
    (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('StylesSidebarPane', () => {
        it('unescapes CSS strings', () => {
            assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.unescapeCssString(String.raw `"I\F1 t\EB rn\E2 ti\F4 n\E0 liz\E6 ti\F8 n\2603 \1F308  can be \t\r\ic\k\y"`), '"I\xF1t\xEBrn\xE2ti\xF4n\xE0liz\xE6ti\xF8n\u2603\u{1F308} can be tricky"');
            assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.unescapeCssString(String.raw `"_\DBFF_\\DBFF_\\\DBFF_\\\\DBFF_\\\\\DBFF_"`), '"_\uFFFD_\\DBFF_\\\\DBFF_\\\\\\DBFF_\\\\\\\\DBFF_"');
            assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.unescapeCssString(String.raw `"\0_\DBFF_\DFFF_\110000"`), '"\uFFFD_\uFFFD_\uFFFD_\uFFFD"', 'U+0000, lone surrogates, and values above U+10FFFF should become U+FFFD');
            assert.strictEqual(_elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.unescapeCssString(String.raw `"_\D83C\DF08_"`), '"_\uFFFD\uFFFD_"', 'surrogates should not be combined');
    ...
    describe('IdleCallbackManager', () => {
        ...
        it('schedules callbacks in order', async () => {
            ...
            class QuickIdleCallbackManager extends _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.IdleCallbackManager {
    ...
    (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('CSSPropertyPrompt', () => {
        const CSSPropertyPrompt = _elements_js__WEBPACK_IMPORTED_MODULE_5__.StylesSidebarPane.CSSPropertyPrompt;
        ...
        const noop = () => { };
        (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('value autocompletion', () => {
