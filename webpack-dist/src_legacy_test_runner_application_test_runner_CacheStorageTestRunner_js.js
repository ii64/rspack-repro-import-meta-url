"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_legacy_test_runner_application_test_runner_CacheStorageTestRunner_js"],{

/***/ "./src/legacy_test_runner/application_test_runner/CacheStorageTestRunner.js":
/*!**********************************************************************************!*\
  !*** ./src/legacy_test_runner/application_test_runner/CacheStorageTestRunner.js ***!
  \**********************************************************************************/
...
/* harmony export */   addCacheEntry: () => (/* binding */ addCacheEntry),
/* harmony export */   addCacheEntryWithBlobType: () => (/* binding */ addCacheEntryWithBlobType),
/* harmony export */   addCacheEntryWithNoCorsRequest: () => (/* binding */ addCacheEntryWithNoCorsRequest),
/* harmony export */   addCacheEntryWithVarsResponse: () => (/* binding */ addCacheEntryWithVarsResponse),
...
/* harmony export */   deleteCacheEntry: () => (/* binding */ deleteCacheEntry),
/* harmony export */   deleteCacheFromInspector: () => (/* binding */ deleteCacheFromInspector),
/* harmony export */   dumpCacheTree: () => (/* binding */ dumpCacheTree),
/* harmony export */   dumpCacheTreeNoRefresh: () => (/* binding */ dumpCacheTreeNoRefresh),
/* harmony export */   dumpCachedEntryContent: () => (/* binding */ dumpCachedEntryContent),
/* harmony export */   dumpCachedEntryContentNoRefresh: () => (/* binding */ dumpCachedEntryContentNoRefresh),
/* harmony export */   waitForCacheRefresh: () => (/* binding */ waitForCacheRefresh)
/* harmony export */ });
...
const dumpCacheTree = async function(pathFilter) {
  ...
  const promise =
      TestRunner.addSnifferPromise(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.ServiceWorkerCacheModel.ServiceWorkerCacheModel.prototype, 'updateCacheNames');
...
const dumpCacheTreeNoRefresh = async function(pathFilter) {
  ...
  const cachesTreeElement = _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ResourcesPanel.ResourcesPanel.instance().sidebar.cacheStorageListTreeElement;
...
const dumpCachedEntryContent = async function(cacheName, requestUrl, withHeader) {
  _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ResourcesPanel.ResourcesPanel.instance().sidebar.cacheStorageListTreeElement.expand();
  const promise =
      TestRunner.addSnifferPromise(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.ServiceWorkerCacheModel.ServiceWorkerCacheModel.prototype, 'updateCacheNames');
  _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ResourcesPanel.ResourcesPanel.instance().sidebar.cacheStorageListTreeElement.refreshCaches();
...
const dumpCachedEntryContentNoRefresh = async function(cacheName, requestUrl, withHeader) {
  _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ResourcesPanel.ResourcesPanel.instance().sidebar.cacheStorageListTreeElement.expand();
...
const deleteCacheFromInspector = async function(cacheName, optionalEntry) {
  _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ResourcesPanel.ResourcesPanel.instance().sidebar.cacheStorageListTreeElement.expand();
  ...
  for (let i = 0; i < cachesTreeElement.childCount(); i++) {
    ...
    if (!optionalEntry) {
      promise =
          TestRunner.addSnifferPromise(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.ServiceWorkerCacheModel.ServiceWorkerCacheModel.prototype, 'cacheRemoved');
    ...
    promise = TestRunner.addSnifferPromise(
        _panels_application_application_js__WEBPACK_IMPORTED_MODULE_2__.ServiceWorkerCacheViews.ServiceWorkerCacheView.prototype, 'updateDataCallback');
    let view = cacheTreeElement.view;
...
const waitForCacheRefresh = function(callback) {
  TestRunner.addSniffer(
      _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.ServiceWorkerCacheModel.ServiceWorkerCacheModel.prototype, 'updateCacheNames', callback, false);
};

const createCache = function(cacheName) {
  return TestRunner.callFunctionInPageAsync('createCache', [cacheName]);
};

const addCacheEntry = function(cacheName, requestUrl, responseText) {
  return TestRunner.callFunctionInPageAsync('addCacheEntryImpl', [cacheName, requestUrl, responseText, 'text/plain']);
};

const addCacheEntryWithBlobType = function(cacheName, requestUrl, blobType) {
  return TestRunner.callFunctionInPageAsync('addCacheEntryImpl', [cacheName, requestUrl, 'OK', blobType]);
};

const addCacheEntryWithVarsResponse = function(cacheName, requestUrl) {
  return TestRunner.callFunctionInPageAsync('addCacheEntryWithVarsResponse', [cacheName, requestUrl]);
};

const addCacheEntryWithNoCorsRequest = function(cacheName, requestUrl) {
  return TestRunner.callFunctionInPageAsync('addCacheEntryWithNoCorsRequest', [cacheName, requestUrl]);
};

const deleteCache = function(cacheName) {
  return TestRunner.callFunctionInPageAsync('deleteCache', [cacheName]);
};

const deleteCacheEntry = function(cacheName, requestUrl) {
