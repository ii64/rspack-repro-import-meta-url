...
/***/ "./panels/timeline/TimelineLoader.test.js":
/*!************************************************!*\
  !*** ./panels/timeline/TimelineLoader.test.js ***!
  \************************************************/
...
async function loadWebDevTraceAsFile() {
    const file = new URL(/* asset import */ __webpack_require__(/*! ./fixtures/traces/web-dev.json.gz */ "./panels/timeline/fixtures/traces/web-dev.json.gz?d591"), __webpack_require__.b);
...
async function loadBasicCpuProfileAsFile() {
    const file = new URL(/* asset import */ __webpack_require__(/*! ./fixtures/traces/node-fibonacci-website.cpuprofile.gz */ "./panels/timeline/fixtures/traces/node-fibonacci-website.cpuprofile.gz?5c51"), __webpack_require__.b);
    const response = await fetch(file);
    const asBlob = await response.blob();
...
/***/ "./panels/timeline/fixtures/traces/node-fibonacci-website.cpuprofile.gz?5c51":
/*!******************************************************************************!*\
  !*** ./panels/timeline/fixtures/traces/node-fibonacci-website.cpuprofile.gz ***!
  \******************************************************************************/
...
/***/ "./panels/timeline/fixtures/traces/web-dev.json.gz?d591":
/*!*********************************************************!*\
  !*** ./panels/timeline/fixtures/traces/web-dev.json.gz ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
