"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_ListModel_test_ts"],{

/***/ "./src/ui/legacy/ListModel.test.ts":
/*!*****************************************!*\
  !*** ./src/ui/legacy/ListModel.test.ts ***!
  \*****************************************/
...
describe('ListModel', () => {
    ...
    it('fires an event when elements are replaced', () => {
        const model = new _legacy_js__WEBPACK_IMPORTED_MODULE_0__.ListModel.ListModel([0, 1, 2]);
        let eventData;
        model.addEventListener(_legacy_js__WEBPACK_IMPORTED_MODULE_0__.ListModel.Events.ItemsReplaced, (event) => {
