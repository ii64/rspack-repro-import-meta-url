"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_entrypoints_main_MainImpl_test_ts"],{

/***/ "./src/entrypoints/main/MainImpl.test.ts":
/*!***********************************************!*\
  !*** ./src/entrypoints/main/MainImpl.test.ts ***!
  \***********************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('MainMenuItem', () => {
    ...
    it('includes focus debuggee item when undocked', async () => {
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.DockController.DockController.instance().setDockSide(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.DockController.DockState.UNDOCKED);
    ...
    it('does not include focus debuggee item when docked', async () => {
        _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.DockController.DockController.instance().setDockSide(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.DockController.DockState.BOTTOM);
        const item = _main_js__WEBPACK_IMPORTED_MODULE_5__.MainImpl.MainMenuItem.instance({ forceNew: true }).item();
        assert.exists(item);
