"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_recorder_components_ReplaySection_test_ts"],{

/***/ "./src/panels/recorder/components/ReplaySection.test.ts":
/*!**************************************************************!*\
  !*** ./src/panels/recorder/components/ReplaySection.test.ts ***!
  \**************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components.js */ "./src/panels/recorder/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('ReplaySection', () => {
    ...
    async function createReplaySection() {
        ...
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_4__.ReplaySection.ReplaySection();
    ...
    afterEach(() => {
        settings.speed = _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Normal;
    });
    it('should change the button value when another option is selected in select menu', async () => {
        ...
        assert.strictEqual(selectButton?.value, _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Normal);
        selectButton?.dispatchEvent(new _components_js__WEBPACK_IMPORTED_MODULE_4__.SelectButton.SelectMenuSelectedEvent(_models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow));
        await coordinator.done();
        assert.strictEqual(selectButton?.value, _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow);
    });
    it('should emit startreplayevent on selectbuttonclick event', async () => {
        ...
        const selectButton = component.shadowRoot?.querySelector('devtools-select-button');
        selectButton?.dispatchEvent(new _components_js__WEBPACK_IMPORTED_MODULE_4__.SelectButton.SelectMenuSelectedEvent(_models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow));
        selectButton?.dispatchEvent(new _components_js__WEBPACK_IMPORTED_MODULE_4__.SelectButton.SelectButtonClickEvent());
        const event = await onceClicked;
        assert.deepEqual(event.speed, _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow);
    });
    it('should save the changed button when option is selected in select menu', async () => {
        const component = await createReplaySection();
        const selectButton = component.shadowRoot?.querySelector('devtools-select-button');
        selectButton?.dispatchEvent(new _components_js__WEBPACK_IMPORTED_MODULE_4__.SelectButton.SelectMenuSelectedEvent(_models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow));
        assert.strictEqual(settings.speed, _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow);
    });
    it('should load the saved button on initial render', async () => {
        settings.speed = _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow;
        const component = await createReplaySection();
        const selectButton = component.shadowRoot?.querySelector('devtools-select-button');
        assert.strictEqual(selectButton?.value, _models_models_js__WEBPACK_IMPORTED_MODULE_3__.RecordingPlayer.PlayRecordingSpeed.Slow);
    });
