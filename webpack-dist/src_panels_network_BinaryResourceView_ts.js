"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_BinaryResourceView_ts"],{

/***/ "./src/panels/network/BinaryResourceView.ts":
/*!**************************************************!*\
  !*** ./src/panels/network/BinaryResourceView.ts ***!
  \**************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './binaryResourceView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class BinaryResourceView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Widget.VBox {
    constructor(base64content, contentUrl, resourceType) {
        super();
        Object.defineProperty(this, "binaryResourceViewFactory", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "binaryViewObjects", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "binaryViewTypeSetting", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "binaryViewTypeCombobox", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "copiedText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "addFadeoutSettimeoutId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "lastView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        copyButton.addEventListener(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_5__.Toolbar.ToolbarButton.Events.Click, _event => {
    ...
    wasShown() {
        this.updateView();
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './binaryResourceView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
    }
    updateView() {
...
class BinaryViewObject {
    constructor(type, label, copiedMessage, createViewFn, content) {
        ...
        Object.defineProperty(this, "copiedMessage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "createViewFn", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
