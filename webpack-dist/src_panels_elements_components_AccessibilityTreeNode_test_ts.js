"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_elements_components_AccessibilityTreeNode_test_ts"],{

/***/ "./src/panels/elements/components/AccessibilityTreeNode.test.ts":
/*!**********************************************************************!*\
  !*** ./src/panels/elements/components/AccessibilityTreeNode.test.ts ***!
  \**********************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('AccessibilityTreeNode', () => {
    it('renders role and name correctly for unignored nodes', async () => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.AccessibilityTreeNode.AccessibilityTreeNode();
