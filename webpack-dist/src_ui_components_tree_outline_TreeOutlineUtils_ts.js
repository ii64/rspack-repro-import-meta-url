"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_tree_outline_TreeOutlineUtils_ts"],{

/***/ "./src/ui/components/tree_outline/TreeOutlineUtils.ts":
/*!************************************************************!*\
  !*** ./src/ui/components/tree_outline/TreeOutlineUtils.ts ***!
  \************************************************************/
...
/* harmony export */   findNextNodeForTreeOutlineKeyboardNavigation: () => (/* binding */ findNextNodeForTreeOutlineKeyboardNavigation),
/* harmony export */   getNodeChildren: () => (/* binding */ getNodeChildren),
/* harmony export */   getPathToTreeNode: () => (/* binding */ getPathToTreeNode),
/* harmony export */   isExpandableNode: () => (/* binding */ isExpandableNode),
/* harmony export */   trackDOMNodeToTreeNode: () => (/* binding */ trackDOMNodeToTreeNode)
/* harmony export */ });
 ...
 */
class TrackDOMNodeToTreeNode extends _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.Directive.Directive {
...
const trackDOMNodeToTreeNode = _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_1__.Directive.directive(TrackDOMNodeToTreeNode);
/**
...
const getNodeChildren = async (node) => {
    if (!node.children) {
 ...
 */
const getPathToTreeNode = async (tree, nodeIdToFind) => {
...
const findNextNodeForTreeOutlineKeyboardNavigation = (options) => {
    const { currentDOMNode, currentTreeNode, direction, setNodeExpandedState, } = options;
    if (!currentTreeNode) {
        return currentDOMNode;
    }
    if (direction === _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardUtilities.ArrowKey.DOWN) {
    ...
    else if (direction === _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardUtilities.ArrowKey.RIGHT) {
    ...
    else if (direction === _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardUtilities.ArrowKey.UP) {
    ...
    else if (direction === _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_0__.KeyboardUtilities.ArrowKey.LEFT) {
