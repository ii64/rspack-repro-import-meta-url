...
class MockProtocolBackend {
    ...
    constructor() {
        ...
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Debugger.getScriptSource', this.#getScriptSourceHandler.bind(this));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Runtime.getProperties', this.#getPropertiesHandler.bind(this));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Debugger.setBreakpointByUrl', this.#setBreakpointByUrlHandler.bind(this));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Storage.getStorageKeyForFrame', () => ({ storageKey: 'test-key' }));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Debugger.removeBreakpoint', this.#removeBreakpointHandler.bind(this));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Debugger.resume', () => ({}));
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Debugger.enable', () => ({ debuggerId: 'DEBUGGER_ID' }));
    ...
    async addScript(target, scriptDescription, sourceMap) {
        ...
        (0,_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.dispatchEvent)(target, 'Debugger.scriptParsed', {
            scriptId,
