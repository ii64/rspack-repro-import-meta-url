...
describe('Cookie', () => {
    it('can be instantiated without issues', () => {
        const cookie = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value');
    ...
    it('can be created from a protocol Cookie with all optional fields set', () => {
        ...
        const cookie = _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie.fromProtocolCookie({
            domain: '.example.com',
    ...
    it('can set initialize with a different priority', () => {
        const cookie = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value', null, "High" /* Protocol.Network.CookiePriority.High */);
    ...
    it('can compare partition keys', () => {
        const unpartitionedCookie = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value');
        assert.isFalse(unpartitionedCookie.partitioned());
        assert.isFalse(Boolean(unpartitionedCookie.partitionKey()));
        const partitionedCookie = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value');
        ...
        const differentHasCrossSiteAncestor = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value');
        ...
        const differentTopLevel = new _sdk_js__WEBPACK_IMPORTED_MODULE_0__.Cookie.Cookie('name', 'value');
