...
/***/ "./panels/protocol_monitor/components/JSONEditor.css.js":
/*!**************************************************************!*\
  !*** ./panels/protocol_monitor/components/JSONEditor.css.js ***!
  \**************************************************************/
...
/***/ "./panels/protocol_monitor/components/JSONEditor.js":
/*!**********************************************************!*\
  !*** ./panels/protocol_monitor/components/JSONEditor.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let JSONEditor = class JSONEditor extends LitElement {
    static styles = [_JSONEditor_css_js__WEBPACK_IMPORTED_MODULE_12__["default"]];
    command = '';
    targetId;
    #hintPopoverHelper;
    constructor() {
    ...
    connectedCallback() {
        ...
        this.#hintPopoverHelper = new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.PopoverHelper.PopoverHelper(this, event => this.#handlePopoverDescriptions(event), 'protocol-monitor.hint');
