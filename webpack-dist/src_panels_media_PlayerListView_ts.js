"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_media_PlayerListView_ts"],{

/***/ "./src/panels/media/PlayerListView.ts":
/*!********************************************!*\
  !*** ./src/panels/media/PlayerListView.ts ***!
  \********************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './playerListView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class PlayerListView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_2__.Widget.VBox {
    constructor(mainContainer) {
        super(true);
        Object.defineProperty(this, "playerEntryFragments", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "playerEntriesWithHostnameFrameTitle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "currentlySelectedEntry", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    onProperty(playerID, property) {
        ...
        // videos on the page.
        if (property.name === _PlayerPropertiesView_js__WEBPACK_IMPORTED_MODULE_5__.PlayerPropertyKeys.FrameUrl) {
        ...
        if (property.name === _PlayerPropertiesView_js__WEBPACK_IMPORTED_MODULE_5__.PlayerPropertyKeys.FrameTitle && property.value) {
    ...
    wasShown() {
        super.wasShown();
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './playerListView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
    }
}
