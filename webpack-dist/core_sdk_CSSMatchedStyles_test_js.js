...
/***/ "./core/sdk/CSSMatchedStyles.test.js":
/*!*******************************************!*\
  !*** ./core/sdk/CSSMatchedStyles.test.js ***!
  \*******************************************/
...
function createMatchedStyles(payload) {
    const node = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DOMModel.DOMNode);
    node.id = 1;
    return _sdk_js__WEBPACK_IMPORTED_MODULE_2__.CSSMatchedStyles.CSSMatchedStyles.create({
...
describe('CSSMatchedStyles', () => {
    ...
    it('does not hide inherited rules that also apply directly to the node if it contains custom properties', async () => {
        const parentNode = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DOMModel.DOMNode);
        parentNode.id = 0;
        const node = sinon.createStubInstance(_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DOMModel.DOMNode);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_1__.describeWithMockConnection)('NodeCascade', () => {
