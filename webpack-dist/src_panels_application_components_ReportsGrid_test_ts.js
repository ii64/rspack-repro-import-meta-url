"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_components_ReportsGrid_test_ts"],{

/***/ "./src/panels/application/components/ReportsGrid.test.ts":
/*!***************************************************************!*\
  !*** ./src/panels/application/components/ReportsGrid.test.ts ***!
  \***************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components.js */ "./src/panels/application/components/components.ts");
...
const renderReportsGrid = async (data) => {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_7__.ReportsGrid.ReportsGrid();
    if (data) {
        component.data = data;
    }
    ...
    const controller = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_3__.getElementWithinComponent)(component, 'devtools-data-grid-controller', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_5__.DataGridController.DataGridController);
    assert.isNotNull(controller.shadowRoot);
    const datagrid = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_3__.getElementWithinComponent)(controller, 'devtools-data-grid', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_5__.DataGrid.DataGrid);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithEnvironment)('ReportsGrid', () => {
    ...
    it('renders grid with correct content', async () => {
        ...
        assert.isNotNull(dataGrid.shadowRoot);
        const headerCells = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getHeaderCells)(dataGrid.shadowRoot);
        const values = Array.from(headerCells, getHeaderText);
        assert.deepEqual(values, ['URL', 'Type', 'Status', 'Destination', 'Generated at', 'Body']);
        const rowValues = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getValuesOfAllBodyRows)(dataGrid.shadowRoot);
