"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_components_perf_ui_FlameChart_test_ts"],{
...
/***/ "./src/ui/legacy/components/perf_ui/FlameChart.test.ts":
/*!*************************************************************!*\
  !*** ./src/ui/legacy/components/perf_ui/FlameChart.test.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../testing/TraceHelpers.js */ "./src/testing/TraceHelpers.ts");
/* harmony import */ var _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./perf_ui.js */ "./src/ui/legacy/components/perf_ui/perf_ui.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('FlameChart', () => {
    it('sorts decorations, putting candy striping before warning triangles', async () => {
        const decorations = [
            { type: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.FlameChartDecorationType.WARNING_TRIANGLE },
            { type: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.FlameChartDecorationType.CANDY, startAtTime: _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.Timing.MicroSeconds(10) },
        ];
    ...
    describe('highlightEntry', () => {
        it('updates the chart to highlight the entry and dispatches an event', async () => {
            ...
            chartInstance.addEventListener(_perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.Events.EntryHighlighted, highlightedEventListener);
    ...
    describe('Index to/from coordinates coversion', () => {
        ...
        describe('coordinatesToGroupIndexAndHoverType', () => {
            it('returns the correct group index for given coordinates', () => {
                ...
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 16), { groupIndex: -1, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.OUTSIDE_TRACKS });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 50), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 55), { groupIndex: 1, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
            });
            it('returns the correct group index for given coordinates after re-order', () => {
                ...
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 54), { groupIndex: 1, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 55), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 88), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 89), { groupIndex: -1, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.OUTSIDE_TRACKS });
            });
            it('returns the correct group index and the icon type for given coordinates', () => {
                ...
                // Start of the view
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(0, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
                // End of the title label, For title label checking, the end is included.
                const endOfTitle = /* HEADER_LEFT_PADDING */ 6 + labelWidth;
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(endOfTitle, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(endOfTitle + 1, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK });
                chartInstance.setEditModeForTest(true);
                // Start of the view (before the first icon). Will return the track header.
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(0, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
                // First icon (Up)
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(/* HEADER_LEFT_PADDING */ 6, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.TRACK_CONFIG_UP_BUTTON });
                // Second icon (Down)
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 25, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.TRACK_CONFIG_DOWN_BUTTON });
                // Third icon (Hide)
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE * 2 + GAP_BETWEEN_EDIT_ICONS */ 44, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.TRACK_CONFIG_HIDE_BUTTON });
                // This is after the third icon, which is the start of the title label, so should return INSIDE_TRACK_HEADER
                assert.deepEqual(chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_MODE_TOTAL_ICON_WIDTH */ 60, 17), { groupIndex: 0, hoverType: _perf_ui_js__WEBPACK_IMPORTED_MODULE_4__.FlameChart.HoverType.INSIDE_TRACK_HEADER });
            });
        });
    });
