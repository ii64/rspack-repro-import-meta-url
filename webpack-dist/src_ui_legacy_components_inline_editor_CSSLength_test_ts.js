"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_components_inline_editor_CSSLength_test_ts"],{
...
/***/ "./src/ui/legacy/components/inline_editor/CSSLength.test.ts":
/*!******************************************************************!*\
  !*** ./src/ui/legacy/components/inline_editor/CSSLength.test.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
describe('CSSLength', () => {
    it('can render CSSLength component correctly', () => {
        const component = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLength.CSSLength();
    ...
    describe('#CSSLengthUtils', () => {
        it('parses CSS properties with length correctly', () => {
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('42px'), { value: 42, unit: _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.LengthUnit.PIXEL });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('-5vw'), { value: -5, unit: _inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.LengthUnit.VW });
