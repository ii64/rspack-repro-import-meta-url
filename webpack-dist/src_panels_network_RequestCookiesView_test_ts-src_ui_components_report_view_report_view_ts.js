"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_RequestCookiesView_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/RequestCookiesView.test.ts":
/*!*******************************************************!*\
  !*** ./src/panels/network/RequestCookiesView.test.ts ***!
  \*******************************************************/
...
function renderCookiesView(request) {
    const component = new _network_js__WEBPACK_IMPORTED_MODULE_4__.RequestCookiesView.RequestCookiesView(request);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('RequestCookiesView', () => {
    beforeEach(() => {
    ...
    it('show a message when request site has cookies in another partition', () => {
        const request = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.NetworkRequest.NetworkRequest.create('requestId', 'https://www.example.com/foo.html', '', null, null, null);
