"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_lantern_metrics_TBTUtils_test_ts"],{

/***/ "./src/models/trace/lantern/metrics/TBTUtils.test.ts":
/*!***********************************************************!*\
  !*** ./src/models/trace/lantern/metrics/TBTUtils.test.ts ***!
  \***********************************************************/
...
/* harmony import */ var _TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TBTUtils.js */ "./src/models/trace/lantern/metrics/TBTUtils.ts");
...
describe('TotalBlockingTime utils', () => {
    it('reports 0 when no task is longer than 50ms', () => {
        ...
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)(events, fcpTimeMs, interactiveTimeMs))
            .to.equal(0);
    });
    ...
    it('clips properly if TTI falls in the middle of a task', () => {
        ...
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 1951, end: 2100, duration: 149 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(0); // Duration after clipping is 49, which is < 50.
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 1950, end: 2100, duration: 150 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(0); // Duration after clipping is 50, so time after 50ms is 0ms.
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 1949, end: 2100, duration: 151 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(1); // Duration after clipping is 51, so time after 50ms is 1ms.
    });
    it('clips properly if FCP falls in the middle of a task', () => {
        const fcpTimeMs = 1000;
        const interactiveTimeMs = 2000;
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 900, end: 1049, duration: 149 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(0); // Duration after clipping is 49, which is < 50.
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 900, end: 1050, duration: 150 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(0); // Duration after clipping is 50, so time after 50ms is 0ms.
        expect((0,_TBTUtils_js__WEBPACK_IMPORTED_MODULE_0__.calculateSumOfBlockingTime)([{ start: 900, end: 1051, duration: 151 }], fcpTimeMs, interactiveTimeMs))
            .to.equal(1); // Duration after clipping is 51, so time after 50ms is 1ms.
    });
