"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_docs_report_basic_ts"],{

/***/ "./src/ui/components/docs/report/basic.ts":
/*!************************************************!*\
  !*** ./src/ui/components/docs/report/basic.ts ***!
  \************************************************/
...
/* harmony import */ var _report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../report_view/report_view.js */ "./src/ui/components/report_view/report_view.ts");
...
const exampleRenderHelper = (key, value) => _lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_0__.html `
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>${key}</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName}>${value}</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName}>
        `;
...
_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_0__.render(_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_0__.html `
        ...
        <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.Report.litTagName} .data=${{
    reportTitle: 'Optional Title',
}}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionHeader.litTagName}>Section 1</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionHeader.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>Basic plain text field</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName}>And this is the value</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>A field with a code value</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportKey.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName} class="source-code">SomeCodeValue</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportValue.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionDivider.litTagName}></${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionDivider.litTagName}>
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionHeader.litTagName}>Section 2</${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionHeader.litTagName}>
          ...
          <${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionDivider.litTagName}></${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.ReportSectionDivider.litTagName}>
        </${_report_view_report_view_js__WEBPACK_IMPORTED_MODULE_2__.ReportView.Report.litTagName}>
      `, container);
