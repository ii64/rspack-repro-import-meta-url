"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_elements_components_ElementsTreeExpandButton_test_ts"],{

/***/ "./src/panels/elements/components/ElementsTreeExpandButton.test.ts":
/*!*************************************************************************!*\
  !*** ./src/panels/elements/components/ElementsTreeExpandButton.test.ts ***!
  \*************************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('Elements tree expand button', () => {
    it('render and click handler trigger correctly', async () => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.ElementsTreeExpandButton.ElementsTreeExpandButton();
        let clicks = 0;
