...
/***/ "./ui/legacy/components/color_picker/ColorFormatSpec.test.js":
/*!*******************************************************************!*\
  !*** ./ui/legacy/components/color_picker/ColorFormatSpec.test.js ***!
  \*******************************************************************/
...
describe('ColorFormatSpec for inputs', () => {
    describe('rgb/rgba() format', () => {
        it('should return rounded numbers between 0 - 255 as input values and rounded alpha', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["rgb" /* Common.Color.Format.RGB */];
    ...
    describe('hsl/hsla() format', () => {
        it('should return rounded numbers with percentages', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["hsl" /* Common.Color.Format.HSL */];
            const values = spec.toValues(color);
    ...
    describe('hwb() format', () => {
        it('should return rounded numbers with percentages', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["hwb" /* Common.Color.Format.HWB */];
            const values = spec.toValues(color);
    ...
    describe('lch() format', () => {
        it('should return values', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["lch" /* Common.Color.Format.LCH */];
            const values = spec.toValues(color);
    ...
    describe('oklch() format', () => {
        it('should return values', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["oklch" /* Common.Color.Format.OKLCH */];
            const values = spec.toValues(color);
    ...
    describe('lab() format', () => {
        it('should return values', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["lab" /* Common.Color.Format.LAB */];
            const values = spec.toValues(color);
            assert.deepEqual(values, ['21', '98', '0', '1']);
        });
        it('should create the color from the input values', () => {
    ...
    describe('oklab() format', () => {
        it('should return values', () => {
            ...
            assert.exists(color);
            const spec = _color_picker_js__WEBPACK_IMPORTED_MODULE_1__.ColorFormatSpec.colorFormatSpec["oklab" /* Common.Color.Format.OKLAB */];
            const values = spec.toValues(color);
