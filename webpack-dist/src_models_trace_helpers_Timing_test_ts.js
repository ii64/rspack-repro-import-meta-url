"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_helpers_Timing_test_ts"],{

/***/ "./src/models/trace/helpers/Timing.test.ts":
/*!*************************************************!*\
  !*** ./src/models/trace/helpers/Timing.test.ts ***!
  \*************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('Timing helpers', () => {
    describe('Timing conversions', () => {
        ...
        it('can convert seconds to microseconds', () => {
            ...
            const expected = _trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.Timing.MicroSeconds(1000000);
        ...
        it('can convert microSeconds milliseconds', () => {
            const input = _trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.Timing.MicroSeconds(1000000);
            const expected = _trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.Timing.MilliSeconds(1000);
    ...
    it('eventTimingsSeconds returns the right numbers', async () => {
        const event = {
            ts: 100000, // 100k microseconds = 100ms = 0.1second
            dur: 50000, // 50k microseconds = 50ms = 0.05second
        };
