...
/***/ "./models/trace/helpers/SamplesIntegrator.test.js":
/*!********************************************************!*\
  !*** ./models/trace/helpers/SamplesIntegrator.test.js ***!
  \********************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('SamplesIntegrator', function () {
    ...
    describe('buildProfileCalls', () => {
        ...
        it('creates JS profile calls with a top-level V8 invocation', () => {
            ...
            //                 |-b-|
            const integrator = new _trace_js__WEBPACK_IMPORTED_MODULE_4__.Helpers.SamplesIntegrator.SamplesIntegrator(parsedBasicProfile, PROFILE_ID, pid, tid);
            const callEvent = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("FunctionCall" /* TraceModel.Types.TraceEvents.KnownEventName.FunctionCall */, 0, 500);
        ...
        it('creates JS frame events for mixed with/without top-level events', () => {
            ...
            const callEvent = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("FunctionCall" /* TraceModel.Types.TraceEvents.KnownEventName.FunctionCall */, 250, 250);
            const traceEvents = [callEvent];
            const constructedCalls = integrator.buildProfileCalls(traceEvents);
            assert.strictEqual(constructedCalls.length, 2);
            assert.strictEqual(constructedCalls[0].callFrame.functionName, 'a');
        ...
        it('creates JS frame events with v8.run trace event as parent', () => {
            ...
            const parsedProfile = new _models_cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_0__.CPUProfileDataModel.CPUProfileDataModel(cdpProfile);
            const integrator = new _trace_js__WEBPACK_IMPORTED_MODULE_4__.Helpers.SamplesIntegrator.SamplesIntegrator(parsedProfile, PROFILE_ID, pid, tid);
            const evaluateScript = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("EvaluateScript" /* TraceModel.Types.TraceEvents.KnownEventName.EvaluateScript */, 0, 500);
        ...
        it('restarts the call frame stack when a new top level event is encountered', () => {
            ...
            //                                |-----------a------------|
            //                                |-----------b------------|
            const runTask = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("RunTask" /* TraceModel.Types.TraceEvents.KnownEventName.RunTask */, 0, 100);
            const evaluateScript = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("EvaluateScript" /* TraceModel.Types.TraceEvents.KnownEventName.EvaluateScript */, 0, 100);
            const runMicroTasks = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_2__.makeCompleteEvent)("RunMicrotasks" /* TraceModel.Types.TraceEvents.KnownEventName.RunMicrotasks */, 50, 100);
