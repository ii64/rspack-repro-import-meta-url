"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_protocol_monitor_components_JSONEditor_test_ts"],{

/***/ "./src/panels/protocol_monitor/components/JSONEditor.test.ts":
/*!*******************************************************************!*\
  !*** ./src/panels/protocol_monitor/components/JSONEditor.test.ts ***!
  \*******************************************************************/
...
/* harmony import */ var _testing_ExpectStubCall_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../testing/ExpectStubCall.js */ "./src/testing/ExpectStubCall.ts");
...
/* harmony import */ var _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../protocol_monitor.js */ "./src/panels/protocol_monitor/protocol_monitor.ts");
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components.js */ "./src/panels/protocol_monitor/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('JSONEditor', () => {
    const renderJSONEditor = () => {
        const jsonEditor = new _components_js__WEBPACK_IMPORTED_MODULE_8__.JSONEditor.JSONEditor();
    ...
    const populateMetadata = async (jsonEditor) => {
        ...
        const metadataByCommand = _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__.ProtocolMonitor.buildProtocolMetadata(mockDomain);
    ...
    describe('Binding input bar', () => {
        it('should show the command written in the input bar inside the editor when parameters are strings with the correct value', async () => {
            ...
            const { command, parameters } = _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__.ProtocolMonitor.parseCommandInput(JSON.stringify(cdpCommand));
        ...
        it('does not output parameters if the input is invalid json', async () => {
            ...
            const { command, parameters } = _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__.ProtocolMonitor.parseCommandInput(cdpCommand);
            const { inputs } = await renderEditorForCommand(command, parameters);
    ...
    describe('Display command written in editor inside input bar', () => {
        it('should display the command edited inside the CDP editor into the input bar', async () => {
            const split = new _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_6__.SplitWidget.SplitWidget(true, false, 'protocol-monitor-split-container', 400);
            const editorWidget = new _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__.ProtocolMonitor.EditorWidget();
            const jsonEditor = editorWidget.jsonEditor;
            jsonEditor.command = 'Test.test';
            jsonEditor.parameters = [
                {
                    name: 'test',
                    type: _components_js__WEBPACK_IMPORTED_MODULE_8__.JSONEditor.ParameterType.String,
                    description: 'test',
                    optional: false,
                    value: 'test',
                },
            ];
            const dataGrid = new _protocol_monitor_js__WEBPACK_IMPORTED_MODULE_7__.ProtocolMonitor.ProtocolMonitorDataGrid(split);
    ...
    describe('Send parameters in a correct format', () => {
        it('should return the parameters in a format understandable by the ProtocolMonitor when sending a command via CTRL + Enter', async () => {
            ...
            jsonEditor.parameters = inputParameters;
            const responsePromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getEventPromise)(jsonEditor, _components_js__WEBPACK_IMPORTED_MODULE_8__.JSONEditor.SubmitEditorEvent.eventName);
            (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.dispatchKeyDownEvent)(jsonEditor, { key: 'Enter', ctrlKey: true, metaKey: true });
        ...
        it('should return the parameters in a format understandable by the ProtocolMonitor when sending a command via the send button', async () => {
            ...
            const event = new _components_js__WEBPACK_IMPORTED_MODULE_8__.Toolbar.SendCommandEvent();
            const responsePromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getEventPromise)(jsonEditor, _components_js__WEBPACK_IMPORTED_MODULE_8__.JSONEditor.SubmitEditorEvent.eventName);
    ...
    it('checks that the selection of a target works', async () => {
        ...
        const event = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_4__.SelectMenu.SelectMenuItemSelectedEvent('target1');
        const shadowRoot = jsonEditor.renderRoot;
    ...
    it('should copy the CDP command to clipboard via copy event', async () => {
        ...
        const event = new _components_js__WEBPACK_IMPORTED_MODULE_8__.Toolbar.CopyCommandEvent();
        toolbar.dispatchEvent(event);
...
/***/ "./src/panels/protocol_monitor/protocol_monitor.ts":
/*!*********************************************************!*\
  !*** ./src/panels/protocol_monitor/protocol_monitor.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _ProtocolMonitor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProtocolMonitor.js */ "./src/panels/protocol_monitor/ProtocolMonitor.ts");
