"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_FilePathScoreFunction_test_ts"],{

/***/ "./src/panels/sources/FilePathScoreFunction.test.ts":
/*!**********************************************************!*\
  !*** ./src/panels/sources/FilePathScoreFunction.test.ts ***!
  \**********************************************************/
...
/* harmony import */ var _sources_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sources.js */ "./src/panels/sources/sources.ts");
    ...
    describe('score', () => {
        ...
        it('should match highlights and score', () => {
            ...
            for (let i = 0; i < testQueries.length; ++i) {
                const highlights = new Array();
                const filePathScoreFunction = new _sources_js__WEBPACK_IMPORTED_MODULE_0__.FilePathScoreFunction.FilePathScoreFunction(testQueries[i][0]);
        ...
        it('should return correct scores', () => {
            // ported from third_party/blink/web_tests/http/tests/devtools/components/file-path-scoring.js
            const filePathScoreFunction = new _sources_js__WEBPACK_IMPORTED_MODULE_0__.FilePathScoreFunction.FilePathScoreFunction('execontext');
