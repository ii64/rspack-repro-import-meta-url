"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_render_coordinator_render_coordinator_test_ts"],{

/***/ "./src/ui/components/render_coordinator/render_coordinator.test.ts":
/*!*************************************************************************!*\
  !*** ./src/ui/components/render_coordinator/render_coordinator.test.ts ***!
  \*************************************************************************/
...
/* harmony import */ var _render_coordinator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render_coordinator.js */ "./src/ui/components/render_coordinator/render_coordinator.ts");
...
describe('Render Coordinator', () => {
    let coordinator;
    beforeEach(() => {
        coordinator = _render_coordinator_js__WEBPACK_IMPORTED_MODULE_0__.RenderCoordinator.RenderCoordinator.instance({ forceNew: true });
