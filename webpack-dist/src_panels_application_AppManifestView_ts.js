"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_AppManifestView_ts"],{

/***/ "./src/panels/application/AppManifestView.ts":
/*!***************************************************!*\
  !*** ./src/panels/application/AppManifestView.ts ***!
  \***************************************************/
...
/* harmony import */ var _ui_legacy_components_inline_editor_inline_editor_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../ui/legacy/components/inline_editor/inline_editor.js */ "./src/ui/legacy/components/inline_editor/inline_editor.ts");
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './appManifestView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class AppManifestView extends _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ObjectWrapper.eventMixin(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.Widget.VBox) {
    constructor(emptyView, reportView, throttler) {
        super(true);
        Object.defineProperty(this, "emptyView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "errorsSection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "installabilitySection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "identitySection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "presentationSection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "iconsSection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "windowControlsSection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "protocolHandlersSection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "shortcutSections", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "screenshotsSections", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "shortNameField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "startURLField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "themeColorSwatch", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "backgroundColorSwatch", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "orientationField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "newNoteUrlField", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "protocolHandlersView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    targetAdded(target) {
        ...
        this.registeredListeners = [
            ...
            this.serviceWorkerManager.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.ServiceWorkerManager.Events.RegistrationUpdated, () => {
    ...
    async updateManifest(immediately) {
        ...
        void this.throttler.schedule(() => this.renderManifest(url, data, errors, installabilityErrors, appId), immediately ? _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Throttler.Scheduling.AsSoonAsPossible : _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Throttler.Scheduling.Default);
    }
    ...
    wasShown() {
        super.wasShown();
        this.reportView.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './appManifestView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './appManifestView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
    }
    async appendWindowControlsToSection(overlayModel, url, themeColor) {
        ...
        osSelectElement.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.UIUtils.createOption('Windows', _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.OverlayModel.EmulatedOSType.WindowsOS, 'windows'));
        osSelectElement.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.UIUtils.createOption('macOS', _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.OverlayModel.EmulatedOSType.MacOS, 'macos'));
        osSelectElement.appendChild(_ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_8__.UIUtils.createOption('Linux', _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.OverlayModel.EmulatedOSType.LinuxOS, 'linux'));
