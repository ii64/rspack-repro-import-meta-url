"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_timeline_track_appenders_InteractionsTrackAppender_test_ts"],{

/***/ "./src/panels/timeline/track_appenders/InteractionsTrackAppender.test.ts":
/*!*******************************************************************************!*\
  !*** ./src/panels/timeline/track_appenders/InteractionsTrackAppender.test.ts ***!
  \*******************************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('InteractionsTrackAppender', function () {
    ...
    describe('appendTrackAtLevel', function () {
        ...
        it('adds total times correctly', async function () {
            ...
            for (const event of events) {
                const markerIndex = entryData.indexOf(event);
                assert.exists(markerIndex);
                const expectedTotalTimeForEvent = _models_trace_trace_js__WEBPACK_IMPORTED_MODULE_0__.Helpers.Timing.microSecondsToMilliseconds((event.dur || 0));
    ...
    it('candy-stripes and adds warning triangles to long interactions', async function () {
        ...
        assert.deepEqual(decorationsForEntry, [
            {
                type: _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_3__.FlameChart.FlameChartDecorationType.CANDY,
            ...
            {
                type: _ui_legacy_components_perf_ui_perf_ui_js__WEBPACK_IMPORTED_MODULE_3__.FlameChart.FlameChartDecorationType.WARNING_TRIANGLE,
