"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_cpu_profile_CPUProfileDataModel_test_ts"],{

/***/ "./src/models/cpu_profile/CPUProfileDataModel.test.ts":
/*!************************************************************!*\
  !*** ./src/models/cpu_profile/CPUProfileDataModel.test.ts ***!
  \************************************************************/
...
/* harmony import */ var _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../cpu_profile/cpu_profile.js */ "./src/models/cpu_profile/cpu_profile.ts");
...
describe('ProfileTreeModel', function () {
    it('calculates self and total times correctly for a CPU profile', () => {
        ...
        const root = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameRoot);
        root.self = 10;
        const callFrameA = makeCallFrame('A');
        const nodeA = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameA);
        root.children.push(nodeA);
        nodeA.self = 0;
        const callFrameB = makeCallFrame('B');
        const nodeB = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameB);
        nodeA.children.push(nodeB);
        nodeB.self = 20;
        const callFrameC = makeCallFrame('C');
        const nodeC = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameC);
        nodeA.children.push(nodeC);
        nodeC.self = 10;
        const callFrameD = makeCallFrame('D');
        const nodeD = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameD);
        root.children.push(nodeD);
        nodeD.self = 10;
        const callFrameE = makeCallFrame('E');
        const nodeE = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameE);
        nodeD.children.push(nodeE);
        nodeE.self = 20;
        const profileTreeModel = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileTreeModel();
    ...
    it('calculates depth correctly for the nodes in a profile tree', () => {
        ...
        const nodeF = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.ProfileTreeModel.ProfileNode(callFrameF);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_0__.describeWithEnvironment)('CPUProfileDataModel', () => {
    ...
    it('builds a tree from a CPU profile', () => {
        ...
        //              \
        //               7
        const cpuProfileDataModel = new _cpu_profile_cpu_profile_js__WEBPACK_IMPORTED_MODULE_1__.CPUProfileDataModel.CPUProfileDataModel(profile);
