"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_code_highlighter_CodeHighlighter_test_ts"],{

/***/ "./src/ui/components/code_highlighter/CodeHighlighter.test.ts":
/*!********************************************************************!*\
  !*** ./src/ui/components/code_highlighter/CodeHighlighter.test.ts ***!
  \********************************************************************/
...
/* harmony import */ var _code_highlighter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./code_highlighter.js */ "./src/ui/components/code_highlighter/code_highlighter.ts");
...
function testHighlight(code, mimeType) {
    return async () => {
        ...
        const highlighter = await _code_highlighter_js__WEBPACK_IMPORTED_MODULE_0__.CodeHighlighter.create(rawCode, mimeType);
        let i = 0;
    ...
    describe('languageFromMIMEType', () => {
        it('also supports common legacy MIME types for JavaScript', async () => {
            for (const mimeType of ['application/ecmascript', 'application/javascript', 'text/jscript']) {
                const language = await _code_highlighter_js__WEBPACK_IMPORTED_MODULE_0__.CodeHighlighter.languageFromMIME(mimeType);
