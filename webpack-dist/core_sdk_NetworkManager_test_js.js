...
/***/ "./core/sdk/NetworkManager.test.js":
/*!*****************************************!*\
  !*** ./core/sdk/NetworkManager.test.js ***!
  \*****************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('MultitargetNetworkManager', () => {
    describe('Trust Token done event', () => {
        it('is not lost when arriving before the corresponding requestWillBeSent event', () => {
            ...
            const networkManager = new _common_common_js__WEBPACK_IMPORTED_MODULE_7__.ObjectWrapper.ObjectWrapper();
            const startedRequests = [];
            networkManager.addEventListener(_sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.Events.RequestStarted, event => {
                startedRequests.push(event.data.request);
            });
            const networkDispatcher = new _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.NetworkDispatcher(networkManager);
    ...
    it('uses main frame to get certificate', () => {
        ...
        const tabTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)({ type: _sdk_js__WEBPACK_IMPORTED_MODULE_9__.Target.Type.Tab });
        const mainFrameTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)({ parentTarget: tabTarget });
        const prerenderTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)({ parentTarget: tabTarget, subtype: 'prerender' });
        const subframeTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)({ parentTarget: mainFrameTarget, subtype: '' });
...
describe('NetworkDispatcher', () => {
    ...
    (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithEnvironment)('request', () => {
    ...
    (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.describeWithEnvironment)('WebBundle requests', () => {
        let networkDispatcher;
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('InterceptedRequest', () => {
    let target;
    ...
    async function checkRequestOverride(target, request, requestId, responseStatusCode, responseHeaders, responseBody, expectedOverriddenResponse, expectedSetCookieHeaders = []) {
        const multitargetNetworkManager = _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.MultitargetNetworkManager.instance();
        ...
        const networkRequest = _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkRequest.NetworkRequest.create(requestId, request.url, request.url, null, null, null);
        ...
        const interceptedRequest = new _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.InterceptedRequest(fetchAgent, request, "Document" /* Protocol.Network.ResourceType.Document */, requestId, networkRequest, responseStatusCode, filteredResponseHeaders);
        interceptedRequest.responseBody = async () => {
            return new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData(responseBody, false, 'text/html');
        };
    ...
    beforeEach(async () => {
        ...
        const networkPersistenceManager = await (0,_testing_OverridesHelpers_js__WEBPACK_IMPORTED_MODULE_6__.createWorkspaceProject)('file:///path/to/overrides', [
            ...
            { name: 'index.html', path: 'file:/usr/local/example/', content: 'Overridden file content' },
            {
                ...
                content: `[
            {
              "applyTo": "index.html-${_platform_platform_js__WEBPACK_IMPORTED_MODULE_8__.StringUtilities.hashCode('www.longurl.com/' + LONG_URL_PART).toString(16)}.html",
              "headers": [{
            ...
            {
                name: `index.html-${_platform_platform_js__WEBPACK_IMPORTED_MODULE_8__.StringUtilities.hashCode('www.longurl.com/' + LONG_URL_PART).toString(16)}.html`,
                path: 'www.longurl.com/longurls/',
            ...
            },
            {
                ...
                content: `[
            {
              "applyTo": "index.html-${_platform_platform_js__WEBPACK_IMPORTED_MODULE_8__.StringUtilities.hashCode(_models_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_1__.NetworkPersistenceManager.NetworkPersistenceManager
    ...
    it('does not intercept OPTIONS requests', async () => {
        ...
        const networkRequest = _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkRequest.NetworkRequest.create(requestId, request.url, request.url, null, null, null);
        const interceptedRequest = new _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.InterceptedRequest(fetchAgent, request, "Document" /* Protocol.Network.ResourceType.Document */, requestId, networkRequest);
        interceptedRequest.responseBody = async () => {
            return new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData('interceptedRequest content', false, 'text/html');
        };
        assert.isTrue(continueRequestSpy.notCalled);
        await _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.MultitargetNetworkManager.instance().requestIntercepted(interceptedRequest);
        assert.isTrue(fulfillRequestSpy.notCalled);
    ...
    describe('NetworkPersistenceManager', () => {
        it('decodes the intercepted response body with the right charset', async () => {
            ...
            const networkProject = new _models_bindings_bindings_js__WEBPACK_IMPORTED_MODULE_0__.ContentProviderBasedProject.ContentProviderBasedProject(_models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_3__.Workspace.WorkspaceImpl.instance(), 'testing-network', _models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_3__.Workspace.projectTypes.Network, 'Override network project', false);
            _models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_3__.Workspace.WorkspaceImpl.instance().addProject(networkProject);
            const uiSourceCode = networkProject.createUISourceCode('https://www.example.com/utf16.html', _common_common_js__WEBPACK_IMPORTED_MODULE_7__.ResourceType.resourceTypes.Document);
            networkProject.addUISourceCode(uiSourceCode);
            const interceptedRequest = new _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.InterceptedRequest(fetchAgent, request, "Document" /* Protocol.Network.ResourceType.Document */, requestId, networkRequest, 200, [{ name: 'content-type', value: 'text/html; charset-utf-16' }]);
            interceptedRequest.responseBody = async () => {
                // Very simple HTML doc base64 encoded.
                return new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_2__.ContentData.ContentData('//48ACEARABPAEMAVABZAFAARQAgAGgAdABtAGwAPgAKADwAcAA+AEkA8QB0AOsAcgBuAOIAdABpAPQAbgDgAGwAaQB6AOYAdABpAPgAbgADJjTYBt88AC8AcAA+AAoA', true, 'text/html', 'utf-16');
            };
            await _sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.MultitargetNetworkManager.instance().requestIntercepted(interceptedRequest);
            const content = await _models_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_1__.NetworkPersistenceManager.NetworkPersistenceManager.instance()
    ...
    it('marks both requests as overridden when there are 2 requests with the same URL', async () => {
        ...
        const { dispatcher } = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_9__.NetworkManager.NetworkManager);
