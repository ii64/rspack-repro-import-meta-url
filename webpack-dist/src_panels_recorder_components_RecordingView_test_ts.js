"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_recorder_components_RecordingView_test_ts"],{

/***/ "./src/panels/recorder/components/RecordingView.test.ts":
/*!**************************************************************!*\
  !*** ./src/panels/recorder/components/RecordingView.test.ts ***!
  \**************************************************************/
...
/* harmony import */ var _converters_converters_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../converters/converters.js */ "./src/panels/recorder/converters/converters.ts");
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components.js */ "./src/panels/recorder/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('RecordingView', () => {
    ...
    const recorderSettingsMock = {
        preferredCopyFormat: _models_models_js__WEBPACK_IMPORTED_MODULE_7__.ConverterIds.ConverterIds.JSON,
    };
    async function renderView() {
        const view = new _components_js__WEBPACK_IMPORTED_MODULE_8__.RecordingView.RecordingView();
        recorderSettingsMock.preferredCopyFormat = _models_models_js__WEBPACK_IMPORTED_MODULE_7__.ConverterIds.ConverterIds.JSON;
    ...
    async function changeCodeView(view) {
        ...
        assert.ok(menu);
        const event = new _ui_components_menus_menus_js__WEBPACK_IMPORTED_MODULE_4__.SelectMenu.SelectMenuItemSelectedEvent(_models_models_js__WEBPACK_IMPORTED_MODULE_7__.ConverterIds.ConverterIds.Replay);
    ...
    it('should show code and change preferred copy method', async () => {
        ...
        await waitForTextEditor(view);
        assert.notEqual(recorderSettingsMock.preferredCopyFormat, _models_models_js__WEBPACK_IMPORTED_MODULE_7__.ConverterIds.ConverterIds.JSON);
    });
});
