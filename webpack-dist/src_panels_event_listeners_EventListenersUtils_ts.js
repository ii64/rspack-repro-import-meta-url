"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_event_listeners_EventListenersUtils_ts"],{

/***/ "./src/panels/event_listeners/EventListenersUtils.ts":
/*!***********************************************************!*\
  !*** ./src/panels/event_listeners/EventListenersUtils.ts ***!
  \***********************************************************/
...
/* harmony export */   frameworkEventListeners: () => (/* binding */ frameworkEventListeners)
/* harmony export */ });
...
async function frameworkEventListeners(object) {
    const domDebuggerModel = object.runtimeModel().target().model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMDebuggerModel.DOMDebuggerModel);
    if (!domDebuggerModel) {
    ...
    function convertToEventListeners(pageEventListenersObject) {
        return _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.RemoteObject.RemoteArray.objectAsArray(pageEventListenersObject)
            .map(toEventListener)
        ...
        function toEventListener(listenerObject) {
            ...
            function createEventListener() {
                ...
                return new _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMDebuggerModel.EventListener(domDebuggerModel, object, type, useCapture, passive, once, handler, originalHandler, location, removeFunctionObject, _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DOMDebuggerModel.EventListener.Origin.FrameworkUser);
            }
        }
    }
    function convertToInternalHandlers(pageInternalHandlersObject) {
        return _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.RemoteObject.RemoteArray.objectAsArray(pageInternalHandlersObject)
            .map(toTargetFunction)
            .then(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.RemoteObject.RemoteArray.createFromRemoteObjects.bind(null));
    }
