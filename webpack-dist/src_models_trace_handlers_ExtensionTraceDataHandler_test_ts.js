"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_handlers_ExtensionTraceDataHandler_test_ts"],{

/***/ "./src/models/trace/handlers/ExtensionTraceDataHandler.test.ts":
/*!*********************************************************************!*\
  !*** ./src/models/trace/handlers/ExtensionTraceDataHandler.test.ts ***!
  \*********************************************************************/
...
/* harmony import */ var _trace_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../trace.js */ "./src/models/trace/trace.ts");
...
describe('ExtensionTraceDataHandler', function () {
    ...
    function makeTimingEventWithExtensionData({ name, ts: tsMicro, detail, dur: durMicro }) {
        ...
        const firstEvent = {
            args,
            name,
            ph: isMark ? _trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.TraceEvents.Phase.INSTANT : _trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.TraceEvents.Phase.ASYNC_NESTABLE_START,
        ...
        return [
            firstEvent,
            {
                ...
                ph: _trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.TraceEvents.Phase.ASYNC_NESTABLE_END,
            },
        ];
    }
    async function createTraceExtensionDataFromTestInput(extensionData) {
        ...
        await _trace_js__WEBPACK_IMPORTED_MODULE_0__.Handlers.ModelHandlers.UserTimings.finalize();
        ...
        await _trace_js__WEBPACK_IMPORTED_MODULE_0__.Handlers.ModelHandlers.ExtensionTraceData.finalize();
        return _trace_js__WEBPACK_IMPORTED_MODULE_0__.Handlers.ModelHandlers.ExtensionTraceData.data();
    }
    ...
    describe('Timeline markers from user timings that use the extension API', function () {
        ...
        it('discards markers whose details are not valid stringified JSON', async () => {
            const performanceMarkEvent = {
                ...
                name: 'test-perf-mark',
                cat: 'blink.user_timing',
                ph: _trace_js__WEBPACK_IMPORTED_MODULE_0__.Types.TraceEvents.Phase.INSTANT,
