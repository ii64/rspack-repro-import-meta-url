"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_issues_IssueView_test_ts"],{
...
/***/ "./src/panels/issues/IssueView.test.ts":
/*!*********************************************!*\
  !*** ./src/panels/issues/IssueView.test.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _testing_UserMetricsHelpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../testing/UserMetricsHelpers.js */ "./src/testing/UserMetricsHelpers.ts");
...
/* harmony import */ var _issues_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./issues.js */ "./src/panels/issues/issues.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('IssueView', () => {
    it('records metrics when an issue is expanded', () => {
        ...
        view.expand();
        assert.isTrue((0,_testing_UserMetricsHelpers_js__WEBPACK_IMPORTED_MODULE_3__.recordedMetricsContain)(_core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.InspectorFrontendHostAPI.EnumeratedHistogram.IssuesPanelIssueExpanded, _core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.UserMetrics.IssueExpanded.Other));
        view.clear();
    });
    it('records metrics when a SameSite Cookie issue is expanded', () => {
        ...
        treeOutline.appendChild(view);
        view.expand();
        assert.isTrue((0,_testing_UserMetricsHelpers_js__WEBPACK_IMPORTED_MODULE_3__.recordedMetricsContain)(_core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.InspectorFrontendHostAPI.EnumeratedHistogram.IssuesPanelIssueExpanded, _core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.UserMetrics.IssueExpanded.SameSiteCookie));
        assert.isFalse((0,_testing_UserMetricsHelpers_js__WEBPACK_IMPORTED_MODULE_3__.recordedMetricsContain)(_core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.InspectorFrontendHostAPI.EnumeratedHistogram.IssuesPanelIssueExpanded, _core_host_host_js__WEBPACK_IMPORTED_MODULE_0__.UserMetrics.IssueExpanded.GenericCookie));
        view.clear();
    });
