"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_Infobar_test_ts"],{
...
/* harmony import */ var _components_buttons_buttons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/buttons/buttons.js */ "./src/ui/components/buttons/buttons.ts");
...
describe('Infobar', () => {
    ...
    it('shows details message containing a string', () => {
        const component = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Infobar.Infobar(_legacy_js__WEBPACK_IMPORTED_MODULE_3__.Infobar.Type.Warning, 'This is a warning');
    ...
    it('shows details message containing HTML element(s)', () => {
        ...
        const link = _legacy_js__WEBPACK_IMPORTED_MODULE_3__.XLink.XLink.create('https://www.example.com', linkText);
