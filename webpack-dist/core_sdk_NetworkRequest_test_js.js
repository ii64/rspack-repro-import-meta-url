...
/***/ "./core/sdk/NetworkRequest.test.js":
/*!*****************************************!*\
  !*** ./core/sdk/NetworkRequest.test.js ***!
  \*****************************************/
...
describe('NetworkRequest', () => {
    ...
    it('parses response cookies from headers', () => {
        const request = _sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkRequest.NetworkRequest.createWithoutBackendRequest('requestId', 'url', 'documentURL', null);
        ...
        (0,_testing_Cookies_js__WEBPACK_IMPORTED_MODULE_1__.expectCookie)(request.responseCookies[0], { name: 'foo', value: 'bar', size: 8 });
        (0,_testing_Cookies_js__WEBPACK_IMPORTED_MODULE_1__.expectCookie)(request.responseCookies[1], { name: 'baz', value: 'qux', size: 7 });
    });
    it('infers status text from status code if none given', () => {
        const fakeRequest = _sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkRequest.NetworkRequest.createWithoutBackendRequest('fakeRequestId', 'url1', 'documentURL', null);
    ...
    it('can handle the case of duplicate cookies with only 1 of them being blocked', async () => {
        const request = _sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkRequest.NetworkRequest.create('requestId', 'url', 'documentURL', null, null, null);
        request.addExtraResponseInfo({
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('NetworkRequest', () => {
    ...
    beforeEach(() => {
        ...
        const networkManager = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkManager.NetworkManager);
    ...
    it('adds blocked response cookies to - and removes exempted cookies from cookieModel', async () => {
        const removeBlockedCookieSpy = sinon.spy(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.CookieModel.CookieModel.prototype, 'removeBlockedCookie');
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.setMockConnectionResponseHandler)('Network.getCookies', () => ({ cookies: [] }));
        const cookieModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.CookieModel.CookieModel);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('ServerSentEvents', () => {
    let target;
    let networkManager;
    beforeEach(() => {
        target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.createTarget)();
    ...
    it('sends EventSourceMessageAdded events for EventSource text/event-stream', () => {
        ...
        const networkEvents = [];
        networkManager.requestForId('1').addEventListener(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkRequest.Events.EventSourceMessageAdded, ({ data }) => networkEvents.push(data));
    ...
    it('sends EventSourceMessageAdded events for raw text/event-stream', async () => {
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.setMockConnectionResponseHandler)('Network.streamResourceContent', () => ({
            getError() {
                return undefined;
            },
            bufferedData: '',
        ...
        const networkEvents = [];
        const { promise: twoEventsReceivedPromise, resolve } = _platform_platform_js__WEBPACK_IMPORTED_MODULE_4__.PromiseUtilities.promiseWithResolvers();
        networkManager.requestForId('1').addEventListener(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkRequest.Events.EventSourceMessageAdded, ({ data }) => {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('requestStreamingContent', () => {
    let target;
    let networkManager;
    beforeEach(() => {
        target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.createTarget)();
    ...
    it('sends ChunkAdded events when new data is received', async () => {
        ...
        sinon.stub(_sdk_js__WEBPACK_IMPORTED_MODULE_5__.NetworkManager.NetworkManager, 'streamResponseBody')
            .returns(Promise.resolve(new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_0__.ContentData.ContentData('Zm9v', true, 'text/html')));
