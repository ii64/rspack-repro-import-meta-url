...
/***/ "./panels/application/components/ReportsGrid.test.js":
/*!***********************************************************!*\
  !*** ./panels/application/components/ReportsGrid.test.js ***!
  \***********************************************************/
...
const renderReportsGrid = async (data) => {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.ReportsGrid.ReportsGrid();
    if (data) {
        component.data = data;
    }
    ...
    const controller = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getElementWithinComponent)(component, 'devtools-data-grid-controller', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_4__.DataGridController.DataGridController);
    assert.isNotNull(controller.shadowRoot);
    const datagrid = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_2__.getElementWithinComponent)(controller, 'devtools-data-grid', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_4__.DataGrid.DataGrid);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithEnvironment)('ReportsGrid', () => {
    ...
    it('renders grid with correct content', async () => {
        ...
        assert.isNotNull(dataGrid.shadowRoot);
        const headerCells = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getHeaderCells)(dataGrid.shadowRoot);
        const values = Array.from(headerCells, getHeaderText);
        assert.deepEqual(values, ['URL', 'Type', 'Status', 'Destination', 'Generated at', 'Body']);
        const rowValues = (0,_testing_DataGridHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getValuesOfAllBodyRows)(dataGrid.shadowRoot);
