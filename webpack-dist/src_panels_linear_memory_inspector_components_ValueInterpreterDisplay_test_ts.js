"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_linear_memory_inspector_components_ValueInterpreterDisplay_test_ts"],{
...
/***/ "./src/panels/linear_memory_inspector/components/ValueInterpreterDisplay.test.ts":
/*!***************************************************************************************!*\
  !*** ./src/panels/linear_memory_inspector/components/ValueInterpreterDisplay.test.ts ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('ValueInterpreterDisplay', () => {
    const combinationsForNumbers = [
        { endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little, signed: true },
        { endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little, signed: false },
        { endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Big, signed: false },
        { endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Big, signed: true },
    ];
    function testNumberFormatCombinations(baseData, combinations) {
        ...
        for (let i = 0; i < combinations.length; ++i) {
            ...
            let expectedValue;
            const isLittleEndian = endianness === _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little;
            const view = new DataView(baseData.buffer);
            switch (baseData.type) {
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int8:
                    expectedValue = signed ? -expectedIntValue : expectedIntValue;
                    signed ? view.setInt8(0, expectedValue) : view.setInt8(0, expectedValue);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int16:
                    expectedValue = signed ? -expectedIntValue : expectedIntValue;
                    signed ? view.setInt16(0, expectedValue, isLittleEndian) : view.setUint16(0, expectedValue, isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int32:
                    expectedValue = signed ? -expectedIntValue : expectedIntValue;
                    signed ? view.setInt32(0, expectedValue, isLittleEndian) : view.setUint32(0, expectedValue, isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int64:
                    expectedValue = signed ? -expectedIntValue : expectedIntValue;
                    signed ? view.setBigInt64(0, BigInt(expectedValue), isLittleEndian) :
                        view.setBigUint64(0, BigInt(expectedValue), isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float32:
                    expectedValue = expectedFloatValue;
                    view.setFloat32(0, expectedValue, isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float64:
                    expectedValue = expectedFloatValue;
                    view.setFloat64(0, expectedValue, isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer32:
                    expectedValue = '0x' + expectedIntValue.toString(16);
                    view.setInt32(0, expectedIntValue, isLittleEndian);
                    break;
                case _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer64:
                    expectedValue = '0x' + expectedIntValue.toString(16);
    ...
    it('correctly formats signed/unsigned and endianness for Integer 8-bit (decimal)', () => {
        const formatData = {
            ...
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int8,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
    ...
    it('correctly formats signed/unsigned and endianness for Integer 16-bit (decimal)', () => {
        const formatData = {
            ...
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int16,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats signed/unsigned and endianness for Integer 32-bit (decimal)', () => {
        const formatData = {
            ...
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int32,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats signed/unsigned and endianness for Integer 64-bit (decimal)', () => {
        const formatData = {
            ...
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int64,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats endianness for Float 32-bit (decimal)', () => {
        const formatData = {
            buffer: new ArrayBuffer(4),
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float32,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats endianness for Float 64-bit (decimal)', () => {
        const formatData = {
            buffer: new ArrayBuffer(8),
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float64,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats endianness for Pointer 32-bit', () => {
        const formatData = {
            buffer: new ArrayBuffer(4),
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer32,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Hexadecimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats endianness for Pointer 64-bit', () => {
        const formatData = {
            buffer: new ArrayBuffer(8),
            type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer64,
            mode: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Hexadecimal,
        };
        testNumberFormatCombinations(formatData, combinationsForNumbers);
    });
    it('correctly formats floats in decimal mode', () => {
        ...
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatFloat(expectedFloat, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal);
        assert.strictEqual(actualValue, '341.34');
    });
    it('correctly formats floats in scientific mode', () => {
        const expectedFloat = 341.34;
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatFloat(expectedFloat, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Scientific);
        assert.strictEqual(actualValue, '3.41e+2');
    });
    it('correctly formats integers in decimal mode', () => {
        const expectedInteger = 120;
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatInteger(expectedInteger, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal);
        assert.strictEqual(actualValue, '120');
    });
    it('correctly formats integers in hexadecimal mode', () => {
        const expectedInteger = 16;
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatInteger(expectedInteger, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Hexadecimal);
        assert.strictEqual(actualValue, '0x10');
    });
    it('returns N/A for negative hex numbers', () => {
        const negativeInteger = -16;
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatInteger(negativeInteger, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Hexadecimal);
        assert.strictEqual(actualValue, 'N/A');
    });
    it('correctly formats integers in octal mode', () => {
        const expectedInteger = 16;
        const actualValue = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.formatInteger(expectedInteger, _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Octal);
    ...
    it('renders pointer values in LinearMemoryInspector.ValueInterpreterDisplayUtils.ValueTypes', () => {
        ...
        component.data = {
            ...
            valueTypes: new Set([
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer32,
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Pointer64,
            ]),
    ...
    it('renders value in selected LinearMemoryInspector.ValueInterpreterDisplayUtils.ValueTypes', () => {
        ...
        component.data = {
            ...
            endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little,
            valueTypes: new Set([
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int16,
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float32,
            ]),
            memoryLength: array.length,
        };
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
    ...
    it('renders only unsigned values for Octal and Hexadecimal representation', () => {
        ...
        component.data = {
            ...
            endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little,
            valueTypes: new Set([
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int8,
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int16,
                _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int32,
            ]),
            valueTypeModes: new Map([
                [
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int8,
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Octal,
                ],
                [
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int16,
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Hexadecimal,
                ],
                [
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Int32,
                    _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal,
                ],
            ]),
            memoryLength: array.length,
        };
    ...
    it('triggers a value changed event on selecting a new mode', async () => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplay.ValueInterpreterDisplay();
        const array = [1, 132, 172, 71];
        const oldMode = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Decimal;
        const newMode = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueTypeMode.Scientific;
        const mapping = _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.getDefaultValueTypeMapping();
        mapping.set(_components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float32, oldMode);
        component.data = {
            buffer: new Uint8Array(array).buffer,
            endianness: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.Endianness.Little,
            valueTypes: new Set([
        ...
        assert.deepEqual(event.data, { type: _components_js__WEBPACK_IMPORTED_MODULE_2__.ValueInterpreterDisplayUtils.ValueType.Float32, mode: newMode });
    });
