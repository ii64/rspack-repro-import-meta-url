...
/***/ "./panels/profiler/IsolateSelector.js":
/*!********************************************!*\
  !*** ./panels/profiler/IsolateSelector.js ***!
  \********************************************/
...
class IsolateSelector extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.Widget.VBox {
    ...
    constructor() {
        ...
        _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.TargetManager.instance().addEventListener("NameChanged" /* SDK.TargetManager.Events.NameChanged */, this.targetChanged, this);
        _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_3__.TargetManager.TargetManager.instance().addEventListener("InspectedURLChanged" /* SDK.TargetManager.Events.InspectedURLChanged */, this.targetChanged, this);
    }
    wasShown() {
        super.wasShown();
