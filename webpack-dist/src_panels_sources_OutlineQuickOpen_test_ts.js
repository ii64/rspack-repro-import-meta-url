"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_OutlineQuickOpen_test_ts"],{

/***/ "./src/panels/sources/OutlineQuickOpen.test.ts":
/*!*****************************************************!*\
  !*** ./src/panels/sources/OutlineQuickOpen.test.ts ***!
  \*****************************************************/
...
describe('OutlineQuickOpen', () => {
    describe('generates a correct JavaScript outline', () => {
        function javaScriptOutline(doc) {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.javascript.javascript()];
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions });
...
`), [
    ...
    describe('generates a correct JSX outline', () => {
        function jsxOutline(doc) {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.javascript.javascript({ jsx: true })];
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions });
            return _sources_js__WEBPACK_IMPORTED_MODULE_2__.OutlineQuickOpen.outline(state);
        }
  ...
  return <blink>{name}</blink>;
    ...
    describe('generates a correct TypeScript outline', () => {
        function typeScriptOutline(doc) {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.javascript.javascript({ typescript: true })];
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions });
            return _sources_js__WEBPACK_IMPORTED_MODULE_2__.OutlineQuickOpen.outline(state);
        }
        it('for an empty script', () => {
    ...
    describe('generates a correct CSS outline', () => {
        function cssOutline(doc) {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.css.css()];
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions });
            return _sources_js__WEBPACK_IMPORTED_MODULE_2__.OutlineQuickOpen.outline(state);
        }
    ...
    describe('generates a correct HTML outline', () => {
        function htmlOutline(doc) {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.html.html()];
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions });
            return _sources_js__WEBPACK_IMPORTED_MODULE_2__.OutlineQuickOpen.outline(state);
        }
...
:host {
  --custom-variable: 5px;
    ...
    describe('generates a reasonable C++ outline', () => {
        let extensions;
        before(async () => {
            const cpp = await _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.cpp();
            extensions = [cpp.cpp()];
        });
    ...
    describe('generates a correct WebAssembly outline', () => {
        let extensions;
        before(async () => {
            const wast = await _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.wast();
...
describe('OutlineQuickOpen', () => {
    const { OutlineQuickOpen } = _sources_js__WEBPACK_IMPORTED_MODULE_2__.OutlineQuickOpen;
...
function testBar(arg3) { }`;
        const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.javascript.javascript()];
        const textEditor = { state: _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({ doc, extensions }) };
        const sourceFrame = sinon.createStubInstance(_sources_js__WEBPACK_IMPORTED_MODULE_2__.UISourceCodeFrame.UISourceCodeFrame);
        sourceFrame.editorLocationToUILocation.callThrough();
        sinon.stub(sourceFrame, 'textEditor').value(textEditor);
        const sourcesView = sinon.createStubInstance(_sources_js__WEBPACK_IMPORTED_MODULE_2__.SourcesView.SourcesView);
