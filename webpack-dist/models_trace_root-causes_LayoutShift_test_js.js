...
/***/ "./models/trace/root-causes/LayoutShift.test.js":
/*!******************************************************!*\
  !*** ./models/trace/root-causes/LayoutShift.test.js ***!
  \******************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_0__.describeWithMockConnection)('LayoutShift root causes', () => {
    /*
    ...
    describe('assigns root causes to layout shifts', () => {
        ...
        beforeEach(() => {
            ...
            layoutShifts = new _RootCauses_js__WEBPACK_IMPORTED_MODULE_3__.LayoutShiftRootCauses(protocolInterface, { enableIframeRootCauses: true });
        });
        ...
        describe('Injected iframes', () => {
            ...
            it('ignores injected iframes if disabled', async () => {
                layoutShifts = new _RootCauses_js__WEBPACK_IMPORTED_MODULE_3__.LayoutShiftRootCauses(protocolInterface, { enableIframeRootCauses: false });
                const rootCauses = await Promise.all(shifts.map(shift => layoutShifts.rootCausesForEvent(model, shift)));
                assertArrayHasNoNulls(rootCauses);
