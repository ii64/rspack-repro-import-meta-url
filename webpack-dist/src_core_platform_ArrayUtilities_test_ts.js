"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_platform_ArrayUtilities_test_ts"],{

/***/ "./src/core/platform/ArrayUtilities.test.ts":
/*!**************************************************!*\
  !*** ./src/core/platform/ArrayUtilities.test.ts ***!
  \**************************************************/
...
describe('ArrayUtilities', () => {
        ...
        it('calculates the correct binary index', () => {
            ...
            function testArray(array) {
                ...
                for (let i = -100; i <= 100; ++i) {
                    ...
                    const actual = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.binaryIndexOf(array, i, comparator);
    ...
    describe('merge and intersect', () => {
        it('orders merge intersect', () => {
            ...
            function count(a, x) {
                return _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.upperBound(a, x, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR) -
                    _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.lowerBound(a, x, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR);
            }
    ...
    describe('upperBound', () => {
        it('finds the first object after the needle whose value is greater than the needle', async () => {
            ...
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.upperBound(input, 2, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR);
            assert.strictEqual(index, 3);
        });
        it('can take left and right params to alter the range', async () => {
            const input = [0, 1, 2, 3, 4, 5];
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.upperBound(input, 2, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR, 4, 6);
        ...
        it('can take a custom comparator to determine how to compare elements', async () => {
            ...
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.upperBound(input, 2, (needle, element) => {
    ...
    describe('lowerBound', () => {
        it('finds the first object after the needle whose value is equal to or greater than the needle', async () => {
            const input = [0, 1, 2, 3, 4, 5];
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.lowerBound(input, 2, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR);
            assert.strictEqual(index, 2);
        });
        it('can take left and right params to alter the range', async () => {
            const input = [0, 1, 2, 3, 4, 5];
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.lowerBound(input, 2, _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.DEFAULT_COMPARATOR, 5, 6);
            assert.strictEqual(index, 5);
        });
        it('can take a custom comparator to determine how to compare elements', async () => {
            const input = [{ time: 0, name: 'test1' }, { time: 2, name: 'test2' }, { time: 3, name: 'test3' }];
            const index = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.lowerBound(input, 2, (needle, element) => {
                if (needle > element.time) {
                    return 1;
                }
                if (element.time > needle) {
    ...
    describe('Nearest', () => {
        describe('Finding the last item where predicate is true', () => {
            it('works with an even number of entries', () => {
                ...
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(ascEntries, value => value.a < 7);
                assert.strictEqual(nearest, 2);
                const descEntries = [{ a: 23 }, { a: 18 }, { a: 13 }, { a: 12 }, { a: 12 }, { a: 3 }, { a: 1 }, { a: 0 }];
                nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(descEntries, value => value.a > 7);
            ...
            it('works with an odd number of entries', () => {
                ...
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(ascEntries, value => value.a < 31);
                ...
                nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(descEntries, value => value.a > 2);
                assert.strictEqual(nearest, 6);
            });
            it('returns null if there are no matches at all', () => {
                ...
                let zeroth = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(ascEntries, value => value.a < 0);
                ...
                zeroth = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(descEntries, value => value.a > 40);
                assert.isNull(zeroth);
            });
            it('works when the result is the last item', () => {
                ...
                let last = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(ascEntries, value => value.a < 40);
                ...
                last = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(descEntries, value => value.a > 0);
            ...
            it('works on exact values', () => {
                ...
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromEnd(ascEntries, predicateFunc);
        ...
        describe('Finding the first item in the array where predicate is true', () => {
            it('works with an even number of entries', () => {
                ...
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(ascEntries, value => value.a > 7);
                assert.strictEqual(nearest, 2);
                const descEntries = [{ a: 23 }, { a: 18 }, { a: 13 }, { a: 12 }, { a: 12 }, { a: 3 }, { a: 1 }, { a: 0 }];
                nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(descEntries, value => value.a < 13);
                assert.strictEqual(nearest, 3);
            });
            it('works with an odd number of entries', () => {
                const ascEntries = [
                ...
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(ascEntries, value => value.a > 31);
                assert.strictEqual(nearest, 6);
                const descEntries = [
                    { a: 33 },
                    { a: 32 },
                ...
                nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(descEntries, value => value.a < 32);
                assert.strictEqual(nearest, 2);
            });
            it('returns null if there are no matches at all', () => {
                const entries = [
                ...
                const nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(entries, predicate);
            ...
            it('works when the result is the first item', () => {
                ...
                let first = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(ascEntries, greaterThanPredicate);
            ...
            it('works on exact values', () => {
                ...
                const gePredicate = (value) => value.a >= 3;
                // Even number of entries.
                let nearest = _platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.nearestIndexFromBeginning(ascEntries, gePredicate);
                assert.strictEqual(nearest, 2);
                // Odd number of entries.
                ascEntries.push({ a: 7 });
    ...
    describe('arrayDoesNotContainNullOrUndefined', () => {
        it('should return false when array contains null', () => {
            assert.isFalse(_platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.arrayDoesNotContainNullOrUndefined([1, null, 2]));
        });
        it('should return false when array contains undefined', () => {
            assert.isFalse(_platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.arrayDoesNotContainNullOrUndefined([1, undefined, 2]));
        });
        it('should return true when array does not contain undefined and null', () => {
            assert.isTrue(_platform_js__WEBPACK_IMPORTED_MODULE_0__.ArrayUtilities.arrayDoesNotContainNullOrUndefined([1, 2]));
        });
    });
});
