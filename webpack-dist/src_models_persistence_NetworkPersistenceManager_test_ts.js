"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_persistence_NetworkPersistenceManager_test_ts"],{

/***/ "./src/models/persistence/NetworkPersistenceManager.test.ts":
/*!******************************************************************!*\
  !*** ./src/models/persistence/NetworkPersistenceManager.test.ts ***!
  \******************************************************************/
...
/* harmony import */ var _testing_OverridesHelpers_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../testing/OverridesHelpers.js */ "./src/testing/OverridesHelpers.ts");
...
/* harmony import */ var _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../persistence/persistence.js */ "./src/models/persistence/persistence.ts");
/* harmony import */ var _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../workspace/workspace.js */ "./src/models/workspace/workspace.ts");
...
const setUpEnvironmentWithUISourceCode = (url, resourceType, project) => {
    const { workspace, networkPersistenceManager } = (0,_testing_OverridesHelpers_js__WEBPACK_IMPORTED_MODULE_6__.setUpEnvironment)();
    if (!project) {
        project = { id: () => url, type: () => _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.Workspace.projectTypes.Network };
    }
    const uiSourceCode = new _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.UISourceCode.UISourceCode(project, url, resourceType);
    project.uiSourceCodes = () => [uiSourceCode];
    workspace.addProject(project);
    return { workspace, project: project, uiSourceCode, networkPersistenceManager };
};
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('NetworkPersistenceManager', () => {
    beforeEach(async () => {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('NetworkPersistenceManager', () => {
        ...
        const expected = [
            {
                ...
                requestStage: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Fetch.RequestStage.Response,
            },
            {
    ...
    it('recognizes forbidden network URLs', () => {
        assert.isTrue(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.NetworkPersistenceManager.isForbiddenNetworkUrl('chrome://version'));
        assert.isTrue(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.NetworkPersistenceManager.isForbiddenNetworkUrl('https://chromewebstore.google.com/index.html'));
        assert.isTrue(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.NetworkPersistenceManager.isForbiddenNetworkUrl('https://chrome.google.com/script.js'));
        assert.isFalse(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.NetworkPersistenceManager.isForbiddenNetworkUrl('https://www.example.com/script.js'));
    });
});
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('NetworkPersistenceManager', () => {
    ...
    beforeEach(async () => {
        _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.NetworkManager.MultitargetNetworkManager.dispose();
        (0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_7__.setMockResourceTree)(false);
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)();
    ...
    it('is aware of which \'.headers\' files are currently active', done => {
        const workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.Workspace.WorkspaceImpl.instance();
        const project = {
            type: () => _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.Workspace.projectTypes.Network,
        };
        ...
        const eventURLs = [];
        networkPersistenceManager.addEventListener(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.Events.RequestsForHeaderOverridesFileChanged, event => {
            eventURLs.push(event.data.url());
        });
        workspace.dispatchEventToListeners(_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.Workspace.Events.UISourceCodeAdded, networkUISourceCode);
        ...
        workspace.dispatchEventToListeners(_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_10__.Workspace.Events.ProjectRemoved, project);
        setTimeout(() => {
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('NetworkPersistenceManager', () => {
    ...
    it('updates active state when target detach and attach', async () => {
        const { networkPersistenceManager } = (0,_testing_OverridesHelpers_js__WEBPACK_IMPORTED_MODULE_6__.setUpEnvironment)();
        const { project } = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_8__.createFileSystemUISourceCode)({ url: 'file:///tmp', mimeType: 'text/plain' });
        ...
        const target = await (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)();
...
describe('NetworkPersistenceManager', () => {
    ...
    it('escapes patterns to be used in RegExes', () => {
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/'), 'www\\.example\\.com/');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/index.html'), 'www\\.example\\.com/index\\.html');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/*'), 'www\\.example\\.com/.*');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/*.js'), 'www\\.example\\.com/.*\\.js');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/file([{with-special$_^chars}])'), 'www\\.example\\.com/file\\(\\[\\{with\\-special\\$_\\^chars\\}\\]\\)');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/page.html?foo=bar'), 'www\\.example\\.com/page\\.html\\?foo=bar');
        assert.strictEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.escapeRegex('www.example.com/*?foo=bar'), 'www\\.example\\.com/.*\\?foo=bar');
    });
    it('detects when the tail of a path matches with a default index file', () => {
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('index.html'), { head: '', tail: 'index.html' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('index.htm'), { head: '', tail: 'index.htm' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('index.php'), { head: '', tail: 'index.php' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('index.ht'), { head: 'index.ht' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('*.html'), { head: '', tail: '*.html' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('*.htm'), { head: '', tail: '*.htm' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('path/*.html'), { head: 'path/', tail: '*.html' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('foo*.html'), { head: 'foo*.html' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('a*'), { head: 'a*' });
        assert.deepEqual(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_9__.NetworkPersistenceManager.extractDirectoryIndex('a/*'), { head: 'a/*' });
    });
    ...
    it('generates header patterns', async () => {
      ...
      },
      {
        ...
        const { uiSourceCode } = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_8__.createFileSystemUISourceCode)({
            url: 'file:///path/to/overrides/www.example.com/.headers',
            content: headers,
            mimeType: 'text/plain',
