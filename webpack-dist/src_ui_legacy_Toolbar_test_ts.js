"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_Toolbar_test_ts"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_render_coordinator_render_coordinator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/render_coordinator/render_coordinator.js */ "./src/ui/components/render_coordinator/render_coordinator.ts");
...
const coordinator = _components_render_coordinator_render_coordinator_js__WEBPACK_IMPORTED_MODULE_0__.RenderCoordinator.RenderCoordinator.instance();



(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('Toolbar', () => {
    describe('ToolbarInput', () => {
        it('sets a title on the clear button', async () => {
            const input = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.ToolbarInput('placeholder');
    ...
    it('can append items into the toolbar', async () => {
        ...
        const toolbar = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.Toolbar('test-toolbar', div);
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.renderElementIntoDOM)(div);
        const itemOne = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.ToolbarInput('placeholder-item-1');
        toolbar.appendToolbarItem(itemOne);
        const itemTwo = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.ToolbarInput('placeholder-item-2');
    ...
    it('knows if it has an item in the toolbar', async () => {
        const toolbar = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.Toolbar('test-toolbar');
        const item = new _legacy_js__WEBPACK_IMPORTED_MODULE_3__.Toolbar.ToolbarInput('placeholder');
