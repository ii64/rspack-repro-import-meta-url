"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_handlers_UserInteractionsHandler_test_ts"],{

/***/ "./src/models/trace/handlers/UserInteractionsHandler.test.ts":
/*!*******************************************************************!*\
  !*** ./src/models/trace/handlers/UserInteractionsHandler.test.ts ***!
  \*******************************************************************/
...
describe('UserInteractionsHandler', function () {
        ...
        const events = [
            {
                ...
                ph: _trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.Phase.ASYNC_NESTABLE_START,
    ...
    it('gets the correct score classification for Interaction to Next Paint event', () => {
        const eventA = makeFakeInteraction('pointerdown', { startTime: 0, endTime: 10000, interactionId: 1 });
        assert.strictEqual(_trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.UserInteractions.scoreClassificationForInteractionToNextPaint(eventA.dur), _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.PageLoadMetrics.ScoreClassification.GOOD);
        const eventB = makeFakeInteraction('pointerdown', { startTime: 0, endTime: 250000, interactionId: 1 });
        assert.strictEqual(_trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.UserInteractions.scoreClassificationForInteractionToNextPaint(eventB.dur), _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.PageLoadMetrics.ScoreClassification.OK);
        const eventC = makeFakeInteraction('pointerdown', { startTime: 0, endTime: 1000000, interactionId: 1 });
        assert.strictEqual(_trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.UserInteractions.scoreClassificationForInteractionToNextPaint(eventC.dur), _trace_js__WEBPACK_IMPORTED_MODULE_1__.Handlers.ModelHandlers.PageLoadMetrics.ScoreClassification.BAD);
    });
});
