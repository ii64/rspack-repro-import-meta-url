"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_animation_AnimationTimeline_test_ts"],{

/***/ "./src/panels/animation/AnimationTimeline.test.ts":
/*!********************************************************!*\
  !*** ./src/panels/animation/AnimationTimeline.test.ts ***!
  \********************************************************/
...
/* harmony import */ var _elements_elements_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../elements/elements.js */ "./src/panels/elements/elements.ts");
/* harmony import */ var _animation_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animation.js */ "./src/panels/animation/animation.ts");
...
var _ManualPromise_waitPromise, _ManualPromise_resolveFn;
...
const TIME_ANIMATION_PAYLOAD = {
    ...
    startTime: 42,
    currentTime: 0,
    type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Animation.AnimationType.CSSAnimation,
    source: {
        delay: 0,
        endDelay: 0,
        duration: 10000,
...
const SDA_ANIMATION_PAYLOAD = {
    ...
    viewOrScrollTimeline: {
        axis: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_2__.DOM.ScrollOrientation.Vertical,
        sourceNodeId: 42,
        startOffset: 42,
        endOffset: 142,
    },
...
class ManualPromise {
    constructor() {
        _ManualPromise_waitPromise.set(this, void 0);
        _ManualPromise_resolveFn.set(this, void 0);
        __classPrivateFieldSet(this, _ManualPromise_waitPromise, new Promise(r => {
            __classPrivateFieldSet(this, _ManualPromise_resolveFn, r, "f");
        }), "f");
    }
    resolve() {
        __classPrivateFieldGet(this, _ManualPromise_resolveFn, "f").call(this);
        __classPrivateFieldSet(this, _ManualPromise_waitPromise, new Promise(r => {
            __classPrivateFieldSet(this, _ManualPromise_resolveFn, r, "f");
        }), "f");
    }
    wait() {
        return __classPrivateFieldGet(this, _ManualPromise_waitPromise, "f");
    }
}
_ManualPromise_waitPromise = new WeakMap(), _ManualPromise_resolveFn = new WeakMap();
...
const stubAnimationGroup = () => {
    sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationModel.AnimationGroup.prototype, 'scrollNode')
        .resolves(new _animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode(null));
};
const stubAnimationDOMNode = () => {
    const verticalScrollRange = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'verticalScrollRange').resolves(100);
    const horizontalScrollRange = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'horizontalScrollRange').resolves(100);
    const scrollLeft = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'scrollLeft').resolves(10);
    const scrollTop = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'scrollTop').resolves(10);
    const addScrollEventListener = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'addScrollEventListener').resolves();
    const removeScrollEventListener = sinon.stub(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationDOMNode.AnimationDOMNode.prototype, 'removeScrollEventListener').resolves();
    return {
        verticalScrollRange,
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('AnimationTimeline', () => {
    let target;
    let view;
    beforeEach(() => {
        _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Linkifier.registerLinkifier({
            ...
            async loadLinkifier() {
                return _elements_elements_js__WEBPACK_IMPORTED_MODULE_6__.DOMLinkifier.Linkifier.instance();
            },
        });
    ...
    const updatesUiOnEvent = (inScope) => async () => {
        ...
        const model = target.model(_animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationModel.AnimationModel);
        assert.exists(model);
        view = _animation_js__WEBPACK_IMPORTED_MODULE_7__.AnimationTimeline.AnimationTimeline.instance({ forceNew: true });
        view.markAsRoot();
        ...
        if (inScope) {
            await (0,_testing_ExpectStubCall_js__WEBPACK_IMPORTED_MODULE_4__.expectCall)(sinon.stub(view, 'previewsCreatedForTest'));
        }
