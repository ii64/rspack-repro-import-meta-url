"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_components_SharedStorageAccessGrid_test_ts"],{

/***/ "./src/panels/application/components/SharedStorageAccessGrid.test.ts":
/*!***************************************************************************!*\
  !*** ./src/panels/application/components/SharedStorageAccessGrid.test.ts ***!
  \***************************************************************************/
...
async function renderSharedStorageAccessGrid(events) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_6__.SharedStorageAccessGrid.SharedStorageAccessGrid();
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_3__.describeWithLocale)('SharedStorageAccessGrid', () => {
    it('renders shared storage access events', async () => {
        ...
        const component = await renderSharedStorageAccessGrid([
            ...
            {
                accessTime: 10,
                type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Storage.SharedStorageAccessType.WorkletDelete,
                mainFrameId: noId,
