"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_developer_resources_DeveloperResourcesListView_ts"],{

/***/ "./src/panels/developer_resources/DeveloperResourcesListView.ts":
/*!**********************************************************************!*\
  !*** ./src/panels/developer_resources/DeveloperResourcesListView.ts ***!
  \**********************************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './developerResourcesListView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class DeveloperResourcesListView extends _ui_legacy_legacy_js__WEBPACK_IMPORTED_MODULE_6__.Widget.VBox {
    constructor(isVisibleFilter) {
        super(true);
        Object.defineProperty(this, "nodeForItem", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.dataGrid.setResizeMethod(_ui_legacy_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_5__.DataGrid.ResizeMethod.Last);
        this.dataGrid.setStriped(true);
        this.dataGrid.element.classList.add('flex-auto');
        this.dataGrid.addEventListener(_ui_legacy_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_5__.DataGrid.Events.SortingChanged, this.sortingChanged, this);
    ...
    wasShown() {
        super.wasShown();
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './developerResourcesListView.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
    }
}
