"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer_package_src_cdp_Accessibility_ts"],{

/***/ "./src/third_party/puppeteer/package/src/cdp/Accessibility.ts":
/*!********************************************************************!*\
  !*** ./src/third_party/puppeteer/package/src/cdp/Accessibility.ts ***!
  \********************************************************************/
...
var _Accessibility_realm, _AXNode_instances, _AXNode_richlyEditable, _AXNode_editable, _AXNode_focusable, _AXNode_hidden, _AXNode_name, _AXNode_role, _AXNode_ignored, _AXNode_cachedHasFocusableChild, _AXNode_realm, _AXNode_isPlainTextField, _AXNode_isTextOnlyObject, _AXNode_hasFocusableChild;
/**
...
class Accessibility {
     ...
     */
    constructor(realm) {
        _Accessibility_realm.set(this, void 0);
        __classPrivateFieldSet(this, _Accessibility_realm, realm, "f");
    }
    /**
    ...
    async snapshot(options = {}) {
        ...
        const { nodes } = await __classPrivateFieldGet(this, _Accessibility_realm, "f").environment.client.send('Accessibility.getFullAXTree');
        let backendNodeId;
        if (root) {
            const { node } = await __classPrivateFieldGet(this, _Accessibility_realm, "f").environment.client.send('DOM.describeNode', {
                objectId: root.id,
            });
            backendNodeId = node.backendNodeId;
        }
        const defaultRoot = AXNode.createTree(__classPrivateFieldGet(this, _Accessibility_realm, "f"), nodes);
...
_Accessibility_realm = new WeakMap();
class AXNode {
    constructor(realm, payload) {
        ...
        __classPrivateFieldSet(this, _AXNode_realm, realm, "f");
    ...
    serialize() {
        ...
        const node = {
            ...
            elementHandle: async () => {
                ...
                return (await __classPrivateFieldGet(this, _AXNode_realm, "f").adoptBackendNode(this.payload.backendDOMNodeId));
            },
        };
