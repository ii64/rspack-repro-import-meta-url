"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_NetworkPanel_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/NetworkPanel.test.ts":
/*!*************************************************!*\
  !*** ./src/panels/network/NetworkPanel.test.ts ***!
  \*************************************************/
...
/* harmony import */ var _network_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./network.js */ "./src/panels/network/network.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_5__.describeWithMockConnection)('NetworkPanel', () => {
    ...
    beforeEach(async () => {
        ...
        await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./network-meta.js */ "./src/panels/network/network-meta.ts"));
