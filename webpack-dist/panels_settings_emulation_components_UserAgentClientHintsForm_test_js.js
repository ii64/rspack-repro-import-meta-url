...
/***/ "./panels/settings/emulation/components/UserAgentClientHintsForm.test.js":
/*!*******************************************************************************!*\
  !*** ./panels/settings/emulation/components/UserAgentClientHintsForm.test.js ***!
  \*******************************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('UserAgentClientHintsForm', () => {
    const testMetaData = {
        brands: [
            {
                brand: 'Brand1',
    ...
    const renderUserAgentClientHintsForm = () => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.UserAgentClientHintsForm.UserAgentClientHintsForm();
    ...
    it('renders the UA brands form with brand values', () => {
        ...
        const brandInputs = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementsWithinComponent)(component, '.ua-brand-name-input', HTMLInputElement);
    ...
    it('renders the full-version-list brands form with brand values', () => {
        ...
        const brandInputs = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementsWithinComponent)(component, '.fvl-brand-name-input', HTMLInputElement);
        const brandInputValues = [...brandInputs].map(brandInput => brandInput.value);
    ...
    it('Submitting the form returns metaData', async () => {
        ...
        const eventPromise = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getEventPromise)(component, 'clienthintssubmit');
        const submitButton = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementWithinComponent)(component, 'devtools-button', _ui_components_buttons_buttons_js__WEBPACK_IMPORTED_MODULE_2__.Button.Button);
        submitButton.click();
