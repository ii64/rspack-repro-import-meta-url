"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_request_link_icon_RequestLinkIcon_test_ts"],{
...
/***/ "./src/ui/components/request_link_icon/RequestLinkIcon.test.ts":
/*!*********************************************************************!*\
  !*** ./src/ui/components/request_link_icon/RequestLinkIcon.test.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../panels/network/forward/forward.js */ "./src/panels/network/forward/forward.ts");
...
/* harmony import */ var _icon_button_icon_button_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../icon_button/icon_button.js */ "./src/ui/components/icon_button/icon_button.ts");
/* harmony import */ var _render_coordinator_render_coordinator_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../render_coordinator/render_coordinator.js */ "./src/ui/components/render_coordinator/render_coordinator.ts");
/* harmony import */ var _request_link_icon_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./request_link_icon.js */ "./src/ui/components/request_link_icon/request_link_icon.ts");
// Copyright 2020 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
...
var _MockRequestResolver_promiseMap;
...
class MockRequestResolver {
    constructor() {
        _MockRequestResolver_promiseMap.set(this, new Map());
    }
    waitFor(requestId) {
        if (!requestId) {
            if (__classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").size !== 1) {
                throw new Error('more than one request being awaited, specify a request id');
            }
            requestId = __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").keys().next().value;
        }
        requestId = requestId || '';
        const entry = __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").get(requestId);
        if (entry) {
        ...
        __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").set(requestId, { resolve, promise });
        return promise;
    }
    resolve(result, requestId) {
        if (!requestId && __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").size === 1) {
            requestId = __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").keys().next().value;
        }
        ...
        __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").delete(requestId);
    }
    clear() {
        for (const { resolve } of __classPrivateFieldGet(this, _MockRequestResolver_promiseMap, "f").values()) {
            resolve(null);
        }
    }
}
_MockRequestResolver_promiseMap = new WeakMap();
    ...
    describe('handles clicks correctly', () => {
        ...
        before(() => {
            ...
            _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.ViewManager.registerViewExtension({
                ...
                persistence: _legacy_legacy_js__WEBPACK_IMPORTED_MODULE_4__.ViewManager.ViewPersistence.CLOSEABLE,
                async loadView() {
        ...
        it('if the button is clicked', async () => {
            ...
            assert.isTrue(revealOverride.calledOnceWith(sinon.match({ tab: _panels_network_forward_forward_js__WEBPACK_IMPORTED_MODULE_1__.UIRequestLocation.UIRequestTabs.HeadersComponent })));
        });
    });
});
