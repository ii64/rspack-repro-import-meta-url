"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_csp_evaluator_package_checks_parser_checks_test_ts"],{

/***/ "./src/third_party/csp_evaluator/package/checks/parser_checks_test.ts":
/*!****************************************************************************!*\
  !*** ./src/third_party/csp_evaluator/package/checks/parser_checks_test.ts ***!
  \****************************************************************************/
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './parser_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/**
 * @license
...
describe('Test parser checks', () => {
    ...
    it('CheckUnknownDirective', () => {
        ...
        const violations = checkCsp(test, Object(function webpackMissingModule() { var e = new Error("Cannot find module './parser_checks'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        expect(violations.length).toBe(1);
        expect(violations[0].severity).toBe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).SYNTAX);
    ...
    it('CheckInvalidKeywordForgottenSingleTicks', () => {
        ...
        expect(violations.every((v) => v.severity === Object(function webpackMissingModule() { var e = new Error("Cannot find module '../finding'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).SYNTAX)).toBeTrue();
