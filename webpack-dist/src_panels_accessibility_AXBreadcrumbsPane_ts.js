"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_accessibility_AXBreadcrumbsPane_ts"],{

/***/ "./src/panels/accessibility/AXBreadcrumbsPane.ts":
/*!*******************************************************!*\
  !*** ./src/panels/accessibility/AXBreadcrumbsPane.ts ***!
  \*******************************************************/
...
/* harmony import */ var _ui_components_panel_feedback_panel_feedback_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../ui/components/panel_feedback/panel_feedback.js */ "./src/ui/components/panel_feedback/panel_feedback.ts");
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './axBreadcrumbs.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var _AXBreadcrumbsPane_legacyTreeDisabled;
...
class AXBreadcrumbsPane extends _AccessibilitySubPane_js__WEBPACK_IMPORTED_MODULE_8__.AccessibilitySubPane {
    constructor(axSidebarView) {
        ...
        Object.defineProperty(this, "axSidebarView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "preselectedBreadcrumb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "inspectedNodeBreadcrumb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "collapsingBreadcrumbId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "hoveredBreadcrumb", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        _AXBreadcrumbsPane_legacyTreeDisabled.set(this, false);
        ...
        const experiment = _core_root_root_js__WEBPACK_IMPORTED_MODULE_3__.Runtime.ExperimentName.FULL_ACCESSIBILITY_TREE;
        ...
        if (_core_root_root_js__WEBPACK_IMPORTED_MODULE_3__.Runtime.experiments.isEnabled(experiment)) {
            __classPrivateFieldSet(this, _AXBreadcrumbsPane_legacyTreeDisabled, true, "f");
    ...
    setAXNode(axNode) {
        if (__classPrivateFieldGet(this, _AXBreadcrumbsPane_legacyTreeDisabled, "f")) {
            return;
        }
    ...
    wasShown() {
        super.wasShown();
        this.registerCSSFiles([Object(function webpackMissingModule() { var e = new Error("Cannot find module './axBreadcrumbs.css.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]);
    }
}
_AXBreadcrumbsPane_legacyTreeDisabled = new WeakMap();
...
class AXBreadcrumb {
    constructor(axNode, depth, inspected) {
        ...
        Object.defineProperty(this, "nodeElementInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "nodeWrapper", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "childrenGroupElement", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "preselectedInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "inspectedInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "expandLoggable", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
