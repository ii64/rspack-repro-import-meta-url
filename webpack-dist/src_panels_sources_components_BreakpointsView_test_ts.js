"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_components_BreakpointsView_test_ts"],{

/***/ "./src/panels/sources/components/BreakpointsView.test.ts":
/*!***************************************************************!*\
  !*** ./src/panels/sources/components/BreakpointsView.test.ts ***!
  \***************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components.js */ "./src/panels/sources/components/components.ts");
...
async function renderSingleBreakpoint(type = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.REGULAR_BREAKPOINT, hoverText) {
    // Only provide a hover text if it's not a regular breakpoint.
    assert.isTrue(!hoverText || type !== _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.REGULAR_BREAKPOINT);
    const component = await createAndInitializeBreakpointsView();
    const data = {
        breakpointsActive: true,
                ...
                breakpointItems: [
                    {
                        ...
                        isHit: true,
                        status: _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED,
                        type,
                        hoverText,
                    },
                ],
        ...
        groups: [
            {
                ...
                breakpointItems: [
                    {
                        id: '1',
                        type: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.REGULAR_BREAKPOINT,
                        location: '234',
                    ...
                    },
                    {
                        ...
                        codeSnippet: 'if (x > a) {',
                        isHit: true,
                        status: _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.DISABLED,
                    },
                ],
            },
            {
...
function checkCheckboxState(checkbox, breakpointItem) {
    ...
    if (breakpointItem.status === _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.INDETERMINATE) {
        assert.isTrue(indeterminate);
    }
    else {
        assert.isFalse(indeterminate);
        assert.strictEqual((breakpointItem.status === _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED), checked);
    }
}
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_6__.describeWithEnvironment)('BreakpointsSidebarController', () => {
    ...
    it('changes breakpoint state', async () => {
        const { groups, location } = await setUpTestWithOneBreakpointLocation();
        const breakpointItem = groups[0].breakpointItems[0];
        assert.strictEqual(breakpointItem.status, _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED);
        const breakpoint = location.breakpoint;
    ...
    describe('getUpdatedBreakpointViewData', () => {
        it('extracts breakpoint data', async () => {
            ...
            const createExpectedBreakpointGroups = (testData) => {
                const status = testData.enabled ? _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED :
                    _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.DISABLED;
                let type = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.REGULAR_BREAKPOINT;
                if (testData.condition) {
                    if (testData.isLogpoint) {
                        type = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.LOGPOINT;
                    }
                    else {
                        type = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.CONDITIONAL_BREAKPOINT;
                    }
                }
                return {
                    name: testData.url,
        ...
        it('correctly extracts the enabled state', async () => {
            ...
            const breakpointItem = groups[0].breakpointItems[0];
            assert.strictEqual(breakpointItem.status, _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.DISABLED);
        });
        it('correctly extracts the enabled state', async () => {
            const testData = [
            ...
            assert.lengthOf(actualViewData.groups, 1);
            assert.lengthOf(actualViewData.groups[0].breakpointItems, 1);
            assert.strictEqual(actualViewData.groups[0].breakpointItems[0].status, _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.INDETERMINATE);
        });
        ...
        it('correctly extracts conditional breakpoints', async () => {
            ...
            assert.strictEqual(breakpointItem.type, _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.CONDITIONAL_BREAKPOINT);
        ...
        it('correctly extracts logpoints', async () => {
            ...
            assert.lengthOf(actualViewData.groups[0].breakpointItems, 1);
            const breakpointItem = actualViewData.groups[0].breakpointItems[0];
            assert.strictEqual(breakpointItem.type, _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.LOGPOINT);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_7__.describeWithMockConnection)('BreakpointsSidebarController', () => {
    ...
    const DEFAULT_BREAKPOINT = [
        ...
        true, // enabled
        false, // isLogpoint
        _models_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_3__.BreakpointManager.BreakpointOrigin.USER_ACTION,
    ];
    // Flaky
    ...
    it('does not auto-expand if a breakpoint was not triggered by user action', async () => {
        ...
        const b2 = await breakpointManager.setBreakpoint(uiSourceCode, 0, 3, _models_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_3__.BreakpointManager.EMPTY_BREAKPOINT_CONDITION, true, false, _models_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_3__.BreakpointManager.BreakpointOrigin.OTHER);
        assert.exists(b2);
        {
            const data = await controller.getUpdatedBreakpointViewData();
            assert.lengthOf(data.groups, 1);
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_7__.describeWithMockConnection)('BreakpointsView', () => {
    ...
    it('shows a tooltip with edit condition on regular breakpoints', async () => {
        const { component } = await renderSingleBreakpoint(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.REGULAR_BREAKPOINT);
        assert.isNotNull(component.shadowRoot);
        await hover(component, BREAKPOINT_ITEM_SELECTOR);
        const editBreakpointButton = component.shadowRoot.querySelector(EDIT_SINGLE_BREAKPOINT_SELECTOR);
        assert.instanceOf(editBreakpointButton, HTMLButtonElement);
    ...
    describe('group checkboxes', () => {
        ...
        it('show a checked group checkbox if at least one breakpoint in that group is enabled', async () => {
            ...
            data.groups[0].breakpointItems[0].status = _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED;
            component.data = data;
            await coordinator.done();
            await hover(component, SUMMARY_SELECTOR);
            assert.isNotNull(component.shadowRoot);
        ...
        it('show an unchecked group checkbox if no breakpoint in that group is enabled', async () => {
            ...
            for (let i = 0; i < breakpointItems.length; ++i) {
                breakpointItems[i].status = _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.DISABLED;
            }
            component.data = data;
            await coordinator.done();
            await hover(component, SUMMARY_SELECTOR);
        ...
        it('disable all breakpoints on unchecking', async () => {
            ...
            for (let i = 0; i < numBreakpointItems; ++i) {
                data.groups[0].breakpointItems[i].status = _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.ENABLED;
            }
            component.data = data;
            await coordinator.done();
            await hover(component, SUMMARY_SELECTOR);
        ...
        it('enable all breakpoints on unchecking', async () => {
            ...
            // Make sure that all breakpoints are disabled.
            for (let i = 0; i < numBreakpointItems; ++i) {
                data.groups[0].breakpointItems[i].status = _components_js__WEBPACK_IMPORTED_MODULE_11__.BreakpointsView.BreakpointStatus.DISABLED;
            }
            component.data = data;
            await coordinator.done();
            await hover(component, SUMMARY_SELECTOR);
    ...
    describe('conditional breakpoints', () => {
        ...
        it('are rendered', async () => {
            const { component } = await renderSingleBreakpoint(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.CONDITIONAL_BREAKPOINT, breakpointDetails);
    ...
    describe('logpoints', () => {
        const breakpointDetails = 'x, a';
        it('are rendered', async () => {
            const { component } = await renderSingleBreakpoint(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_1__.DebuggerModel.BreakpointType.LOGPOINT, breakpointDetails);
            const breakpointItem = component.shadowRoot?.querySelector(BREAKPOINT_ITEM_SELECTOR);
            assert.exists(breakpointItem);
            assert.instanceOf(breakpointItem, HTMLDivElement);
