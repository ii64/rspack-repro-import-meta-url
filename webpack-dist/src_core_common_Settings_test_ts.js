"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_common_Settings_test_ts"],{

/***/ "./src/core/common/Settings.test.ts":
/*!******************************************!*\
  !*** ./src/core/common/Settings.test.ts ***!
  \******************************************/
...
var _MockStore_store;

const SettingsStorage = _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingsStorage;
const VersionController = _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.VersionController;
class MockStore {
    constructor() {
        _MockStore_store.set(this, new Map());
    }
    register() {
    }
    set(key, value) {
        __classPrivateFieldGet(this, _MockStore_store, "f").set(key, value);
    }
    get(key) {
        return __classPrivateFieldGet(this, _MockStore_store, "f").get(key);
    }
    remove(key) {
        __classPrivateFieldGet(this, _MockStore_store, "f").delete(key);
    }
    clear() {
        __classPrivateFieldGet(this, _MockStore_store, "f").clear();
    }
}
_MockStore_store = new WeakMap();
...
describe('Settings instance', () => {
    ...
    it('can be instantiated in a test', () => {
        ...
        const settings = _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance({
            forceNew: true,
    ...
    it('throws when constructed without storage', () => {
        assert.throws(() => _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance());
        assert.throws(() => _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance({ forceNew: true, syncedStorage: null, globalStorage: null, localStorage: null }));
    });
    it('stores synced settings in the correct storage', () => {
        ...
        _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.registerSettingExtension({
            ...
            settingType: _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingType.BOOLEAN,
            defaultValue: false,
            storageType: _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced,
        });
        const settings = _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance({ forceNew: true, syncedStorage, globalStorage: dummyStorage, localStorage: dummyStorage });
        const dynamicSetting = settings.createSetting('dynamic-synced-setting', 'default val', _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced);
    ...
    it('registers settings with the backing store when creating them', () => {
        ...
        const mockBackingStore = {
            ..._common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.NOOP_STORAGE,
        ...
        _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.registerSettingExtension({
            ...
            settingType: _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingType.BOOLEAN,
            defaultValue: false,
            storageType: _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Global,
        });
        const settings = _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance({ forceNew: true, syncedStorage: storage, globalStorage: storage, localStorage: storage });
        settings.createSetting('dynamic-local-setting', 42, _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Local);
        settings.createSetting('dynamic-synced-setting', 'foo', _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Synced);
    ...
    describe('forceGet', () => {
        it('triggers a setting changed event in case the value in the backing store got updated and we update the cached value', async () => {
            ...
            const testSetting = settings.createSetting('test', 'default val', _common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.SettingStorageType.Global);
            const changes = [];
