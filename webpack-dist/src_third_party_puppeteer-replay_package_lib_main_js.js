"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer-replay_package_lib_main_js"],{

/***/ "./src/third_party/puppeteer-replay/package/lib/main.js":
/*!**************************************************************!*\
  !*** ./src/third_party/puppeteer-replay/package/lib/main.js ***!
  \**************************************************************/
...
/* harmony export */   AssertedEventType: () => (/* binding */ AssertedEventType),
/* harmony export */   JSONStringifyExtension: () => (/* binding */ JSONStringifyExtension),
/* harmony export */   LighthouseRunnerExtension: () => (/* binding */ LighthouseRunnerExtension),
/* harmony export */   LighthouseStringifyExtension: () => (/* binding */ LighthouseStringifyExtension),
/* harmony export */   PuppeteerReplayStringifyExtension: () => (/* binding */ PuppeteerReplayStringifyExtension),
/* harmony export */   PuppeteerRunnerExtension: () => (/* binding */ PuppeteerRunnerExtension),
/* harmony export */   PuppeteerRunnerOwningBrowserExtension: () => (/* binding */ PuppeteerRunnerOwningBrowserExtension),
/* harmony export */   PuppeteerStringifyExtension: () => (/* binding */ PuppeteerStringifyExtension),
/* harmony export */   Runner: () => (/* binding */ Runner),
/* harmony export */   RunnerExtension: () => (/* binding */ RunnerExtension),
/* harmony export */   Schema: () => (/* binding */ Schema),
/* harmony export */   SelectorType: () => (/* binding */ SelectorType),
/* harmony export */   StepType: () => (/* binding */ StepType),
/* harmony export */   StringifyExtension: () => (/* binding */ StringifyExtension),
/* harmony export */   assertAllStepTypesAreHandled: () => (/* binding */ assertAllStepTypesAreHandled),
/* harmony export */   createRunner: () => (/* binding */ createRunner),
/* harmony export */   formatAsJSLiteral: () => (/* binding */ formatAsJSLiteral),
/* harmony export */   formatJSONAsJS: () => (/* binding */ formatJSONAsJS),
/* harmony export */   getSelectorType: () => (/* binding */ getSelectorType),
/* harmony export */   maxTimeout: () => (/* binding */ maxTimeout),
/* harmony export */   minTimeout: () => (/* binding */ minTimeout),
/* harmony export */   mouseButtonMap: () => (/* binding */ mouseButtonMap),
/* harmony export */   parse: () => (/* binding */ parse),
/* harmony export */   parseSourceMap: () => (/* binding */ parseSourceMap),
/* harmony export */   parseStep: () => (/* binding */ parseStep),
/* harmony export */   pointerDeviceTypes: () => (/* binding */ pointerDeviceTypes),
/* harmony export */   selectorToPElementSelector: () => (/* binding */ selectorToPElementSelector),
/* harmony export */   stringify: () => (/* binding */ stringify),
/* harmony export */   stringifyStep: () => (/* binding */ stringifyStep),
/* harmony export */   stripSourceMap: () => (/* binding */ stripSourceMap),
/* harmony export */   typeableInputTypes: () => (/* binding */ typeableInputTypes),
/* harmony export */   validTimeout: () => (/* binding */ validTimeout)
/* harmony export */ });
/**
...
class LighthouseRunnerExtension extends PuppeteerRunnerExtension {
    ...
    async beforeAllSteps(flow) {
        ...
        const { startFlow, desktopConfig } = await Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module 'lighthouse'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
