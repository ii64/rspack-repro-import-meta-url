...
/***/ "./panels/application/components/OriginTrialTreeView.test.js":
/*!*******************************************************************!*\
  !*** ./panels/application/components/OriginTrialTreeView.test.js ***!
  \*******************************************************************/
...
async function renderOriginTrialTreeView(data) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_4__.OriginTrialTreeView.OriginTrialTreeView();
    component.data = data;
...
async function renderOriginTrialTreeViewTreeOutline(data) {
    ...
    const treeOutline = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementWithinComponent)(component, 'devtools-tree-outline', _ui_components_tree_outline_tree_outline_js__WEBPACK_IMPORTED_MODULE_3__.TreeOutline.TreeOutline);
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('OriginTrialTreeView', () => {
