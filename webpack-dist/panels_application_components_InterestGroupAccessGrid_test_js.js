"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["panels_application_components_InterestGroupAccessGrid_test_js"],{

/***/ "./panels/application/components/InterestGroupAccessGrid.test.js":
/*!***********************************************************************!*\
  !*** ./panels/application/components/InterestGroupAccessGrid.test.js ***!
  \***********************************************************************/
...
async function renderInterestGroupAccessGrid(events) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_5__.InterestGroupAccessGrid.InterestGroupAccessGrid();
...
function getInternalDataGridShadowRoot(component) {
    const dataGridController = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementWithinComponent)(component, 'devtools-data-grid-controller', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_3__.DataGridController.DataGridController);
    const dataGrid = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementWithinComponent)(dataGridController, 'devtools-data-grid', _ui_components_data_grid_data_grid_js__WEBPACK_IMPORTED_MODULE_3__.DataGrid.DataGrid);
    assert.isNotNull(dataGrid.shadowRoot);
    return dataGrid.shadowRoot;
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('InterestGroupAccessGrid', () => {
