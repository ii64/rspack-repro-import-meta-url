"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_components_panel_feedback_PreviewToggle_test_ts"],{
...
/***/ "./src/ui/components/panel_feedback/PreviewToggle.test.ts":
/*!****************************************************************!*\
  !*** ./src/ui/components/panel_feedback/PreviewToggle.test.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _render_coordinator_render_coordinator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../render_coordinator/render_coordinator.js */ "./src/ui/components/render_coordinator/render_coordinator.ts");
/* harmony import */ var _panel_feedback_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./panel_feedback.js */ "./src/ui/components/panel_feedback/panel_feedback.ts");
...
const coordinator = _render_coordinator_render_coordinator_js__WEBPACK_IMPORTED_MODULE_3__.RenderCoordinator.RenderCoordinator.instance();
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('Preview toggle', () => {
    it('calls out correctly to enable experiment', async () => {
        const isEnabledStub = sinon.stub(_core_root_root_js__WEBPACK_IMPORTED_MODULE_0__.Runtime.experiments, 'isEnabled');
        isEnabledStub.callsFake(() => false);
        const setEnabledStub = sinon.stub(_core_root_root_js__WEBPACK_IMPORTED_MODULE_0__.Runtime.experiments, 'setEnabled');
        setEnabledStub.callsFake(() => { });
        const spy = sinon.spy();
        const component = new _panel_feedback_js__WEBPACK_IMPORTED_MODULE_4__.PreviewToggle.PreviewToggle();
        component.data = {
            name: 'toggle name',
        ...
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.dispatchClickEvent)(input);
