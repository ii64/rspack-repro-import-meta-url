"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_BlockedURLsPane_test_ts-src_ui_components_report_view_report_view_ts"],{

/***/ "./src/panels/network/BlockedURLsPane.test.ts":
/*!****************************************************!*\
  !*** ./src/panels/network/BlockedURLsPane.test.ts ***!
  \****************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_3__.describeWithMockConnection)('BlockedURLsPane', () => {
    beforeEach(() => {
    ...
    describe('update', () => {
        const updatesOnRequestFinishedEvent = (inScope) => () => {
            ...
            const blockedURLsPane = new _network_js__WEBPACK_IMPORTED_MODULE_4__.BlockedURLsPane.BlockedURLsPane();
            ...
            const request = sinon.createStubInstance(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.NetworkRequest.NetworkRequest, {
                wasBlocked: true,
        ...
        it('is called upon Reset event', () => {
            const blockedURLsPane = new _network_js__WEBPACK_IMPORTED_MODULE_4__.BlockedURLsPane.BlockedURLsPane();
            const updateStub = sinon.stub(blockedURLsPane, 'update');
            _models_logs_logs_js__WEBPACK_IMPORTED_MODULE_1__.NetworkLog.NetworkLog.instance().dispatchEventToListeners(_models_logs_logs_js__WEBPACK_IMPORTED_MODULE_1__.NetworkLog.Events.Reset, { clearIfPreserved: true });
