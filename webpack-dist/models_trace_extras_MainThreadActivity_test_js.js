...
/***/ "./models/trace/extras/MainThreadActivity.test.js":
/*!********************************************************!*\
  !*** ./models/trace/extras/MainThreadActivity.test.js ***!
  \********************************************************/
...
describe('MainThreadActivity', function () {
    ...
    it('focuses the window to avoid periods of low utilisation', async () => {
        const events = [
            ...
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(1_000), milliToMicro(50), DEVTOOLS_CATEGORY),
        ];
    ...
    it('uses the entire trace window if the period of low utilisation makes up the majority of the trace', async () => {
        const events = [
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(100), milliToMicro(50), DEVTOOLS_CATEGORY),
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(200_000), milliToMicro(50_000), DEVTOOLS_CATEGORY),
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(300_000), milliToMicro(50_000), DEVTOOLS_CATEGORY),
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(400_000), milliToMicro(50_000), DEVTOOLS_CATEGORY),
            (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_0__.makeCompleteEvent)('Program', milliToMicro(4_000_000), milliToMicro(50_000), DEVTOOLS_CATEGORY),
        ];
