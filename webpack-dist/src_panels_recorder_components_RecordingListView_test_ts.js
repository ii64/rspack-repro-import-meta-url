"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_recorder_components_RecordingListView_test_ts"],{

/***/ "./src/panels/recorder/components/RecordingListView.test.ts":
/*!******************************************************************!*\
  !*** ./src/panels/recorder/components/RecordingListView.test.ts ***!
  \******************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components.js */ "./src/panels/recorder/components/components.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('RecordingListView', () => {
    ...
    it('should open a recording on Enter', async () => {
        const view = new _components_js__WEBPACK_IMPORTED_MODULE_3__.RecordingListView.RecordingListView();
        ...
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(recording, { key: 'Enter' });
    ...
    it('should not open a recording on Enter on the delete button', async () => {
        ...
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.dispatchKeyDownEvent)(deleteButton, { key: 'Enter', bubbles: true });
