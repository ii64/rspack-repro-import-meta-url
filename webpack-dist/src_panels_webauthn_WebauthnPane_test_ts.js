"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_webauthn_WebauthnPane_test_ts"],{

/***/ "./src/panels/webauthn/WebauthnPane.test.ts":
/*!**************************************************!*\
  !*** ./src/panels/webauthn/WebauthnPane.test.ts ***!
  \**************************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('WebAuthn pane', () => {
    ...
    let Webauthn;
    before(async () => {
        Webauthn = await Promise.all(/*! import() */[__webpack_require__.e("src_panels_webauthn_WebauthnPane_ts"), __webpack_require__.e("src_panels_webauthn_webauthn_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./webauthn.js */ "./src/panels/webauthn/webauthn.ts"));
    });
    ...
    const tests = (inScope) => {
        ...
        it('lists and removes credentials', async () => {
            ...
            model.dispatchEventToListeners(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.WebAuthnModel.Events.CredentialAdded, {
                authenticatorId,
                credential,
            });
        ...
        it('updates credentials', async () => {
            ...
            model.dispatchEventToListeners(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.WebAuthnModel.Events.CredentialAsserted, {
                authenticatorId,
