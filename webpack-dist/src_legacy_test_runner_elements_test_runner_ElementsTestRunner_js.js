"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_legacy_test_runner_elements_test_runner_ElementsTestRunner_js"],{
...
/***/ "./src/legacy_test_runner/elements_test_runner/ElementsTestRunner.js":
/*!***************************************************************************!*\
  !*** ./src/legacy_test_runner/elements_test_runner/ElementsTestRunner.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _panels_animation_animation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../panels/animation/animation.js */ "./src/panels/animation/animation.ts");
/* harmony import */ var _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../panels/elements/elements.js */ "./src/panels/elements/elements.ts");
/* harmony import */ var _panels_event_listeners_event_listeners_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../panels/event_listeners/event_listeners.js */ "./src/panels/event_listeners/event_listeners.ts");
...
ElementsTestRunner.expandAndDumpEventListeners = function(eventListenersView, callback, force) {
  ...
  if (force) {
    ...
    TestRunner.addSniffer(
        _panels_event_listeners_event_listeners_js__WEBPACK_IMPORTED_MODULE_5__.EventListenersView.EventListenersView.prototype, 'eventListenersArrivedForTest',
        listenersArrived);
  }
};
...
ElementsTestRunner.waitForStyleCommitted = function(next) {
  TestRunner.addSniffer(
      _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.StylePropertyTreeElement.StylePropertyTreeElement.prototype, 'editingCommitted', (...args) => {
...
ElementsTestRunner.waitForSelectorCommitted = function(callback) {
  TestRunner.addSniffer(
      _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.StylePropertiesSection.StylePropertiesSection.prototype, 'editingSelectorCommittedForTest', callback);
};

ElementsTestRunner.waitForMediaTextCommitted = function(callback) {
  TestRunner.addSniffer(
      _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.StylePropertiesSection.StylePropertiesSection.prototype, 'editingMediaTextCommittedForTest', callback);
};

ElementsTestRunner.waitForStyleApplied = function(callback) {
  TestRunner.addSniffer(
      _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.StylePropertyTreeElement.StylePropertyTreeElement.prototype, 'styleTextAppliedForTest', callback);
};
...
ElementsTestRunner.filterMatchedStyles = function(text) {
  ...
  _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.ElementsPanel.ElementsPanel.instance().stylesWidget.onFilterChanged({data: text});
};

ElementsTestRunner.dumpRenderedMatchedStyles = function() {
  const sectionBlocks = _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.ElementsPanel.ElementsPanel.instance().stylesWidget.sectionBlocks;
  ...
  function dumpRenderedProperty(property) {
    ...
    for (let i = 0; i < property.childCount(); ++i) {
      ...
      let text = indent;
      text += _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.StringUtilities.sprintf(
...
async function extractLinkText(element) {
  ...
  const info = _ui_legacy_components_utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.Linkifier.Linkifier.linkInfo(anchor);
...
ElementsTestRunner.dumpDOMUpdateHighlights = function(rootNode, callback, depth) {
  ...
  function print(treeItem, prefix, depth) {
    if (!treeItem.root) {
      const elementXPath = _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.DOMPath.xPath(treeItem.node(), true);
...
ElementsTestRunner.dumpBreadcrumb = function(message) {
  ...
  const result = [];
  const crumbs = _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.ElementsPanel.ElementsPanel.instance().breadcrumbs.crumbsElement;
...
ElementsTestRunner.addNewRuleInStyleSheet = function(styleSheetHeader, selector, callback) {
  TestRunner.addSniffer(
      _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.StylesSidebarPane.StylesSidebarPane.prototype, 'addBlankSection',
...
ElementsTestRunner.addNewRule = function(selector, callback) {
  _panels_elements_elements_js__WEBPACK_IMPORTED_MODULE_4__.ElementsPanel.ElementsPanel.instance()
...
ElementsTestRunner.getDocumentElements = function() {
  ...
  const documents = Array.from(map.values()).filter(n => n instanceof _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DOMModel.DOMDocument);
  return documents;
};
