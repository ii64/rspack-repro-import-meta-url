...
/***/ "./panels/recorder/components/ReplaySection.test.js":
/*!**********************************************************!*\
  !*** ./panels/recorder/components/ReplaySection.test.js ***!
  \**********************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('ReplaySection', () => {
    ...
    it('should change the button value when another option is selected in select menu', async () => {
        ...
        selectButton?.dispatchEvent(new _components_js__WEBPACK_IMPORTED_MODULE_4__.SelectButton.SelectMenuSelectedEvent("slow" /* Models.RecordingPlayer.PlayRecordingSpeed.Slow */));
        await coordinator.done();
