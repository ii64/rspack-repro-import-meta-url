...
/***/ "./panels/network/RequestTimingView.test.js":
/*!**************************************************!*\
  !*** ./panels/network/RequestTimingView.test.js ***!
  \**************************************************/
...
describe('ResourceTimingView', () => {
    it('RequestTimeRanges has router evaluation field with SW router source as network', async () => {
        ...
        const timeRanges = _RequestTimingView_js__WEBPACK_IMPORTED_MODULE_1__.RequestTimingView.calculateRequestTimeRanges(request, 100);
