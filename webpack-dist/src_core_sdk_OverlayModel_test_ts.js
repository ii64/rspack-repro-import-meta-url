"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_sdk_OverlayModel_test_ts"],{

/***/ "./src/core/sdk/OverlayModel.test.ts":
/*!*******************************************!*\
  !*** ./src/core/sdk/OverlayModel.test.ts ***!
  \*******************************************/
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.describeWithMockConnection)('OverlayModel', () => {
    ...
    beforeEach(() => {
        const target = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.createTarget)({ url: DOCUMENT_URL_FOR_TEST });
        overlayModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.OverlayModel.OverlayModel);
        cssModel = target.model(_sdk_js__WEBPACK_IMPORTED_MODULE_3__.CSSModel.CSSModel);
        assert.exists(cssModel);
        windowControls = new _sdk_js__WEBPACK_IMPORTED_MODULE_3__.OverlayModel.WindowControls(cssModel);
        // Set up mock response handler to get the default style sheet
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('CSS.getStyleSheetText', () => {
    ...
    it('toggles controls toolbar', async () => {
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('Overlay.setShowWindowControlsOverlay', request => {
            config = request;
            return request;
        });
    ...
    it('toggles the emulated overlay', async () => {
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_2__.setMockConnectionResponseHandler)('CSS.setStyleSheetText', req => {
            styleSheet = req.text;
            return req;
        });
