...
/***/ "./panels/timeline/TimelineUIUtils.test.js":
/*!*************************************************!*\
  !*** ./panels/timeline/TimelineUIUtils.test.js ***!
  \*************************************************/
...
`;
        ...
        it('treats the v8.parseOnBackgroundWaiting as scripting even though it would usually be idle', function () {
            const event = (0,_testing_TraceHelpers_js__WEBPACK_IMPORTED_MODULE_10__.makeCompleteEvent)("v8.parseOnBackgroundWaiting" /* TraceEngine.Types.TraceEvents.KnownEventName.StreamingCompileScriptWaiting */, 1, 1, 'v8,devtools.timeline,disabled-by-default-v8.compile');
