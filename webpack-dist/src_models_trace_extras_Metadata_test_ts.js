"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_extras_Metadata_test_ts"],{

/***/ "./src/models/trace/extras/Metadata.test.ts":
/*!**************************************************!*\
  !*** ./src/models/trace/extras/Metadata.test.ts ***!
  \**************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('Trace Metadata', () => {
    it('returns the associated metadata', async () => {
        ...
        assert.deepEqual(metadata, {
            ...
            dataOrigin: _trace_js__WEBPACK_IMPORTED_MODULE_2__.Types.File.DataOrigin.TraceEvents,
