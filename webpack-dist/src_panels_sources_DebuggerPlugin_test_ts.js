"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_sources_DebuggerPlugin_test_ts"],{

/***/ "./src/panels/sources/DebuggerPlugin.test.ts":
/*!***************************************************!*\
  !*** ./src/panels/sources/DebuggerPlugin.test.ts ***!
  \***************************************************/
...
/* harmony import */ var _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../third_party/codemirror.next/codemirror.next.js */ "./src/third_party/codemirror.next/codemirror.next.js");
/* harmony import */ var _ui_components_text_editor_text_editor_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../ui/components/text_editor/text_editor.js */ "./src/ui/components/text_editor/text_editor.ts");
/* harmony import */ var _sources_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./sources.js */ "./src/panels/sources/sources.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.describeWithMockConnection)('Inline variable view scope helpers', () => {
    ...
    async function toOffsetWithSourceMap(sourceMap, location) {
        ...
        const text = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(content);
    ...
    async function toOffset(source, location) {
        ...
        const text = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(source);
    ...
    it('can resolve single scope mappings with source map', async () => {
        ...
        const expectedOffsets = (0,_testing_MockScopeChain_js__WEBPACK_IMPORTED_MODULE_7__.parseScopeChain)(originalScopes);
        ...
        const scopeMappings = await _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin.computeScopeMappings(callFrame, l => toOffsetWithSourceMap(sourceMap, l));
        const text = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(originalSource);
    ...
    it('can resolve simple scope mappings', async () => {
        ...
        const scopes = '          {              }';
        const expectedOffsets = (0,_testing_MockScopeChain_js__WEBPACK_IMPORTED_MODULE_7__.parseScopeChain)(scopes);
        ...
        const scopeMappings = await _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin.computeScopeMappings(callFrame, l => toOffset(source, l));
        assert.strictEqual(scopeMappings.length, 1);
...
function makeState(doc, extensions = []) {
    return _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorState.create({
        doc,
        extensions: [
            extensions,
            _ui_components_text_editor_text_editor_js__WEBPACK_IMPORTED_MODULE_9__.Config.baseConfiguration(doc),
            _ui_components_text_editor_text_editor_js__WEBPACK_IMPORTED_MODULE_9__.Config.autocompletion.instance(),
        ],
    });
}
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_5__.describeWithEnvironment)('Inline variable view parser', () => {
    it('parses simple identifier', () => {
        const state = makeState('c', _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.javascript.javascriptLanguage);
        const variables = _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin.getVariableNamesByLine(state, 0, 1, 1);
    ...
    it('parses simple function', () => {
      ...
      debugger;
        ...
        const state = makeState(code, _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.javascript.javascriptLanguage);
        const variables = _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin.getVariableNamesByLine(state, 10, code.length, code.indexOf('debugger'));
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_5__.describeWithEnvironment)('Inline variable view scope value resolution', () => {
    it('resolves single variable in single scope', () => {
        const value42 = { type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.RemoteObjectType.Number, value: 42 };
        const scopeMappings = [{ scopeStart: 0, scopeEnd: 10, variableMap: new Map([['a', value42]]) }];
        const variableNames = [{ line: 3, from: 5, id: 'a' }];
        const valuesByLine = _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin.getVariableValuesByLine(scopeMappings, variableNames);
    ...
    it('resolves shadowed variables', () => {
        const value1 = { type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.RemoteObjectType.Number, value: 1 };
        const value2 = { type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.RemoteObjectType.Number, value: 2 };
        const scopeMappings = [
...
describe('DebuggerPlugin', () => {
    describe('computePopoverHighlightRange', () => {
        const { computePopoverHighlightRange } = _sources_js__WEBPACK_IMPORTED_MODULE_10__.DebuggerPlugin;
        it('correctly returns highlight range depending on cursor position and selection', () => {
            const doc = 'Hello World!';
            const selection = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorSelection.create([
                _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorSelection.range(2, 5),
            ]);
            const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorState.create({ doc, selection });
        ...
        describe('in JavaScript files', () => {
            const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.javascript.javascript()];
            it('correctly returns highlight range for member assignments', () => {
                const doc = 'obj.foo = 42;';
                const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorState.create({ doc, extensions });
...
globalThis.foo = bar + baz;
                ...
                const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.html.html()];
                const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorState.create({ doc, extensions });
...
<button onclick="foo(bar, baz)">Click me!</button>`;
  ...
  return obj.x + obj.y;
                ...
                const extensions = [_third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.javascript.tsxLanguage];
                const state = _third_party_codemirror_next_codemirror_next_js__WEBPACK_IMPORTED_MODULE_8__.EditorState.create({ doc, extensions });
