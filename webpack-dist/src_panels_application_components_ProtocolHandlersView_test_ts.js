"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_application_components_ProtocolHandlersView_test_ts"],{

/***/ "./src/panels/application/components/ProtocolHandlersView.test.ts":
/*!************************************************************************!*\
  !*** ./src/panels/application/components/ProtocolHandlersView.test.ts ***!
  \************************************************************************/
...
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components.js */ "./src/panels/application/components/components.ts");
...
async function renderProtocolHandlersComponent(manifestLink, protocolHandlers) {
    const component = new _components_js__WEBPACK_IMPORTED_MODULE_2__.ProtocolHandlersView.ProtocolHandlersView();
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithEnvironment)('ProtocolHandlersView', () => {
    it('renders view when protocols are detected', async () => {
        ...
        const protocolsDetectedMessage = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getCleanTextContentFromElements)(statusElement, 'span');
        ...
        const selectElement = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementWithinComponent)(component, '.protocol-select', HTMLSelectElement);
        const values = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getCleanTextContentFromElements)(selectElement, 'option');
    ...
    it('renders protocols not detected status message', async () => {
        ...
        const protocolsNotDetectedMessage = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getCleanTextContentFromElements)(noStatusElement, 'span');
