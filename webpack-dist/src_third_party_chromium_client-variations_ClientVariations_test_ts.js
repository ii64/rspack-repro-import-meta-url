"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_chromium_client-variations_ClientVariations_test_ts"],{

/***/ "./src/third_party/chromium/client-variations/ClientVariations.test.ts":
/*!*****************************************************************************!*\
  !*** ./src/third_party/chromium/client-variations/ClientVariations.test.ts ***!
  \*****************************************************************************/
...
/* harmony import */ var _client_variations_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./client-variations.js */ "./src/third_party/chromium/client-variations/client-variations.ts");
...
describe('formatClientVariations', () => {
    it('formats input containing both types of variation IDs', () => {
        const result = _client_variations_js__WEBPACK_IMPORTED_MODULE_0__.formatClientVariations({
...
describe('parseClientVariations', () => {
    it('returns empty lists for unparseable text', () => {
        const result = _client_variations_js__WEBPACK_IMPORTED_MODULE_0__.parseClientVariations('gibberish');
    ...
    it('returns empty lists for empty input', () => {
        const result = _client_variations_js__WEBPACK_IMPORTED_MODULE_0__.parseClientVariations('');
        assert.deepEqual(result, {
            variationIds: [],
            triggerVariationIds: [],
        });
    ...
    it('parses a valid serialized proto', () => {
        const result = _client_variations_js__WEBPACK_IMPORTED_MODULE_0__.parseClientVariations('CG8I3gEIzQIYvAMYqwQ=');
        assert.deepEqual(result, {
            variationIds: [111, 222, 333],
            triggerVariationIds: [444, 555],
        });
    ...
    it('returns empty lists for invalid encoded data', () => {
        const result = _client_variations_js__WEBPACK_IMPORTED_MODULE_0__.parseClientVariations('Z2liYmVyaXNo');
        assert.deepEqual(result, {
            variationIds: [],
            triggerVariationIds: [],
        });
