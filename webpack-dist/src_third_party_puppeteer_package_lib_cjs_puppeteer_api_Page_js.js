"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer_package_lib_cjs_puppeteer_api_Page_js"],{

/***/ "./src/third_party/puppeteer/package/lib/cjs/puppeteer/api/Page.js":
/*!*************************************************************************!*\
  !*** ./src/third_party/puppeteer/package/lib/cjs/puppeteer/api/Page.js ***!
  \*************************************************************************/
...
const locators_js_1 = __webpack_require__(/*! ./locators/locators.js */ "./src/third_party/puppeteer/package/lib/cjs/puppeteer/api/locators/locators.js");
/**
 * @internal
 */
    ...
    return class Page extends _classSuper {
        ...
        async screencast(options = {}) {
            const [{ ScreenRecorder }, [width, height, devicePixelRatio]] = await Promise.all([
                Promise.resolve().then(() => __importStar(__webpack_require__(/*! ../node/ScreenRecorder.js */ "./src/third_party/puppeteer/package/lib/cjs/puppeteer/node/ScreenRecorder.js"))),
            ...
            if (options.path) {
                const { createWriteStream } = await Promise.resolve().then(() => __importStar(__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))));
