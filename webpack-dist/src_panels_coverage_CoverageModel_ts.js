"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_coverage_CoverageModel_ts"],{

/***/ "./src/panels/coverage/CoverageModel.ts":
/*!**********************************************!*\
  !*** ./src/panels/coverage/CoverageModel.ts ***!
  \**********************************************/
...
/* harmony export */   CoverageInfo: () => (/* binding */ CoverageInfo),
/* harmony export */   CoverageModel: () => (/* binding */ CoverageModel),
/* harmony export */   CoverageType: () => (/* binding */ CoverageType),
/* harmony export */   Events: () => (/* binding */ Events),
/* harmony export */   SourceURLCoverageInfo: () => (/* binding */ SourceURLCoverageInfo),
/* harmony export */   SuspensionState: () => (/* binding */ SuspensionState),
/* harmony export */   URLCoverageInfo: () => (/* binding */ URLCoverageInfo),
/* harmony export */   mergeSegments: () => (/* binding */ mergeSegments)
/* harmony export */ });
...
(function (CoverageType) {
    ...
    CoverageType[CoverageType["JavaScript"] = 2] = "JavaScript";
    CoverageType[CoverageType["JavaScriptPerFunction"] = 4] = "JavaScriptPerFunction";
...
class CoverageModel extends _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.SDKModel.SDKModel {
    constructor(target) {
        super(target);
        Object.defineProperty(this, "cpuProfilerModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "coverageByURL", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "coverageByContentProvider", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "coverageUpdateTimes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "suspensionState", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "currentPollPromise", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "shouldResumePollingOnResume", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "jsBacklog", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "cssBacklog", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "performanceTraceRecording", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sourceMapManager", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "willResolveSourceMaps", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "processSourceMapBacklog", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        this.cpuProfilerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.CPUProfilerModel.CPUProfilerModel);
        this.cssModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.CSSModel.CSSModel);
        this.debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
        this.sourceMapManager = this.debuggerModel?.sourceMapManager() || null;
        this.sourceMapManager?.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.SourceMapManager.Events.SourceMapAttached, this.sourceMapAttached, this);
    ...
    async start(jsCoveragePerBlock) {
        ...
        if (this.cssModel) {
            ...
            this.clearCSS();
            this.cssModel.addEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.CSSModel.Events.StyleSheetAdded, this.handleStyleSheetAdded, this);
    ...
    async resolveSourceMap(script, sourceMap) {
        ...
        if (urlCoverage.sourcesURLCoverageInfo.size === 0) {
            const generatedContent = _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.ContentData.ContentData.textOr(await script.requestContentData(), '');
            const generatedText = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(generatedContent);
    ...
    async stop() {
        ...
        if (this.cssModel) {
            ...
            this.cssModel.removeEventListener(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.CSSModel.Events.StyleSheetAdded, this.handleStyleSheetAdded, this);
        }
        await Promise.all(promises);
    }
    reset() {
    ...
    async pollAndCallback() {
        ...
        console.assert(this.suspensionState !== SuspensionState.Suspended || Boolean(this.performanceTraceRecording), 'CoverageModel was suspended while polling.');
        if (updates.length) {
    ...
    async processCSSCoverage(ruleUsageList, stamp) {
        ...
        for (const entry of rulesByStyleSheet) {
            ...
            const subentry = await this.addCoverage(styleSheetHeader, styleSheetHeader.contentLength, styleSheetHeader.startLine, styleSheetHeader.startColumn, ranges, CoverageType.CSS, stamp);
            if (subentry) {
                updatedEntries.push(...subentry);
            }
        }
    ...
    addStyleSheetToCSSCoverage(styleSheetHeader) {
        void this.addCoverage(styleSheetHeader, styleSheetHeader.contentLength, styleSheetHeader.startLine, styleSheetHeader.startColumn, [], CoverageType.CSS, Date.now());
    }
    ...
    async addCoverage(contentProvider, contentLength, startLine, startColumn, ranges, type, stamp) {
        ...
        if (!urlCoverage) {
            ...
            if (sourceMap) {
                const generatedContent = _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.ContentData.ContentData.textOr(await contentProvider.requestContentData(), '');
                const generatedText = new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(generatedContent);
    ...
    addCoverageForSource(url, size, type, generatedUrlCoverage) {
        const uiSourceCode = _models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_4__.Workspace.WorkspaceImpl.instance().uiSourceCodeForURL(url);
...
_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.SDKModel.SDKModel.register(CoverageModel, { capabilities: _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.Target.Capability.None, autostart: false });
...
class URLCoverageInfo extends _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ObjectWrapper.ObjectWrapper {
    constructor(url) {
        super();
        Object.defineProperty(this, "urlInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "coverageInfoByLocation", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sizeInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "usedSizeInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "typeInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "isContentScriptInternal", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sourcesURLCoverageInfo", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "sourceSegments", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    ensureEntry(contentProvider, contentLength, lineOffset, columnOffset, type) {
        ...
        if ((type & CoverageType.JavaScript) && !this.coverageInfoByLocation.size &&
            contentProvider instanceof _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.Script.Script) {
    ...
    async getFullText() {
        ...
        const resource = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.ResourceTreeModel.ResourceTreeModel.resourceForURL(url);
        if (!resource) {
            return null;
        }
        const content = _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.ContentData.ContentData.textOr(await resource.requestContentData(), '');
        return new _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.Text.Text(content);
    }
    ...
    async entriesForExportBasedOnContent() {
        ...
        for (const infoKey of coverageByLocationKeys) {
            ...
            const entry = {
                ...
                text: _models_text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_3__.ContentData.ContentData.textOr(await info.getContentProvider().requestContentData(), null),
            };
            result.push(entry);
        }
        return result;
...
class SourceURLCoverageInfo extends URLCoverageInfo {
    constructor(sourceUrl, generatedUrlCoverage) {
        super(sourceUrl);
        Object.defineProperty(this, "generatedURLCoverageInfo", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "lastSourceUsedRange", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
...
const mergeSegments = (segmentsA, segmentsB) => {
    const result = [];
    let indexA = 0;
    let indexB = 0;
...
class CoverageInfo {
    constructor(contentProvider, size, lineOffset, columnOffset, type, generatedUrlCoverageInfo) {
        ...
        Object.defineProperty(this, "usedSize", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "statsByTimestamp", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "lineOffset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "columnOffset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "coverageType", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "sourceUsedSizeMap", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "sourceDeltaMap", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "sourceUsedRangeMap", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    usageForRange(start, end) {
        let index = _core_platform_platform_js__WEBPACK_IMPORTED_MODULE_1__.ArrayUtilities.upperBound(this.segments, start, (position, segment) => position - segment.end);
