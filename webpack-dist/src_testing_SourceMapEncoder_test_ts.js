"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_testing_SourceMapEncoder_test_ts"],{

/***/ "./src/testing/SourceMapEncoder.test.ts":
/*!**********************************************!*\
  !*** ./src/testing/SourceMapEncoder.test.ts ***!
  \**********************************************/
...
/* harmony import */ var _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SourceMapEncoder.js */ "./src/testing/SourceMapEncoder.ts");
...
describe('SourceMapEncoder', () => {
    ...
    it('translates number lists correctly', () => {
        ...
        assert.strictEqual('A', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([0]));
        assert.strictEqual('oG', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([100]));
        // Encoding of column => source:line:column mapping.
        assert.strictEqual('w+BoGUwM', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([1000, 100, 10, 200]));
        assert.strictEqual('DFHJ', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([-1, -2, -3, -4]));
        // Encoding of column => source:line:column@name mapping.
        assert.strictEqual('CEGIK', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([1, 2, 3, 4, 5]));
        assert.strictEqual('qGsGuGwGyG', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeVlqList([101, 102, 103, 104, 105]));
    });
    it('can encode trivial source maps correctly', () => {
        ...
        assert.deepEqual({
            ...
            mappings: 'A',
            version: 3,
        }, _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0']));
        assert.deepEqual({
            sources: ['a.js'],
            names: [],
            mappings: 'AAAA',
            version: 3,
        }, _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0']));
        assert.deepEqual({
            sources: ['a.js'],
            names: ['b'],
            mappings: 'AAAAA',
            version: 3,
        }, _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0@b']));
    });
    it('can encode multiple lines correctly', () => {
        // Next line encoding.
        assert.strictEqual('AAAA;AACA', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0', '1:0 => a.js:1:0']).mappings);
        assert.strictEqual('A;A', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0', '1:0']).mappings);
        // Skipping lines.
        assert.strictEqual(';A;;;A', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['1:0', '4:0']).mappings);
        assert.strictEqual(';AACA;;;AAEA', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['1:0 => a.js:1:0', '4:0 => a.js:3:0']).mappings);
    });
    it('can encode relative offset mappings correctly', () => {
        // Relative columns.
        assert.strictEqual('AAAA,EAAI,IAAD', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0', '0:2 => a.js:0:4', '0:6 => a.js:0:3']).mappings);
        // Reset after new line.
        assert.strictEqual('AAAA,EAAC;MAAE', _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0', '0:2 => a.js:0:1', '1:6 => a.js:0:3']).mappings);
        ...
        assert.deepEqual({
            ...
            version: 3,
        }, _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:1 => a.js:1:1', '1:1 => b.js:3:2', '2:1 => c.js:1:3', '3:1 => b.js:1:0']));
    });
    it('can encode names correctly', () => {
        assert.deepEqual({
            ...
            version: 3,
        }, _SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_0__.encodeSourceMap(['0:0 => a.js:0:0@a', '1:0 => a.js:1:0@b', '2:0 => a.js:2:0@c', '3:0 => a.js:3:0@a']));
    });
