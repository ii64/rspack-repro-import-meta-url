"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_trace_handlers_WarningsHandler_test_ts"],{

/***/ "./src/models/trace/handlers/WarningsHandler.test.ts":
/*!***********************************************************!*\
  !*** ./src/models/trace/handlers/WarningsHandler.test.ts ***!
  \***********************************************************/
...
describe('WarningsHandler', function () {
    ...
    it('identifies long tasks', async function () {
        ...
        assert.strictEqual(event?.name, _trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.KnownEventName.RunTask);
    });
    ...
    it('identifies reflows that take over 30ms', async function () {
        ...
        assert.strictEqual(stylesRecalc.name, _trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.KnownEventName.UpdateLayoutTree);
        assert.strictEqual(layout.name, _trace_js__WEBPACK_IMPORTED_MODULE_1__.Types.TraceEvents.KnownEventName.Layout);
    });
