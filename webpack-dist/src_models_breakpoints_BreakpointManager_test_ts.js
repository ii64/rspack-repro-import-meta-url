"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_models_breakpoints_BreakpointManager_test_ts"],{

/***/ "./src/models/breakpoints/BreakpointManager.test.ts":
/*!**********************************************************!*\
  !*** ./src/models/breakpoints/BreakpointManager.test.ts ***!
  \**********************************************************/
...
/* harmony import */ var _testing_LanguagePluginHelpers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../testing/LanguagePluginHelpers.js */ "./src/testing/LanguagePluginHelpers.ts");
...
/* harmony import */ var _testing_MockScopeChain_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../testing/MockScopeChain.js */ "./src/testing/MockScopeChain.ts");
/* harmony import */ var _testing_PersistenceHelpers_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../testing/PersistenceHelpers.js */ "./src/testing/PersistenceHelpers.ts");
...
/* harmony import */ var _testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../testing/SourceMapEncoder.js */ "./src/testing/SourceMapEncoder.ts");
/* harmony import */ var _testing_SourceMapHelpers_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../testing/SourceMapHelpers.js */ "./src/testing/SourceMapHelpers.ts");
/* harmony import */ var _testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../testing/UISourceCodeHelpers.js */ "./src/testing/UISourceCodeHelpers.ts");
/* harmony import */ var _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../bindings/bindings.js */ "./src/models/bindings/bindings.ts");
/* harmony import */ var _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../breakpoints/breakpoints.js */ "./src/models/breakpoints/breakpoints.ts");
/* harmony import */ var _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../persistence/persistence.js */ "./src/models/persistence/persistence.ts");
/* harmony import */ var _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../text_utils/text_utils.js */ "./src/models/text_utils/text_utils.ts");
/* harmony import */ var _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../workspace/workspace.js */ "./src/models/workspace/workspace.ts");
...
(0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.describeWithMockConnection)('BreakpointManager', () => {
    ...
    const DEFAULT_BREAKPOINT = [
        _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.EMPTY_BREAKPOINT_CONDITION,
        true, // enabled
        false, // isLogpoint
        _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointOrigin.OTHER,
    ];
    ...
    let workspace;
    beforeEach(async () => {
        workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance();
        targetManager = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.TargetManager.TargetManager.instance();
        const resourceMapping = new _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.ResourceMapping.ResourceMapping(targetManager, workspace);
        debuggerWorkspaceBinding = _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance({
            forceNew: true,
            resourceMapping,
            targetManager,
        });
        _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.IgnoreListManager.IgnoreListManager.instance({ forceNew: true, debuggerWorkspaceBinding });
        backend = new _testing_MockScopeChain_js__WEBPACK_IMPORTED_MODULE_7__.MockProtocolBackend();
        ...
        await (0,_testing_ResourceTreeHelpers_js__WEBPACK_IMPORTED_MODULE_9__.getInitializedResourceTreeModel)(target);
        breakpointManager = _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointManager.instance({ forceNew: true, targetManager, workspace, debuggerWorkspaceBinding });
    });
    ...
    describe('possibleBreakpoints', () => {
        it('correctly asks the back-end for breakable positions', async () => {
            ...
            (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.setMockConnectionResponseHandler)('Debugger.getPossibleBreakpoints', getPossibleBreakpoints);
            const uiTextRange = new _text_utils_text_utils_js__WEBPACK_IMPORTED_MODULE_16__.TextRange.TextRange(0, 0, 1, 0);
    ...
    describe('Breakpoints', () => {
        ...
        it('are only set if the uiSourceCode is still valid (not removed)', async () => {
            ...
            _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance().removeProject(uiSourceCode.project());
            // Set the breakpoint.
            const breakpoint = await breakpointManager.setBreakpoint(uiSourceCode, BREAKPOINT_SCRIPT_LINE, 2, ...DEFAULT_BREAKPOINT);
    ...
    describe('Breakpoint#backendCondition()', () => {
        function createBreakpoint(condition, isLogpoint) {
            const { uiSourceCode } = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_12__.createContentProviderUISourceCode)({ url: URL, mimeType: 'text/javascript' });
            const storageState = {
                url: URL,
            ...
            return new _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.Breakpoint(breakpointManager, uiSourceCode, storageState, _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointOrigin.USER_ACTION);
        }
        ...
        it('substitutes source-mapped variables', async () => {
            ...
            const cdpSetBreakpointPromise = new Promise(res => {
                (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.clearMockConnectionResponseHandler)('Debugger.setBreakpointByUrl');
                (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.setMockConnectionResponseHandler)('Debugger.setBreakpointByUrl', request => {
                    res(request);
                    return {};
                });
            });
            ...
            /* isLogpoint */ false, _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointOrigin.USER_ACTION);
            assert.exists(breakpoint);
            await breakpoint.updateBreakpoint();
    ...
    it('allows awaiting the restoration of breakpoints', async () => {
        _core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.experiments.enableForTest(_core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.ExperimentName.INSTRUMENTATION_BREAKPOINTS);
        const debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
        assert.exists(debuggerModel);
        const { uiSourceCode, project } = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_12__.createContentProviderUISourceCode)({ url: URL, mimeType: 'text/javascript' });
        ...
        _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance().removeProject(project);
        _core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.experiments.disableForTest(_core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.ExperimentName.INSTRUMENTATION_BREAKPOINTS);
    });
    it('allows awaiting on scheduled update in debugger', async () => {
        ...
        assert.isTrue(result === _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.DebuggerUpdateResult.OK);
    ...
    it('removes ui source code from breakpoint even after breakpoint live location update', async () => {
        ...
        const { uiSourceCode: uiSourceCodeTs } = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_12__.createContentProviderUISourceCode)({ url: 'http://example.com/source.ts', mimeType: 'text/typescript' });
        const debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
        assert.exists(debuggerModel);
        // Create an inline script and get a UI source code instance for it.
        const script = await backend.addScript(target, scriptDescription, null);
        ...
        const mapping = (0,_testing_UISourceCodeHelpers_js__WEBPACK_IMPORTED_MODULE_12__.createFakeScriptMapping)(debuggerModel, uiSourceCodeTs, BREAKPOINT_TS_LINE, script.scriptId);
        _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().addSourceMapping(mapping);
        ...
        _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().removeSourceMapping(mapping);
        await breakpoint.remove(false);
    });
    ...
    it('eagerly restores JavaScript breakpoints in a new target', async () => {
        ...
        _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointManager.instance({ forceNew: true, targetManager, workspace, debuggerWorkspaceBinding });
        ...
        _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.TargetManager.TargetManager.instance().setScopeTarget((0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)());
    ...
    it('saves generated location into storage', async () => {
        ...
        (0,_testing_SourceMapHelpers_js__WEBPACK_IMPORTED_MODULE_11__.setupPageResourceLoaderForSourceMap)(sourceMapContent);
    ...
    it('restores latest breakpoints from storage', async () => {
        ...
        const breakpointRequestLines = new Promise((resolve, reject) => {
            ...
            _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointManager.instance({
                forceNew: true,
                targetManager,
                workspace,
    ...
    describe('with instrumentation breakpoints turned on', () => {
        beforeEach(() => {
            ...
            const workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance();
            _core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.experiments.enableForTest(_core_root_root_js__WEBPACK_IMPORTED_MODULE_1__.Runtime.ExperimentName.INSTRUMENTATION_BREAKPOINTS);
            breakpointManager = _breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.BreakpointManager.instance({ forceNew: true, targetManager, workspace, debuggerWorkspaceBinding });
        });
        afterEach(() => {
        ...
        async function testBreakpointMovedOnInstrumentationBreak(fileSystemPath, fileSystemFileUrl, content, type) {
            const debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
            assert.exists(debuggerModel);
            const { uiSourceCode: fileSystemUiSourceCode, project } = (0,_testing_PersistenceHelpers_js__WEBPACK_IMPORTED_MODULE_8__.createFileSystemFileForPersistenceTests)({ fileSystemFileUrl, fileSystemPath, type: type }, scriptDescription.url, content, target);
            ...
            assert.exists(uiSourceCode);
            assert.strictEqual(uiSourceCode.project().type(), _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.projectTypes.Network);
            // Set the breakpoint response for our upcoming request.
            ...
            const resumeSentPromise = (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.registerListenerOnOutgoingMessage)('Debugger.resume');
            // Inform the front-end about an instrumentation break.
            backend.dispatchDebuggerPause(script, _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Debugger.PausedEventReason.Instrumentation);
        ...
        it('can restore breakpoints in scripts', async () => {
            ...
            const resumeSentPromise = (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.registerListenerOnOutgoingMessage)('Debugger.resume');
            // Inform the front-end about an instrumentation break.
            backend.dispatchDebuggerPause(reloadedScript, _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Debugger.PausedEventReason.Instrumentation);
            // Wait for the breakpoints to be set, and the resume to be sent.
            await resumeSentPromise;
            // Verify the restored position.
        ...
        it('can restore breakpoints in a default-mapped inline scripts without sourceURL comment', async () => {
            ...
            assert.exists(uiSourceCode);
            assert.strictEqual(uiSourceCode.project().type(), _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.projectTypes.Debugger);
            ...
            const reloadedUiSourceCode = debuggerWorkspaceBinding.uiSourceCodeForScript(reloadedScript);
            assert.exists(reloadedUiSourceCode);
            assert.strictEqual(reloadedUiSourceCode.project().type(), _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.projectTypes.Debugger);
            // Set the breakpoint response for our upcoming request.
            void backend.responderToBreakpointByUrlRequest(URL_HTML, INLINE_BREAKPOINT_RAW_LINE)({
                breakpointId: 'RELOADED_BREAK_ID',
                locations: [
        ...
        it('can restore breakpoints in an inline script without sourceURL comment', async () => {
            ...
            function dispatchDocumentOpened() {
                (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.dispatchEvent)(target, 'Page.documentOpened', {
                    frame: {
                        id: 'main',
                        loaderId: 'foo',
                        url: URL_HTML,
                        ...
                        mimeType: 'text/html',
                        secureContextType: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Page.SecureContextType.Secure,
                        crossOriginIsolatedContextType: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Page.CrossOriginIsolatedContextType.Isolated,
                        gatedAPIFeatures: [],
                    },
                });
            }
            ...
            const reloadedUiSourceCode = debuggerWorkspaceBinding.uiSourceCodeForScript(reloadedScript);
            assert.exists(reloadedUiSourceCode);
            assert.strictEqual(reloadedUiSourceCode.project().type(), _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.projectTypes.Network);
            // Set the breakpoint response for our upcoming request.
            void backend.responderToBreakpointByUrlRequest(URL_HTML, INLINE_BREAKPOINT_RAW_LINE)({
                breakpointId: 'RELOADED_BREAK_ID',
                locations: [
        ...
        it('can restore breakpoints in scripts with language plugins', async () => {
            const { pluginManager } = _bindings_bindings_js__WEBPACK_IMPORTED_MODULE_13__.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance();
            const scriptInfo = { url: URL, content: '' };
            const script = await backend.addScript(target, scriptInfo, null);
            class Plugin extends _testing_LanguagePluginHelpers_js__WEBPACK_IMPORTED_MODULE_5__.TestPlugin {
                constructor() {
        ...
        it('can move breakpoints to network files that are set in matching file system files', async () => {
            const workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance();
            _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.Persistence.PersistenceImpl.instance({ forceNew: true, workspace, breakpointManager });
        ...
        it('can move breakpoints to network files that are set in override files', async () => {
            ...
            _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.Persistence.PersistenceImpl.instance({ forceNew: true, workspace, breakpointManager });
            _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.NetworkPersistenceManager.NetworkPersistenceManager.instance({ forceNew: true, workspace: _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance() });
    ...
    it('Breakpoint does not keep file system source code alive after file system removal', async () => {
        ...
        const resolvedBreakpointLine = 1;
        const workspace = _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance();
        const persistence = _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.Persistence.PersistenceImpl.instance({ forceNew: true, workspace, breakpointManager });
        _persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.NetworkPersistenceManager.NetworkPersistenceManager.instance({ forceNew: true, workspace: _workspace_workspace_js__WEBPACK_IMPORTED_MODULE_17__.Workspace.WorkspaceImpl.instance() });
        // Create a file system project and source code.
        const fileName = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.ParsedURL.ParsedURL.extractName(scriptDescription.url);
        const fileSystemPath = 'file://path/to/filesystem';
        const fileSystemFileUrl = fileSystemPath + '/' + fileName;
        const { uiSourceCode: fileSystemUiSourceCode, project } = (0,_testing_PersistenceHelpers_js__WEBPACK_IMPORTED_MODULE_8__.createFileSystemFileForPersistenceTests)({ fileSystemFileUrl, fileSystemPath }, scriptDescription.url, scriptDescription.content, target);
        const debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
        assert.exists(debuggerModel);
        // Add the same script via the debugger protocol.
        const bindingCreatedPromise = persistence.once(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.Persistence.Events.BindingCreated);
        const script = await backend.addScript(target, scriptDescription, null);
        const uiSourceCode = await uiSourceCodeFromScript(debuggerModel, script);
        ...
        const bindingRemovedPromise = persistence.once(_persistence_persistence_js__WEBPACK_IMPORTED_MODULE_15__.Persistence.Events.BindingRemoved);
        project.dispose();
    ...
    it('Breakpoints are set only into network project', async () => {
        ...
        const fileSystemPath = 'file://path/to/filesystem';
        const fileSystemFileUrl = fileSystemPath + '/' + fileName;
        (0,_testing_PersistenceHelpers_js__WEBPACK_IMPORTED_MODULE_8__.createFileSystemFileForPersistenceTests)({ fileSystemFileUrl, fileSystemPath }, scriptDescription.url, scriptDescription.content, target);
        const debuggerModel = target.model(_core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_2__.DebuggerModel.DebuggerModel);
        assert.exists(debuggerModel);
        ...
        breakpointManager.addEventListener(_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.Events.BreakpointAdded, ({ data: { breakpoint } }) => {
    ...
    it('updates a breakpoint after live editing the underlying script', async () => {
        ...
        (0,_testing_MockConnection_js__WEBPACK_IMPORTED_MODULE_6__.setMockConnectionResponseHandler)('Debugger.setScriptSource', () => ({ status: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_3__.Debugger.SetScriptSourceResponseStatus.Ok }));
        const uiSourceCode = await uiSourceCodeFromScript(debuggerModel, script);
        assert.exists(uiSourceCode);
        // Set the breakpoint on the front-end/model side.
        const breakpoint = await breakpointManager.setBreakpoint(uiSourceCode, 0, 0, ...DEFAULT_BREAKPOINT);
    ...
    describe('can correctly set breakpoints for all pre-registered targets', () => {
        ...
        function waitForBreakpointLocationsAdded() {
            ...
            breakpointManager.addEventListener(_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.Events.BreakpointAdded, () => {
        ...
        beforeEach(async () => {
            ...
            const workerTarget = (0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_4__.createTarget)({ name: 'worker', parentTarget: target });
            // Add script with source map.
            const scriptInfo = { url: URL, content: COMPILED_SCRIPT_SOURCES_CONTENT };
            const sourceMapInfo = { url: SOURCE_MAP_URL, content: sourceMapContent };
            ...
            const modelAddedStub = sinon.stub(_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_14__.BreakpointManager.Breakpoint.prototype, 'modelAdded').callsFake((() => { }));
    ...
    describe('supports modern Web development workflows', () => {
        it('supports webpack code splitting', async () => {
            ...
            const route1SourceMapInfo = {
                ...
                content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_10__.encodeSourceMap)(['0:0 => shared.ts:0:0', '1:0 => route1.ts:0:0'], sourceRoot),
            };
            ...
            const route2SourceMapInfo = {
                ...
                content: (0,_testing_SourceMapEncoder_js__WEBPACK_IMPORTED_MODULE_10__.encodeSourceMap)(['0:0 => shared.ts:0:0', '1:0 => route2.ts:0:0'], sourceRoot),
            };
