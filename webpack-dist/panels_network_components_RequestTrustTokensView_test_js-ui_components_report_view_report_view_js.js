...
/***/ "./panels/network/components/RequestTrustTokensView.test.js":
/*!******************************************************************!*\
  !*** ./panels/network/components/RequestTrustTokensView.test.js ***!
  \******************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('RequestTrustTokensView', () => {
    const mockId = 'mockId';
    ...
    const renderRequestTrustTokensView = (request) => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_2__.RequestTrustTokensView.RequestTrustTokensView(request);
    ...
    it('renders the RefreshPolicy for redemptions', () => {
        ...
        const [typeSpan, refreshPolicySpan] = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementsWithinComponent)(component, 'devtools-report-value.code', HTMLElement);
    ...
    it('renders all issuers as a list', () => {
        ...
        const issuerElements = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementsWithinComponent)(component, 'ul.issuers-list > li', HTMLElement);
    ...
    it('renders a result section with success status for successful requests', () => {
        ...
        const simpleText = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.getElementWithinComponent)(component, 'span > strong', HTMLElement);
