"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_mobile_throttling_ThrottlingManager_test_ts"],{

/***/ "./src/panels/mobile_throttling/ThrottlingManager.test.ts":
/*!****************************************************************!*\
  !*** ./src/panels/mobile_throttling/ThrottlingManager.test.ts ***!
  \****************************************************************/
...
/* harmony import */ var _mobile_throttling_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mobile_throttling.js */ "./src/panels/mobile_throttling/mobile_throttling.ts");
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithEnvironment)('ThrottlingManager', () => {
    describe('OfflineToolbarCheckbox', () => {
        it('has initial checked state which depends on throttling setting', () => {
            const throttlingManager = _mobile_throttling_js__WEBPACK_IMPORTED_MODULE_3__.ThrottlingManager.throttlingManager();
        ...
        it('updates setting when checkbox is clicked on', () => {
            const throttlingManager = _mobile_throttling_js__WEBPACK_IMPORTED_MODULE_3__.ThrottlingManager.throttlingManager();
            const multiTargetNetworkManager = _core_sdk_sdk_js__WEBPACK_IMPORTED_MODULE_0__.NetworkManager.MultitargetNetworkManager.instance();
