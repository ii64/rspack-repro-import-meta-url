...
/***/ "./ui/legacy/components/inline_editor/CSSLength.test.js":
/*!**************************************************************!*\
  !*** ./ui/legacy/components/inline_editor/CSSLength.test.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
describe('CSSLength', () => {
    ...
    describe('#CSSLengthUtils', () => {
        it('parses CSS properties with length correctly', () => {
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('42px'), { value: 42, unit: "px" /* InlineEditor.CSSLengthUtils.LengthUnit.PIXEL */ });
            assert.deepEqual(_inline_editor_js__WEBPACK_IMPORTED_MODULE_1__.CSSLengthUtils.parseText('-5vw'), { value: -5, unit: "vw" /* InlineEditor.CSSLengthUtils.LengthUnit.VW */ });
