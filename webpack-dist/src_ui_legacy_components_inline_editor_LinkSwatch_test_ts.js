"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_ui_legacy_components_inline_editor_LinkSwatch_test_ts"],{
...
/***/ "./src/ui/legacy/components/inline_editor/LinkSwatch.test.ts":
/*!*******************************************************************!*\
  !*** ./src/ui/legacy/components/inline_editor/LinkSwatch.test.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _inline_editor_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inline_editor.js */ "./src/ui/legacy/components/inline_editor/inline_editor.ts");
// Copyright 2020 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('CSSVarSwatch', () => {
    it('can be instantiated successfully', () => {
        const component = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_2__.LinkSwatch.CSSVarSwatch();
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_1__.describeWithLocale)('LinkSwatch', () => {
    it('can be instantiated successfully', () => {
        const component = new _inline_editor_js__WEBPACK_IMPORTED_MODULE_2__.LinkSwatch.LinkSwatch();
        (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component);
        assert.instanceOf(component, HTMLElement, 'The swatch is an instance of HTMLElement');
    });
    ...
    it('calls the onLinkActivate callback', async () => {
        ...
        const element = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_0__.renderElementIntoDOM)(component).shadowRoot.querySelector('devtools-base-link-swatch').shadowRoot
