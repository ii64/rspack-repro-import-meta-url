"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_core_platform_DOMUtilities_test_ts"],{

/***/ "./src/core/platform/DOMUtilities.test.ts":
/*!************************************************!*\
  !*** ./src/core/platform/DOMUtilities.test.ts ***!
  \************************************************/
...
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./platform.js */ "./src/core/platform/platform.ts");
...
describe('DOMUtilities', () => {
    describe('deepActiveElement', () => {
        it('returns the active element if there is no shadow root', () => {
            ...
            btn.focus();
            const activeElement = _platform_js__WEBPACK_IMPORTED_MODULE_1__.DOMUtilities.deepActiveElement(document);
    ...
    describe('getEnclosingShadowRootForNode', () => {
        ...
        it('returns the shadow root in the tree', () => {
            var _TestComponent_shadow;
            const div = document.createElement('div');
            class TestComponent extends HTMLElement {
                constructor() {
                    super(...arguments);
                    _TestComponent_shadow.set(this, this.attachShadow({ mode: 'open' }));
                }
                connectedCallback() {
                    __classPrivateFieldGet(this, _TestComponent_shadow, "f").appendChild(div);
                }
            }
            _TestComponent_shadow = new WeakMap();
