...
/***/ "./panels/sources/components/BreakpointsView.js":
/*!******************************************************!*\
  !*** ./panels/sources/components/BreakpointsView.js ***!
  \******************************************************/
...
class BreakpointsSidebarController {
    ...
    constructor(breakpointManager, settings) {
        this.#collapsedFilesSettings = _core_common_common_js__WEBPACK_IMPORTED_MODULE_0__.Settings.Settings.instance().createSetting('collapsed-files', []);
        this.#collapsedFiles = new Set(this.#collapsedFilesSettings.get());
        this.#breakpointManager = breakpointManager;
        this.#breakpointManager.addEventListener(_models_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_6__.BreakpointManager.Events.BreakpointAdded, this.#onBreakpointAdded, this);
        this.#breakpointManager.addEventListener(_models_breakpoints_breakpoints_js__WEBPACK_IMPORTED_MODULE_6__.BreakpointManager.Events.BreakpointRemoved, this.#onBreakpointRemoved, this);
    ...
    #getBreakpointLocations() {
        const locations = this.#breakpointManager.allBreakpointLocations().filter(breakpointLocation => breakpointLocation.uiLocation.uiSourceCode.project().type() !== _models_workspace_workspace_js__WEBPACK_IMPORTED_MODULE_8__.Workspace.projectTypes.Debugger);
...
class BreakpointsView extends _ui_components_legacy_wrapper_legacy_wrapper_js__WEBPACK_IMPORTED_MODULE_11__.LegacyWrapper.WrappableComponent {
    ...
    static litTagName = _ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.literal `devtools-breakpoint-view`;
    ...
    set data(data) {
        ...
        this.#urlToDifferentiatingPath = (0,_BreakpointsViewUtils_js__WEBPACK_IMPORTED_MODULE_17__.getDifferentiatingPathMap)(titleInfos);
        void this.render();
    }
    connectedCallback() {
        this.#shadow.adoptedStyleSheets = [_ui_components_input_input_js__WEBPACK_IMPORTED_MODULE_10__.checkboxStyles, _breakpointsView_css_js__WEBPACK_IMPORTED_MODULE_16__["default"]];
    }
    async render() {
        ...
        <div class='pause-on-uncaught-exceptions'
          ...
          <label class='checkbox-label'>
            <input type='checkbox' tabindex=-1 class="small" ?checked=${this.#pauseOnUncaughtExceptions} @change=${this.#onPauseOnUncaughtExceptionsStateChanged.bind(this)} jslog=${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_15__.toggle('pause-uncaught').track({ change: true })}>
        ...
        <div class='pause-on-caught-exceptions'
              ...
              data-last-pause>
            <label class='checkbox-label'>
              <input data-pause-on-caught-checkbox type='checkbox' class="small" tabindex=-1 ?checked=${pauseOnCaughtIsChecked} ?disabled=${pauseOnCaughtExceptionIsDisabled} @change=${this.#onPauseOnCaughtExceptionsStateChanged.bind(this)} jslog=${_ui_visual_logging_visual_logging_js__WEBPACK_IMPORTED_MODULE_15__.toggle('pause-on-caught-exception').track({ change: true })}>
              <span>${i18nString(UIStrings.pauseOnCaughtExceptions)}</span>
            </label>
        </div>
        <div role=tree>
          ${_ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.Directives.repeat(this.#breakpointGroups, group => group.url, (group, groupIndex) => _ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.html `${this.#renderBreakpointGroup(group, groupIndex)}`)}
        </div>`;
            // clang-format on
            _ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.render(out, this.#shadow, { host: this });
        });
      ...
      <details class=${_ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.Directives.classMap(classMap)}
          ...
          <summary @contextmenu=${contextmenuHandler}
            ...
            <span class='group-hover-actions'>
              ${this.#renderRemoveBreakpointButton(group.breakpointItems, i18nString(UIStrings.removeAllBreakpointsInFile), _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.Action.BreakpointsInFileRemovedFromRemoveButton)}
            </span>
          </summary>
        ${_ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.Directives.repeat(group.breakpointItems, item => item.id, (item, breakpointItemIndex) => this.#renderBreakpointEntry(item, group.editable, groupIndex, breakpointItemIndex))}
      </details>
      `;
        // clang-format on
    }
    ...
    <div class=${_ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.Directives.classMap(classMap)}
      ...
      <span class='breakpoint-item-location-or-actions'>
        ${editable ? this.#renderEditBreakpointButton(breakpointItem) : _ui_lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_14__.nothing}
        ${this.#renderRemoveBreakpointButton([breakpointItem], i18nString(UIStrings.removeBreakpoint), _core_host_host_js__WEBPACK_IMPORTED_MODULE_1__.UserMetrics.Action.BreakpointRemovedFromRemoveButton)}
...
/***/ "./panels/sources/components/breakpointsView.css.js":
/*!**********************************************************!*\
  !*** ./panels/sources/components/breakpointsView.css.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
