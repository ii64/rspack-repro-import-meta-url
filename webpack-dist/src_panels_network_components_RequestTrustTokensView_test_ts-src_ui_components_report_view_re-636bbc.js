"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_panels_network_components_RequestTrustTokensView_test_ts-src_ui_components_report_view_re-636bbc"],{

/***/ "./src/panels/network/components/RequestTrustTokensView.test.ts":
/*!**********************************************************************!*\
  !*** ./src/panels/network/components/RequestTrustTokensView.test.ts ***!
  \**********************************************************************/
...
(0,_testing_EnvironmentHelpers_js__WEBPACK_IMPORTED_MODULE_2__.describeWithLocale)('RequestTrustTokensView', () => {
    const mockId = 'mockId';
    ...
    const renderRequestTrustTokensView = (request) => {
        const component = new _components_js__WEBPACK_IMPORTED_MODULE_3__.RequestTrustTokensView.RequestTrustTokensView(request);
    ...
    it('renders the RefreshPolicy for redemptions', () => {
        const component = renderRequestTrustTokensView(makeRequest({
            operation: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationType.Redemption,
            refreshPolicy: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenParamsRefreshPolicy.UseCached,
        }));
        const [typeSpan, refreshPolicySpan] = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementsWithinComponent)(component, 'devtools-report-value.code', HTMLElement);
    ...
    it('renders all issuers as a list', () => {
        ...
        const component = renderRequestTrustTokensView(makeRequest({
            operation: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationType.Signing,
            issuers: expectedIssuers,
        }));
        const issuerElements = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementsWithinComponent)(component, 'ul.issuers-list > li', HTMLElement);
    ...
    it('renders a result section with success status for successful requests', () => {
        const component = renderRequestTrustTokensView(makeRequest(undefined, {
            status: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationDoneEventStatus.Ok,
            type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationType.Issuance,
            requestId: mockId,
        }));
        const simpleText = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementWithinComponent)(component, 'span > strong', HTMLElement);
    ...
    it('renders a result section with failure status for failed requests', () => {
        const component = renderRequestTrustTokensView(makeRequest(undefined, {
            status: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationDoneEventStatus.BadResponse,
            type: _generated_protocol_js__WEBPACK_IMPORTED_MODULE_0__.Network.TrustTokenOperationType.Issuance,
            requestId: mockId,
        }));
        const simpleText = (0,_testing_DOMHelpers_js__WEBPACK_IMPORTED_MODULE_1__.getElementWithinComponent)(component, 'span > strong', HTMLElement);
