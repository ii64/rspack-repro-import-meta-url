"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([["src_third_party_puppeteer_package_lib_esm_puppeteer_api_locators_locators_js"],{

/***/ "./src/third_party/puppeteer/package/lib/esm/puppeteer/api/locators/locators.js":
/*!**************************************************************************************!*\
  !*** ./src/third_party/puppeteer/package/lib/esm/puppeteer/api/locators/locators.js ***!
  \**************************************************************************************/
...
class Locator extends _common_EventEmitter_js__WEBPACK_IMPORTED_MODULE_1__.EventEmitter {
    ...
    operators = {
        conditions: (conditions, signal) => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)((handle) => {
                return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.merge)(...conditions.map(condition => {
        ...
        retryAndRaceWithSignalAndTimer: (signal, cause) => {
            ...
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.pipe)((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.retry)({ delay: RETRY_DELAY }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.raceWith)(...candidates));
        },
    };
    ...
    #waitForEnabledIfNeeded = (handle, signal) => {
        ...
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.frame.waitForFunction(element => {
    ...
    #waitForStableBoundingBoxIfNeeded = (handle) => {
        ...
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.defer)(() => {
            ...
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.evaluate(element => {
        ...
        }).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.first)(([rect1, rect2]) => {
            return (rect1.x === rect2.x &&
                rect1.y === rect2.y &&
                rect1.width === rect2.width &&
                rect1.height === rect2.height);
        }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.retry)({ delay: RETRY_DELAY }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.ignoreElements)());
    };
    /**
     ...
     */
        ...
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.isIntersectingViewport({ threshold: 0 })).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.filter)(isIntersectingViewport => {
            return !isIntersectingViewport;
        }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(() => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.scrollIntoView());
        }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(() => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.defer)(() => {
                return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.isIntersectingViewport({ threshold: 0 }));
            }).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.first)(_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.identity), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.retry)({ delay: RETRY_DELAY }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.ignoreElements)());
        }));
    };
    #click(options) {
        ...
        ], signal), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.tap)(() => {
            return this.emit(LocatorEvent.Action, undefined);
        }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(handle => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.click(options)).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.catchError)(err => {
    ...
    #fill(value, options) {
        ...
        return this._wait(options).pipe(this.operators.conditions([
            ...
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.evaluate(el => {
                ...
                .pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(inputType => {
                switch (inputType) {
                    case 'select':
                    ...
                    case 'typeable-input':
                        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.evaluate((input, newValue) => {
                        ...
                        }, value)).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(textToType => {
                            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.type(textToType));
                        }));
                    case 'other-input':
                        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.focus()).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(() => {
                            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.evaluate((input, value) => {
                                input.value = value;
                ...
                .pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.catchError)(err => {
                void handle.dispose().catch(_common_util_js__WEBPACK_IMPORTED_MODULE_2__.debugError);
                throw err;
            }));
        }), this.operators.retryAndRaceWithSignalAndTimer(signal, cause));
    ...
    #hover(options) {
        ...
        return this._wait(options).pipe(this.operators.conditions([
            ...
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.hover()).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.catchError)(err => {
                void handle.dispose().catch(_common_util_js__WEBPACK_IMPORTED_MODULE_2__.debugError);
                throw err;
            }));
        }), this.operators.retryAndRaceWithSignalAndTimer(signal, cause));
    ...
    #scroll(options) {
        ...
        return this._wait(options).pipe(this.operators.conditions([
            ...
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(handle.evaluate((el, scrollTop, scrollLeft) => {
            ...
            }, options?.scrollTop, options?.scrollLeft)).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.catchError)(err => {
                void handle.dispose().catch(_common_util_js__WEBPACK_IMPORTED_MODULE_2__.debugError);
                throw err;
            }));
        }), this.operators.retryAndRaceWithSignalAndTimer(signal, cause));
    ...
    async waitHandle(options) {
        ...
        return await (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.firstValueFrom)(this._wait(options).pipe(this.operators.retryAndRaceWithSignalAndTimer(options?.signal, cause)));
    }
    /**
     ...
     */
    click(options) {
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.firstValueFrom)(this.#click(options));
    }
    /**
     ...
     */
    fill(value, options) {
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.firstValueFrom)(this.#fill(value, options));
    }
    /**
     * Hovers over the located element.
     */
    hover(options) {
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.firstValueFrom)(this.#hover(options));
    }
    /**
     * Scrolls the located element.
     */
    scroll(options) {
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.firstValueFrom)(this.#scroll(options));
    }
}
/**
 * @internal
...
class FunctionLocator extends Locator {
    ...
    _wait(options) {
        const signal = options?.signal;
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.defer)(() => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(this.#pageOrFrame.waitForFunction(this.#func, {
...
class FilteredLocator extends DelegatedLocator {
    ...
    _wait(options) {
        return this.delegate._wait(options).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(handle => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(Promise.resolve(this.#predicate(handle, options?.signal))).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.filter)(value => {
                return value;
...
class MappedLocator extends DelegatedLocator {
    ...
    _wait(options) {
        return this.delegate._wait(options).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.mergeMap)(handle => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(Promise.resolve(this.#mapper(handle, options?.signal)));
        }));
    }
}
/**
...
class NodeLocator extends Locator {
    ...
    _wait(options) {
        const signal = options?.signal;
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.defer)(() => {
            return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.from)(this.#pageOrFrame.waitForSelector(this.#selector, {
                visible: false,
                timeout: this._timeout,
                signal,
            }));
        }).pipe((0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.filter)((value) => {
            return value !== null;
        }), (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.throwIfEmpty)(), this.operators.conditions([this.#waitForVisibilityIfNeeded], signal));
    }
}
...
class RaceLocator extends Locator {
    ...
    _wait(options) {
        return (0,_third_party_rxjs_rxjs_js__WEBPACK_IMPORTED_MODULE_0__.race)(...this.#locators.map(locator => {
